...
description: "Функция расширенной банковской выверки позволяет импортировать электронные банковские выписки и автоматически выверять их с банковскими проводками в Microsoft Dynamics 365 for Operations. В данном разделе описывается процесс выверки."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Функция расширенной банковской выверки позволяет импортировать электронные банковские выписки и автоматически выверять их с банковскими проводками в Microsoft Dynamics 365 for Operations. В данном разделе описывается процесс выверки.  
...
После обработки всех строк выписки следует пометить лист банковской выверки как выверенный.
