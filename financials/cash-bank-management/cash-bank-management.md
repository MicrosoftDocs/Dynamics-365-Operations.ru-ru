---
title: "Домашняя страница управления банком и кассовыми операциями"
description: "Можно использовать управление банком и кассовыми операциями для настройки банковских счетов и финансовых инструментов юридического лица, связанных с этими банковскими счетами."
author: twheeloc
manager: AnnBe
ms.date: 2017-04-04
ms.topic: index-page
...
-   [Аккредитивы и импорт коллекций](letters-of-credit-import-collections.md)
...
-   [Создание накладных поставщика с использованием предложения по оплате](../accounts-payable/create-vendor-payments-payment-proposal.md)
...
-   [Сценарий: Обработка скидки при оплате наличными для переплаты](../cash-bank-management/cash-discount-handling-overpayments.md)
