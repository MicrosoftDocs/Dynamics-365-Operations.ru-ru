...
description: "В данной статье описывается, как просмотреть и изучить финансовые отчеты в Microsoft Dynamics AX. Она содержит сведения о различных параметрах, которые можно применить к финансовым отчетам, чтобы изменить их внешний вид и данные, которые они содержат."
author: RobinARH
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
В данной статье описывается, как просмотреть и изучить финансовые отчеты в Microsoft Dynamics AX. Она содержит сведения о различных параметрах, которые можно применить к финансовым отчетам, чтобы изменить их внешний вид и данные, которые они содержат.
...
-   Чтобы применить фильтры измерений в отчет, выберите **добавить фильтр измерения**. Выбор аналитики и затем введите идентификатор измерения или выберите аналитику в списке. Чтобы удалить фильтр аналитики, щелкните **Очистить**.
...
Можно просмотреть отчеты за текущий месяц или предыдущие месяцы, не создавая отчет повторно. Чтобы открыть отчет для предыдущего месяца, щелкните **Показывать**и нажмите кнопку **предыдущие отчеты**. Появится список предыдущих месяцев, для которых был создан для отчета. Разверните месяц, чтобы просмотреть отчет за этот месяц, выберите дату и нажмите кнопку **ОК**. Отобразится отчет за предыдущий месяц. Чтобы вернуться к отчету за текущий месяц, нажмите кнопку **Отмена**.
...
[Финансовая отчетность в Microsoft Dynamics AX](/dynamics365/operations/dev-itpro/analytics/financial-reporting-intro)
