...
-   **Источник** — в этом компоненте пользователь определяет исходные данные для распределения. Распределения могут быть основаны на сальдо ГК (**источника данных** = **книги**) или фиксированной суммы (**источника данных** = **фиксированное значение**). Если для параметра **Источник данных** задано значение **Книга учета**, необходимо определить критерии фильтра по источнику для правила распределения книги учета (например, для расходов на рекламу).
