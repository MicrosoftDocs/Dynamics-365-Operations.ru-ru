...
description: "В этой статье приводятся примеры, которые показывают, как используются определения разносок для бюджетных обязательств по заказу покупки и ассигнования бюджета."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="posting-definition-examples"></a>Примеры определений разносок

В этой статье приводятся примеры, которые показывают, как используются определения разносок для бюджетных обязательств по заказу покупки и ассигнования бюджета.
...
> [!NOTE]
> Для связывания определения разноски с проводками конкретного типа, используйте **определений разносок проводок** страницы. После связывания определения разноски с типом проводок и выберите **определения разноски** на **параметры главной книги** страницы, все проводки, проводки выбранного типа должны использовать определения разноски.
...
|--------------------------------|--------|--------|---------|
| 606400 Подразделение\_Подразделение 1\_3566 обучения | 250,00 |        |         |
...
| Счет + аналитики           | по дебету  | по кредиту | Комментарий |
|--------------------------------|--------|--------|---------|
| 300143 Подразделение\_Подразделение 1\_3566 обучения | 250,00 |        |         |
| 300144 Подразделение\_Подразделение 1\_3566 обучения |        | 250,00 |         |

В этом примере критериям определения разноски соответствует любой счет в составе модуля "Структура счета - Прибыли и убытки". Таким образом, когда Подразделений 606500 #\_Подразделение 1\_3566 обучение, созданные записи создаются для счетов, которые определены в **созданные операции** область для определения разноски.
...
| Счет + аналитики           | по дебету  | по кредиту | Комментарий |
|--------------------------------|--------|--------|---------|
| 300145 Подразделение\_Подразделение 1\_3566 обучения |        | 250,00 |         |
| 300146 Подразделение\_Подразделение 1\_3566 обучения | 250,00 |        |         |

В этом примере критериям определения разноски соответствует любой счет в составе модуля "Структура счета - Прибыли и убытки". Таким образом, когда Подразделений 606400 #\_Подразделение 1\_3566 обучение, создаются созданные записи книги учета.
