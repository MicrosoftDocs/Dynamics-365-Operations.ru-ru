...
При выборе **за полгода один раз** в *** периода частоты ** поле **, можно настроить два вручную интервала графика списания. Суммы амортизации для таких двух интервалов показаны в следующей таблице.
...
Общая сумма процентов для всех интервалов не должна равняться 100. Тем не менее, вы получаете сообщение, если значение в **Суммарный процент** на **амортизация основного средства графики профилей** страница не **100**.
