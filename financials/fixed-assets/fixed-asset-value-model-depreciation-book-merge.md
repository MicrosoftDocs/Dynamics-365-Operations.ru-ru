...
description: "В предыдущих выпусках имеются две концепции переоценки для основных средств — модели стоимости и журналы амортизации. В Microsoft Dynamics 365 выпуска 1611 операций функции модели стоимости и функции книги амортизации были объединены в один понятие, которое называется книги."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
В предыдущих выпусках имеются две концепции переоценки для основных средств — модели стоимости и журналы амортизации. В Microsoft Dynamics 365 выпуска 1611 операций функции модели стоимости и функции книги амортизации были объединены в один понятие, которое называется книги.

Новая функциональность книги основана на более ранней функции модели стоимости, но также включает все функции, которые ранее были представлены только в журналах амортизации. [![Книги как объединение функций значение модели и амортизации книги](./media/fixed-assets.png)](./media/fixed-assets.png) из-за слияние, теперь можно использовать единый набор страниц, запросов и отчетов для всех процессов основных средств. Таблицы в этом разделе описывают более раннюю функциональность для журналов амортизации и моделей стоимости вместе с новой функциональностью для книг.
