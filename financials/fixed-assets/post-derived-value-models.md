---
title: "Разноска с журналами производной"
...
# <a name="post-with-derived-books"></a>Разноска с журналами производной
...
2.  В VM 1 щелкните вкладку "Производные книги". Выберите VM 2 в поле "Книга" и "Приобретение" в поле "Тип проводки".

Книги могут быть прикреплены к определенным ОС. 

Когда ввод в эксплуатацию разнесен для ОС с журналом мс 1, ввод в эксплуатацию разносится не только в мс 1, но также в журнал производной 2 мс. Открыть обновляется статус обеих журналов основных средств.

> [!NOTE]                                                                                                         
> Если вы не используете производные книги, необходимо разнести ввод в эксплуатацию ОС для книги МС 1 и книги МС 2.

Дополнительные сведения см. в разделе [журналах производной](derived-books.md)
