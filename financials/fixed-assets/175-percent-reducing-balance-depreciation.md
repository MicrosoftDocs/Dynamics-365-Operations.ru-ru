...
> [!NOTE] 
> Как правило, когда сумму, которая вычисляется с использованием уменьшаемого метод амортизации сальдо в 175% становится меньше суммы, по которой будет рассчитана с помощью линейного метода выполняется преобразование для линейного метода для оставшегося срока службы.
