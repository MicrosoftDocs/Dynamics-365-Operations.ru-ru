---
title: "Повторный расчет восстановительных затрат и сумм страхования для групп основных средств"
...
# <a name="recalculate-replacement-costs-and-insured-values-for-fixed-asset-groups"></a>Повторный расчет восстановительных затрат и сумм страхования для групп основных средств
...
-   \[(Коэффициент страховой суммы группы активов / 100) + 1\]\* актива Существующая страховая сумма
