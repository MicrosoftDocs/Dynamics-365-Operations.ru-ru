...
> [!NOTE]
> Как правило, когда сумму, которая вычисляется с использованием уменьшаемым метод амортизации с остатком в 150% становится меньше суммы, по которой будет рассчитана с помощью линейного метода выполняется преобразование для линейного метода для оставшегося срока службы.
