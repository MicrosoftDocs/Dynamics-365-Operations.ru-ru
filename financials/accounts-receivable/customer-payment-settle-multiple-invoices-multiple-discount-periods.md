---
title: "Использование платежа клиента для сопоставления нескольких счетов, охватывающих несколько периодов скидок"
...
# <a name="use-a-customer-payment-to-settle-multiple-invoices-that-span-multiple-discount-periods"></a>Использование платежа клиента для сопоставления нескольких счетов, охватывающих несколько периодов скидок
...
Клиент 4032 Fabrikam продает товары. Fabrikam предлагает скидку при оплате наличными в размере 1%, если накладная оплачивается в течение 14 дней. Fabrikam также предлагает скидки по оплате на частичные платежи. Параметры settement располагаются на **параметры расчетов с клиентами** страницы.

## <a name="invoices"></a>Накладные
Клиент 4032 имеет три накладных на общую сумму 3 000,00:

-   Накладная FTI-10040 на 1 000,00, была введена 15 мая. Эту накладную распространяется скидка на оплату в размере 1%, если она оплачивается в течение 14 дней.
-   Накладная FTI-10041 на 1 000,00, была введена 25 июня. Эту накладную распространяется скидка на оплату в размере 1%, если она оплачивается в течение 14 дней.
-   Накладная FTI-10042 на 1 000,00, была введена 25 июня. Эту накладную распространяется скидка на оплату в размере 2%, если она оплачивается за 5 дней и скидку в размере 1% при оплате в течение 14 дней.
...
Арни вручную можно ввести сумму платежа 1 485,00 прежде, чем он открывает **сопоставление проводок** страницы. Если Арни вручную вводит сумму платежа и затем помечает все три проводки, но он не корректировки стоимости в **сумма для сопоставления** поле для каждой проводки, он получает следующее сообщение, когда он закрывает страницы:
