...
-   **Процент** установлен ** ** в **рассчитать проценты на основе** на **Настройка кодов процентов** страницы.

Например, чтобы настроить код процента, который начисляет 5% за каждые два месяца, превышение проводки платежа по накладной срок выполнения, следует ввести 2 в **расчета процента каждый** и выберите **месяц**.
...
-   Можно ввести дополнительные ограничения суммы процентов.
-   ** Сумма ** выбрано в **рассчитать проценты на основе** на **задать коды процентного начисления** страницы.

Например, чтобы настроить код процента, который начисляет 25,00 за каждые 20 дней, превышение проводки платежа по накладной срок выполнения, необходимо ввести в 20 **расчета процента каждый** и выберите **день**.
