...
Можно выбрать несколько накладных на странице списка **Заказ на продажу**, а затем использовать команду **Создать накладные** для их консолидации. На **Разноска накладной** страницу, можно изменить **Суммарная обработка** параметр Суммировать по номеру заказа (при наличии нескольких отборочных накладных для одного заказа на продажу) или по счетам по накладной (при наличии нескольких заказов на продажу для отдельной накладной счета). Используйте **упорядочить** кнопку, чтобы консолидировать заказы на продажу в одном накладных, на основе **суммарным заказом** параметры.
