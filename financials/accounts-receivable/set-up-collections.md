...
## <a name="set-up-journal-names-settlement-writeoff-and-nsf"></a>Настройка имен журналов (сопоставление, Списание и денежным Покрытием)
...
> [!NOTE] 
> Если контактное лицо по сбору не указан для клиента, используется основное контактное лицо клиента. Если основное контактное лицо не указано, сообщения электронной почты будут отправляться на первый адрес, указанный на странице **Контакты**.
