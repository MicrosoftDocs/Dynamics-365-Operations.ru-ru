...
<a name="what-is-the-goal-of-sepa-direct-debits"></a>Что такое цель прямого дебета SEPA
---------------------------------------

Прямое дебетование SEPA позволяет кредитору для сбора платежей с банковского счета клиента, при условии, что предоставлена требование подписанного клиентом кредиторам. Клиент подписывает предписание, которое дает кредитору право собирать платежи и поручает банку клиента осуществить оплату. 
...
Номера International bank account number (IBAN) и БИК используются для идентификации всех счетов в 32 странах/регионах SEPA. Введите BIC SWIFT-код поля и поля IBAN IBAN. Оба поля расположены на экспресс-вкладке "Дополнительная идентификация" на вкладке "Банковский счет" на странице "Банковские счета". Это справедливо как для банковского счета кредитора, так и банковского счета клиента.
...
Форматы данных SEPA основаны на стандарте сообщений ISO 20022. Будет установите флажок универсального электронной отчетности, а затем выберите SEPA прямого дебета формат настройки конфигурации формата экспорта, при настройке расчетов с клиентами методов оплаты. Вы используете этот метод платежа, когда вы создаете файл оплаты в журнале оплаты клиента.
