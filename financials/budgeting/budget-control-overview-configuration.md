---
title: "Обзор управления бюджета"
description: "В этой статье представлены бюджетного контроля и приводятся сведения о настройке бюджетного контроля в Microsoft Dynamics 365 для операций, чтобы управлять ресурсами финансовых."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="budget-control-overview"></a>Обзор управления бюджета

В этой статье представлены бюджетного контроля и приводятся сведения о настройке бюджетного контроля в Microsoft Dynamics 365 для операций, чтобы управлять ресурсами финансовых.

<a name="overview"></a>Обзор
--------

Бюджетный контроль в Microsoft Dynamics 365 для операций поддерживает управление организации финансовых ресурсов в плане счетов, бизнес-правил, группы пользователей, документов-источников и журналов, настраиваемой расчет доступных средств, бюджетные циклы и пороговые значения. Используя органы управления, организация может запланировать, измерить, управлять, и прогнозировать свои финансовые ресурсы в течение всего финансового года. 

После утверждения бюджетов в Dynamics 365 for Operations бюджетных планов можно использовать для создания записей регистра бюджета для записи бюджета расходов для организации. Кроме того можно создать или импортировать записей регистра бюджета из программы независимых производителей вместо использования функции планирования бюджета. 
...
Можно настроить бюджетный контроль, в зависимости от нескольких факторов:
...
-   **Документов источника** — какие необходимо оценить документов-источников для бюджетного контроля? Документы требуется проанализировать на строке или на документ?
...
Следующие шаги в конфигурации выполняются на различных вкладках на **конфигурации бюджетного контроля** страницы.
...
> [!NOTE] 
> Если расчет изменяется во время цикла бюджета, изменения не влияют на все документы, ранее прошли проверки контроля бюджета и, учтенных или завершения.
...
> [!Important]
> Бюджетный контроль будет включена для любого счета ГК из **прибылей и убытков**, **о расходах**, **выручки, балансовый отчет, задолженности, собственного капитала** или **средств** типа. Если эта вкладка содержит правило, которое имеет пустые критерии, бюджетный контроль будет включен для **всех** комбинаций финансовых аналитик, которые включают счета ГК этих типов. Поэтому важно создать правила бюджетного контроля, определяющие только диапазоны комбинаций финансовых аналитик, где важно включать бюджетный контроль.  
...
На этой странице пользователи могут выполнять в **статистические данные бюджетного контроля по периодам** страница, просмотр сведений о доступности бюджета и резервирований для выбранных бюджетных управления комбинации измерений. Пользователи могут также детализировать в страницу **Статистика бюджетного контроля ** для просмотра доступности бюджета для всех комбинаций финансовых аналитик, используемых в бюджетном контроле. 
