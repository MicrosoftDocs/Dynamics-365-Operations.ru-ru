...
description: "В этой статье описываются различные методы распределения, доступные в Microsoft Dynamics 365 для операций и порядок их использования."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
В этой статье описываются различные методы распределения, доступные в Microsoft Dynamics 365 для операций и порядок их использования.  
...
[![AllocateAcrossPeriods](./media/allocateacrossperiods-300x259.png)](./media/allocateacrossperiods.png)<ph id="t1"></ph>**распределить по периодам** — позволяет распределить строки бюджетного плана из исходного сценария бюджетного плана по периодам в сценарии назначения категории распределения периода. Исходная сумма задана несколько линиям в сценарии назначения, основанном на проценте и дате, которые определены в категории распределения периода.         
