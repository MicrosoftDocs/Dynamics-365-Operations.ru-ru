...
Анализатор источника учета — это новая страница, на которой представлены сведения об источнике. Можно использовать проводник источника учета или как автономное средство для анализа подробные сведения о записи главной книги учета. Например можно использовать проводник источника учета для получения наиболее подробные сведения об источнике для сальдо пробный баланс или для операции. Затем можно использовать функцию "Экспорт в MS Excel" для дальнейшего анализа сведений в Microsoft Excel (например, в сводной таблице или сводном отчете).
...
Для всех документов, использующих framework исходного документа, учет источника в обозревателе отображается дополнительные данные, в зависимости от распределения по бухгалтерским счетам и, если это применимо, проект по бухгалтерским счетам. Эти сведения включают тип денежной суммы, проект, мероприятие, категория и свойства строки. Вот несколько примеров анализа, который можно выполнить:
