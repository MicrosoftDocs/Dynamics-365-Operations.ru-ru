...
Накладная поставщика из заказа на покупку является накладной, которая создается при получении продуктов или услуг согласно заказу на покупку, размещенному у поставщика. Накладная от поставщика содержит заголовок и одну или несколько строк для номенклатур или услуг. Накладная поставщика завершает цикл из заказа на покупку, поступления продуктов с накладной поставщика. 
...
-   Регистра накладных поставщика позволяет быстро ввести накладные, которые не ссылаются на заказ на покупку, таким образом, вы можете начислять расходов. С помощью журнала утверждения накладных поставщика, можно выбрать для тех накладных и разнести их в сальдо поставщика для реверсирования начисления.
...
Можно добавить новую строку, которая не была заказа на покупку с накладной поставщика. Необходимо выбрать элемент номер или категории закупок. Затем добавьте количества, цены и суммы в строку. Строка будет включена только в политики сопоставления для итогов по накладной.
