...
Сопоставление расходов можно использовать, чтобы убедиться, чтобы суммы расходов не отличаются от ожидаемых сумм более чем на допустимое отклонение. Итоговые суммы для каждого кода расходов, который применяется к накладной и заказу на покупку, сравниваются на сравнение значений накладных расходов - накладная: страницы, как показано в следующей таблице. Если допустимый допуск для кода расходов равен 25%, то отклонение 99 999 999 999,99% для кода расходов лицензии считается несоответствием сопоставления.
...
Дополнительные сведения см. в разделе [трехстороннем сопоставлении политик](three-way-matching-policies.md).
