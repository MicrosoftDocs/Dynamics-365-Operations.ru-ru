...
После оплаты чеков, перечисленных в файле положительных платежей, вы получаете номер подтверждения из банка. Затем можно подтвердить файла положительное зарплаты в Microsoft Dynamics 365 для операций. 
...
Дополнительные сведения см. в разделе [установить вверх и создать файлы положительное оплаты](set-up-generate-positive-pay-files.md).
