...
Иногда, после того как платеж поставщика был разнесен, платеж необходимо реверсировать. Реверсирование отличается от удаления, аннулирования или отклонения платежа. Вы можете удалить платеж, только если он имеет статус **Создано**. Этот статус указывает, что платеж будет создан, но еще не были созданы. Данное ограничение всегда применяется, независимо от способа оплаты. Аннулирование неразнесенных чеков можно, после они были созданы, но до их учета. Если созданные платежные выполняется как перевод электронных фондов (EFT), перед разноской можно отклонить платежа. Чтобы отклонить платеж, изменить **статус оплаты** значение. Платеж, который был аннулирован или отклонен могут быть повторно созданы после **статус оплаты** обратно изменяется значение **нет**. 

После разноски платежа, используются реверсирования. Платежи осуществляются в электронном виде нельзя отменить после их учета. Вместо этого необходимо создать новую проводку на сумму платежа для получения ответственность обратно на счет поставщика. Существует два метода для реверсирования разнесенные чеки. В одном методе реверсирования разносятся сразу же после нажатия **Отмена платежа** на странице **Чек**. В другом методе при нажатии кнопки **Отмена платежа** на странице **Чек** реверсирование отправляется в журнал сторнирований банковских чеков в модуле "Управление банком и кассовыми операциями", где проверяющий может разнести или отклонить реверсирование. 
...
> [!NOTE]
> При удалении журнала, реверсирование будет удалена из системы, но исходный чек остается в **проверка** страницы. Статус этого чека больше не будет **Отмена незаконченного процесса**.
