...
## <a name="masshire-project-statuses"></a>Статусы проекта по массовому набору сотрудников
...
<tbody>
<tr class="odd">
<td>Перед закрытием проекта по массовому набору сотрудников все должности в проекте должны иметь либо статус "Создано", либо статус "Закрыто".</td>
</tr>
</tbody>
</table>
</div></td>
