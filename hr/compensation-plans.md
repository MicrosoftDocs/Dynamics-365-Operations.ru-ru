...
Управление компенсациями позволяет контролировать доставку базовой оплаты и вознаграждений. Для сотрудника фиксированной базовой оплаты и за успешную работу управляются с помощью планов фиксированной компенсации. Поощрительные выплаты, такие как премии, вознаграждения за производительность, опционы на покупку акций и гранты, а также одноразовые компенсации, контролируются с помощью планов переменных компенсаций. 
...
<li>Действия можно гарантировать, что расчет применяется при обработке планов фиксированной компенсации.  Например действия типа собственного капитала сравнения оплата сотрудников для минимального контрольную точку для уровня для сотрудника и убедитесь, что сотрудник получение оплачивается по крайней мере минимальное.</li>
</ul></td>
</tr>
<tr class="even">
<td>Уровни</td>
...
<td>Периодичность оплаты используется, чтобы определить период времени, для которого указан компенсаций.  Например ставка зарплаты оплаты частоты поможет понять, если сумма компенсации указан как годовой заработной и каждый час. Периодичность оплаты также используется для настройки коэффициентов пересчета для конвертации сумм компенсацию из ежемесячной, еженедельной, двухнедельной и почасовой оплаты годовой частоты платежей.</td>
</tr>
<tr class="odd">
...
<td>Сетка компенсации содержат структуры компенсации.  Сетка компенсации может использоваться один или несколько планов компенсации.</td>
</tr>
<tr class="odd">
...
Каждый раз, когда выполняется событие процесса, создается событие компенсации.  События компенсации содержат результаты процесса компенсации для каждого сотрудника, включенного в это событие процесса.  При вычислениях верны, можно загрузить событие компенсации для обновления записей о компенсации для сотрудников, которые подвержены события процесса.
