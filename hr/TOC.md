# [Домашняя страница Talent](index.md)
...
## [Обработка компенсации](process-compensation.md)
...
# Связанные функции, доступные в Finance and Operations
## Функции для США
...
#### [Создание отчетов ACA](generate-aca-reports.md)
