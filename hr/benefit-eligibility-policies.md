...
В этом разделе сведения о льгот политик приемлемости, какие справки, можно определить кто имеет право на льготы конкретной.
...
Для создания политик приемлемости используются для следующих компонентов:
