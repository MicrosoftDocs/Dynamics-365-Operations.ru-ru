---
title: "Организация трудовых ресурсов с помощью подразделения, задания и должности"
...
# <a name="organize-your-workforce-using-departments-jobs-and-positions"></a>Организация трудовых ресурсов с помощью подразделения, задания и должности
...
|**Accounting**|Супервизор по учету|Главный бухгалтер|
|**Accounting**|Учет-A|Бухгалтер|
|**Human resources**|Менеджер по персоналу (восток)|Менеджер по персоналу|
|**Human resources**|Менеджер по персоналу (запад)|Менеджер по персоналу|
|**Human resources**|Менеджер по персоналу (центр)|Менеджер по персоналу|
...
функциональные обязанности — как задачи по заданию. Функциональная обязанность описывает одну или несколько задач, обязанностей или ответственностей, которые присваиваются заданию. Функциональные обязанности можно назначить к заданиям и использовать для настройки и реализации правил приемлемости для Планов компенсационных выплат. В следующей таблице перечислены примеры должностных обязанностей.
...
Должности являются важным элементом нижнего уровня организационной иерархии. Позиция — это индивидуальный экземпляр должности. Например должность, «(восток), менеджер по продажам» — одна из должностей, связанными с заданием, «Менеджер по продажам». Должности существуют в подразделениях и назначены работникам.
