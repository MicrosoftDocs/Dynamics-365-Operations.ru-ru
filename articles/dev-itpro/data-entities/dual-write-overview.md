...
---
# <a name="near-real-time-data-integration-between-finance-and-operations-and-common-data-service"></a>Интеграция данных между Finance and Operations и Common Data Service почти в режиме реального времени

[!include [banner](../includes/banner.md)]

[!include [preview](../includes/preview-banner.md)]

В современном цифровом мире бизнес-экосистемы используют пакет Microsoft Dynamics 365 в целом. Поскольку данные от людей, клиентов, операций и устройств Интернета вещей (IoT) стекаются в один источник, есть возможность для цифровых циклов обратной связи. Для достижения этого опыта важна интеграция между приложениями Dynamics 365 for Finance and Operations и Dynamics 365 for Customer Engagement. Приложения Customer Engagement строятся на основе Common Data Service. Интеграция данных между Finance and Operations с Common Data Service позволяет приложениям Customer Engagement взаимодействовать согласованно и свободно с Finance and Operations.

Finance and Operations и Common Data Service обеспечивают синхронизацию данных почти в режиме реального времени между приложениями Finance and Operations и Customer Engagement через систему двойной записи. Охват широк и включает 28 поверхностных областей Finance and Operations. Цель состоит в том, чтобы обеспечить пользовательский опыт "одного Dynamics 365" через бесшовные потоки данных, которые соединяют бизнес-процессы между приложениями.
...
Выполните следующие шаги, чтобы настроить интеграцию между Finance and Operations и Common Data Service.
