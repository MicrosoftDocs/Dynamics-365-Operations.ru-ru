...
- AX (для данных, которые должны импортироваться или экспортироваться в том же формате, который используется для Microsoft Dynamics 365 for Finance and Operations)
- ColonSeparated
