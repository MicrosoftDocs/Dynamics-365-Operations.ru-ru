...
Эта тема описывает интеграцию данных сайтов и складов между Finance and Operations и Common Data Service. Операционные сайты и склады являются общими концепциями в приложении управления цепочкой поставок. Они используются для моделирования цепочки поставок компании.
...
## <a name="operational-sites"></a>Операционные сайты

Операционные сайты доступны в Common Data Service с использованием следующих сопоставлений.
...
## <a name="warehouses"></a>Склады

Склады доступны с использованием следующих сопоставлений.
