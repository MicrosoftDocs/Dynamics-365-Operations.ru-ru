...
---
# <a name="use-record-template-to-create-a-new-record"></a>Использование шаблона записи для создания новой записи
...
В данной процедуре используется компания USMF.

1. В **области переходов** перейдите к **Основные средства > Основные средства > Основные средства**.
2. Нажмите кнопку **Создать**. Вы получите запрос на выбор шаблона. Выберите шаблон, который соответствует вашим бизнес-требованиям.  
