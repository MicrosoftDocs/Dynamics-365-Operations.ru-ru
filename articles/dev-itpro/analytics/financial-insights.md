...
## <a name="how-financial-statements-work"></a>Как работают финансовые отчеты
...
Помимо визуальных объектов из исходной рабочей области **Обзор финансового директора**, новые ключевые индикаторы производительности, диаграммы и финансовые отчеты теперь доступны. Доступны следующие финансовые отчеты:
