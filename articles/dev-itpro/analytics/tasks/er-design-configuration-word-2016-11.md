...
1. В области переходов выберите **Модули > Администрирование организации > Рабочие области > Электронная отчетность**. Убедитесь, что поставщик конфигураций Litware, Inc. выбран как активный.  
2. Щелкните **Конфигурации отчетности**. Мы повторно используем существующую конфигурацию ER, которая изначально была создана для создания выходных данных отчета в формате OPENXML.  
...
1. Нажмите кнопку **Вложения**. Замените существующий шаблон Excel на ранее загруженный шаблон Word — SampleVendPaymDocReport.docx. Обратите внимание, что этот шаблон содержит только макет документа, который требуется создать как выходные данные ER.  
2. Нажмите кнопку **Удалить**.
3. Нажмите кнопку **Да**.
4. Нажмите кнопку **Создать**.
5. Щелкните **Файл**.
6. Щелкните **Обзор**. Найдите и выберите ранее загруженный шаблон SampleVendPaymDocReport.docx. Щелкните **OK**. Выберите шаблон, загруженный на предыдущем шаге.  
...
Откройте этот документ в Word и сделайте следующее:  
1. Откройте вкладку Word "Разработчик" (настройте ленту, если она еще не включена).
2. Выберите область сопоставления XML.
3. Выберите пользовательскую XML-часть "Отчет" в списке подстановки.
4. Выполните сопоставление элементов выбранной пользовательской XML-части и элементов управления содержимым документа Word.  5. Сохраните обновленный документ Word на локальном диске.  
...
2. Нажмите кнопку **Да**. Добавление нового шаблона. Если вы выполнили действия, описанные в предыдущей подзадаче, выберите документ Word, который был подготовлен и сохранен локально. В противном случае выберите ранее загруженный шаблон SampleVendPaymDocReportBounded.docx MS Word.  
3. Нажмите кнопку **Создать**.
4. Щелкните **Файл**.
5. Щелкните **Обзор**. Найдите и выберите ранее загруженный шаблон SampleVendPaymDocReportBounded.docx. Щелкните **OK**.
...
1. В области **Панель операций** щелкните **Конфигурации**.
...
8. Закройте страницу.
9. Закройте страницу.
10. В **области переходов** выберите **Модули > Расчеты с поставщиками > Платежи > Журнал платежей**.
11. Выберите **Строки**.
...
16. Щелкните **OK**.
17. Щелкните **OK**. Проанализируйте созданные выходные данные. Обратите внимание, что созданные выходные данные представлены в формате Word и содержат сведения об обработанных платежах.  
