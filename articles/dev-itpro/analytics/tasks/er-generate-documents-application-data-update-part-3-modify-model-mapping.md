...
---
# <a name="modify-model-and-mapping-to-generate-documents-with-application-data"></a>Изменение модели и сопоставления для создания документов с обновлением данных приложения
