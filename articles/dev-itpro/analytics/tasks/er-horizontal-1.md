...
Необходимо также загрузить и сохранить локальную копию шаблона с примером отчета, который находится здесь, [https://go.microsoft.com/fwlink/?linkid=862266](https://go.microsoft.com/fwlink/?linkid=862266). 
