...
1. Перейдите в раздел "Управление организацией" > "Рабочие области" > "Электронная отчетность".
    ...
    * Предположим, что разрабатывается процесс для анализа входящих банковских выписок для обновления данных приложения. Вы будете получать входящие банковские выписки как TXT-файлы, содержащие коды IBAN. В рамках процесса импорта банковской выписки необходимо проверить правильность этих кодов IBAN с помощью логики, которая уже доступна в Dynamics 365 for Finance and Operations.   
