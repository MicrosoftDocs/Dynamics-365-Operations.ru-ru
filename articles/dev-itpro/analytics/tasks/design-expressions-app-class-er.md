...
---
# <a name="design-expressions-to-call-application-class-methods-er"></a>Разработка выражений для вызова методов классов приложений (ER)
...
Эти шаги можно выполнить с использованием любого набора данных. Также необходимо загрузить и сохранить локально следующий файл: (https://go.microsoft.com/fwlink/?linkid=862266): SampleIncomingMessage.txt.
...
1. Перейдите в раздел "Управление организацией" > "Рабочие области" > "Электронная отчетность".
    ...
    * Предположим, что разрабатывается процесс для анализа входящих банковских выписок для обновления данных приложения. Вы будете получать входящие банковские выписки как TXT-файлы, содержащие коды IBAN. В рамках процесса импорта банковской выписки необходимо проверить правильность этих кодов IBAN с помощью логики, которая уже доступна в Dynamics 365 for Finance and Operations, Enterprise Edition.   
