...
---
# <a name="prepare-data-models-to-use-document-management-files-in-er-output"></a>Подготовка моделей данных для использования файлов управления документами в выходных данных электронной отчетности
...
3. В поле "Имя" введите "Модель накладной клиента (настраиваемая)".
    * Модель накладной клиента (настраиваемая)  
