...
---
# <a name="upgrade-your-format-by-adopting-of-new-base-version-of-that-format-for-electronic-reporting-er"></a>Обновление формата путем принятия новой базовой версии этого формата для электронной отчетности (ER)
...
Предположим, что имеются новые характерные для данной страны особенности, которые должны поддерживаться Litware:  
- Значение для кода SWIFT счета кредитора в каждой проводке по оплате.  
- Лимит в 100 символов для длины текста имени поставщика при создании файла.  
