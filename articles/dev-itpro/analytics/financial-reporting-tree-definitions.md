...
|-----------------------|-------------|
| Организация               | Название компании для единицы отчетности. Значение **@ANY**, которое типично задается только к общему уровню, позволяет дереву отчетности быть использованным для всех компаний. Компания назначается каждой дочерней ветви. |
