...
|  showFilterPane  |   Логическое значение, указывающее, должна ли отображаться область фильтров (<strong>true</strong>) или нет (<strong>false</strong>).   |
|   showNavPane    | Логическое значение, указывающее, должна ли отображаться область перехода (<strong>true</strong>) или нет (<strong>false</strong>). |
