...
8.  Нажмите кнопку Обновить, чтобы обновить ранее рассмотренные исключения. Щелкните Да для того, чтобы выполнить полное обновление всех результатов, или щелкните Нет для того, чтобы выполнить частичное обновление адресованных элементов.
    | ![Примечание](https://i-technet.sec.s-msft.com/areas/global/content/clear.gif "Примечание")**Примечание**                    |
    |------------------------------------------------------------------------------------------------------------|
