...
## <a name="power-bi-content-for-dynamics-365-for-finance-and-operations-enterprise-edition-july-2017"></a>Содержимое Power BI для Dynamics 365 for Finance and Operations, Enterprise Edition (июль 2017 г.)
При использовании Microsoft Dynamics 365 for Finance and Operations, Enterprise Edition (июль 2017 г.) доступно следующее содержимое Power BI:
...
### <a name="accessing-the-content"></a>Доступ к содержимому
Это содержимое Power BI доступно в библиотеке общих ресурсов в LCS. Дополнительные сведения о том, как загрузить содержимое и подключить его к вашим данным, см. в разделе [Содержимое Power BI в LCS от Майкрософт и ваших партнеров](power-bi-content-microsoft-partners.md). Чтобы просмотреть демонстрацию, которая показывает, как реализовать содержимое Power BI, см. [Содержимое Power BI от Майкрософт и ваших партнеров в службах Dynamics Lifecycle Services](https://mix.office.com/watch/9puyb1b2xs1w) (Office mix).
...
### <a name="accessing-the-content"></a>Доступ к содержимому
Это содержимое Power BI доступно на сайте PowerBI.com.
...
5. Введите URL-адрес вашей среды Dynamics AX. URL-адрес должен быть в формате **https://&lt;YourAOSTenant&gt;.cloudax.dynamics.com**. Нажмите **Далее**.
6. Выберите **oAuth2** как метод проверки подлинности, затем щелкните **Войти**.
7. Когда появится запрос, введите учетную запись Microsoft Office 365, у которой имеется разрешение на доступ к вашей среде Microsoft Dynamics AX.
