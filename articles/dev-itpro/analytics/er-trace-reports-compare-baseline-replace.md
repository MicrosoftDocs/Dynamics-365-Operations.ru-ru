...
![Страница базовых образцов формата электронной отчетности](media/GER-BaselineSample-AddBaseline2.PNG "Снимок экрана страницы базовых образцов формата электронной отчетности")
...
7. Нажмите **ОК**.
    ...
    ![Диалоговое окно параметров электронной отчетности](media/GER-BaselineSample-FormatRunToMakeBaselineFile3.PNG "Снимок экрана диалогового окна параметров электронной отчетности")

8. Выберите **Базовые**.

    ![Страница базовых образцов формата электронной отчетности](media/GER-BaselineSample-ReviewAddedBaselineLine.PNG "Снимок экрана страницы базовых образцов формата электронной отчетности")
...
![Страница базовых образцов формата электронной отчетности](media/GER-BaselineSample-AddBaseline3.PNG "Снимок экрана страницы базовых образцов формата электронной отчетности")
...
2. В дереве компонентов формата разверните пункт **Вывод**, разверните **Вывод\\Документ**, затем установите флажок для **Вывод\\Документ\\ProcessingDateTime**.
    ...
    ![Диалоговое окно выбора компонентов](media/GER-BaselineSample-SelectComponentForBindingReplacement.PNG "Снимок экрана диалогового окна выбора компонентов")

3. Нажмите **ОК**.

![Страница базовых образцов формата электронной отчетности](media/GER-BaselineSample-AddBaseline4.PNG "Снимок экрана страницы базовых образцов формата электронной отчетности")
...
![Диалоговое окно параметров пользователя](media/GER-BaselineSample-ERUserParameters1.png "Снимок экрана диалогового окна параметров пользователя")
...
3. Выберите **Вложения**.
    ...
    ![Страница вложений](media/GER-BaselineSample-AttachedBaselineFile.PNG "Снимок экрана страницы вложений")
...
Новые возможности ER позволяют экспортировать базовые настройки для выбранного формата ER из текущей среды Finance and Operations и сохранять их в виде файлов XML. 
...
Экспортированные базовые настройки можно импортировать в другую среду Finance and Operations. Среду сначала следует импортировать как формат ER. Затем можно импортировать базовые параметры.
