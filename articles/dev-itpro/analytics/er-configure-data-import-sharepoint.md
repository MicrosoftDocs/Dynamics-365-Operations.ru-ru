...
![Пример файла Microsoft Excel для импорта из SharePoint](./media/GERImportFromSharePoint-02-Excel.PNG)
...
10. На странице **Состояния файла для источников** выберите **Обновить**и затем в разделе **Файлы** просмотрите список файлов.
   ...
   Раздел **Источники журнала импорта в формате** указывает, что произошла ошибка при импорте и файл до сих пор находится в папке SharePoint для файлов с ошибками (флажок **Удален** не установлен). Если исправить этот файл на сайте SharePoint, добавив правильный код поставщика, затем переместить его в папку SharePoint источника импорта файлов (основного), можно импортировать этот файл еще раз.
