...
- Чтобы ограничить вычисление определенным блоком, введите полный иерархический код из аналитической структуры. Например, введите **IF @Unit(SUMMARY^ACME^WEST COAST^SALES)**.
