...
2.  В диалоговом окне **Группы шаблонов** нажмите кнопку **Создать**.
...
2.  В диалоговом окне **Компании** выберите компанию, которой следует назначить группу шаблонов.
...
Можно экспортировать группу шаблонов или отдельные шаблоны отчетов в группу шаблонов. Можно использовать экспортированную группу шаблонов как резервную копию. Можно также копировать экспортированные данные между группами строительных блоков или установками Finance and Operations. Конструктор отчетов включает ссылочные стили шрифтов и наборы аналитик вместе с группой строительных блоков.
1.  В конструкторе отчетов, в меню **Компания**, щелкните **Группы строительного блока**.
