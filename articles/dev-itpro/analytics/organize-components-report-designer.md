...
> [!NOTE]
> При переименовании строительного блока необходимо обновить все определения отчетности, использующие этот строительный блок. В противном случае создать новый отчет невозможно.
