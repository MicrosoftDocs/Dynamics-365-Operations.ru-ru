...
Перейти к **Результаты финансовой деятельности** Power BI можно из Microsoft Dynamics Lifecycle Services (LCS) и из PowerBI.com.

### <a name="available-from-lcs"></a>Доступно из LCS
Содержимое Power BI **Результаты финансовой деятельности**, доступное из LCS, поддерживает следующие версии:

- Версии Microsoft Dynamics 365 for Finance and Operations, Enterprise Edition
- Microsoft Dynamics 365 for Operations версии 1611 

Содержимое Power BI можно найти в библиотеке общих ресурсов LCS. Дополнительные сведения о том, как загрузить пакет содержимого и реализовать его в вашей организации, см. в разделе [Содержимое Power BI в LCS от Майкрософт и ваших партнеров](power-bi-content-microsoft-partners.md). Чтобы просмотреть демонстрацию, которая показывает, как реализовать содержимое Power BI, см. [Содержимое Power BI от Майкрософт и ваших партнеров в службах Dynamics Lifecycle Services](https://mix.office.com/watch/9puyb1b2xs1w) (Office mix).

### <a name="available-from-powerbicom"></a>Доступно из PowerBI.com
Содержимое Power BI **Результаты финансовой деятельности**, доступное на сайте PowerBI.com, поддерживает Microsoft Dynamics AX версий 7.0 и 7.0.1. Дополнительные сведения о том, как подключить и загрузить данные Dynamics AX, см. в разделе [Доступ к содержимому Power BI с сайта PowerBI.com](power-bi-home-page.md).
