...
[Microsoft Dynamics 365 for Finance and Operations — предоставляется 21Vianet в Китае](https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/deployment/china-local-deployment)
...
#### <a name="finance-and-operations-whats-new"></a>Что нового в Finance and Operations
В [содержимом "Что нового"](../../fin-and-ops/get-started/whats-new-changed.md) перечислены возможности, включенные в конкретные выпуски Finance and Operations.
