...
Microsoft Dynamics 365 for Finance and Operations включает функции для стран и регионов, описанные в [руководстве по наличию локализации и перевода продуктов](https://aka.ms/ax-availabilityguide). Эти функции включаются в зависимости основного адреса активного юридического лица. 
...
### <a name="chinafinancialslocalizationschinamd"></a>[Китай](../../financials/localizations/china.md)
...
### <a name="estoniafinancialslocalizationsestoniamd"></a>[Эстония](../../financials/localizations/estonia.md)
