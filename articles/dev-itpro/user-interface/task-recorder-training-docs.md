...
ms.locfileid: "1571008"
---
# <a name="create-documentation-or-training-by-using-task-recordings"></a>Создание документации или обучения с помощью записей задач
...
[Подключение справки](../../fin-and-ops/get-started/help-connect.md)
