---
title: Типы функционального местоположения
description: В этой статье объясняется, как создавать типы функциональных местоположений в «Управлении активами».
