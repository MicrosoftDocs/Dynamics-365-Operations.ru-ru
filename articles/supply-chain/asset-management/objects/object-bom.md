...
description: В этой статье описываются спецификации актива в «Управлении активами».
...
1. Выберите **Управление активами** \> **Активы** \> **Активные активы**. Выберите актив в списке, а затем выберите **Спецификация актива**.
