...
description: В этой статье объясняется, как создавать функциональные местоположения в управлении активами.
...
В этой статье объясняется, как создавать функциональные местоположения в управлении активами.
...
1. Выберите **Управление активами** > **Функциональные местоположения** > **Все функциональные местоположения**.  
...
1. Выберите **Управление активами** > **Функциональные местоположения** > **Все функциональные местоположения**. Можно создать функциональное местоположение из представления сетки или представления детализации.
