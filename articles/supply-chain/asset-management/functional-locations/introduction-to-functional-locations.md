...
description: В этой статье содержится обзор функциональных местоположений в «Управлении активами».
