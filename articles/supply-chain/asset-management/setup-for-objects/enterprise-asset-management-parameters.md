...
ms.locfileid: "9015822"
---
# <a name="asset-management-parameters"></a>Параметры управления активами

[!include [banner](../../includes/banner.md)]

В управлении активами должны быть настроены общие параметры, касающиеся активов, заказов на работу и планирования заказов на работу. В этой статье описывается, как настроить их. Выберите **Управление активами** > **Настройка** > **Параметры управления активами**, чтобы открыть страницу.
...
## <a name="the-assets-tab"></a>Вкладка "Активы"

На вкладке **Активы** имеются следующие параметры:
...
- В поле **Представление** выберите стандартное представление, отображаемое при открытии **Представление актива** (**Управление активами** > **Ресурсы** > **Представление актива**).
...
## <a name="the-work-orders-tab"></a>Вкладка "Заказы на работу"

На вкладке **Заказы на работу** имеются следующие параметры:
...
- Выберите **Да** для **Копировать отказы**, если вы хотите автоматически скопировать сбои, зарегистрированные в запросах на техническое обслуживание, в связанные заказы на работу. 
...
## <a name="the-work-order-scheduling-tab"></a>Вкладка "Планирование заказа на работу"

Вкладка **Планирование заказов на работу** содержит следующие параметры на экспресс-вкладке **Общие**:
...
## <a name="the-document-types-tab"></a>Вкладка "Типы документов"
...
## <a name="the-number-sequences-tab"></a>Вкладка "Номерные серии"
