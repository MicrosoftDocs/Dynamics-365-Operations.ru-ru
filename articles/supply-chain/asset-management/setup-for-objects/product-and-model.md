...
description: В этой статье объясняется, как настроить производителей активов и связанные с ними модели в «Управлении активами».
...
В этой статье объясняется, как настроить производителей активов и связанные с ними модели в «Управлении активами». Модели могут быть связаны с типами активов.
...
1. Выберите **Управление активами** \> **_Активы_* \> **Все активы**.
