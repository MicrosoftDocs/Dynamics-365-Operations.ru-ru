...
8. В поле **Тип активов** выберите тип актива, с которым должна быть связана модель производителя.
    ...
    > [!NOTE]
    > Можно также настроить отношения для типов активов, производителей и моделей в поиске **Типы активов**. Дополнительные сведения см. в разделе [Создание типа актива](../setup-for-objects/object-types.md).
