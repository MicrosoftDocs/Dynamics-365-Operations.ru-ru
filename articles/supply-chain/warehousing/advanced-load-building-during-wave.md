...
Этот сценарий показывает, как параметры, описанные ранее в этой статье, влияют на складские операции во время обработки заказа на продажу. В этом сценарии используются демонстрационные данные **USMF** вместе с другими демонстрационными значениями, предусмотренными в этих инструкциях по настройке.
