...
# Единица измерения и политики хранения
...
## Группы упорядочения единиц для выпущенных продуктов
...
## Единицы по умолчанию для процессов получения на мобильном устройстве
