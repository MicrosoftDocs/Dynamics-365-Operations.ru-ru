...
| Finance and Operations | Microsoft Finance and Operations версии 1611 <br>–или– <br>Microsoft Dynamics AX версии 7.0/7.0.1 и платформа Microsoft Dynamics AX с обновлением 2 и исправлением КБ 3210014 |
...
9.  Перейдите на вкладку **Настройка**. [![wh-05-ad-configure-app](./media/wh-05-ad-configure-app.png)](./media/wh-05-ad-configure-app.png)
