...
description: В этой статье описывается порядок настройки комплектации кластера и способ применения подтверждения номенклатуры с комплектацией кластера.
author: Mirzaab
ms.date: 05/26/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9014773"
---
# <a name="set-up-cluster-picking"></a>Настройка комплектации кластера

[!include[banner](../includes/banner.md)]

В этой статье описывается, как разрешить работникам использовать мобильные устройства для группировки работ комплектации в кластеры, чтобы они могли скомплектовать номенклатуры из одного местонахождения для нескольких заказов на выполнение работ одновременно. Это называется *комплектацией кластера*.
...
1. На панели списка выберите пункт меню, который требуется настроить.
1. На панели действий выберите **Настройка подтверждения работы**.
1. Выполните одно из следующих действий:
    - Если уже существует строка для **Тип работы**, который необходимо настроить, выберите ее и затем выберите **Правка** на панели операций.
    - Если соответствующая строка не существует, выберите **Создать** на панели операций, затем настройте для параметра **Тип работы** соответствующий тип.
1. Установите флажок **Подтверждение продукта** для новой или выбранной строки. Это позволит работникам проверять каждую позицию запасов с помощью мобильного устройства.
