...
## <a name="turn-this-feature-on-or-off"></a><a name="enable-create-transfer-order-from-warehouse-app"></a>Включение или отключение этой функции
...
1. Включите следующие две функции (по порядку) в рабочей области [Управление функциями](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md). В Supply Chain Management версии 10.0.25 обе эти функции включены по умолчанию.
    ...
    1. *Создать и обработать заказы на перемещение из приложения склада*
1. Чтобы автоматизировать обработку исходящих отгрузок, необходимо также включить функцию [Подтверждение исходящих отгрузок из пакетных заданий](confirm-outbound-shipments-from-batch-jobs.md).
