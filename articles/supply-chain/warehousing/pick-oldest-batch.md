...
description: В этой статье описывается, как настроить и применить параметры для комплектации самой старой партии на мобильном устройстве.
author: Mirzaab
ms.date: 05/26/2017
ms.topic: article
ms.prod: ''
