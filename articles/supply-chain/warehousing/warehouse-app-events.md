...
description: В этой статье описывается обработка событий приложения склада, используемая для обработки сообщений о событиях приложения склада в рамках пакетного задания.
author: perlynne
ms.date: 09/02/2020
ms.topic: article
ms.prod: ''
