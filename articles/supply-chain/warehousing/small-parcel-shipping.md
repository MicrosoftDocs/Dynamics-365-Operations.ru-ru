...
В этом примере показано, как настроить и использовать службы SPS после подготовки системы, как описано ранее в этом разделе. В этом сценарии используется ранее упомянутый демонстрационный механизм ставок.
...
1. Если вы еще не настроили определение принтера ZPL, настройте его с помощью приложения агента маршрутизации документов. Дополнительные сведения см. в разделе [Обзор печати документов](../../fin-ops-core/dev-itpro/analytics/print-documents.md) и связанных темах.
