...
-   **Соответствие упакованному количеству** — эта стратегия используется для проверки того, имеется ли в месте комплектации указанное количество, предусмотренное в упаковке. Работает только для директив для мест хранения типа "комплектация". 
