---
title: Настройка полей для мобильного приложения Warehouse Management
description: В этой статье описывается, как определить и настроить имена полей и приоритеты для полей, отображаемых в мобильном приложении "Управление складом".
author: Mirzaab
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
В этой статье описывается, как определить и настроить имена полей и приоритеты для полей, отображаемых в мобильном приложении "Управление складом".

> [!NOTE]
> Эта статья относится к функциям в модуле "Управление складом". Он не применяется к функциям в модуле "Управление запасами". Мобильное приложение "Управление складом" — это приложение, которое можно использовать для выполнения задач на складе. Можно определить и настроить имена полей, которые используются в приложении, а также настроить приоритет, который должен быть назначен именам полей. В этой статье описывается, как определить и настроить эти имена полей и приоритеты мобильного приложения "Управление складом", а также как они используются.
