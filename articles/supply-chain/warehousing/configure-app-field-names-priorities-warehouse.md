...
## <a name="configure-warehousing-app-field-names"></a>Настройка имен полей в приложении склада
...
## <a name="configure-warehousing-app-field-priority"></a>Настройка приоритетов полей в приложении склада
