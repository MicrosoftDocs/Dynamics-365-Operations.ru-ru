...
description: В этой статье представлен сценарий, в котором несколько заказов запущены на склад в одной и той же загрузке, а затем автоматически консолидируются в отгрузки.
author: Mirzaab
ms.date: 05/12/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9428099"
---
# <a name="consolidate-shipments-by-releasing-to-warehouse-from-the-load-planning-workbench"></a>Консолидация отгрузок путем выпуска на склад из рабочего места планирования загрузки

[!include [banner](../includes/banner.md)]

В этой статье представлен сценарий, в котором несколько заказов запущены на склад в одной и той же загрузке, а затем автоматически консолидируются в отгрузки.
