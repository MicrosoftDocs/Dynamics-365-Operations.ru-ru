...
description: В этой статье представлен сценарий, в котором несколько заказов запущены на склад, а затем консолидируются в отгрузки с помощью рабочее место консолидации отгрузок.
author: Mirzaab
ms.date: 08/09/2022
ms.topic: article
ms.prod: ''
...
В этой статье представлен сценарий, в котором несколько заказов запущены на склад, а затем консолидируются в отгрузки с помощью рабочее место консолидации отгрузок.
...
## <a name="turn-the-manual-shipment-consolidation-feature-on-or-off"></a>Включение или выключение функции консолидации отгрузок вручную

Для использования консолидации отгрузки вручную это должно быть включено в системе. В Supply Chain Management версии 10.0.29 эта функция включена по умолчанию. Администраторы могут включать и выключать эту функцию, выполнив поиск функции *Консолидация отгрузок вручную* в рабочей области [Управление функциями](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md).

Необходимо также включить функцию *Консолидация отгрузок*, прежде чем можно будет создавать политики (в Supply Chain Management версии 10.0.29 эта функция является обязательной и не может быть отключена). Дополнительные сведения см. в разделе [Настройка политик консолидации отгрузок](configure-shipment-consolidation-policies.md).
