---
title: Настройте названий шагов и инструкций для мобильного приложения Warehouse Management
description: В этой теме описывается создание и отображение пользовательских инструкций для каждого шага потока задач, настроенного для мобильного приложения Warehouse Management.
author: Mirzaab
ms.date: 08/11/2021
ms.topic: article
ms.search.form: ''
...
ms.locfileid: "7902255"
---
# <a name="customize-step-titles-and-instructions-for-the-warehouse-management-mobile-app"></a>Настройте названий шагов и инструкций для мобильного приложения Warehouse Management
