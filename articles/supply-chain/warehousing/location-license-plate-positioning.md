...
В этой статье представлен сценарий, который показывает, как настроить и использовать эту функцию.
...
Выполните следующие процедуры, чтобы настроить функцию *Позиционирование местонахождения грузомест* для сценария, представленного в этой статье.
