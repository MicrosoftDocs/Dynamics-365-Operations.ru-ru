...
description: В этой статье описывается, как работать с мобильным приложением сканирования складских штрих-кодов на устройствах, совместимых с Android.
author: Mirzaab
ms.date: 05/26/2017
ms.topic: article
ms.prod: ''
