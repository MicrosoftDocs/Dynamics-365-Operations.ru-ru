...
>[!NOTE] 
>Строки возврата, содержащие ссылки на заказ на продажу, обрабатываются как коррекции или реверсирование продажи. Для получения дополнительных сведений см. пункт "Разноска в главную книгу" далее в данном разделе.
