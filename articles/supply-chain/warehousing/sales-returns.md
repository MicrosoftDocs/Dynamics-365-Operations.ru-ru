...
>[Примечание!] По умолчанию параметр **Корректировка по кредиту** включен, если включен параметр **Корректирующая кредит-нота** на странице **Параметры модуля расчетов с клиентами**. Однако мы не рекомендуем выполнять разноску возвратов как сторно.
