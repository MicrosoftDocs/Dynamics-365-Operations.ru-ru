...
description: В этой статье представлена информация о процессе для заказов на возврат. Сюда входят сведения о возвратах клиентами и их влияние на расчет себестоимости и количества запасов в наличии.
author: Mirzaab
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
### <a name="charges"></a>Накладные расходы
