...
description: Эта статья объясняет, как управлять импортом входящих расширенных предварительных уведомлений об отгрузке (ASN) через входящий информационный объект ASN.
