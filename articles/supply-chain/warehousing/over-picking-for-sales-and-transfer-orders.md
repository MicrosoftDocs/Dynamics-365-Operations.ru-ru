...
description: В этой статье объясняется, как включить комплектацию с превышением для заказов на продажу и заказов на перемещение.
...
В этой статье представлен сценарий, показывающий, как можно подключить конкретного работника или всех работников к комплектации с превышением. Процесс комплектации с превышением позволяет осуществлять контролируемую комплектацию с превышением при работе комплектации.
...
В этой статье представлен сценарий, который показывает, как настроить и использовать эту функцию комплектации с превышением.
