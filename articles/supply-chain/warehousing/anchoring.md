---
title: Привязка
description: В этой статье объясняется, как включить и использовать привязку.
...
ms.locfileid: "8903821"
---
# <a name="anchoring"></a>Привязка

[!include [banner](../includes/banner.md)]

В этой статье приводятся сведения о процессе привязки. Здесь описывается необходимая конфигурация и логика, выполняемая, когда работник склада изменяет промежуточное местоположение или местоположение загрузки.
...
В этой статье представлен сценарий, показывающий работу привязки. В ходе сценария будут создан набор заказов на продажу, и они будут выпущены на склад. Затем вы переопределите предполагаемое промежуточное местоположение и проверите, что все остальные операции размещения направляются в новое местоположение.
