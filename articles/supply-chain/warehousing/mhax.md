...
description: В этой статье описывается порядок настройки интерфейс транспортно-складского оборудования (MHAX), чтобы можно было подключиться к внешним системам физической обработки материалов (MH).
author: Mirzaab
ms.date: 08/09/2022
ms.topic: article
ms.prod: ''
...
1. Если используется Supply Chain Management версии 10.0.28 или ранее, выполните следующие шаги:
    1. Перейдите в раздел **Администрирование системы \> Рабочие области \> Управление функциями**.
    1. В рабочей области **[Управление функциями](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md)** включите функцию с именем *Интерфейс транспортно-складского оборудования*. (В Supply Chain Management 10.0.29 эта функция обязательна и не может быть отключена.)
...
1. Разверните **Торговля \> Управление складом и транспортировкой**, а затем установите флажок **Интерфейс транспортно-складского оборудования**.
