...
ms.locfileid: "6773065"
---
# <a name="wave-creation-and-processing"></a>Создание и обработка волны

[!include [banner](../includes/banner.md)]

В этом разделе описывается, как создать, обработать и выпустить волну, чтобы создать работу комплектации для загрузки, отгрузки, производственного заказа или заказа канбана. Волны можно создать для следующих типов заказов:
...
1. В зависимости от типа волны, которую требуется создать, выполните одно из следующих действий:
    ...
    - Перейдите в раздел **Управление складом** \> **Общий** \> **Волны** \> **Волны отгрузок** \> **Все волны**. На панели операций выберите **Волна**.
    - Перейдите в раздел **Управление складом** \> **Общий** \> **Волны** \> **Волны производства** \> **Все волны производства**. На панели операций выберите **Волна производства**.
    - Перейдите в раздел **Управление складом** \> **Общий** \> **Волны** \> **Волны канбана** \> **Все волны канбана**. На панели операций выберите **Создать волну**.
...
1. В зависимости от типа обрабатываемой волны выберите один из следующих параметров:
    ...
    - Выберите **Управление складом** \> **Общий** \> **Волны** \> **Волны отгрузок** \> **Все волны**. На панели операций выберите **Волна**.
    - Выберите **Управление складом** \> **Общий** \> **Волны** \> **Волны производства** \> **Все волны производства**. На панели операций выберите **Волна производства**.
    - Выберите **Управление складом** \> **Общий** \> **Волны** \> **Волны канбана** \> **Все волны канбана**. На панели операций выберите **Создать волну**.
...
1. В зависимости от типа отменяемой волны выберите один из следующих параметров:
      ...
      - Перейдите в раздел **Управление складом** \> **Общий** \> **Волны** \> **Волны отгрузок** \> **Все волны**.
      - Перейдите в раздел **Управление складом** \> **Общий** \> **Волны** \> **Волны производства** \> **Все волны производства**.
      - Перейдите в раздел **Управление складом** \> **Общий** \> **Волны** \> **Волны канбана** \> **Все волны канбана**.
