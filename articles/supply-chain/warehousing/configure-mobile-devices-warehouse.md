...
> [!NOTE]
> Эта статья относится к функциям в модуле "Управление складом". Он не применяется к функциям в модуле "Управление запасами". Пункты меню, которые появляются в меню на мобильном устройстве склада, настраиваются на странице **Пункты меню мобильного устройства**. Так как пункты меню можно поместить в различные меню, легко задать структуры меню так, чтобы только определенные типы работы были видны конкретным пользователям. Можно настроить пункты меню для выполнения следующих задач:
...
| Отметка об отъезде водителя | Зарегистрируйте, что водитель завершил свое назначение. |
...
| Создать заказ на перемещение из грузомест | Позволяет складским работникам создавать и обрабатывать заказы на перемещение непосредственно из мобильного приложения управления складом. Работники склада начинают с выбора склада назначения, затем могут просканировать одно или несколько грузомест с помощью приложения. Когда работник склада выбирает **Завершить заказ**, пакетное задание создаст необходимый заказ на перемещение и строки заказа на основе запасов в наличии, зарегистрированных для этих грузомест. Дополнительные сведения см. в разделе [Создание заказов на перемещение из приложения склада](create-transfer-order-from-warehouse-app.md)
...
<td>Получение входящего предварительного уведомления об отгрузке (ASN) с помощью кода номерного знака.</td>
</tr>
<tr>
<td>Получение и складирование номерного знака</td>
<td>Получение и складирование входящего предварительного уведомления об отгрузке (ASN) с помощью кода номерного знака.</td>
</tr>
<tr>
...
<tr>
<td rowspan="2">Заказ на возврат</td>
...
<tr>
<td rowspan="6">Заказ на перемещение</td>
...
<strong>Примечание.</strong> Используйте этот параметр, только если номенклатуры были отгружены со склада, который не включен для процессов управления складом (WMS).</td>
</tr>
<tr>
...
<tr>
<td rowspan="3">Подсчет циклов</td>
...
<td>Supply Chain Management определяет тип работы, который назначен сотруднику, и порядок, в котором сотрудник выполняет работу. При выборе этого параметра можно выбрать <strong>Работа, управляемая системой</strong> на панели операций, чтобы открыть страницу <strong>Порядок сортировки, управляемый системой</strong>, где можно настроить критерии сортировки для работы. Критерии сортировки определяют порядок, в котором работник выполняет работу. Может быть добавлено любое требуемое число критериев.</td>
</tr>
<tr class="odd">
...
<li><strong>Предупредить</strong> — работник может комплектовать любую партию в местонахождении, но получает предупреждающее сообщение, если партия не является самой старой.</li>
...
<td>Введите текст, чтобы указать работнику, что следует сканировать, когда работа комплектации группируется системой Supply Chain Management. Например, если используется поле <strong>ShipmentId</strong> для группировки работы комплектации по отгрузке, можно ввести <strong>Код отгрузки</strong> в поле. Это поле требует, чтобы вы создали пункт меню для использования существующей работы, сгруппированной системой. Также необходимо выбрать поле, по которому будет выполняться группировка, в поле <strong>Системная группировка</strong>.</td>
</tr>
<tr class="even">
...
<tr class="even">
<td>Показать список строк работы</td>
<td>Выберите параметр того, как работники смогут просматривать строки и взаимодействовать с ними в текущей выбранной работе по комплектации. Дополнительные сведения об этом параметре см. в разделе <a href="pick-line-overview.md">Настройка пункта меню мобильного устройства для предоставления обзора строки комплектации</a>.</td>
</tr>
</tbody>
</table>
...
> [!NOTE]
> Вы можете требовать подтверждения продукта только для типов работ "комплектация" и "складирование".

## <a name="additional-resources"></a>Дополнительные ресурсы

- [Настройка пункта меню мобильного устройства для выполнения работы типа заказа на покупку](tasks/set-up-mobile-device-menu.md)
- [Настройка пункта меню мобильного устройства для регистрации полученных номенклатур](tasks/set-up-mobile-device-menu-item-register-received-items.md)
