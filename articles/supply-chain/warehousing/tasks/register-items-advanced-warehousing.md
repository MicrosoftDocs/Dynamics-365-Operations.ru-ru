...
description: В этой статье представлен сценарий, который показывает, как зарегистрировать номенклатуры с помощью журнала прибытия номенклатур при расширенного управления складами.
author: Mirzaab
ms.date: 03/24/2021
...
В этой статье представлен сценарий, который показывает, как зарегистрировать номенклатуры с помощью журнала прибытия номенклатур при расширенного управления складами. Обычно эту задачу выполняет сотрудник, ответственный за приемку.
