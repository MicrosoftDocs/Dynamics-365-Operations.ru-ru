...
description: В этой статье показано, как настроить пункт меню "Мобильное устройство".
author: Mirzaab
ms.date: 08/02/2019
