...
1. *Блокировка работы для всей организации* — эта функция необходима для ручной и автоматической настройки создания запланированной работы.
