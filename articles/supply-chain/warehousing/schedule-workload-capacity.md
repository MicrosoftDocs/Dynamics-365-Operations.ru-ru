...
description: В этой статье рассматривается, как настроить и запланировать мощность загрузки для работников на складе или для всего склада.
author: Mirzaab
ms.date: 05/26/2017
ms.topic: article
ms.prod: ''
