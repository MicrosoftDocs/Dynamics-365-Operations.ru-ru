...
description: В этой статье описывается использование внешнего каталога или каталога внешних заказов для сбора информации о ценовых предложениях от поставщика и добавления этой информации в заявку.
