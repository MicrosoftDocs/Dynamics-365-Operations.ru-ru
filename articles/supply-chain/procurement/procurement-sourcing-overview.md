...
Создание накладных по заказам на покупку приводит к записи обязательства по счету поставщика в модуле "Расчеты с поставщиками", где можно обработать *платеж поставщику*.
