...
> [!NOTE]
> В eProcurement запрос предложения для вашей заявки на покупку может позволять поставщикам добавить другие строки. В таком случае в заявке на покупку отображаются утвержденные альтернативы.
