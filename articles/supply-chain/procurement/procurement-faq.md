...
description: В этом разделе представлены ответы на часто задаваемые вопросы (FAQ) о функции закупок в Supply Chain Management
author: kamaybac
ms.date: 05/31/2021
ms.topic: article
...
ms.locfileid: "7477365"
---
# <a name="procurement-faq"></a>Вопросы и ответы по закупкам

[!include [banner](../includes/banner.md)]

В этом разделе представлены ответы на часто задаваемые вопросы (FAQ) о функции закупок в Supply Chain Management.
