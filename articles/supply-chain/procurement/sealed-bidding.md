...
> [!IMPORTANT]
> Необходимо создать хранилище ключей в подписке Azure, владельцем которой является ваша организация (а не подписка, в которой выполняется Supply Chain Management).
