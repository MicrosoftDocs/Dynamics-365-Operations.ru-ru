...
При использовании местоположений под управлением грузоместом можно указать, следует ли скомплектовать заказанное количество или полное доступное количество для номенклатуры во время обработки работы комплектации сырья. Чтобы настроить параметр:

1. Перейдите в раздел **Управление сведениями о продукте \> Продукты \> Выпущенные продукты** и откройте соответствующую номенклатуру.
1. Разверните экспресс-вкладку **Склад**.
1. Выберите один из следующих параметров для поля **Комплектация материалов в местоположения грузоместа**:
    - *Комплектация заказа*: должно быть скомплектовано только заказанное количество.
    - *Промежуточное хранение*: когда возможно, в грузоместе должно быть скомплектовано полное количество. Чтобы у работник была возможность комплектации полного количества грузоместа, оно не должно содержать смешанных номенклатуры и смешанных аналитик. Если грузоместо содержит смешанные аналитики или номенклатуры, комплектация будет продолжена так, как если бы она был настроена как *Комплектация заказа*.
