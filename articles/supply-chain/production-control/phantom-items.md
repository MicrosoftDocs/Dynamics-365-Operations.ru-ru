...
На следующем рисунке (a) — это спецификация на продукт H и детали F и G, а (b) — маршрутный лист для продуктов H и детали F.

![Пример структуры спецификации с двумя уровнями.](media/product-H-part-F.png)
...
![Техническая спецификация для продукта H.](media/product-H-part-B.png)
...
![Искусственный тип строки, используемый в многоуровневых структурах спецификации.](media/product-G-route-sheet-G.png)
...
![Пример сети маршрута, используемой в многоуровневой спецификации.](media/product-G-part-F.png)

На следующем рисунке (a) — это спецификация на продукт G и деталь F, а (b) — маршрутный лист для продукта G и детали F.

![Спецификация для продукта G и части F и маршрутная страница для продукта G и части F.](media/product-G-part-F-with-route-sheet.png)
