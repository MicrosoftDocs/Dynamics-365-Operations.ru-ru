...
Можно определить параметры заказов по умолчанию на странице **Параметры заказа по умолчанию**. Чтобы открыть эту страницу, выберите **Управление сведениями о продукте** &gt; **Продукты** &gt; **Выпущенные продукты** &gt; **Выбор выпущенного продукта** &gt; в **плане**. Можно также перейти **Управление запасами** &gt; **Настройки заказа** &gt; **Параметры заказа по умолчанию**.
