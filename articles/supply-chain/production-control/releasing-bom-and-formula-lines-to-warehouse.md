...
Для быстрой демонстрации порядка выпуска спецификации и строк формулы в производство с помощью пакетного задания просмотрите это короткое видео на YouTube:
...
Для быстрой демонстрации порядка выпуска материала пропорционально количеству готовой продукции посмотрите это короткое видео на YouTube:
