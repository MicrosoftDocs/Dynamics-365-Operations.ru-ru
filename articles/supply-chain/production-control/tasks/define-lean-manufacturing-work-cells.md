...
17. В поле "Местонахождение выхода" нажмите кнопку раскрывающегося списка, чтобы открыть поиск.
    * В производственном потоке с несколькими действиями процесса это часто местонахождение получения следующей производственной ячейки.  
...
32. В списке найдите и выберите требуемую запись.
    * Эта процедура требуют типа модели производственного потока "пропускная способность", чтобы указать определения мощности пропускной способности.  
