...
description: В этой статье описывается разработка содержимого пользовательского интерфейса для каждой конфигурации.
...
1. В заголовке страницы выполните следующие настройки:
    ...
    - **Главное представление** — выберите один из предварительно определенных списков заданий (*Активные задания*, *Все задания*, *Мои задания* и *Мое оборудование*).
