...
1. В заголовке страницы выполните следующие настройки:
    ...
    - **Главное представление** — выберите один из предварительно определенных списков заданий (*Активные задания*, *Все задания* и *Мое оборудование*).
