...
## <a name="turn-on-new-features-in-feature-management"></a>Включение новых функций в управлении функциями

Некоторые параметры, которые описаны в этой теме, должны быть включены в системе, прежде чем они будут доступны для использования. На странице [Управление функциями](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) можно включить необходимые функции.
