...
description: В статье объясняется, как настроить элементы управления формы таким образом, чтобы к ним были применены стили выполнения производственного цеха по умолчанию.
...
ms.locfileid: "8859150"
---
# <a name="style-the-production-floor-execution-interface"></a>Стиль интерфейса выполнения производственного цеха

[!include [banner](../includes/banner.md)]

В статье объясняется, как настроить элементы управления формы таким образом, чтобы к ним были применены стили выполнения производственного цеха по умолчанию.
...
- Все элементы управления в диалоговом окне должны быть настроены, как описано в этой статье.
