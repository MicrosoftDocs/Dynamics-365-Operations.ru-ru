...
description: Эта статья содержит сведения о планировании операций. Планирование операций можно использовать, чтобы получить общую оценку производственного процесса по времени.
...
ms.locfileid: "8871901"
---
# <a name="operations-scheduling"></a>Планирование операций

[!include [banner](../includes/banner.md)]

Эта статья содержит сведения о планировании операций. Планирование операций можно использовать, чтобы получить общую оценку производственного процесса по времени.
