...
ms.locfileid: "8852225"
---
# <a name="production-process-overview"></a>Обзор производственного процесса

[!include [banner](../includes/banner.md)]

Эта статья содержит обзор производственных процессов. В ней описываются различные этапы производственных заказов, заказов партии и канбанов, начиная с создания заказа до закрытия финансового периода.
...
1. **Оценено** — вы можете рассчитывать оценки потребления материала и ресурсов. Оценка создает проводки запасов с сырьем, которые имеют статус **Заказано**. Поступления для главных продуктов, сопутствующих продуктов и побочных продуктов создаются при оценке производственных заказов или заказов партий. Если спецификация содержит строки типа **Фиксированное снабжение**, создаются заказы на покупку материалов или создаются субподрядные операционные услуги, которые прикрепляются к производственному заказу или заказу партии. Номенклатуры или заказы, зарезервированные согласно стратегии резервирования производственного заказа, и цена готовых изделий вычисляются на основе настроек параметров.
1. **Запланировано** — можно планировать производство на основе операций, отдельных заданий или на основе обоих этих параметров.
