...
Если ваша система еще не содержит функцию, описанную в этом разделе, перейдите в [Управление функциями](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) и включите функцию *Унифицированная номерная серия для кодов заданий*.
