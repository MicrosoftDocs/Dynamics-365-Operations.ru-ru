...
description: В этой статье описаны ключевые понятия и термины, которые необходимо понимать для настройки и использования управления производством.
...
ms.locfileid: "8907213"
---
# <a name="registration-for-manufacturing-execution"></a>Регистрация для выполнения производства

[!include [banner](../includes/banner.md)]

В этой статье описаны ключевые понятия и термины, которые необходимо понимать для настройки и использования управления производством. 
