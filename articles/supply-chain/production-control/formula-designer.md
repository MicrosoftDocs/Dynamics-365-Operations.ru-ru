...
description: В этой статье описывается использование конструктора формул для анализа и поддержания формул в виде дерева.
...
ms.locfileid: "8849281"
---
# <a name="formula-designer"></a>Конструктор формул

[!include [banner](../includes/banner.md)]

В этой статье описывается использование конструктора формул для анализа и поддержания формул в виде дерева.
