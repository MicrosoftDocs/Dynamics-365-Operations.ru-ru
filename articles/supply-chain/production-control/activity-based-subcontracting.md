...
description: В этой статье подробно описывается использование субподрядных мероприятий в производственном потоке для бережливого производства.
...
ms.locfileid: "8890751"
---
# <a name="activity-based-subcontracting"></a>Субподряды на основе мероприятий

[!include [banner](../includes/banner.md)]

В этой статье подробно описывается использование субподрядных мероприятий в производственном потоке для бережливого производства.
