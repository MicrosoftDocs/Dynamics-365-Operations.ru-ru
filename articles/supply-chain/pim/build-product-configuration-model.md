...
## <a name="configure-products"></a>Настройка продуктов

### <a name="configure-one-or-more-products"></a>Настройка одного или нескольких продуктов
...
### <a name="multiple-sites-and-intercompany-considerations"></a>Многоузловые и внутрихолдинговые сценарии
