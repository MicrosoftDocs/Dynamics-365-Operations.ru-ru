...
[Создание номенклатуры номера продукта для предопределенных вариантов продуктов](tasks/create-product-number-nomenclature-predefined-variants-2016-11.md)
