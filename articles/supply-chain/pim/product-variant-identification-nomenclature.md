...
description: В этой статье описывается, как можно настроить номенклатуру номеров продукции для замены фиксированного формата [Номер шаблона продукта - Конфигурация – Размер - Цвет - Стиль].
author: t-benebo
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
...
## <a name="nomenclature-of-constraint-based-configurations"></a>Номенклатура конфигураций на основе ограничений
...
## <a name="nomenclature-of-dimension-based-configurations"></a>Номенклатура конфигураций на основе аналитик
