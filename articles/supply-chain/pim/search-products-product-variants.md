...
## <a name="how-searchworks"></a>Как работает поиск
...
## <a name="configure-the-productsearch"></a>Настройка поиска продуктов
...
### <a name="step-1include-all-the-relevant-product-and-product-variant-identifiers-and-dimensions-in-the-search-criteria"></a>Шаг 1. Включите все соответствующие коды и аналитики продуктов и вариантов продукта в критерии поиска
