...
description: В этой статье представлен обзор функций, которые относятся к обработке и документированию опасных материалов во время управления информацией о продуктах и управления складом.
author: t-benebo
ms.date: 06/10/2020
ms.topic: overview
ms.prod: ''
...
Дополнительные сведения о настройке нормативных правил и значений для опасных материалов и порядке назначения значений соответствующим продуктам см. в следующих статьях:
