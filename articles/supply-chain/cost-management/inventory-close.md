...
> [!NOTE] 
> - Закрытие запасов — это обязательный шаг процедуры закрытия месяца для всех моделей запасов. Включает в себя стандартную калькуляцию затрат и калькуляцию затрат со скользящим средним. Закрытие финансового периода невозможно до тех пор, пока не будет выполнено закрытие запасов на дату окончания периода.
