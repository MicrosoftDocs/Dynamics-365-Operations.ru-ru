...
description: В этой статье содержится обзор того, какие типы проводок увеличивают, а какие уменьшают количество запасов.
author: JennySong-SH
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8895854"
---
# <a name="physical-and-financial-updates"></a>Физические и финансовые обновления

[!include [banner](../includes/banner.md)]

В этой статье содержится обзор того, какие типы проводок увеличивают, а какие уменьшают количество запасов. 
