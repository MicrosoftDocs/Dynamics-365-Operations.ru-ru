...
description: В этой статье рассматривается понятие backflush-расчета себестоимости, используемого для бережливого производства.
author: JennySong-SH
ms.date: 04/10/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8906105"
---
# <a name="backflush-costing"></a>Backflush-расчет себестоимости

[!include [banner](../includes/banner.md)]

В этой статье рассматривается понятие backflush-расчета себестоимости, используемого для бережливого производства. 
...
Модель НЗП бережливого производства позволяет использовать статус единицы обработки канбана для управления материалами, незаконченными продуктами и готовыми продуктами, которые являются частью НЗП.
