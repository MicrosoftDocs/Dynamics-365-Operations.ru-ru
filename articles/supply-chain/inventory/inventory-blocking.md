...
description: Эта статья содержит обзор блокировки запасов, которая является частью процесса проверки качества в Supply Chain Management. Можно использовать блокировку запасов для предотвращения обработки или расхода номенклатур.
author: yufeihuang
ms.date: 08/09/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9334696"
---
# <a name="inventory-blocking"></a>Блокировка запасов

[!include [banner](../includes/banner.md)]

Эта статья содержит обзор блокировки запасов, которая является частью процесса проверки качества в Supply Chain Management. Можно использовать блокировку запасов для предотвращения обработки или расхода номенклатур.
...
## <a name="disable-expected-receipts-from-quality-orders-that-sample-blocked-inventory"></a>Отключить ожидаемые приходы из заказов для контроля качества, образцы для которых берутся из заблокированных запасов
