...
> [!NOTE]
> Функция *Изменение статуса запасов номенклатур, контролируемых отслеживанием аналитики* позволяет изменять статус запасов номенклатур, контролируемых аналитиками отслеживания, включая возможность обновления только выбранных записей. В Supply Chain Management 10.0.25 эта функция обязательна и не может быть отключена. При запуске версии, более старой, чем 10.0.25, администраторы могут включать или выключать эту функцию путем поиска функции *Изменить статус запасов для номенклатур, управляемых аналитиками отслеживания* в рабочей области [Управление функциями](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md). Если эта функция включена, вы сможете выполнять следующие действия:
>
