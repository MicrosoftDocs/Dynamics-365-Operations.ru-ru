...
Чтобы удалить данные инвентаризации, которые хранятся в подписке Dataverse, откройте [Power Apps](https://make.powerapps.com), выберите **Среда** на панели переходов и выберите среду Dataverse, связанную с вашей средой LCS. Затем перейдите к **Решения** и удалите следующие пять решений в указанном порядке:

1. Привязка решения для приложения отображения запасов в решениях Dynamics 365
