...
---
# <a name="inventory-visibility-reservations"></a>Резервирования Inventory Visibility

[!include [banner](../includes/banner.md)]


В этой статье описывается, как настроить функцию резервирования для создания резервирований, потребления зарезервированных и/или незарезервированных складских количеств с помощью отображения запасов.
