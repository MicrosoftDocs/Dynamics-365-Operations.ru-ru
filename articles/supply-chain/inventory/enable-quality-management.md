...
<li>Приемка для 30
<ul>
<li>Заказ для контроля качества #1 создается для 1 (для первого принятого количества, которое имеет фиксированное значение 1).</li>
<li>Для оставшегося количества заказы для контроля качества не создаются.</li>
</ul>
</li>
<li>Приемка для 10
<ul>
