...
Эта тема описывает, как можно использовать управление качеством в Dynamics 365 Supply Chain Management, чтобы улучшить качество продукта в вашей цепи поставок.
...
## <a name="quality-order-auto-generation-examples"></a>Примеры автоматического создания заказов для контроля качества
...
<ol>
<li>Приемка для 3: 1 для #b1, #s1; 1 для #b2, #s2; и 1 для #b3, #s3
<ul>
<li>Заказ для контроля качества #1 для 1 партии #b1, последовательный #s1</li>
<li>Заказ для контроля качества #2 для 1 партии #b2, последовательный #s2</li>
<li>Заказ для контроля качества #3 для 1 партии #b3, последовательный #s3</li>
</ul>
</li>
<li>Приемка для 2: 1 для #b4, #s4; и 1 для #b5, #s5
<ul>
<li>Заказ для контроля качества #4 для 1 партии #b4, последовательный #s4</li>
<li>Заказ для контроля качества #5 для 1 партии #b5, последовательный #s5</li>
</ul>
</li>
</ol>
...
<p>Количество в заказе: 10</p>
<ol>
<li>Приемка для 4: 1 для #b1, #s1; 1 для #b2, #s2; 1 для #b3, #s3 и 1 для #b4, #s4
<ul>
<li>Заказ для контроля качества #1 для 1 партии #b1, последовательный #s1</li>
<li>Заказ для контроля качества #2 для 1 партии #b2, последовательный #s2</li>
<li>Заказ для контроля качества #3 для 1 партии #b3, последовательный #s3</li>
...
<ul>
<li>Заказ для контроля качества #5 для 2, без ссылки на партию и серийный номер</li>
</ul>
</li>
<li>Приемка для 6: 1 для #b5, #s5; 1 для #b6, #s6; 1 для #b7, #s7; 1 для #b8, #s8; 1 для #b9, #s9; и 1 для #b10, #s10
<ul>
<li>Заказы для контроля качества не создаются.</li>
</ul>
</li>
