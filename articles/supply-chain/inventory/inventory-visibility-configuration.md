...
> - Необходимо иметь по крайней мере одну иерархию индексов (например, содержащую базовую аналитику `Empty`), иначе запросы не будут заданы с ошибкой "Не задана иерархия индексов".
