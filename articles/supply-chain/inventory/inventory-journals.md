...
> [!NOTE]
> Не все журналы запасов поддерживают OData, следовательно нельзя использовать соединитель данных Excel для публикации, обновления или импорта данных обратно в Dynamics 365 for Finance and Operations. 
