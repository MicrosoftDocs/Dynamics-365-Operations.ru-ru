...
1. Выберите **Назначить роль**, а затем выберите *Системный администратор*. Если имеется роль с именем *Пользователь Common Data Service*, выберите ее также.
