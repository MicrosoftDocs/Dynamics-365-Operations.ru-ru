...
1. В диалоговом окне **Настройка среды Power Platform** установите флажок, а затем выберите **Настройка**. Обычно программа установки занимает от 60 до 90 минут.
1. После завершения настройки среды Microsoft Power Platform выполните вход в [центр администрирования Power Platform](https://admin.powerplatform.microsoft.com) и установите надстройку глобального учета запасов, выполнив следующие действия:
...
1. Вернитесь в среду LCS. На экспресс-вкладке **Надстройки сред** выберите **Установить новую надстройку**.
