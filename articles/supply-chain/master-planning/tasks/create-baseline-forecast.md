...
ms.locfileid: "7578328"
---
# <a name="guide-create-a-baseline-forecast"></a>Руководство: создание базового прогноза
...
4. Выберите **Ключи распределения номенклатуры**.
...
5. Выберите **Сведения о строке прогноза**.
