...
description: В этой статье представлен обзор календарей цепочки поставок и их влияния на сводное планирование.
author: t-benebo
ms.date: 08/19/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8890983"
---
# <a name="calendars-and-master-planning"></a>Календари и сводное планирование

[!include [banner](../includes/banner.md)]

В этой статье представлен обзор календарей цепочки поставок и их влияния на сводное планирование.  Объясняются различные календари, используемые в механизме сводного планирования, включая их влияние на даты отгрузки и получения в спланированных заказах. Наконец, приведены рекомендации в отношении назначения, использования и обновления календарей.
