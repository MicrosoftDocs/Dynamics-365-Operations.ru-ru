...
## <a name="differences-between-planning-optimization-and-the-built-in-planning-engine"></a>Различия между оптимизацией планирования и встроенной подсистемой планирования

Прогнозы поставок работают немного по-разному в зависимости от того, какая подсистема планирования используется (встроенное сводное планирование или оптимизация планирования). В этом разделе описываются различия.

### <a name="vendor-groups"></a>Группы поставщиков

При добавлении строки прогноза можно указать поставщика и группу поставщиков. Во встроенной подсистеме планирования создаваемые спланированные заказы группируются по комбинациям значений поставщиков и групп поставщиков. В оптимизации планирования спланированные заказы группируются по поставщикам.
...
Встроенный механизм планирования создаст следующие заказы:
...
Во встроенном механизме сводного планирования результат будет непредсказуемым, если у некоторых прогнозов имеется поставщик, но у других — нет.
...
Встроенный механизм планирования сокращает для всех состояний заказов на перемещение, в то время как оптимизация планирования сокращает прогноз только по заказам на перемещение, которые находятся в состоянии *Выпущен*.
