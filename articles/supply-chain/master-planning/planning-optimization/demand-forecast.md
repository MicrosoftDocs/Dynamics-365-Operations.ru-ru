...
description: В этой статье объясняется, как включать прогнозы спроса при сводном планировании.
author: t-benebo
ms.date: 12/02/2020
ms.topic: article
ms.prod: ''
