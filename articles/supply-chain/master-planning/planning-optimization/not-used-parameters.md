---
title: Параметры, не используемые в оптимизации планирования
description: В этой статье перечисляются параметры, которые в настоящее время не учитываются в ходе оптимизации планирования.
author: t-benebo
ms.date: 09/02/2021
ms.topic: article
...
ms.locfileid: "8907358"
---
# <a name="parameters-not-used-by-planning-optimization"></a>Параметры, не используемые в оптимизации планирования

[!include [banner](../../includes/banner.md)]

В этой статье перечисляются параметры, которые в настоящее время не учитываются в ходе оптимизации планирования. Служба планирования может пропустить параметр, так как, например, соответствующие функции еще не поддерживаются. Кроме того, этот параметр может стать устаревшим из-за функциональных изменений.
