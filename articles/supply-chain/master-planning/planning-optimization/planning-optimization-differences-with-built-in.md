...
| Назначение ресурсов | При работе с бесконечной емкостью встроенный механизм сводного планирования назначает все спланированные заказы для одного и того же ресурса в данной группе ресурсов. Оптимизация планирования улучшает это за счет выбора ресурсов в случайном порядке, что позволяет разным производственным заказам использовать разные ресурсы. Если необходимо использовать один и тот же ресурс для всех спланированных заказов, следует указать этот ресурс в маршруте. |
| Расширенные типы данных (EDT) | Оптимизация планирования не поддерживает изменения точности EDT. Например, если точность количества продукта расширяется с двух знаков после запятой (по умолчанию) до четырех, оптимизация планирования будет продолжать использовать только два десятичных знака. |
