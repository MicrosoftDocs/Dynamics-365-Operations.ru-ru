...
description: Эта статья содержит сведения о планировании с неограниченной емкостью. Здесь также описываются текущие ограничения функций.
author: t-benebo
ms.date: 08/09/2022
ms.topic: article
...
ms.locfileid: "9740014"
---
# <a name="scheduling-with-infinite-capacity"></a>Планирование без ограничений по емкости

[!include [banner](../../includes/banner.md)]

Функция *Планирование с неограниченной мощностью для оптимизации планирования* включает в себя планирование, основанное на информации о маршруте. Она позволяет планировать задания на основе широкого диапазона настроек маршрута. Планирование охватывает часто используемые параметры маршрута, включая последовательность операций маршрута или требования для ресурсов операций маршрута.

## <a name="turn-the-infinite-capacity-scheduling-feature-on-or-off"></a>Включение или выключение функции планирования с неограниченной мощностью
...
Функция *Планирование с неограниченной мощностью для оптимизации планирования* включает планирование заданий, основанное на информации о маршруте. Таким образом, настройка маршрута может использоваться для планирования производственных процессов. Хотя эта функция имеет ряд ограничений, которых нет в устаревшем механизме сводного планирования, она поддерживает наиболее общие функциональные возможности, необходимые для сценариев производства.
...
В целом, планирование поддерживает наиболее часто используемые сценарии. Можно создать маршрут, добавить первичные и вторичные операции, определить следующие операции, добавить потребности в ресурсах, а также добавить время настройки и время выполнения. Затем система будет учитывать эти сведения во время планирования.

## <a name="limitations"></a>Ограничения

При использовании функции *Планирование без ограничения емкости для оптимизации планирования* действуют следующие ограничения:
