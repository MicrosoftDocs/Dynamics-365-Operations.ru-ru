...
description: В этой статье приводятся сведения о планировании с неограниченной мощностью для оптимизации планирования. Здесь также описываются текущие ограничения функций.
author: t-benebo
ms.date: 08/09/2022
ms.topic: article
