---
title: Чистые потребности и информация об источниках потребности
description: В этой статье приводятся сведения о расчете чистых потребностей и сведения определения источника потребности.
author: t-benebo
ms.date: 7/28/2021
ms.topic: article
...
ms.locfileid: "9748447"
---
# <a name="net-requirements-and-pegging-information"></a>Чистые потребности и информация об источниках потребности
...
- **Обновление \> Прогнозное планирование** — запускает прогнозное планирование непосредственно со страницы **чистые потребности**. Оптимизация планирования не поддерживает эту операцию.
- **Обновление \> Планирование непрерывности** — выполнение планирование непрерывности непосредственно со страницы **чистые потребности**. Оптимизация планирования не поддерживает эту операцию.
...
> [!NOTE]
> Требование *Резервный запас* не включен на странице **Чистые потребности**.
