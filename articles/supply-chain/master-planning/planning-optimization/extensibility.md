...
description: В этой статье описываются сценарии расширения, которые поддерживаются в оптимизации планирования.
author: t-benebo
ms.date: 08/05/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8857554"
---
# <a name="planning-optimization-extensibility"></a>Расширяемость оптимизации планирования

[!include [banner](../../includes/banner.md)]

В этой статье описываются сценарии расширяемости, которые относятся к сводному планированию и поддерживаются в оптимизации планирования. Такие возможности доступны с версии Microsoft Dynamics 365 Supply Chain Management 10.0.13.
