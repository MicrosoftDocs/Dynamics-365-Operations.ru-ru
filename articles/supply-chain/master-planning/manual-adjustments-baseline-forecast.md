...
- Функция *Выбор прогнозной модели на странице сведений о прогнозе спроса* добавляет параметры на страницу **Сведения о прогнозе спроса**, которая позволяет вам выбрать включаемые модели прогноза. В Supply Chain Management версии 10.0.21 эта функция включена по умолчанию. В Supply Chain Management 10.0.25 эта функция обязательна и не может быть отключена. При запуске версии, более старой, чем 10.0.25, администраторы могут включать или выключать эту функцию путем поиска функции *Выбор прогнозной модели на странице сведений о прогнозе спроса* в рабочей области [Управление функциями](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md).
