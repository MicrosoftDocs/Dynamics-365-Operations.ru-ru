...
-   Если вы включите **Выбор модели прогноза в сведениях прогноза спроса** в управлении функциями, вы сможете выбрать модели прогноза, которые будут включены, для исторического прогноза, на странице **сведений о прогнозе спроса**. (В Supply Chain Management версии 10.0.21 эта функция включена по умолчанию.)
