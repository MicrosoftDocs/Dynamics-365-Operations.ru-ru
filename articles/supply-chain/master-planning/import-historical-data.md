...
Можно использовать следующий файл в качестве примера. Загрузите [HistoricalDemandData](/dynamics/s-e/). Этот файл содержит исторические данные по спросу для номенклатуры D0001. Он содержит только следующие обязательные поля: сайт, количество и дата спроса.
