...
Чтобы создать прогноз, Supply Chain Management использует веб-сервис Machine Learning. Чтобы подключиться к сервису, необходимо предоставить следующую информацию, если выполняется вход в Microsoft Azure Machine Learning Studio (классическая версия).
