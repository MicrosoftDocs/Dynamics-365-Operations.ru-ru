---
title: Ключи сокращения прогноза
...
- Временная граница уменьшения прогноза спроса не включена в расчет уменьшения прогноза. Вместо этого временная граница группы покрытия используется для уменьшения прогноза.
