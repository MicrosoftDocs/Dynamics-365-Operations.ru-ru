...
---
# <a name="method-used-to-reduce-forecast-requirements"></a>Метод, используемый для сокращения потребностей по прогнозу
...
При выборе **Проводки - ключ сокращения** или **Проводки - динамический период** как метода уменьшения требований прогноза, можно указать, какие проводки снижают прогноз. На странице **Выпущенные продукты** на экспресс-вкладке **Прочее** в поле **Уменьшить прогноз по** выберите **Все проводки**, если все проводки должны снижать прогноз или **Заказы**, если только заказы на продажу должны снижать прогноз.
