...
> Доступна мощность группы ресурсов =  
> (емкость для ресурсов в группе, основанная на их календаре) –  
> (запланированная загрузка заданий по ресурсам в группе) –  
> (запланированная загрузка операций по ресурсам в группе) –  
> (запланированная загрузка операций по группе ресурсов)
...
> Доступная мощность для возможности =  
> (мощность для возможности) –  
> (запланированная загрузка задания по ресурсам с определенной возможностью, включеной в группу ресурсов) –  
> (запланированная загрузка операций по ресурсам с определенной возможностью, включеной в группу ресурсов) –  
> (запланированная загрузка операций по самой группе ресурсов, которые требуют определенную возможность)
