...
description: В этой статье приводятся сведения о параметрах покрытия, которые сводное планирование использует для расчета потребностей в номенклатуре.
author: t-benebo
ms.date: 09/13/2019
ms.topic: article
ms.prod: ''
