...
| <em>ApportionmentEngine</em> |                        Код общего механизма, который определяет механизм распределения в базе данных Microsoft Dynamics 365 for Finance and Operations.                        |
