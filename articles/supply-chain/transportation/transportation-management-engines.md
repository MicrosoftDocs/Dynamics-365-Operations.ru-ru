...
| 5        | Страна/регион места назначения           | Назначение | Строка    | Страна или регион |           |
...
- [Системы управления транспортировкой](https://download.microsoft.com/download/e/0/9/e0957665-c12f-43c7-94c0-611cc49d7d61/TransportationManagementEnginesInAX.pdf)
