...
description: В этой статье описывается создание транспортной накладной при использовании процессов управления складом (WMS).
author: Weijiesa
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9069707"
---
# <a name="create-a-bill-of-lading"></a>Создание транспортной накладной

[!include [banner](../includes/banner.md)]

В этой статье описывается создание транспортной накладной при использовании процессов управления складом (WMS).  
