...
description: В этой статье описывается, как настроить и использовать функциональность для включения в загрузки веса и объема контейнера.
author: Weijiesa
ms.date: 05/26/2017
ms.topic: article
ms.prod: ''
