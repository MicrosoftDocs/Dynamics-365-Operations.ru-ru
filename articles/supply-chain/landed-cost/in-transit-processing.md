...
description: В этой статье описывается, как работать с заказами товаров в пути. Если заказ или рейс настроены для использования обработки товаров в пути, можно выставить накладные по товарам до того, как они будут получены на складе для потребления.
author: Weijiesa
ms.date: 01/13/2021
ms.topic: article
ms.prod: ''
