...
description: В этой статье описывается, как настроить информацию о доставке для модуля "Стоимость на складе".
author: Weijiesa
ms.date: 12/09/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8895622"
---
# <a name="delivery-information-setup"></a>Настройка сведений о доставке

[!include [banner](../../includes/banner.md)]

В этой статье описывается, как настроить информацию о доставке для модуля **Стоимость на складе**.
