...
description: В этом разделе представлены сведения о мероприятиях контейнера, которые используются для отслеживания хода выполнения контейнеров отгрузки.
author: yufeihuang
ms.date: 05/27/2022
ms.topic: article
ms.search.form: ''
