...
Никакие другие типы обработки исходных документов или работы склада в настоящее время не поддерживаются в единицах масштабирования. Например, для рабочей нагрузки выполнения склада в единице масштабирования невозможно выполнить процесс приема заказов на перемещение (приход перемещения); вместо этого это должно обрабатываться экземпляром концентратора.
...
| Отмена строк складских заказов<p>Обратите внимание, что это поддерживается только в том случае, если по строке не была выполнена регистрация во время обработки операции *запрос на отмену*</p> | Да | Нет |
...
| Обработка работы с *недоукомплектованием*                               | Да | Да |
...
| Обработать | Узел | Рабочая нагрузка выполнения склада на единице масштабирования |
|---------|-----|------------------------------|
| Приемка и размещение готовых товаров | Да | Да |
| Размещение побочных и попутных продуктов | Да | Да |
| Запустить производственный заказ | Да | Да |
| <p>Все остальные процессы управления складом, которые относятся к производству, включая:</p><li>Выпуск на склад</li><li>Обработка волны производства</li><li>Комплектация сырья</li><li>Канбан складирован</li><li>Комплектация по канбану</li><li>Отходы производства</li><li>Последняя палета производства</li><li>Регистрация потребления материалов</li><li>Пустой канбан</li></ul> | Да | Нет |
