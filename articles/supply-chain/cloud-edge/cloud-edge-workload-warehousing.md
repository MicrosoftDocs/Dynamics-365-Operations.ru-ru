...
description: В этой статье приводятся сведения о функции, которая позволяет модулям масштабирования выполнять выбранные процессы из рабочей нагрузки управления складом.
author: perlynne
ms.date: 09/03/2021
ms.topic: article
ms.prod: ''
...
> [!WARNING]
> Не все бизнес-функции управления складом полностью поддерживаются для складов, выполняющих рабочую нагрузку в единицах масштабирования. Убедитесь в том, что используются только процессы, которые в этой статье описаны как поддерживаемые явным образом.
...
>
> При выполнении рабочей нагрузки в единице масштабирования вы не можете выполнить неподдерживаемые процессы для этого конкретного склада в концентраторе. В таблицах, указанных ниже в этой статье, описываются поддерживаемые возможности.
>
...
<!--| Ручная обработка на станции упаковки, включая работу "Комплектация упакованного контейнера"  | Нет  | Да, но без объявления отгрузки TMS и разноски отборочной накладной продаж и без примечаний упаковки и изображений продукта |-->
