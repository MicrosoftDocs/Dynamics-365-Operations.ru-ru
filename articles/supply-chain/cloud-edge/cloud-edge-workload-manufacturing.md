---
title: Производственные рабочие нагрузки для облачных и пограничных единиц масштабирования
description: В этой статье описывается, как рабочие нагрузки выполнения производства работают с облачными и пограничными единицами масштабирования.
...
В этой статье описывается, как рабочие нагрузки выполнения производства работают с облачными и пограничными единицами масштабирования.
...
В текущем выпуске операция запуска для производства и заказов партии поддерживается [рабочей нагрузкой выполнения склада](cloud-edge-workload-warehousing.md) (не рабочей нагрузкой выполнения производства). Таким образом, чтобы использовать эту функцию при соединении с единицей масштабирования, необходимо выполнить следующие задачи:
