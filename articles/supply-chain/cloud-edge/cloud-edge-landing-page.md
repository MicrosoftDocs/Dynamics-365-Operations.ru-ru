...
---
# <a name="use-scale-units-to-help-increase-resilience-for-supply-chain-management-workloads"></a>Использование единиц масштабирования позволяет повысить устойчивость для рабочих нагрузок Supply Chain Management
...
## <a name="core-value-proposition-for-scale-units"></a>Основное ценностное предложение для единиц масштабирования
...
- Надстройка для облачной единицы масштабирования для Dynamics 365 Supply Chain Management (*доступна с апреля 2021 года*)
- Надстройка для пограничной единицы масштабирования для Dynamics 365 Supply Chain Management (*будет доступно в ближайшее время*)
...
Рабочая нагрузка "Управление складом" представляет собой первую распределенную рабочую нагрузку для единиц масштабирования, которые были выпущены для общей доступности.

В модуле Управление складом единицы масштабирования доставляют следующие возможности:

- Система может обрабатывать выбранные методы волны для заказов на продажу и пополнения спроса.
...
Дополнительные сведения см. в разделе [Рабочие нагрузки управления складом для облачных и пограничных единиц масштабирования](cloud-edge-workload-warehousing.md).
...
Первый выпуск производственных рабочих нагрузок в данный момент находится в режиме предварительная версия и предоставляет следующие возможности:
