...
1.  Щелкните **Управление сервисным обслуживанием** \> **Настройка** \> **Ремонт** \> **Условия**.

2.  Щелкните **Управление сервисным обслуживанием** \> **Настройка** \> **Ремонт** \> **Области симптомов**.

3.  Щелкните **Управление сервисным обслуживанием** \> **Настройка** \> **Ремонт** \> **Области диагностики**.

4.  Щелкните **Управление сервисным обслуживанием** \> **Настройка** \> **Ремонт** \> **Решения**.

5.  Щелкните **Управление сервисным обслуживанием** \> **Настройка** \> **Ремонт** \> **Этапы ремонта**.
...
3.  Щелкните **Ремонт** \> **Строки ремонта**, чтобы открыть форму **Строки ремонта**.
...
6.  Выберите в строке ремонта предопределенные признаки, диагностику и значения исполнения, связанные со строкой ремонта, и при необходимости перейдите на вкладку **Примечание** для создания примечания к строке ремонта.

7.  Нажмите CTRL+S, чтобы сохранить новую строку ремонта. Поле **Дата и время создания** на вкладке **Общие** формы **Строки ремонта** обновляется значением времени сохранения.
