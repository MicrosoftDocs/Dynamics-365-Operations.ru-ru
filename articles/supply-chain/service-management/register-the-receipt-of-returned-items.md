...
1.  Выберите **Продажи и маркетинг** \> **Возвраты продаж** \> **Все заказы на возврат**. Создайте новый заказ на возврат или откройте заказ на возврат из списка. На экспресс-вкладке **Строки** выберите строку заказа на возврат. Щелкните **Обновить строку**, а затем щелкните **Регистрация**.
