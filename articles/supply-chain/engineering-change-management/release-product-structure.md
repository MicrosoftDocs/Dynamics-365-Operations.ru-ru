...
description: В этой статье объясняется, как можно запустить полную структуру продуктов в дополнение к выпуску продуктов вместе с их инженерными версиями. Таким образом можно гарантировать, что связанные с разработкой данные о продуктах могут быть легко использованы в других юридических лицах.
author: t-benebo
ms.date: 09/28/2020
ms.topic: article
ms.prod: ''
...
| Тип производства | Это поле отображается только в том случае, если включено [управление изменениями формул](manage-formula-changes.md) в системе. Выберите тип производства, к которому применяется эта политика выпуска:<ul><li>**Сопутствующий продукт** — используйте эту политику выпуска для управления сопутствующими продуктами. Сопутствующие продукты производятся во время непрерывного производства и не имеют версий или технологических продуктов. Политики выпуска для сопутствующих продуктов могут помочь гарантировать, что важные параметры, такие как **Группа аналитик хранения** и **Группа аналитик отслеживания**, настраиваются с помощью шаблона выпущенного продукта, прежде чем они будут выпущены в компанию.</li><li>**Побочный продукт** — используйте эту политику выпуска для управления побочными продуктами. Побочные продукты производятся во время непрерывного производства и не имеют версий или технологических продуктов. Политики выпуска для побочных продуктов могут помочь гарантировать, что важные параметры, такие как **Группа аналитик хранения** и **Группа аналитик отслеживания**, настраиваются с помощью шаблона выпущенного продукта, прежде чем они будут выпущены в компанию.</li><li>**Нет** — эта политика используется для управления стандартными продуктами, которые не имеют версий или технологических продуктов, а также сопутствующих или побочных продуктов.</li><li>**Номенклатура планирования** — эта политика выпуска используется для управления номенклатурами планирования, производимыми с использованием процесса производства. Номенклатуры планирования используют формулы. Они похожи на номенклатуры формул, но они используются для производства только сопутствующих и побочных продуктов, но не готовой продукции.</li><li>**Спецификация** — данная политика выпуска используется для управления технологическими продуктами, которые не используют формулы и обычно (но не обязательно) включают спецификации.</li><li>**Формула** — эта политика выпуска используется для управления готовыми номенклатурами, производимыми с использованием процесса производства. Эти номенклатуры будут иметь формулу, но не спецификацию.</li></ul> |
