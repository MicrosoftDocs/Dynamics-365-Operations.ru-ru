...
1. Установите флажок **Управление изменением разработки**.
1. Если это необходимо использовать, установите флажок **Аналитика продукта — версия**.
