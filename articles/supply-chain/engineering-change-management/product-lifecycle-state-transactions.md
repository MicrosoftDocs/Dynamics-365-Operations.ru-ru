...
description: В этой статье объясняется, как контролировать, какие проводки разрешены для каждого состояния жизненного цикла, когда инженерный продукт проходит через свой жизненный цикл.
author: t-benebo
ms.date: 02/17/2022
ms.topic: article
ms.prod: ''
...
## <a name="default-product-lifecycle-states"></a>Состояния жизненного цикла продукта по умолчанию

Состояние жизненного цикла по умолчанию для инженерной версии определяется его инженерной категорией. Состояние по умолчанию будет использоваться при создании новой инженерной версии, включая первую версию нового продукта.

При создании нового продукта или инженерного продукта можно также задать состояние жизненного цикла по умолчанию, указав его в выпущенном продукте шаблона политики выпуска, назначенной продукту.

В этом случае продукт может иметь состояние жизненного цикла, отличное от версии при создании нового инженерного продукта.
