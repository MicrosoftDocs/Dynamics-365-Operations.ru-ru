...
| Группа аналитик продуктов | Параметр **Отслеживать версии в проводках** помогает выбрать подтип продукта. Если было указано, что необходимо отслеживать версию в проводках, будут отображены группы аналитик продукта, в которых используется аналитика *версия*. В противном случае будут отображены только группы аналитик продукта, в которых аналитика *версия* не используется. |
...
Поле **Политика готовности продукта** используется для выбора политики готовности, которая применяется к продуктам, относящимся к этой категории. Дополнительные сведения см. в разделе [Готовность продуктов](product-readiness.md).
