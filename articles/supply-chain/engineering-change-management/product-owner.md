...
description: Эта статья содержит сведения о владельцах продуктов. Владелец продукта — это группа пользователей, ответственных за конкретные продукты. Только участники этой группы могут выпускать эти продукты. Владелец продукта также может использоваться в рабочем процессе утверждения.
author: t-benebo
ms.date: 09/28/2020
ms.topic: article
ms.prod: ''
