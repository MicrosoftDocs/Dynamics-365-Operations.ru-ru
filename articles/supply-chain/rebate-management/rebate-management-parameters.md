---
title: Параметры ретробонусов
description: В этой статье описывается страница параметров управления ретробонусами. На этой странице содержатся параметры, влияющие на разноску, обновление статуса, номерные серии и другое поведение.
author: sherry-zheng
ms.date: 02/19/2021
ms.topic: article
ms.prod: ''
