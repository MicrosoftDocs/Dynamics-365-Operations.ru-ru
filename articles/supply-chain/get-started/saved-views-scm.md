...
| Страница | Имя представления | Описание представления | Имя функции |
|---|---|---|---|
| Список выпущенных продуктов | Создание продукта | Упрощенное представление страниц, включающее только поля, чаще всего используемые при создании продуктов. | Сохраненные представления для выпущенных продуктов |
| Сведения об используемом продукте | Создание продукта | Упрощенное представление страниц, включающее только поля, чаще всего используемые при создании продуктов. | Сохраненные представления для выпущенных продуктов |
| Сведения об используемом продукте | Управление логистическими сведениями | Упрощенное представление страниц, включающее только поля, чаще всего используемые при управлении логистическими сведениями о продуктах. | Сохраненные представления для выпущенных продуктов |
| Сведения об используемом продукте | Управление сведениями о закупках | Упрощенное представление страниц, включающее только поля, чаще всего используемые при управлении сведениями о закупках для продуктов. | Сохраненные представления для выпущенных продуктов |
| Сведения об используемом продукте | Управление сведениями о продажах | Упрощенное представление страниц, включающее только поля, чаще всего используемые при управлении сведениями о продуктах, связанными с продажами. | Сохраненные представления для выпущенных продуктов |
