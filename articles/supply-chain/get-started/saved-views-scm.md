...
|---|---|---|---|
| Список количества в наличии | Финансы | Этот упрощенное представление позволяет сосредоточиться на финансовой информации при управлении запасами в наличии. | Сохраненные представления для управления запасами (включены по умолчанию с версии 10.0.21.) |
| Список количества в наличии | Контроль качества | Этот упрощенное представление позволяет сосредоточиться на контроле качества при управлении запасами в наличии. | Сохраненные представления для управления запасами (включены по умолчанию с версии 10.0.21.) |
| Список количества в наличии | Получение | Этот упрощенное представление позволяет сосредоточиться на операциях получения при управлении запасами в наличии. | Сохраненные представления для управления запасами (включены по умолчанию с версии 10.0.21.) |
| Список количества в наличии | Доставка | Этот упрощенное представление позволяет сосредоточиться на операциях отгрузки при управлении запасами в наличии. | Сохраненные представления для управления запасами (включены по умолчанию с версии 10.0.21.) |
| Транзакции | Упрощенное | Это упрощенное представление позволяет просматривать статус запасов, не отвлекаясь на финансовую информацию и другие поля, которые используются реже остальных. | Сохраненные представления для управления запасами (включены по умолчанию с версии 10.0.21.) |
| Заказы на перемещение | Доставка | Этот упрощенное представление позволяет сосредоточиться на операциях отгрузки при управлении заказами на перемещение. | Сохраненные представления для управления запасами (включены по умолчанию с версии 10.0.21.) |
| Заказы на перемещение | Получение | Этот упрощенное представление позволяет сосредоточиться на операциях получения при управлении заказами на перемещение. | Сохраненные представления для управления запасами (включены по умолчанию с версии 10.0.21.) |
| Заказы на перемещение | Контроль качества | Этот упрощенное представление позволяет сосредоточиться на контроле качества при управлении заказами на перемещение. | Сохраненные представления для управления запасами (включены по умолчанию с версии 10.0.21.) |
| Заказы на перемещение | Финансы | Этот упрощенное представление позволяет сосредоточиться на финансовой информации при управлении заказами на перемещение. | Сохраненные представления для управления запасами (включены по умолчанию с версии 10.0.21.) |
...
| Страница | Имя представления | Описание представления | Имя функции |
|---|---|---|---|
| Список выпущенных продуктов | Создание продукта | Упрощенное представление страниц, включающее только поля, чаще всего используемые при создании продуктов. | Сохраненные представления для выпущенных продуктов (включены по умолчанию с версии 10.0.21.) |
| Сведения об используемом продукте | Создание продукта | Упрощенное представление страниц, включающее только поля, чаще всего используемые при создании продуктов. | Сохраненные представления для выпущенных продуктов (включены по умолчанию с версии 10.0.21.) |
| Сведения об используемом продукте | Управление логистическими сведениями | Упрощенное представление страниц, включающее только поля, чаще всего используемые при управлении логистическими сведениями о продуктах. | Сохраненные представления для выпущенных продуктов (включены по умолчанию с версии 10.0.21.) |
| Сведения об используемом продукте | Управление сведениями о закупках | Упрощенное представление страниц, включающее только поля, чаще всего используемые при управлении сведениями о закупках для продуктов. | Сохраненные представления для выпущенных продуктов (включены по умолчанию с версии 10.0.21.) |
| Сведения об используемом продукте | Управление сведениями о продажах | Упрощенное представление страниц, включающее только поля, чаще всего используемые при управлении сведениями о продуктах, связанными с продажами. | Сохраненные представления для выпущенных продуктов (включены по умолчанию с версии 10.0.21.) |
...
| Страница | Имя представления | Описание представления | Имя функции |
|---|---|---|---|
| Страница спецификации производственного заказа | Упрощенное | Это упрощенное представление включает только наиболее часто используемые поля. Таким образом обеспечивается более быстрый обзор и упрощенный процесс работы. | Сохраненные представления для управления производством (включены по умолчанию с версии 10.0.21.) |
| Страница сведений о производственном заказе | Упрощенное | Это упрощенное представление включает только наиболее часто используемые поля. Таким образом обеспечивается более быстрый обзор и упрощенный процесс работы. | Сохраненные представления для управления производством (включены по умолчанию с версии 10.0.21.) |
| Страница листа подбора по производственному заказу | Упрощенное | Это упрощенное представление включает только наиболее часто используемые поля. Таким образом обеспечивается более быстрый обзор и упрощенный процесс работы. | Сохраненные представления для управления производством (включены по умолчанию с версии 10.0.21.) |
| Страница списка производственных заказов | Упрощенное | Это упрощенное представление включает только наиболее часто используемые поля. Таким образом обеспечивается более быстрый обзор и упрощенный процесс работы. | Сохраненные представления для управления производством (включены по умолчанию с версии 10.0.21.) |
...
| Рабочее место планирования загрузки | Упрощенное | Это упрощенное представление включает только наиболее часто используемые поля. Таким образом обеспечивается более быстрый обзор и упрощенный процесс работы. | Сохраненное представление для рабочего места планирования загрузки |
