...
| --- | --- | --- |
| Управление активами | [Применить правила для группирования заказов на работу при выполнении плана обслуживания](../asset-management/preventive-and-reactive-maintenance/creating-work-orders.md) | Обязательная аналитика |
...
| Управление активами | [Усовершенствования обслуживания на основе счетчиков](../asset-management/preventive-and-reactive-maintenance/maintenance-plans.md) | Включено по умолчанию |
| Управление активами | [Выставление счетов по заказу на работу](../asset-management/integration-to-project-management-and-accounting/customer-billing.md) | Обязательная аналитика |
...
| Производство | Включить отображение складских аналитик в списке материалов для операций производственного маршрута | Включено по умолчанию |
...
| Сводное планирование | Планирование ресурсов с обслуживанием | Обязательная аналитика |
...
| Управление сведениями о продукте | [Улучшенное наследование атрибутов для управления изменениями разработки](../engineering-change-management/engineering-attributes-and-search.md) | Обязательная аналитика |
...
| Управление транспортировкой | [Отгрузка небольших посылок](../warehousing/small-parcel-shipping.md) | Включено по умолчанию |
...
| Управление складом | [Консолидировать отгрузку](../warehousing/configure-shipment-consolidation-policies.md) | Включено по умолчанию |
...
| Управление складом | [Отделение работы размещения от ASN](whats-new-scm-10-0-21.md) | Включено по умолчанию |
| Управление складом | [Отложенные операции складирования](../warehousing/deferred-processing-manual-inventory-movement.md) | Включено по умолчанию |
...
| Управление складом | [Гибкое резервирование аналитик на уровне склада](../warehousing/flexible-warehouse-level-dimension-reservation.md) | Включено по умолчанию |
| Управление складом | [Гибкое резервирование номерных знаков с привязкой к конкретному заказу](../warehousing/flexible-warehouse-level-dimension-reservation.md) | Включено по умолчанию |
...
| Управление складом | [Плановый кросс-докинг](../warehousing/planned-cross-docking.md) | Включено по умолчанию |
...
| Управление складом | Сведения об этикетках волны отгрузки | Включено по умолчанию |
...
| Управление складом | [Продвигаемые поля приложения склада](../warehousing/warehouse-app-promoted-fields.md) | Включено по умолчанию |
| Управление складом | [Инструкции для шагов приложения склада](../warehousing/mobile-app-titles-instructions.md) | Включено по умолчанию |
| Управление складом | [Статус места хранения на складе](../warehousing/warehouse-location-status.md) | Включено по умолчанию |
...
Microsoft Dynamics 365 Supply Chain Management 10.0.29 включает обновления платформы. Дополнительные сведения см. в разделе [Обновления платформы для версии 10.0.29 приложений для финансов и операций (июнь 2022 г.)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-29.md). <!--KFM: Confirm link -->
