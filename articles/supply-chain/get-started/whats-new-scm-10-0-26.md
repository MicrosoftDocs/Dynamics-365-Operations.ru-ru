...
| Управление складом | Расширенный анализатор для штрихкодов GS1 | Эта функция добавляет расширенный синтаксический анализатор для данных символов GS1. Новый синтаксический анализатор реализует алгоритм общей спецификации GS1 для разбора символов GS1 и обеспечивает более надежную проверку данных. |
...
Microsoft Dynamics 365 Supply Chain Management 10.0.26 включает обновления платформы. Дополнительные сведения см. в разделе [Обновления платформы для версии 10.0.26 приложений для финансов и операций (май 2022 г.)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-26.md).<!-- KFM Confirm link -->
