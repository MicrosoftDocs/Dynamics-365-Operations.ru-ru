...
---
# <a name="whats-new-and-changed-in-dynamics-365-supply-chain-management-1007-january-2020"></a>Что нового и что изменилось в Dynamics 365 Supply Chain Management 10.0.7 (январь 2020 г.)

[!include [banner](../includes/banner.md)]


В этой теме описываются новые и измененные компоненты Microsoft Dynamics 365 Supply Chain Management 10.0.7. Эта версия имеет номер сборки 10.0.283 и доступна следующим образом:
...
Дополнительные сведения о версии 10.0.7 см. в разделе [Дополнительные ресурсы](whats-new-scm-10-0-7.md#additional-resources).
...
Для получения сведений об исправлениях ошибок, включенных в каждое из обновлений, которые являются частью 10.0.7, войдите в службы Lifecycle Services (LCS) и просмотрите [статью базы знаний](https://fix.lcs.dynamics.com/Issue/Details?kb=4528173&bugId=386529&dbType=3&qc=d6f5cd3ead06907477eae511043a52c1d4290a12bf52374dd55faf0d28ae732e).

### <a name="platform-update-31"></a>Обновление платформы update 31
Microsoft Dynamics 365 Supply Chain Management 10.0.7 включает обновление платформы Platform update 31. Дополнительные сведения об обновлении платформы Platform update 31 см. в разделе [Что нового и что изменилось в обновлении платформы Platform update 31](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-31.md).
