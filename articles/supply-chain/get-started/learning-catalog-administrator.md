...
| [Управление проектом реализации для Finance and Operations](/learn/paths/implement-finance-operations/) | Ознакомьтесь с наиболее важными элементами и рекомендациями по управлению успешным проектом внедрения Finance and Operations. С первого шага, на котором планируется и разрабатывается методология проекта, использование служб FastTrack, стратегии разработки, управления данными и т. д. до лучших способов для обслуживания и отслеживания операций после ввода в эксплуатацию. | Бесплатный путь онлайн-обучения в произвольном темпе | 11.5 часов |
