...
|---|---|---|
| Сводное планирование | Отрицательные дни для оптимизации планирования | Эта функция позволяет оптимизировать планирование с учетом допуска задержки в зависимости от параметра **Отрицательные дни**, определенного в группах покрытия. |
