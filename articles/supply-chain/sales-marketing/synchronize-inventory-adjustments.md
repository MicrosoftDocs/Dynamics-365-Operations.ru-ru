...
description: В этой статье описываются шаблоны и базовые задачи, которые используются для синхронизации корректировок и перемещений запасов из Dynamics 365 Supply Chain Management в Dynamics 365 Field Service.
author: Henrikan
ms.date: 04/30/2019
ms.topic: article
ms.prod: ''
...
В этой статье описываются шаблоны и базовые задачи, которые используются для синхронизации корректировок и перемещений запасов из Dynamics 365 Supply Chain Management в Dynamics 365 Field Service.
