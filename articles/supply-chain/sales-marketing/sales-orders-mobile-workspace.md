...
### <a name="view-orders-for-a-customer"></a><span data-ttu-id="5a6f1-131">Просмотр заказов для клиента</span><span class="sxs-lookup"><span data-stu-id="5a6f1-131">View orders for a customer</span></span>
