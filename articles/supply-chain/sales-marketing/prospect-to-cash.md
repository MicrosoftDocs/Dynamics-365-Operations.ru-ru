---
title: Продажа перспективному клиенту
description: В этой статье представлен обзор решения "Перспективный клиент в наличные деньги" между Dynamics 365 Supply Chain Management и Dynamics 365 Sales.
author: Henrikan
ms.date: 04/25/2018
ms.topic: article
ms.prod: ''
