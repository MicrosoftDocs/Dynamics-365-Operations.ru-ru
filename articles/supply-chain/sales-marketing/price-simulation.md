...
>[!NOTE]
>При моделировании цены используется только текущая валюта продаж. Однако при просмотре итоговых значений предложения отображается как валюта компании, так и валюта продаж.  
