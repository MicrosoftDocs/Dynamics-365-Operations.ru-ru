...
description: В этой статье показано, как создать прямую поставку для заказа на продажу.
author: Henrikan
ms.date: 07/11/2019
