...
description: В этой статье объясняется способ обновления заказа на продажу, когда продукты отгружены клиенту.
author: Henrikan
ms.date: 08/20/2019
