...
---
# <a name="share-content-with-other-contributors"></a>Предоставление общего доступа к содержимому другим участникам

[!include [banner](includes/banner.md)]

Microsoft Dynamics 365 Talent: Onboard позволяет обмениваться руководствами и шаблонами по адаптации с другими участниками, чтобы они могли просматривать документы и вносить изменения.
