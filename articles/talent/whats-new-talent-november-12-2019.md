...
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-november-12-2019"></a>Что нового и что изменилось в Dynamics 365 Talent (12 ноября 2019 г.)
...
Изменения, описанные в этом разделе, относятся к сборке номер 8.1.2604. Числа в скобках в некоторых заголовках относятся к номерам поддержки в службе Microsoft Dynamics Lifecycle Services (LCS).

### <a name="office-location-isnt-updated-via-excel-workbook-369727"></a>Расположение Office не обновляется с помощью книги Excel (369727)

Теперь это изменение позволяет обновлять расположение Office с помощью конструктора книг Office.
