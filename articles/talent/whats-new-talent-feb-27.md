...
1. Обновите следующие сопоставления:
    ...
    - **Позиции должности со сведениями о позиции**: добавьте новое сопоставление из сущности **Позиции должности** Common Data Service с сущностью **Сведения о позиции** Finance and Operations. Переместите ее в положение 8 в последовательности.
    ...
    - **Позиции должности с иерархиями позиций**: добавьте новое сопоставление из сущности **Позиции должности** Common Data Service с сущностью **Иерархии позиции** Finance and Operations. Выберите **Расширенный запрос**, чтобы ваш расширенный запрос был доступен для вашего проекта.
