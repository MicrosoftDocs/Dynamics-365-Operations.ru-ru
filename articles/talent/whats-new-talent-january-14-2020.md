---
title: Что нового и что изменилось в Dynamics 365 Talent (14 января 2020 г.)
...
Изменения, описанные в этом разделе, относятся к сборке номер 8.1.2709. Числа в скобках в некоторых заголовках относятся к номерам поддержки в службе Microsoft Dynamics Lifecycle Services (LCS).

### <a name="system-unable-to-generate-calendar-days-when-importing-through-data-management-framework-381195"></a>Система не может создать календарные дни при импорте с помощью платформы управления данными (381195)

Это изменение приводит к исправлению проблемы, когда при импорте календарных дней создается **недопустимый формат даты**. Эта ошибка препятствует созданию строк даты рабочего календаря.
