...
Microsoft Dynamics 365 Talent упрощает множество повседневных задач по управлению записями и автоматизирует несколько процессов, связанных с персоналом организации. К этим процессам относятся удержание сотрудников, администрирование льгот, обучение, оценки производительности и управление изменениями. Кроме того, приложение предоставляет персоналу отдела кадров платформу для управления всеми аспектами деятельности отдела.
...
Для знакомства с Dynamics 365 Talent посмотрите видео [Начало работы с Dynamics 365 Talent.](https://www.youtube.com/watch?v=6rg2ByadbN0)


> [!NOTE] 
> Приложение Dynamics 365 Talent тесно связано с модулем "Управление персоналом" в Dynamics 365 Finance. Одинаковые функциональные возможности могут быть доступны в обоих продуктах. В результате в темах, которые в основном связаны с модулем "Управление персоналом", будет использоваться название продукта Dynamics 365 Finance, а в темах, которые в основном связаны с Talent, будет использоваться название продукта Dynamics 365 Talent. Темы, написанные для одного продукта, могут относиться и к аналогичным функциональным возможностям в связанном продукте.
...
-   [Настройка параметров управления персоналом (HR) для нескольких юридических лиц](set-up-hr-parameters-across-legal-entities.md) 
-   [Вопросы и ответы по действиям с персоналом](personnel-actions-faq.md)
-   [Управление отпусками и отсутствием на работе](leave-absence-overview.md)
-   [Использование Dynamics 365 Talent: отпуска и отсутствие (видео)](https://www.youtube.com/watch?v=1q1UhKmO4tw)
-   [Управление персоналом в Dynamics 365 Talent (видео)](https://www.youtube.com/watch?v=h1T5IjKKAuA)
...
- [Функции и возможности Microsoft Dynamics 365 Talent - Attract](attract-overview.md)
...
-   [Управление компенсациями в Dynamics 365 Talent (видео)](https://www.youtube.com/watch?v=lEw5oKopHDk)
...
-   [Управление развитием персонала в Dynamics 365 Talent (видео)](https://www.youtube.com/watch?v=xB8SU7fqBOQ)
...
-   [Управление номенклатурами, выданным работникам во временное пользование](loan-items.md)
-   [Управление льготами персонала в Dynamics 365 Talent (видео)](https://www.youtube.com/watch?v=nUWkeJTad1o)
...
-   [Распространение и планирование анкет](distribute-questionnaires.md)
