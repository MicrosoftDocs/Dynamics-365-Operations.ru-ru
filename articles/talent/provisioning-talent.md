...
5. Следующие среды PowerApps не могут быть использованы для Talent и будут отфильтрованы из списка выбора в LCS:
    ...
    - **Неподдерживаемые регионы** — в настоящее время Talent поддерживается только в следующих регионах: США, Европа, Великобритания или Австралия.
