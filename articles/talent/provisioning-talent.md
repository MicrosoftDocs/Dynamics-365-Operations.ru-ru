...
3. Среда PowerApps "содержит" приложение Talent, а также соответствующие приложения PowerApps, Flow и CDS. При удалении этой среды PowerApps также удаляются содержащиеся в ней приложения. При подготовке среды Talent можно подготовить среду "Пробная" или "Производственная". Выберите тип среды в зависимости от способа использования среды. 
