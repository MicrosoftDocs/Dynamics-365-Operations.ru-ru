...
3. Обратитесь в Broadbean и введите сведения в поля **Имя пользователя**, **Идентификатор клиента**, **Токен шифрования**.
