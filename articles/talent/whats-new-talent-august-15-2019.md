...
Изменения, описанные в этом разделе, относятся к сборке номер 8.1.2421.0
...
Изменения записей сотрудников редко вступают в силу немедленно. Необходимо обновить данные на дату начала работы сотрудника, которая часто находится в будущем, а также необходимо обновить сведения в прошлом. Эта упрощенная модель навигации позволяет обновлять будущие и прошлые данные без перехода к нескольким формам или изменения контекста дат. Это изменение также динамически изменяет и отображает ключевую информацию в верхней области заголовка записи сотрудника.
