...
description: В этой теме объясняется, как получить справку по Microsoft Dynamics 365 for Talent.
...
ms.locfileid: "1538781"
---
# <a name="get-support-for-talent"></a>Получение поддержки по Talent

[!include [banner](includes/banner.md)]

В этой теме поясняется, как получить помощь по Microsoft Dynamics 365 for Talent Core HR, Dynamics 365 Talent: Attract и Dynamics 365 Talent: Onboard.
...
|------|------------------|
| Задать вопрос в сообществе. | Перейдите в [Сообщество Dynamics 365 for Talent](https://community.dynamics.com/365/talent) для получения помощи по вопросам. Для поиска ответов введите вопрос в поле поиска рядом с полем **Есть вопрос**. Чтобы задать вопрос, выберите **Задать вопрос**. |
...
| Запросить реализацию новых функций и возможностей в Talent. | На основной странице Talent в приложении выберите кнопку **Справка** (**?**), затем выберите **Идеи**. Вы также можете посетить [идеи по приложениям Dynamics 365](https://experience.dynamics.com/ideas/), чтобы просматривать, искать или голосовать за существующие идеи или добавлять новые идеи. |
...
| Задача | Дополнительные сведения |
|------|------------------|
| Задать вопрос в сообществе. | Перейдите в [Сообщество Dynamics 365 for Talent](https://community.dynamics.com/365/talent) для получения помощи. Для поиска ответов введите вопрос в поле поиска рядом с полем **Есть вопрос**. Чтобы задать вопрос, выберите **Задать вопрос**. |
...
| Получить ответы на вопросы о лицензировании Talent. | Обратитесь к своему партнеру или торговому представителю корпорации Майкрософт. |
| Запросить реализацию новых функций и возможностей в Onboard. | Выберите кнопку **Справка** (**?**), затем выберите **Идеи**. Вы также можете посетить [идеи по Dynamics 365 for Talent: Onboard](https://experience.dynamics.com/ideas/categories/?forum=569a7fb2-8327-e911-a95a-000d3a4f3883&forumName=Dynamics%20365%20for%20Talent%3A%20Onboard), чтобы просматривать, искать или голосовать за существующие идеи или добавлять новые идеи. |
