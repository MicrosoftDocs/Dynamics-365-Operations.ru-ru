...
Можно выполнить развертывание Dynamics 365 Finance + Operations (локальная версия). При выборе типа локального развертывания требования к системе, параметры оборудования и функции будут отличаться от облачного развертывания. В этой теме представлены ссылки на содержимое с информацией по локальным развертываниям.

## <a name="get-started"></a>Начало работы
- [Параметр локального развертывания](on-premises-overview.md)
- [Планирование локального развертывания и подготовка к ним](plan-onprem-deployment.md)
- [Требования к системе для локальных развертываний](../../fin-ops/get-started/system-requirements-on-prem.md)
- [Определение параметров оборудования для локальных сред](../../fin-ops/get-started/hardware-sizing-on-premises-environments.md)
- [Покупка Finance + Operations (локальная версия)](../../fin-ops/get-started/purchase-on-premises.md)
...
- [Настройка обратных прокси-серверов для локальных сред](onprem-reverseproxy.md)
...
- [Функции, не реализованные в локальных развертываниях](../../fin-ops/get-started/features-not-implemented-on-prem.md)
