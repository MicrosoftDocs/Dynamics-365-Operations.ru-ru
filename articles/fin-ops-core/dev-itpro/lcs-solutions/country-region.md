...
Приложения для управления финансами и операциями включают функции для стран и регионов, описанные в [руководстве по наличию локализации и перевода продуктов](https://aka.ms/dynamics_365_international_availability_deck). Эти функции включаются в зависимости от основного адреса активного юридического лица. 
...
На странице [Что нового и что изменилось в Finance and Operations](../../fin-ops/get-started/whats-new-changed.md) перечислены возможности, включенные в конкретные выпуски приложений для управления финансами и операциями.
