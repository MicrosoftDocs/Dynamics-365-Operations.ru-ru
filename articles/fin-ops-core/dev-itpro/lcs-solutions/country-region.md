...
description: В этой статье содержатся списки ресурсов, которые помогут вам узнать больше о функциональности и предложениях, относящихся к конкретным странам и регионам.
author: kfend
ms.date: 02/19/2021
ms.topic: index-page
ms.prod: ''
...
[Приложения для управления финансами и операциями, предоставляемые компанией 21Vianet в Китае](../deployment/china-local-deployment.md)

## <a name="localization-and-regulatory-features"></a>Локализация и нормативные компоненты

[!include [banner](../includes/banner.md)]

Приложения для управления финансами и операциями включают функции для стран/регионов, описанные в [руководстве по наличию локализации и перевода продуктов](https://aka.ms/dynamics_365_international_availability_deck). Эти функции включаются в зависимости от основного адреса активного юридического лица. 

В этой статье содержится список ресурсов, которые могут помочь выполнить следующее: 
...
#### <a name="finance-and-operations-apps-whats-new"></a>Что нового в приложениях для управления финансами и операциями
На странице [Что нового и что изменилось в приложениях для управления финансами и операциями](../../fin-ops/get-started/whats-new-changed.md) перечислены возможности, входящие в конкретные выпуски приложений для управления финансами и операциями.
