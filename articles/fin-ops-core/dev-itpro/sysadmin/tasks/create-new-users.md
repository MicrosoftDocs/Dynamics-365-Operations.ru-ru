...
Внешние пользователи должны быть представлены в каталоге клиента (Azure Active Directory (Azure AD)), чтобы им можно было назначить лицензии. Эти внешние пользователи должны быть добавлены к клиенту в Azure AD в качестве гостевых пользователей, а затем им назначаются соответствующие лицензии. Требование для приложений для управления финансами и операциями состоит в том, что компания гостевого пользователя должна использовать Azure AD. Дополнительные сведения см. в разделе [Добавление пользователей сотрудничества Azure Active Directory B2B на портале Azure](/azure/active-directory/b2b/add-users-administrator).
