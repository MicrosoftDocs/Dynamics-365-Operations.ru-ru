...
description: В этой статье представлены сведения о настройке служб SQL Server Reporting Services (SSRS) для локального развертывания.
author: PeterRFriis
ms.date: 06/23/2017
ms.topic: article
...
Используйте шаги, приведенные ранее в этой статье, для настройки служб SQL Server Reporting Services (SSRS) для развертывания Microsoft Dynamics 365 Finance + Operations (on-premises).
