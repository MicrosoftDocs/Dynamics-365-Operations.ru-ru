...
|-----------------------|-------------|
| Организация               | Название компании для элемента аналитической структуры. Значение **\@ANY**, которое назначается, как правило, только на сводном уровне, позволяет использовать аналитическую структуру для всех компаний. Компания назначается каждой дочерней ветви. |
...
| Определения строк       | Имя определения строки для единицы отчетности. Одно и то же определение строк используется для каждого элемента аналитической структуры. При создании отчета программа это определение строк используется для каждого элемента аналитической структуры. Определение строки может включать несколько ссылок финансовых аналитик. Если определение строки указано в дереве отчетности, установите флажок **Использовать определение строки из дерева отчетности** на вкладке **Отчет** определения отчета. |
| Ссылка на финансовые аналитики| Ссылка на финансовые аналитики, которая должна использоваться для единицы отчетности. Ссылки на финансовые аналитики определяются для определения строки, чтобы задать финансовые аналитики, с которыми осуществляется связывание. |
...
4. В диалоговом окне **Вставить единицы отчетности из аналитик** выберите флажок для каждой аналитики, которую включить в дерево отчетности. диалоговое окно **Вставить единицы отчетности из аналитик** содержит следующие разделы.
    ...
    | Раздел                          | Описание |
    |----------------------------------|-------------|
    | Сегментация аналитик отчетности | Используйте кнопки **Разделить сегменты** и **Объединить сегменты** для изменения количества и длины сегментов.<blockquote>[!NOTE] Объединять можно только разделенные сегменты. Для того, чтобы совместить множественные аналитики, используйте подстановочные знаки в ваших значениях аналитик.</blockquote> |
