...
- [Добавление или изменение визуализаций Power BI на панель мониторинга](/powerapps/user/add-powerbi-dashboards)
...
| Функция                                                   | Financial Reporting                                               | Финансовый анализ |
|----------------------------------------------------------|-------------------------------------------------------------------|--------------------|
...
| **Контроль доступа**                                             | Да Соответствует безопасности дерева отчетности Finance | Ограничено Просмотр отчетов для всех организаций (независимо от безопасности приложений для управления финансами и операциями) или только активной организации |
...
- [Доступ к аналитическим рабочим областям и отчетам в среде с 1 блоком](/archive/blogs/dynamicsaxbi/accessing-analytical-workspaces-on-1box-environment)

- [Добавление аналитики в рабочие области с помощью Power BI Embedded](/dynamics365/unified-operations/dev-itpro/analytics/add-analytics-tab-workspaces)
