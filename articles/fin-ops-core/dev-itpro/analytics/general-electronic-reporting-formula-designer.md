...
## <a name="Binding">Привязка данных</a>
...
## <a name="Transformation">Формат данных</a>
...
## <a name="Validation">Управление процессом</a>
...
## <a name="Enabled">Управление содержимым документов</a>
...
## <a name="TestFormula">Проверка настроенных формул</a>
