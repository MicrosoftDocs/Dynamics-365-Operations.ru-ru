...
description: В этой статье объясняется, как разработать формат электронной отчетности (ER), в котором строки остаются на одной странице Microsoft Excel.
author: kfend
ms.date: 02/28/2022
ms.topic: article
ms.prod: ''
...
Процедуры в этой статье могут быть выполнены в компании **USMF**. Написание кода не требуется.
...
Остальные процедуры данной статьи показывают, как можно настроить стандартный формат электронной отчетности, чтобы улучшить вид и удобочитаемость отчета по накладным за счет размещения всего содержимого одной строки накладной на одной странице.
