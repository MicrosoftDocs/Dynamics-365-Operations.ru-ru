...
Вы можете переименовать папки, отчеты, строительные блоки и другие объекты в Report Designer, чтобы организовать свои файлы. В зависимости от типа объекта, который вы переименовываете, вам может потребоваться обновить связи с этим объектом.

## <a name="rename-a-folder-or-building-block-in-report-designer"></a>Переименование папки или шаблона в Report Designer
В Report Designer можно переименовать папки, определения отчетов, столбцов, строк и аналитических структур.

### <a name="rename-a-folder-or-building-block-in-report-designer"></a>Переименование папки или шаблона в Report Designer

1. Используйте панель переходов Report Designer, чтобы найти нужную папку или объект.
...
1. В Report Designer в области перехода щелкните **Группы отчетов**.
...
> [NOTE] Если вы запланировали создание отчетов через заданные интервалы, вы можете переопределить эти настройки и создать отчет немедленно.
...
<tbody>
<tr>
<td>Переопределить настройки компании, подробностей и даты из определений отдельного отчета</td>
<td>Выберите этот флажок, чтобы переопределить индивидуальные определения отчета для отчетов в этой группе отчетов только для генерирования этих отчетов.</td>
</tr>
<tr>
...
<td>Здесь перечислены все дополнительные валюты отчетности, настроенные в системе Microsoft Dynamics 365 Finance. Установите этот флажок, чтобы создать дополнительные отчеты в указанных валютах. Чтобы просмотреть отчеты в веб-средстве просмотра, нажмите кнопку <strong>Валюта</strong> и выберите валюту.</td>
</tr>
<tr>
