...
## <a name="ActivateAdvEditor">Активация расширенного редактора формул</a>
...
## <a name="Autoformatting">Автоформатирование кода</a>
...
## <a name="CodeCompletion">Завершение кода</a>
...
## <a name="CodeNavigation">Навигация по коду</a>
...
## <a name="CodeStructuring">Структурирование кода</a>
...
## <a name="FindAndReplace">Найти и заменить</a>
...
## <a name="DataPasting">Вставка источников данных и функций</a>
...
## <a name="SyntaxColorization">Цветовое выделение синтаксиса</a>
