...
description: В этом разделе описывается, как можно повысить производительность путем уменьшения количества полей таблицы, выбираемых во время выполнения.
author: NickSelin
ms.date: 05/12/2022
ms.topic: article
ms.prod: ''
...
Чтобы узнать больше о том, как ограничить список полученных полей источников типа *Записи таблицы*, выполните пример в этом разделе.
...
Если вы еще не выполнили пример по теме [Создание нового решения ER для печати пользовательского отчета](er-quick-start1-new-solution.md), загрузите и локально сохраните файлы XML для следующих конфигураций предоставленного решения ER.
