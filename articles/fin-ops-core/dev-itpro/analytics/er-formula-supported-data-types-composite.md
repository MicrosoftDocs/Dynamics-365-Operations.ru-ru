...
description: В этой статье содержится информация о составных типах данных, которые поддерживаются в формулах электронной отчетности (ER).
author: NickSelin
ms.date: 06/02/2021
...
В этой статье содержится информация о составных типах данных, которые поддерживаются в выражениях [электронной отчетности (ER)](general-electronic-reporting.md). Составные типы данных — это [класс](#class), [контейнер](#container), [запись](#record), [список записей](#record-list) и [объект](#object).
