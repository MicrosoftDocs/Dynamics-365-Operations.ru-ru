...
В этой статье описан порядок загрузки [конфигураций электронной отчетности (ER)](general-electronic-reporting.md#Configuration) из глобального репозитория службы Configuration Service. Дополнительные сведения см. в разделе [Microsoft Dynamics 365 Finance — Regulatory Services, Configuration service](/business-applications-release-notes/october18/dynamics365-finance-operations/regulatory-service-configuration).
