...
description: В этой статье описываются расширенные функции форматирования, включая фильтры, ограничения, непечатаемые строки и условные операторы в расчетах.
author: panolte
ms.date: 04/26/2019
ms.topic: article
ms.prod: ''
...
|           Форматировать             | A   | млрд    | C        | Д      | Д      | П    |
|------------------------------|-----|------|----------|--------|--------|------|
| Верхний колонтитул 1                     |     |      |          |        |        |      |
| Верхний колонтитул 2                     | A   | млрд    | C        | Д      | Д      | П    |
...
|    Форматировать                    | A   | млрд    | C      | Д            | Д     | П            |
|------------------------------|-----|------|--------|--------------|-------|--------------|
| Верхний колонтитул 1                     | A   | млрд    | C      | Д            | Д     | П            |
| Верхний колонтитул 2                     | -   | -    | С начала года    | Годовые продажи | Штат | $ на человека |
| Заголовок 3                     |     |      |        |              |       |              |
