...
description: В этой статье описывается, как сопоставить элементы модели данных с компонентами созданной конфигурации электронной отчетности (ER).
author: kfend
ms.date: 08/29/2018
