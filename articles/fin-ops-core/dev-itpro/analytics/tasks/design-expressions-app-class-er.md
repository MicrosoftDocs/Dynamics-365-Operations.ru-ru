...
description: В этой статье описывается, как повторно использовать существующую логику приложения в конфигурациях электронной отчетности путем вызова необходимых методов классов приложения.
author: kfend
ms.date: 11/02/2021
...
В этой статье описывается, как повторно использовать существующую логику приложения в конфигурациях [электронной отчетности (ER)](../general-electronic-reporting.md) путем вызова необходимых методов классов приложения в выражениях ER. Значения аргументов для вызывающих классов могут быть динамически определены во время выполнения. Например, значения могут быть основаны на данных в анализируемом документе для обеспечения их правильности.
