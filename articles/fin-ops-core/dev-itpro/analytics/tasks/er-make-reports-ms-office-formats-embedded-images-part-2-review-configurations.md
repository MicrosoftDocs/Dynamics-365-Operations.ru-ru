...
description: В этой статье описано, как разрабатывать конфигурации отчетности для создания электронных документов, содержащих внедренные изображения. (Часть 1 — Настройка параметров).
author: NickSelin
ms.date: 06/13/2017
