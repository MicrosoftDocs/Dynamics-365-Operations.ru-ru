...
description: В этой статье описано, как разрабатывать конфигурации, которые создают электронные документы в форматах Excel и Word, содержащие внедренные изображения.
author: NickSelin
ms.date: 04/23/2021
