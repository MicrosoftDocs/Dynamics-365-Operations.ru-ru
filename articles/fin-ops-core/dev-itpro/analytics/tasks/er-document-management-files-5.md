...
description: В этой статье описывается, как настроить формат электронной отчетности (ER), чтобы использовать файлы управления документами (вложения) в выходных данных электронной отчетности. (Часть 5)
author: kfend
ms.date: 08/29/2018
