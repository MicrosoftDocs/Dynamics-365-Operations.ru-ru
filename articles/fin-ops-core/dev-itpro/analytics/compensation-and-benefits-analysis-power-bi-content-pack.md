...
description: В этой статье описывается содержимое Power BI "Компенсации и льготы".
author: jcart1106
ms.date: 12/19/2017
ms.topic: article
ms.prod: ''
