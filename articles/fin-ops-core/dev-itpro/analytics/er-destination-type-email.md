...
description: В этой теме объясняется, как настроить место назначения электронной почты для каждого компонента ПАПКА или ФАЙЛ формата электронной отчетности (ER), настроенного для создания исходящих документов.
author: NickSelin
manager: AnnBe
ms.date: 12/03/2020
ms.topic: article
...
![Настройка фиксированного адреса электронной почты](./media/er_destinations-emailfixedaddress.png)
...
![Пустое поле "Компания источника электронной почты"](./media/er_destinations-emaildefineaddresssourceformula.png)
...
![Настройка учетной записи атрибутов источника электронной почты](./media/er_destinations-emaildefineaddresssourceattributes.png)
