...
description: В этой статье описывается, что входит в пакет содержимого Power BI "Управление расходами".
author: panolte
ms.date: 03/18/2019
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8878323"
---
# <a name="expense-management-power-bi-content"></a>Содержимое Power BI для управления расходами

[!include [banner](../includes/banner.md)]

В этой статье описывается, что входит в содержимое Power BI "Управление расходами". 
