...
description: В этой статье объясняется, как настроить зависящие от действия места назначения для формата электронной отчетности, настроенного для создания исходящих документов.
author: kfend
ms.date: 12/05/2022
ms.topic: article
ms.prod: ''
...
Можно настроить [места назначения](electronic-reporting-destinations.md) для каждого исходящего компонента (папка или файл) [конфигурации](general-electronic-reporting.md#Configuration) формата [электронной отчетности (ER)](general-electronic-reporting.md), используемой для создания исходящего документа. Пользователи, которые выполняют формат электронной отчетности данного типа и имеют соответствующие права доступа, могут также изменять настроенные настройки пункта назначения во время выполнения.
...
Если никакие шаблоны отчетов [служб SQL Server Reporting Services (SSRS)](SSRS-report.md) не применимы к выбранному документу, стандартный выбор пунктов назначения управления печатью динамически скрывается.
...
Чтобы активировать возможность изменения пунктов назначения электронной отчетности во время выполнения, включите функцию **Разрешить корректировку пунктов назначения электронной отчетности во время выполнения** в рабочей области [Управление функциями](../../fin-ops/get-started/feature-management/feature-management-overview.md#the-feature-management-workspace).
...
[![Настройка пунктов назначения электронной отчетности во время выполнения.](./media/ERdestinaiotnChangeUI.jpg)](./media/ERdestinaiotnChangeUI.jpg)
