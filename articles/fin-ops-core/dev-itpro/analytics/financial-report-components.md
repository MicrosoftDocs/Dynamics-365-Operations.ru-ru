...
Строительные блоки — определения строки, определения столбца, определения дерева отчетности и определения отчета, которые вы создаете для отчета. Группы шаблонов — это коллекции определений и наборы значений измерений.
...
Можно экспортировать группу шаблонов или отдельные шаблоны отчетов в группу шаблонов. Можно использовать экспортированную группу шаблонов как резервную копию. Можно также копировать экспортированные данные между установками. Конструктор отчетов Report Designer включает ссылочные стили шрифтов и наборы значений аналитик вместе с группой строительных блоков.
...
3. В диалоговом окне **Экспорт** выберите определения отчетов для экспорта:
    ...
    - Чтобы экспортировать определенные отчеты, строки, столбцы, деревья или наборы значений аналитик, щелкните соответствующую вкладку и выберите элементы для экспорта. Нажмите и удерживайте клавишу CTRL, чтобы выбрать несколько элементов на вкладке.

    > [!NOTE]
    > При выборе отчетов для экспорта автоматически выбираются связанные с ними строки, столбцы, деревья и наборы значений измерений.
...
Можно импортировать группу строительных блоков в существующую группу строительных блоков. Все импортированные группы строительных блоков сохраняют исходные стили шрифтов и ссылки на компании и включают соответствующие наборы значений аналитик.
...
4. В диалоговом окне **Импорт** выберите определения отчетов для импорта:
    ...
    - Для того, чтобы импортировать специфические отчеты, строки, столбцы, деревья, или наборы значений аналитик, выбирают отчеты, строки, столбцы, деревья, или наборы значений аналитик, которые импортировать.
