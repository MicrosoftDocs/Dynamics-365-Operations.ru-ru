...
#### <a name="data-model-and-model-mapping-components"></a>Компоненты модели данных и сопоставления модели
...
- <a name="DataModelComponent"></a>Модель данных в виде набора характерных для домена бизнес-объектов и иерархически структурированного определения отношений между ними.
- <a name="ModelMappingComponent"></a>Сопоставления модели, которое связывает выбранные источники данных приложения с отдельными элементами этой модели данных во время выполнения, поток данных и заполнение бизнес-данными с компонентом модели данных.
...
#### <a name="FormatComponentOutbound"></a>Компоненты формата для исходящих электронных документов
...
#### <a name="FormatComponentInbound"></a>Компоненты формата для входящих электронных документов
