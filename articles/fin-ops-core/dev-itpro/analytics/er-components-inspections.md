...
- Вы [импортируете](general-electronic-reporting.md#importing-an-er-component-from-lcs-to-use-it-internally) новую [версию](general-electronic-reporting.md#component-versioning) конфигурации электронной отчетности в свой экземпляр Microsoft Dynamics 365 Finance.
