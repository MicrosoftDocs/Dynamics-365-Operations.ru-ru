...
Для использования управления бизнес-документами для редактирования шаблонов в формате Excel или Word с помощью приложений Microsoft Office для рабочего стола необходимо установить Microsoft Office 2010 или более позднюю версию. Это поддерживается в облачном и в локальном развертывании.
...
Необходимо импортировать конфигурации ER, содержащие шаблоны бизнес-документов, в текущий экземпляр. Загрузите и локально сохраните следующие файлы для выполнения этой процедуры.
...
Откроется страница **Редактор шаблонов BDM**. Выбранный шаблон будет доступен для оперативного редактирования с помощью Office 365.
...
Это известная проблема с перенаправлением Office 365. Это происходит при первом входе в Office 365. Чтобы обойти эту проблему, следует нажать кнопку **Назад** в браузере, чтобы вернуться назад.
