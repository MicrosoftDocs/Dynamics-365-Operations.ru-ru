...
>[!NOTE]
> Кроме того, необходимо включить **Взаимодействие с пользовательским интерфейсов по типу Office для управления бизнес-документами** для использования нового интерфейса управления бизнес-документами.
...
#### <a name="i-selected-edit-document-but-instead-of-opening-the-bdm-template-editor-page-in-finance-and-operations-i-have-been-sent-to-the-office-365-web-page"></a>Был выбран пункт **Редактировать документ**, но вместо того, чтобы открыть страницу **Редактор шаблонов BDM** в Finance and Operations, открылась веб-страница Office 365.
