...
description: В этой статье объясняется, как можно сравнить результаты созданных отчетов электронной отчетности (ER) с базовыми значениями отчета.
author: NickSelin
ms.date: 06/17/2019
ms.topic: article
ms.prod: ''
...
![Диалоговое окно создания конфигурации, добавление новой конфигурации модели электронной отчетности.](media/GER-BaselineSample-ModelAdd.PNG "Снимок экрана раскрывающегося диалогового окна создания конфигурации")
...
![Диалоговое окно создания конфигурации, добавление новой конфигурации формата электронной отчетности.](media/GER-BaselineSample-FormatAdd.PNG "Снимок экрана раскрывающегося диалогового окна создания конфигурации")
...
3. В раскрывающемся диалоговом окне выполните следующие действия:
...
4. Выберите **Добавить**.
5. В раскрывающемся диалоговом окне выполните следующие действия:

    1. В дереве выберите **XML\\Элемент**.
    2. В поле **Имя** введите **Документ**.
    3. Нажмите **ОК**.

6. В дереве выберите **Вывод\\Документ**.
7. Выберите **Добавить**.
8. В раскрывающемся диалоговом окне выполните следующие действия:

    1. В дереве выберите **XML\\Атрибут**.
    2. В поле **Имя** введите **ИД**.
    3. Нажмите **ОК**.

    ![Страница конструктора форматов, XML-атрибут, выбранный в дереве.](media/GER-BaselineSample-FormatLayoutDesign.PNG "Снимок экрана страницы конструктора формата")

9. На вкладке **Сопоставление** выберите **Удалить**.
10. Выберите **Добавить корень**.
11. В раскрывающемся диалоговом окне в дереве выберите **Общее\\Параметр пользовательского ввода**, затем выполните следующие действия:

    1. В поле **Имя** введите **ИД**.
    2. В поле **Подпись** введите **Введите ИД**.
    3. Нажмите **ОК**.

12. В дереве выберите **Вывод\\Документ\\ИД**.
13. Выберите **Связать**, затем выберите **Сохранить**.

![Страница конструктора формата, вкладка «Сопоставление».](media/GER-BaselineSample-FormatMappingDesign.PNG "Снимок экрана страницы конструктора формата")
...
![Страница базовых образцов формата электронной отчетности, экспресс-вкладка базовых образцов выбрана.](media/GER-BaselineSample-SetupBaselineLine.PNG "Снимок экрана страницы базовых образцов формата электронной отчетности")
...
6. Перейдите в раздел **Администрирование организации** \> **Электронная отчетность** \> **Журналы отладки конфигураций**.
    ...
    ![Страница журналов выполнений электронной отчетности, с одинаковыми базовыми образцами.](media/GER-BaselineSample-ReviewBaselineComparison1.PNG "Снимок экрана страницы журналов выполнения электронной отчетности")
...
6. Перейдите в раздел **Администрирование организации** \> **Электронная отчетность** \> **Журналы отладки конфигураций**.
    ...
    ![Страница журналов выполнений электронной отчетности, с различными базовыми образцами.](media/GER-BaselineSample-ReviewBaselineComparison2.PNG "Снимок экрана страницы журналов выполнения электронной отчетности")
