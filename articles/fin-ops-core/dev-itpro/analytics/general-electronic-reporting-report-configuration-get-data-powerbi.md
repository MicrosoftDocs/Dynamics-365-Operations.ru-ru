...
description: В этой статье описывается, как вы можете использовать свою конфигурацию электронной отчетности (ER), чтобы организовать перемещение данных из вашего экземпляра в службы Power BI.
author: NickSelin
ms.date: 04/23/2021
ms.topic: article
ms.prod: ''
...
Для выполнения примера из этой статьи необходимы следующие возможности доступа:
