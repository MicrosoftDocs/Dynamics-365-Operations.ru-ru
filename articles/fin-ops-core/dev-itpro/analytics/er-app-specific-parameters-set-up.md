...
6.  В поле **Код** новой записи выберите стрелку раскрывающегося списка, чтобы открыть поиск.
    ...
    ![Страница импорта параметров для конкретного приложения электронной отчетности, подстановка поля кода.](./media/GER-AppSpecParms-LookupForm-CodeFldPicker.PNG)
...
8.  В поле **Результат поиска** новой записи выберите стрелку раскрывающегося списка, чтобы открыть поиск. При поиске представлен список значений для перечисления формата TaxationLevel format для выбора.
    ...
    ![Страница параметров, относящихся к приложению электронной отчетности, результаты подстановки отображаются на предпочтительном немецком языке.](./media/GER-AppSpecParms-LookupForm-LookupFldPicker.PNG)
...
15. Снова выберите **Добавить**, а затем выполните следующие действия:
    ...
    ![Страница параметров, относящихся к приложению электронной отчетности, экспресс-вкладка условий с последней записью «Другое».](./media/GER-AppSpecParms-LookupForm-RulesSet.PNG)
...
7.  В поле **Код** новой записи выберите стрелку раскрывающегося списка, чтобы открыть поиск.
    ...
    ![Страница параметров, относящихся к приложению электронной отчетности, подстановка поля кода с отображением списка налоговых кодов для компании USMF.](./media/GER-AppSpecParms-LookupForm-CodeFldPicker2.PNG)
...
1.  Либо используйте существующий элемент меню **ERSolutionAppSpecificParametersDesigner**, либо реализуйте свой собственный элемент меню **ERSolutionAppSpecificParametersDesigner**.
    ...
    ![Страница Visual Studio, область свойств.](./media/GER-AppSpecParms-LookupForm-Access1.PNG)
...
2.  Выполните одно из следующих действий.
    ...
    1.  Создайте новую кнопку пункта меню и свяжите ее с соответствующей записью их таблицы **ERSolutionTable**, задав для свойства **Источник данных** значение **ERSolutionTable**.
        ...
        ![Страница Visual Studio, области конструктора.](./media/GER-AppSpecParms-LookupForm-Access2.PNG)
