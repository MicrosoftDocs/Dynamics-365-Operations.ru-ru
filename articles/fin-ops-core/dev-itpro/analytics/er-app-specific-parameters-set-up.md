---
title: Настройка параметров формата электронной отчетности для юридического лица
description: В этой статье объясняется, как настроить параметры формата электронной отчетности (ER) для юридического лица.
author: kfend
ms.date: 03/25/2022
ms.topic: article
ms.prod: ''
...
Чтобы выполнить примеры в этой статье, необходимо иметь доступ к Microsoft Dynamics 365 Finance для одной из следующих ролей:
