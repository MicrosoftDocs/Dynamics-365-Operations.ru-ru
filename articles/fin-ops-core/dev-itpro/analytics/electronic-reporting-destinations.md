...
> [!NOTE]
> Описание задания предназначено для информирования пользователя о выполнении сопоставления форматов ER. Оно также содержит имя выполняемого компонента ER.
...
>
> В Microsoft Dynamics 365 Finance версии 10.0.9 (апрель 2020) поддерживается только альбомная ориентация страницы в PDF-документе, который создается из выходных данных Excel. С выпуском Dynamics 365 Finance версии 10.0.10 (май 2020) можно будет [указать ориентацию страницы](#SelectPdfPageOrientation) в PDF-документе, который создается на основе выходных данных Excel, при настройке назначения ER.
>
