...
description: В этой статье описывается, как импортировать данные из файлов, выбранных вручную, в пакетном режиме.
author: kfend
ms.date: 01/07/2022
ms.topic: article
ms.prod: ''
...
В этой статье описывается, как выполнить импорт данных из файла, выбранного вручную, в пакетном режиме. В примерах используются транзакции по поставщику по поставщику в качестве бизнес-данных. Шаги этих примеров можно выполнить в компании **USMF** в Microsoft. Написание кода не требуется.
...
2. С помощью параметра ER [Загрузить из XML-файла](er-defer-sequence-element.md#import-the-sample-er-configurations) импортируйте загруженные конфигурации ER в свой экземпляр Dynamics 365 Finance в следующем порядке:
