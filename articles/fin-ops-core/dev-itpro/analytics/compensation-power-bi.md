...
description: В этой статье описывается содержимое Power BI "Компенсация". В нем объясняется, как получить доступ к отчетам, и представляются сведения о используемой модели данных.
author: jcart1106
ms.date: 12/19/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9206457"
---
# <a name="compensation-power-bi-content"></a>Содержимое Power BI "Компенсация"

[!include [banner](../includes/banner.md)]

В этой статье описывается содержимое Microsoft Power BI **Компенсация**. В нем описывается порядок доступа к отчетам и предоставляется информация о модели данных и объектах, которые использовались для построения пакета содержимого.
...
- Приложения для управления финансами и операциями
