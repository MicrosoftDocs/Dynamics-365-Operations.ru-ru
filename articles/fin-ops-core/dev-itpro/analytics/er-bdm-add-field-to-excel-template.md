...
Чтобы получить дополнительные сведения об этой функции, выполните пример в этой теме. В этом примере показано, как обновить шаблон, чтобы заполнить поля в создаваемых формах накладных с произвольным текстом.
...
2.  Выполните следующие шаги примера в разделе [Обзор управления бизнес-документами](er-business-document-management.md):
