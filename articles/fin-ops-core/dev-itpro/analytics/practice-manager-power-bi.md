...
Содержимое Power BI **Менеджер по методикам** отображается в рабочей области **Управление проектами**.
...
|-------------------|---------|
| Обзор проектов | <ul><li>Созданные проекты</li><li>Оцененные проекты</li><li>Выполняющиеся проекты</li><li>Фактическая выручка по клиентам</li><li>Бюджетная валовая прибыль по проектам</li><li>Обзор управления вырученной стоимостью</li></ul> |
...
| Ключевое агрегированное измерение    | Поле | описание |
|------------------------------|-------|-------------|
| Индекс показателей затрат       | ProjectAccountingCube\_Projects\[Вырученная стоимость\] ÷ ProjectAccountingCube\_Projects\[Общие фактические затраты на выполненные задачи\] | Расчет общей вырученной стоимости, деленной на общие фактические затраты. |
| Индекс выполнения графика   | ProjectAccountingCube\_Projects\[Вырученная стоимость\] ÷ ProjectAccountingCube\_Projects\[Общие плановые затраты на выполненные задачи\] | Расчет общей вырученной стоимости, деленной на общие плановые затраты. |
