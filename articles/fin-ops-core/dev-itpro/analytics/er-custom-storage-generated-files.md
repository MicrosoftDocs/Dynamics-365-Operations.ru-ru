...
description: В этой статье объясняется, как расширить список мест хранения для документов, которые формируются в форматах электронной отчетности (ER).
author: kfend
ms.date: 10/29/2020
ms.topic: article
ms.prod: ''
...
Интерфейс прикладного программирования (API) платформы электронной отчетности (ER) позволяет расширять список местоположения хранения для документов, формируемых форматами ER. В этой статье объясняется, как добавить пользовательское место хранения для создаваемых документов путем делегирования задачи создания мест назначения электронной отчетности в фабрику мест назначения по умолчанию и последующей реализации пользовательского класса, имеющего собственную логику места назначения.
...
Все задачи в этой статье могут быть выполнены в компании **USMF**.
