...
- [Ошибки в сопоставлении сущностей "Поставщики V2" с msdyn_vendors](#error-vendor-map)
- [Ошибки в сопоставлениях сущностей "Клиенты V3" с "Организации"](#error-customer-map)
...
7. Для синхронизации данных для **InvoiceAccount** и **ContactPersonId** из Common Data Service в приложение Finance and Operations необходимо использовать проект интеграции данных.
    ...
    2. Добавьте критерии компании в фильтр со стороны Common Data Service, так что в приложении Finance and Operations будут обновляться только записи, отвечающие условиям фильтра. Чтобы добавить фильтр, выберите кнопку фильтра. Затем, в диалоговом окне **Изменение запроса** можно добавить запрос фильтра, например **\_msdyn\_company\_value eq '\<guid\>'**. 
    ...
    Исходная синхронизация записей теперь завершена.
