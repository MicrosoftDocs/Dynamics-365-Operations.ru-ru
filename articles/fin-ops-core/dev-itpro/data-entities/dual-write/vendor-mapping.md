...
Если вы не хотите хранить данные поставщиков в объекте **Организация/Контакт** в Common Data Service, можно использовать новый дизайн поставщика.
