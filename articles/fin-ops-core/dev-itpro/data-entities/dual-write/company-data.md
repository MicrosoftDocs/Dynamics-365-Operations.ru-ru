...
description: Эта статья описывает интеграцию данных компании между Finance and Operations и Dataverse.
...
+ Для каждой строки компании в Финансы и операции, которая включена для двойной записи, создается связанная строка cdm\_Company.
...
+ Таким образом, члены рабочей группы "USMF Sales" могут видеть любую организацию, которая принадлежит пользователю "USMF DW", которая поступила бы из таблицы компании USMF в Финансы и операции.
