...
Сообщение об ошибке "Не найдены конфигурации проектов для \{имени проекта\}. Либо проект не включен, либо все сопоставления полей являются однонаправленными: взаимодействие с клиентами -> управление финансами и операциями".
...
Неправильный синтаксис фильтра источника, указанного в сопоставлении таблиц для приложений для управления финансами и операциями. Сведения о проверке критериев фильтрации см. в разделе [Устранение неполадок с синхронизацией в режиме реального времени](dual-write-troubleshooting-live-sync.md#live-synchronization-issues-that-are-caused-by-incorrect-query-filter-syntax-on-the-dual-write-maps).
