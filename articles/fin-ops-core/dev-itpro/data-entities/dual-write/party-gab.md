...
> [!TIP]
> Используйте вкладки **Адреса** и **Электронные адреса** в формах **Организация** и **Контакт** для управления почтовым адресом и адресом электронной почты. Это гарантирует, что данные адреса будут синхронизированы с приложениями Finance and Operations.
