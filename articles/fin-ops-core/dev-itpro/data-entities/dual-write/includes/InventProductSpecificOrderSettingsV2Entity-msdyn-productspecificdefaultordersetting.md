## <a name="product-default-order-settings-v2-to-msdyn_productspecificdefaultordersettings"></a>Параметры заказа продуктов по умолчанию V2 -> msdyn_productspecificdefaultordersettings
