## <a name="customers-v3-to-accounts"></a>Клиенты V3 -> организации

Этот шаблон синхронизирует данные между приложениями Finance and Operations и Common Data Service.

Фильтр источника: ((PartyType == "Organization"))

Обратный фильтр источника: customertypecode eq 3
...
Нет | >> | address1_addresstypecode | 2
Нет | >> | customertypecode | 3
PARTYTYPE | << | Нет | Organization
