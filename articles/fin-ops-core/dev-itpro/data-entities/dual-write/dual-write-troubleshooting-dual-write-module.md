...
Включение параллельной обработки может сократить время, необходимое для импорта данных из приложений для управления финансами и операциями в приложения для взаимодействия с клиентами и Microsoft Dataverse. 
