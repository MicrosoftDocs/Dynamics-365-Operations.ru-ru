...
## <a name="enable-debug-mode-to-troubleshoot-live-synchronization-issues-in-finance-and-operations-apps"></a>Включение режима отладки для устранения проблем с синхронизацией приложений для управления финансами и операциями в режиме реального времени
...
## <a name="check-synchronization-errors-on-the-virtual-machine-for-the-finance-and-operations-app"></a>Проверка ошибок синхронизации на виртуальной машине для приложения для управления финансами и операциями
...
## <a name="unlink-and-link-another-dataverse-environment-from-a-finance-and-operations-app"></a>Как отвязать среду Dataverse от приложения для управления финансами и операциями и привязать другую среду
...
## <a name="how-to-ensure-data-integration-is-using-the-most-current-finance-and-operations-schema"></a>Как гарантировать, что интеграция данных использует самую последнюю схему для управления финансами и операциями
...
### <a name="refresh-entity-list-in-finance-and-operations-environment"></a>Обновление списка сущностей в среде для управления финансами и операциями
...
#### <a name="if-the-refresh-fails-to-resolve-the-issue-delete-and-re-add-the-entities"></a>Если проблема не устраняется при обновлении, удалите сущности и добавьте их повторно
...
#### <a name="refresh-entities-in-data-integrator"></a>Обновление сущностей в интеграторе данных
