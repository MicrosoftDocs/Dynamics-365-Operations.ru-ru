...
В этом разделе указывается порядок синхронизации, которому необходимо следовать для создания исходных данных, если не используются зависимости объектов, предоставляемые функцией **первоначальной синхронизации**. Если **первоначальная синхронизация** не используется, необходимо выполнить каждое сопоставление объектов по отдельности.
