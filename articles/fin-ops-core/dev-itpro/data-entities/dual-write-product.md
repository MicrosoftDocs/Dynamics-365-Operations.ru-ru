...
Роли иерархии категорий продуктов | msdyn_productcategoryhierarchies | Иерархии продуктов могут использоваться для разных ролей в D365 Finance and Operations. Для указания категории, используемой в каждой роли, используется объект роли категории продукта. 
