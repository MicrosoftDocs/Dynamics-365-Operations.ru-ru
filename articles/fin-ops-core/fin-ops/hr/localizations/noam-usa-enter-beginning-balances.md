...
- <span data-ttu-id="3d23a-109">Следующие После данные настроены и назначены сотрудникам:</span><span class="sxs-lookup"><span data-stu-id="3d23a-109">The following data is set up and assigned to employees:</span></span>
    ...
    - <span data-ttu-id="3d23a-110">Циклы оплаты и платежные периоды</span><span class="sxs-lookup"><span data-stu-id="3d23a-110">Pay cycles and pay periods</span></span>
...
2. <span data-ttu-id="3d23a-146">На вкладке **Строка выписки о доходах** введите следующее:</span><span class="sxs-lookup"><span data-stu-id="3d23a-146">In the **Earnings statement line** tab, enter the following:</span></span>
    ...
    <span data-ttu-id="3d23a-147">Строка 1: вкладка **Строка выписки о доходах**</span><span class="sxs-lookup"><span data-stu-id="3d23a-147">Line 1: **Earning statement line** tab</span></span>

    | <span data-ttu-id="3d23a-148">Поле</span><span class="sxs-lookup"><span data-stu-id="3d23a-148">Field</span></span>            | <span data-ttu-id="3d23a-149">Стоимость</span><span class="sxs-lookup"><span data-stu-id="3d23a-149">Value</span></span>       |
    |------------------|-------------|
    | <span data-ttu-id="3d23a-150">Код доходов</span><span class="sxs-lookup"><span data-stu-id="3d23a-150">Earnings code</span></span>    | <span data-ttu-id="3d23a-151">Обычная оплата</span><span class="sxs-lookup"><span data-stu-id="3d23a-151">Regular pay</span></span> |
    | <span data-ttu-id="3d23a-152">Количество</span><span class="sxs-lookup"><span data-stu-id="3d23a-152">Quantity</span></span>         | <span data-ttu-id="3d23a-153">1.00</span><span class="sxs-lookup"><span data-stu-id="3d23a-153">1.00</span></span>        |
    | <span data-ttu-id="3d23a-154">Курс</span><span class="sxs-lookup"><span data-stu-id="3d23a-154">Rate</span></span>             | <span data-ttu-id="3d23a-155">30,000</span><span class="sxs-lookup"><span data-stu-id="3d23a-155">30,000</span></span>      |
    | <span data-ttu-id="3d23a-156">Вкладка "Сведения по строке"</span><span class="sxs-lookup"><span data-stu-id="3d23a-156">Line details tab</span></span> |             |
    | <span data-ttu-id="3d23a-157">Руководство</span><span class="sxs-lookup"><span data-stu-id="3d23a-157">Manual</span></span>           | <span data-ttu-id="3d23a-158">(отмечено)</span><span class="sxs-lookup"><span data-stu-id="3d23a-158">(marked)</span></span>    |

    <span data-ttu-id="3d23a-159">Строка 2: вкладка **Строка выписки о доходах**</span><span class="sxs-lookup"><span data-stu-id="3d23a-159">Line 2: **Earning statement line** tab</span></span>

    | <span data-ttu-id="3d23a-160">Поле</span><span class="sxs-lookup"><span data-stu-id="3d23a-160">Field</span></span>            | <span data-ttu-id="3d23a-161">Стоимость</span><span class="sxs-lookup"><span data-stu-id="3d23a-161">Value</span></span>    |
    |------------------|----------|
    | <span data-ttu-id="3d23a-162">Код доходов</span><span class="sxs-lookup"><span data-stu-id="3d23a-162">Earnings code</span></span>    | <span data-ttu-id="3d23a-163">Премия</span><span class="sxs-lookup"><span data-stu-id="3d23a-163">Bonus</span></span>    |
    | <span data-ttu-id="3d23a-164">Количество</span><span class="sxs-lookup"><span data-stu-id="3d23a-164">Quantity</span></span>         | <span data-ttu-id="3d23a-165">1.0000</span><span class="sxs-lookup"><span data-stu-id="3d23a-165">1.0000</span></span>   |
    | <span data-ttu-id="3d23a-166">По норме</span><span class="sxs-lookup"><span data-stu-id="3d23a-166">Rate</span></span>             | <span data-ttu-id="3d23a-167">4250.00</span><span class="sxs-lookup"><span data-stu-id="3d23a-167">4250.00</span></span>  |
    | <span data-ttu-id="3d23a-168">Вкладка "Сведения по строке"</span><span class="sxs-lookup"><span data-stu-id="3d23a-168">Line details tab</span></span> |          |
    | <span data-ttu-id="3d23a-169">Руководство</span><span class="sxs-lookup"><span data-stu-id="3d23a-169">Manual</span></span>           | <span data-ttu-id="3d23a-170">(отмечено)</span><span class="sxs-lookup"><span data-stu-id="3d23a-170">(marked)</span></span> |

    <span data-ttu-id="3d23a-171">Строка 3: вкладка **Строка выписки о доходах**</span><span class="sxs-lookup"><span data-stu-id="3d23a-171">Line 3: **Earning statement line** tab</span></span>

    | <span data-ttu-id="3d23a-172">Поле</span><span class="sxs-lookup"><span data-stu-id="3d23a-172">Field</span></span>           | <span data-ttu-id="3d23a-173">Стоимость</span><span class="sxs-lookup"><span data-stu-id="3d23a-173">Value</span></span>      |
    |-----------------|------------|
    | <span data-ttu-id="3d23a-174">Код доходов</span><span class="sxs-lookup"><span data-stu-id="3d23a-174">Earnings code</span></span>   | <span data-ttu-id="3d23a-175">Комиссия</span><span class="sxs-lookup"><span data-stu-id="3d23a-175">Commission</span></span> |
    | <span data-ttu-id="3d23a-176">Количество</span><span class="sxs-lookup"><span data-stu-id="3d23a-176">Quantity</span></span>        | <span data-ttu-id="3d23a-177">1.0000</span><span class="sxs-lookup"><span data-stu-id="3d23a-177">1.0000</span></span>     |
    | <span data-ttu-id="3d23a-178">По норме</span><span class="sxs-lookup"><span data-stu-id="3d23a-178">Rate</span></span>            | <span data-ttu-id="3d23a-179">!,299.00</span><span class="sxs-lookup"><span data-stu-id="3d23a-179">!,299.00</span></span>   |
    | <span data-ttu-id="3d23a-180">По норме</span><span class="sxs-lookup"><span data-stu-id="3d23a-180">Rate</span></span>            | <span data-ttu-id="3d23a-181">1,299.00</span><span class="sxs-lookup"><span data-stu-id="3d23a-181">1,299.00</span></span>   |
    | <span data-ttu-id="3d23a-182">Вкладка "Сведения по строке"</span><span class="sxs-lookup"><span data-stu-id="3d23a-182">Line detail tab</span></span> |            |
    | <span data-ttu-id="3d23a-183">Руководство</span><span class="sxs-lookup"><span data-stu-id="3d23a-183">Manual</span></span>          | <span data-ttu-id="3d23a-184">(отмечено)</span><span class="sxs-lookup"><span data-stu-id="3d23a-184">(Marked)</span></span>   |

    > [!NOTE]
    > <span data-ttu-id="3d23a-185">Установка ползунка **Вручную** на значение **Да** на вкладке **Сведения по строке** для каждой строки выписки о доходах требуется для того, чтобы начальные сальдо зарплаты были введены для каждого работника.</span><span class="sxs-lookup"><span data-stu-id="3d23a-185">Setting the **Manual** slider to **Yes** in the **Line Details** tab for each earnings statement line is key to have payroll beginning balances entered for each worker.</span></span>

3. <span data-ttu-id="3d23a-186">В области **Действия** нажмите **Запустить выписку о доходах** USA-FED-ER-FICA.</span><span class="sxs-lookup"><span data-stu-id="3d23a-186">On the **Action** pane, click **Release earnings statement** USA-FED-ER-FICA.</span></span>
...
1. <span data-ttu-id="3d23a-207">Откройте страницу **Все выписки по оплате**.</span><span class="sxs-lookup"><span data-stu-id="3d23a-207">Open the **All pay statements** page.</span></span>
