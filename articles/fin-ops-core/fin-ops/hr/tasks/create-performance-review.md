...
7. Можно отобразить или скрыть вкладки, такие как вкладка вложений:
    ...
    1. На панели операций выберите **Показать разделы**, чтобы открыть раскрывающееся диалоговое окно.
...
18. Выберите **Добавить измерение**, чтобы открыть раскрывающееся диалоговое окно.
