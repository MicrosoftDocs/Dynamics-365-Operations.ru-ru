...
Список возможностей Retail, доступных в локальных развертываниях, см. в разделе [Возможности Retail, доступные в локальных развертываниях](https://github.com/MicrosoftDocs/Dynamics-365-Operations/blob/PeterRFriis-patch-1/articles/retail/retail-onprem.md).
