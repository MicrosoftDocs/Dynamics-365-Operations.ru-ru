...
description: В этой статье перечислены руководства по задачам, выпущенные в библиотеках Microsoft BPM по состоянию на февраль 2016 г.
author: josaw1
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8861744"
---
# <a name="new-task-guides-february-2016"></a>Новые руководства по задачам (февраль 2016 г.)

[!include [banner](../includes/banner.md)]

В этой статье перечислены руководства по задачам, выпущенные в библиотеках Microsoft BPM по состоянию на февраль 2016 г. Опубликованные библиотеки включают унифицированную библиотеку APQC (февраль 2016 г.) для Microsoft Dynamics AX и библиотеку по началу работы (февраль 2016 г.).
