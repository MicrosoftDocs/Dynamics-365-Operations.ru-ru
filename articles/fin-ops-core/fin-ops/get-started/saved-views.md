...
- **Пользователи** — выберите пользователя для представления, чтобы просмотреть список страниц, которые этот пользователь посетил. Затем можно изменить возможность пользователя использовать персонализацию для определенных страниц или для всей системы. Можно также импортировать, экспортировать или очистить персонализации для выбранного пользователя. Кроме того, можно сбросить выноски с описанием функций для пользователя. Если пользователь ранее закрыл все всплывающие окна с новыми функциями, они снова будут отображаться при следующем обнаружении этих функций пользователем.
...
Пользователи, которые имеют доступ к странице **Персонализация**, могут также импортировать персональные или шаблонные представления, используя кнопку **импорт представлений** в области действий. В версии 10.0.12 и позднее был добавлен механизм для немедленной публикации представлений при их импорте.  
