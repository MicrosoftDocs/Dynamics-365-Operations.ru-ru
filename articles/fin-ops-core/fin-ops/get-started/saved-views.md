...
Чтобы помочь понять, как сохраненные представления помогают улучшить управление персонализациями на организационном уровне, в этом разделе описывается, как управление персонализацией работало до того, как стали доступны представления.
...
Сохраненные представления используются только в средах уровня 1 (Dev/Test) и 2 (Песочница) для обеспечения дополнительной проверки и изменения структуры. Предварительный просмотр сохраненных представлений будет доступен в производственных средах в будущих выпусках.
