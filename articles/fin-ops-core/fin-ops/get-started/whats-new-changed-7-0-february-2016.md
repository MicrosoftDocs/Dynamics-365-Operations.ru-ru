...
<td>Commerce Data Exchange — это система, которая передает данные между Microsoft Dynamics AX и розничными каналами, такими как интернет-магазины или традиционные магазины. Дополнительные сведения см. в разделе <a href="/dynamicsax-2012/appuser-itpro/commerce-data-exchange">Commerce Data Exchange [AX 2012]</a>.</td>
...
<td>Для этой функциональности требуется <a href="https://www.microsoft.com/en-us/download/details.aspx?id=58205">System Center 2012 Management Pack для Microsoft Dynamics AX 2012 R3 CU8 Retail</a>.</td>
