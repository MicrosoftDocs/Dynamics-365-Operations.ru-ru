...
На этом этапе обновления качества нацелены только на песочницы. Обновления в рабочих средах начнутся после ноября 2022 г.

## <a name="what-is-the-schedule-for-sandbox-quality-updates"></a>Какой график обновлений качества для песочниц?
Сведения о темных часах для каждого региона см. в разделе [Какой график для упреждающих обновлений качества?](../../dev-itpro/deployment/plannedmaintenance-selfservice.md#what-is-the-schedule-for-proactive-quality-updates).
...
## <a name="how-can-one-know-the-set-of-changes-that-went-into-a-quality-update-payload"></a>Как можно узнать об изменениях, которые вошли в состав обновления качества?
Можно просмотреть все статьи базы знаний в сборке обновления качества на странице **Сведения о среде** в LCS, перейдя к разделу, посвященному **обновлению качества**. 
...
## <a name="can-customers-self-install-a-quality-update-build-by-themselves-ahead-of-the-schedule"></a>Могут ли клиенты самостоятельно установить сборку обновления раньше графика?
...
- Обновления качества не применяются, если запланировано обновление службы в течение одной недели с даты плановой установки обновление качества.
...
План для клиентов, на которых распространяются требования и проверки FDA, еще находится в разработке. В ближайшее время ожидается обновление в этой сфере. Пока все подобные клиенты не получают обновления качества.
...
Клиенты с версиями ниже N-2 не будут получать обновления качества. 
...
Поскольку сама суть исправлений не изменяется в отношении содержимого обновлений качества, сейчас мы не ожидаем какого-либо дополнительного влияния, связанного с компонентами розничной торговли.
