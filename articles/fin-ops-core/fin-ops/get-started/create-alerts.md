...
Оповещения можно отправлять извне с помощью структуры бизнес-событий. При создании оповещения установите **Для всей организации** на **нет** и настройте **Послать извне** на **Да**. После того как оповещение запущено в бизнес-событии, можно запустить поток, встроенный в Power Automate, с помощью триггера **Когда бизнес-событие происходит** на соединителе Finance and Operations, или явным образом отправить событие в конечную точку бизнес-событий через **Каталог бизнес-событий**.
