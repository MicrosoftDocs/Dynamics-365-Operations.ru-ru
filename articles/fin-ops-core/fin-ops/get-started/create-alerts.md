...
Оповещения можно отправлять извне с помощью структуры бизнес-событий. При создании оповещения установите **Для всей организации** на **нет** и настройте **Послать извне** на **Да**. После того, как вы получили оповещение, запускающее бизнес-событие, вы либо можете запустить встроенный в Power Automate поток с помощью триггера **Когда происходит бизнес-событие** в соединителе Finance and Operations, либо явным образом отправить событие в конечную точку бизнес-событий через **Каталог бизнес-событий**.
