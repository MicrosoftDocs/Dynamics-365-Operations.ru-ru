...
Ключевые советы более недоступны, но они были заменены функцией поиска действий. Эта новая функция позволяет быстро искать и наживать кнопки на любой видимой панели операций.
