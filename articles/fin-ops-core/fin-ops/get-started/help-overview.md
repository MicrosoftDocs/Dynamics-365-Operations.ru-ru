...
## <a name="help-on-microsoft-docs"></a>Справка по Документации Майкрософт

([Документация Microsoft Dynamics 365](/dynamics365/)) в Документации Майкрософт является источником по умолчанию для проектной документации для перечисленных выше приложений. Этот сайт содержит следующие возможности:
...
Содержимое в Документации Майкрософт можно найти с помощью любой поисковой системы. Для оптимальных результатов рекомендуется использовать поиск по сайту, например **site:docs.microsoft.com dynamics 365 "искомый термин"**.
...
Дополнительные сведения см. в [руководстве для участников разработки портала Документация Майкрософт](/contribute), которое публикуется рабочей группой, которая создала Документация Майкрософт.
