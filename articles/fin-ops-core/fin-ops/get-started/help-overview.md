...
Microsoft выпустила библиотеки проводника по задачам для версий продуктов через выпуск Dynamics 365 for Finance and Operations от Декабрь 2017. В разделе [Доступ к руководствам по задачам в области "Справка"](#accessing-task-guides-from-the-help-pane) в этой статье поясняется, как найти правильные руководства по задачам для вашего продукта.
