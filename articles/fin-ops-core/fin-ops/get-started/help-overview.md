...
Чтобы подписаться на RSS-канал для всех обновлений, которые сделаны в содержимом docs.microsoft.com в приложениях для управления финансами и операциями, используйте следующую ссылку:
