...
После включения этой функции в области сведений появится сообщение под ссылкой **Подробнее**. В сообщении либо указано, что функция была включена, либо указано, что отображается будущая дата, на которую запланировано включение функции. Оно появляется каждый раз при выборе функции в списке функций.
...
- Выберите `Enable new features automatically`, чтобы автоматически включать все новые функции при их добавлении в среду.
- Выберите `Do not enable new features automatically`, чтобы по умолчанию отключать все новые функции при их добавлении в среду.
