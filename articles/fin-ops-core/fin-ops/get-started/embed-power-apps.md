...
3. Настройка внедренного приложения:
    ...
    - В поле **Код приложения** указывается глобальный уникальный код (GUID) приложения на основе холста, которое требуется внедрить. Чтобы получить это значение, найдите приложение на сайте [web.powerapps.com](https://web.powerapps.com), затем ищите в поле **Код приложения** в разделе **Сведения**.
...
1. [Предоставьте совместный доступ к приложению на основе холста](https://docs.microsoft.com/powerapps/maker/canvas-apps/share-app) соответствующим пользователям, чтобы они могли получить доступ к приложению в Power Apps. 
