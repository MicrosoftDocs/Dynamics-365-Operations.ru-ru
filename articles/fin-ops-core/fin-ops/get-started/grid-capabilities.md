...
> [!NOTE]
> Следующие сведения предоставляются, чтобы вы могли планировать в соответствии с этим. Дополнительные сведения о планируемом расписании выпуска версии 10.0.13 см. в разделе [Доступность обновления службы](../../fin-ops/get-started/public-preview-releases.md).

- [KB 4563317] Всплывающие подсказки для изображений не отображаются.
...
- [KB 4562645] Возникает исключение при открытии поиска во время выполнения тестов средств удаленного администрирования сервера (RSAT).
