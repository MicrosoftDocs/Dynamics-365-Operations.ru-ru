...
description: В этой статье описываются параметры фильтрации и запросов для диалогового окна "Расширенный фильтр/сортировка" и оператора "matches" на панели фильтров или в фильтрах заголовков столбцов сетки.
author: jasongre
ms.date: 03/09/2020
ms.topic: article
ms.prod: ''
