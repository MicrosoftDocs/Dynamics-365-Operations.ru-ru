...
- Клиенты, работающие в Китае, должны изучить разделы [Сборник схем Azure для Китая](/azure/china/) и [Finance and Operations, предоставляемые 21Vianet в Китае](../../dev-itpro/deployment/china-local-deployment.md).
