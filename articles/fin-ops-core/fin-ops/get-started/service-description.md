---
title: Описание службы для приложений для управления финансами и операциями
description: В этой статье содержится описание службы для приложений для управления финансами и операциями.
author: tomhig
ms.date: 04/27/2022
ms.topic: article
...
ms.locfileid: "9124939"
---
# <a name="service-description-for-finance-and-operations-apps"></a>Описание службы для приложений для управления финансами и операциями
...
Для приложений для управления финансами и операциями корпорация Microsoft выступает в качестве процессора. В качестве обработчика данных для управления финансами и операциями предоставляет процессы и функции, которые помогают клиентам соблюдать обязательства GDPR в качестве контролера данных. Дополнительные сведения см. в [Обзор GDPR](../../dev-itpro/gdpr/gdpr-guide.md).
...
Корпорация Microsoft предлагает клиентам управления финансами и операциями три плана поддержки: Premier, Professional Direct и поддержку, включенную в подписку. Уровень поддержки отличается в зависимости от плана. В следующей таблице показано сравнение трех планов.
...
В случае возникновения происшествий с приложениями для управления финансами и операциями клиенты передают заявки на техническую поддержку корпорации Microsoft через LCS. CSS обрабатывает происшествия, основываясь на плане поддержки клиента и серьезности инцидента, указанного в CSS.
...
Бизнес-объект, использующий приложения для управления финансами и операциями и представленный клиентом в Office 365.
...
Партнер, которого выбирает клиент для настройки, конфигурации, внедрения и управления решениями для управления финансами и операциями.
