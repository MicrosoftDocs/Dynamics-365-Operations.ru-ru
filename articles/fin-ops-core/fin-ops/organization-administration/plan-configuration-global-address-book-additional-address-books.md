---
title: План для глобальной адресной книги и других адресных книг
description: В этой статье описаны соображения и решения, которые вы должны принять в процессе планирования.
author: msftbrking
ms.date: 01/13/2020
ms.topic: article
ms.prod: ''
...
В этой статье описаны соображения и решения, которые вы должны принять в процессе планирования, прежде чем устанавливать и настраивать глобальную адресную книгу и любые дополнительные адресные книги. Некоторые из решений потребуют от вас подтвердить решения, которые были сделаны в других зонах продукта, таких как организационная иерархия.
