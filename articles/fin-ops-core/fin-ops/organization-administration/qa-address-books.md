...
## <a name="after-importing-addresses-when-i-access-the-records-why-am-i-unable-to-edit-imported-addresses"></a>После импорта адресов при обращении к записям, почему я не могу изменить импортированные адреса?

При импорте адресов имеется поле с меткой **IsLocationOwner**, которое указывает, является ли субъект, связанный с местонахождением (адрес), владельцем адреса. Если субъект является владельцем адреса, адрес можно изменить, используя субъект в глобальной адресной книге или в форме главной записи (например, клиент, поставщик или работник). Если субъект не является владельцем адреса, запись не может быть изменена из формы, указанной ранее. При импорте адресов для **IsLocationOwner** должно быть установлено значение **Да**, если адрес должен быть редактируемым с помощью связанного субъекта. Однако бывают случаи, когда это поле импортируется неправильно. Чтобы решить эту проблему, владелец местонахождения может быть обновлен в глобальной адресной книге из записи субъекта или со страницы **подтвердить владельцев местонахождения**. Чтобы обновить одну запись субъекта, перейдите на **Глобальная адресная книга > Адрес**. Выберите **Изменить**, чтобы открыть страницу **Изменить адрес**, чтобы изменить владельца местонахождения. Выберите **Изменить владельца местонахождения**, чтобы увидеть предыдущего владельца местонахождения, когда выбранный субъект является новым владельцем местонахождения. Если поле предыдущий владелец местонахождения пустое, это означает, что не был установлен владелец местонахождения. При выборе параметра **дополнительно** откроется страница **Управление адресами**, на которой можно также настроить владельца местонахождения. Выберите местонахождение, которое необходимо обновить, а затем выберите команду **задать владельца местонахождения** в меню. Чтобы обновить сведения о владельце местонахождения для нескольких записей, перейдите на **Глобальная адресная книга > Местонахождения > Подтвердить владельцев местонахождения**. Список содержит местонахождения, которые связаны с одним субъектом, но этот субъект не является владельцем. При выборе параметра **Подтвердить владельца** в качестве **Кода предлагаемого субъекта-владельца** будет назначен владелец связанного адреса. После настройки субъекта в качестве владельца связанный адрес будет доступен для изменения из записи субъекта. Чтобы изменить владельца местонахождения, вам должно быть назначена привилегия **задать владельца местонахождения** на странице **Конфигурация безопасности**.  Эта привилегия предоставляется системному администратору по умолчанию.
