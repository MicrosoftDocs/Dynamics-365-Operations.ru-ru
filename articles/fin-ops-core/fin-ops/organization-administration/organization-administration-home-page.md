...
description: В этой статье указываются ресурсы, которые помогут вам в вашей организации.
author: sericks007
ms.date: 08/18/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8882059"
---
# <a name="organization-administration-home-page"></a>Домашняя страница администрирования организации

[!include [banner](../includes/banner.md)]

В этой статье указываются материалы, которые помогут опытным пользователям и администраторам настроить систему так, чтобы она бесперебойно и эффективно работала на благо организации и бизнеса.
