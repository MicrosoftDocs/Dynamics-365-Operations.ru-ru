...
Для поддерживаемых стран и регионов можно создавать большинство предусмотренных законодательством отчетов. Сведения о том, какие отчеты доступны для каждой страны или региона см. на [портале локализации Microsoft Dynamics](https://mbs.microsoft.com/customersource/global/ax/support/support-news/GFMLocalizationPortalMC). (Необходима учетная запись CustomerSource.)
...
Предусмотренного законодательством отчеты должны создаваться с помощью другого приложения. Необходимо убедиться, что в приложениях Finance and Operations фиксируются данные для удовлетворения требований каждой операционной единицы в той части, в которой они отличаются от требований центрального офиса.
