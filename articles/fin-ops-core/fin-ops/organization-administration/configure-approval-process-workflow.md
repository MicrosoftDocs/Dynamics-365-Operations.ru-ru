...
Можно назначить окончательное утверждающего лицо для сценариев, в которых утверждающий является лицом, которое отправило документ на утверждение, и используется "Запретить утверждение отправителем". Чтобы определить ответственного за окончательное утверждение, необходимо выполнить следующие действия.
