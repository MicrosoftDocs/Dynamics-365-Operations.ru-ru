...
Чтобы автоматически прикреплять чеки, включающие проводки по кредитным картам, при создании отчета о расходах, выполните следующие действия:
...
Для создания расхода или сопоставление расхода из чека, выполните следующие действия:
...
Эта возможность используется вместе с функцией **Повторно сформированные отчеты о расходах**, чтобы упростить процесс расходов. Эта функция доступна только в средах уровня 2+, которые являются средой песочницы и рабочей средой.
