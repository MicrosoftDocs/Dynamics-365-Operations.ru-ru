---
title: Пример электронной отчетности для чеков поставщиков
description: В этой статье представлена общая информация о том, как использовать форматы образцов чеков для электронной отчетности.
author: sunfzam
ms.date: 06/14/2017
ms.topic: article
ms.prod: ''
...
Дополнительные сведения см. в разделе [Изменение формата электронной отчетности](../../fin-ops-core/dev-itpro/analytics/modify-electronic-reporting-format-reapply-excel-template.md).
