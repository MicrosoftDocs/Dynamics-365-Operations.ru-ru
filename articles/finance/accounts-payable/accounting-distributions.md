...
Добавлена функция, которая проверяет таблицу распределения бухгалтерских данных, чтобы убедиться, что новые поля правильно настроены. Этот компонент называется **Включение дополнительной проверки данных для документов, использующих структуру учета исходных документов**. Эта функция была включена по умолчанию в версии 10.0.29. 
