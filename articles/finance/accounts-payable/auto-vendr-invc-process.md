...
- Быстрый и эффективный просмотр журнала рабочего процесса.
...
## <a name="vendor-invoice-automation--enhanced-experience-for-viewing-workflow-historical-information-for-vendor-invoices"></a>Автоматизация накладных поставщиков — расширенные возможности просмотра журнальных данных рабочего процесса для накладных поставщиков

Предоставляется удобный для чтения просмотр журнала рабочего процесса накладных поставщиков. Доступ к истории рабочего процесса накладных поставщиков возможен непосредственно из накладной поставщика. Таким образом, для поиска информации требуется меньшее число щелчков мышью.
