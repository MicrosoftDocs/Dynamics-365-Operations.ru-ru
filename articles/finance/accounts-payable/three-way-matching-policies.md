...
description: В этой статье приводятся примеры трехсторонней проверки соответствия.
author: abruer
ms.date: 02/11/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8904940"
---
# <a name="three-way-matching-policies"></a>Политики трехсторонней проверки соответствия

[!include [banner](../includes/banner.md)]

В этой статье приводятся примеры трехсторонней проверки соответствия.
...
2.  April, координатор по расчетам с поставщиками в Fabrikam, вводит и проверяет накладную, отправленную Contoso. Она проверяет следующие данные:
    ...
    -   Для номенклатур, которым требуется двухсторонняя или трехсторонняя проверка соответствия: что цены в строке накладной находятся в пределах допустимых отклонений, определенных в Microsoft Dynamics 365 Finance. Это включает в себя следующие типы соответствия цены:
