...
ms.locfileid: "5841245"
---
# <a name="invoice-automation-for-scanned-documents"></a>Автоматизация накладных для отсканированных документов

[!include [banner](../includes/banner.md)]

В этой теме описаны сущности данных, предусмотренные для сквозной автоматизации обработки накладных поставщиков, включая накладные с вложениями.
