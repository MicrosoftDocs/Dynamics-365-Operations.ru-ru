...
description: В этой статье описываются параметры, доступные для настройки и конфигурирования автоматизации накладных поставщиков.
author: sunfzam
ms.date: 02/14/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8874851"
---
# <a name="setup-options-for-vendor-invoice-automation"></a>Параметры настройки для автоматизации накладных поставщиков

[!include [banner](../includes/banner.md)]

В этой статье описываются параметры, доступные для настройки и конфигурирования автоматизации накладных поставщиков. Функции автоматизации накладных используют следующие типы параметров настройки:

- Параметры для автоматического применения предоплат в импортированных накладных.
...
## <a name="parameters-for-automatically-applying-prepayments-in-imported-invoices"></a>Параметры для автоматического применения предоплат в импортированных накладных

- **Автоматически применять предоплату к импортированным накладным** — если этот параметр имеет значение **Да**, система автоматически ищет существующие предоплаты для соответствующего заказа на покупку при импорте накладных поставщиков. Если имеются какие-либо предоплаты, которые могут быть применены, добавляется одна дополнительная строка для применения предоплат в импортируемых накладных поставщика.
- **Блокировка процесса автоматизации дальнейших действий в случае сбоя применения предоплаты** — если этот параметр имеет значение **Да**, накладные будут заблокированы, если предоплату невозможно применить. Как и другие автоматические процессы, такие как процесс сопоставления поступлений и отправка в workflow-процесс, процесс автоматизации накладных не будет отбирать заблокированные накладные до тех пор, пока предоплата не будет применена вручную. 
