...
> [!NOTE]
> Функция **Включить сортировку по ресурсу во время создания предложения по накладным проекта** позволяет бухгалтерам проекта сортировать проводки по проекту, доступные для выставления счетов по ресурсам при создании нового предложения по накладной проекта. Сетка, в которой отображаются доступные проводки по проекту, будет иметь отдельное поле для кода ресурса и ресурса, позволяя пользователю выполнять фильтрацию и сортировку имени ресурса. Эта функция отключена по умолчанию и может быть включена в **Рабочие области > управление функциями**. Обратитесь за помощью к системному администратору, чтобы включить эту функцию.
