...
3.  В "Fabrikam Продажи" обновите накладную для ICSO888. Цена за единицу измерения равна 0,45, при этом обновляются 100 номенклатур.
