...
description: Эта статья содержит описание и сравнение двух методов, которые организации могут использовать для авансовых платежей (предоплат).
author: abruer
ms.date: 10/24/2022
ms.topic: article
ms.prod: ''
