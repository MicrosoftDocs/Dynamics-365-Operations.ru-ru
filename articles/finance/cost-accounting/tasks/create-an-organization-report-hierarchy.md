...
31. Нажмите кнопку **Создать**.
32. В поле **Имя узла** введите «Центры затрат генерального директора».
33. Нажмите кнопку **Сохранить**.
34. Нажмите кнопку **Создать**.
...
51. В поле **Имя узла** введите «Центры затрат генерального директора».
52. Нажмите кнопку **Сохранить**.
53. Нажмите кнопку **Создать**.
54. В поле **Имя узла** введите «Центры обработки вызовов».
55. Нажмите кнопку **Сохранить**.
56. Нажмите кнопку **Создать**.
