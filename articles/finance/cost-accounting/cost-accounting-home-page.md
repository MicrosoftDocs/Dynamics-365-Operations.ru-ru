...
| &nbsp; | &nbsp;  |
|------|---|
|  [Начало работы с учетом затрат (Learn)](https://docs.microsoft.com/learn/modules/get-started-cost-accounting-dyn365-finance/)  |[Аналитики элементов затрат](cost-elements.md)  |
