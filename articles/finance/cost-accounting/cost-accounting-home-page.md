...
description: В этой статье представлен список разделов справки и другие ресурсы, доступные для модуля "Учет затрат".
author: aprilolson
ms.date: 04/25/2018
ms.topic: article
ms.prod: ''
...
На следующей карте обучения показаны основные понятия и задачи, составляющие структуру модуля "Учет затрат". Перейдите по ссылкам в разделе [Быстрые ссылки](#quick-links), чтобы узнать, как использовать этот модуль.
...
| &nbsp; | &nbsp;  |
|------|---|
|  [Начало работы с учетом затрат (Learn)](/training/modules/get-started-cost-accounting-dyn365-finance/)  |[Аналитики элементов затрат](cost-elements.md)  |
