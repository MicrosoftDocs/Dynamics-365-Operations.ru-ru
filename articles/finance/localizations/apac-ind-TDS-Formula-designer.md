...
description: В этой статье представлен пример того, как рассчитывается налог, удерживаемый у источника (TDS), на основе формулы, определенной для каждого налогового кода TDS в группе TDS, прикрепленной к проводке.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
