...
В этом разделе приводятся сведения о сомнительных долгах для расчетов с поставщиками, списании задолженностей для них, и следующие налоговые регистры:
...
Необходимо создать и настроить налоговые регистры. Дополнительные сведения см. в "Регистры налога на прибыль". В следующих разделах приведены дополнительные сведения о каждом из налоговых регистров.
...
1. Расчет и утверждение журнала налоговых регистров для предыдущего периода. Дополнительные сведения см. в "Регистры налога на прибыль".
