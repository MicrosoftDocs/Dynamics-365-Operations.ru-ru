...
description: В этой статье содержатся сведения о функции корректировки курсовой разницы для пользователей в юридических лицах в Эстонии, Венгрии, Чешской Республике, Латвии, Литве, Польше и России.
author: AdamTrukawka
ms.date: 04/10/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9268560"
---
# <a name="exchange-rate-adjustments"></a>Курсовые разницы

[!include [banner](../includes/banner.md)]

В этой статье содержатся сведения о функции корректировки курсовой разницы для пользователей в юридических лицах в Эстонии, Венгрии, Чешской Республике, Латвии, Литве, Польше и России.
