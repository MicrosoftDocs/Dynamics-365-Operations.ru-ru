...
description: В этой статье объясняется, как устранять неполадки, когда список налоговых функций на странице параметров расчета налогов пуст.
author: wangchen
ms.date: 03/04/2022
...
Если два идентификатора клиентов различаются, то вы столкнулись с проблемой, описанной в этой статье. Если они одинаковы, вы столкнулись с другой проблемой, не связанной с этой. В этом случае рекомендуется обратиться в службу поддержки Майкрософт.
