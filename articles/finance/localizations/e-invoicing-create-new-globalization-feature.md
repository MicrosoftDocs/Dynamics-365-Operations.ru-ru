...
11. Завершите настройку и разверните функцию электронного выставления накладных в среде службы. Дополнительные сведения см. в разделе [Завершение, публикация и развертывание функции глобализации](e-invoicing-complete-publish-deploy-globalization-feature).
...
9. Завершите настройку и разверните функцию электронного выставления накладных в среде службы. Дополнительные сведения см. в разделе [Завершение, публикация и развертывание функции глобализации](e-invoicing-complete-publish-deploy-globalization-feature).
