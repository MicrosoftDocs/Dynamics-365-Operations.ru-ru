...
description: В этой статье содержатся сведения о функции для мелких наличных денег, которая позволяет пользователям в Эстонии, Литве, Чешской Республике, Венгрии, Латвии, Польше и России отражать кассовые операции в системе.
...
Дополнительные сведения о процессе утверждения для кассовых документов см. в разделе &quot;Утверждение и разноска проводок по кассе&quot; далее в этой статье.</td>
</tr>
<tr class="odd">
<td>Лимит остатка</td>
...
<td>Установите этот флажок для использования дополнительного статуса <strong>Подтвержден</strong> во время процесса утверждении для кассовых документов. (Дополнительные сведения см. в разделе &quot;Утверждение и разноска проводок по кассе&quot;.)</td>
</tr>
</tbody>
</table>
...
<td>Статус первой проводки имеет значение <strong>Нет</strong>. Сведения о том, как задать статус проводки, см. в разделе &quot;Утверждение и разноска проводок по кассе&quot;.</td>
</tr>
<tr class="even">
<td>Вид документа</td>
...
## <a name="cash-transaction-approval-and-posting"></a>Утверждение и разноска проводок по кассе
