...
description: В этой теме содержатся сведения об отчетности Интрастат в Германии.
author: andosip
ms.date: 08/2/2021
ms.topic: article
...
ms.locfileid: "6759851"
---
# <a name="german-intrastat"></a>Немецкий Интрастат

Страница **Интрастат** используется для создания и подготовки отчетов о торговле между странами ЕС. Декларация немецкого Интрастат содержит информацию о торговле товарами для отчетности.
...
3. Настройка параметров внешней торговли:
    ...
    1. В Dynamics 365 Finance перейдите в **Налог** > **Настройка** > **Параметры внешней торговли**.
    ...
    6. В поле **Кредит-нота** выберите код проводки для возврата товаров. Этот код используется для возврата товаров после записи исходной проводки под кодом проводки.
    7. В поле **Налоговый орган** выберите налоговый орган Интрастат.
    8. Перейдите **Налог** > **Косвенные налоги** > **Налог** > **Налоговые органы** и введите следующие сведения для налогового органа Интрастат, выбранного на предыдущем шаге:

       - Идентификация органа
       - Адрес 
       - Контактная информация

    9. На вкладке **Свойства страны/региона** в поле **Страна/регион** перечислите все страны или регионы, с которыми ваша компания имеет деловые отношения. Для каждой страны или региона в поле **Тип страны/региона** выберите **ЕС**, чтобы страна или регион отображались в отчете Интрастат.
