...
description: В этой теме объясняется, как настроить и создать отчет по подоходному налогу для Индонезии.
author: sndray
ms.date: 12/15/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "7943664"
---
# <a name="withholding-tax-report-for-indonesia-id-00005"></a>Отчет по подоходному налогу для Индонезии (ID-00005)

[!include [banner](../includes/banner.md)]

В этой теме объясняется, как настроить и создать файл подоходного налога PPH, который юридические лица в Индонезии используют для отчета о транзакциях подоходного налога в приложении e-Bupot.
