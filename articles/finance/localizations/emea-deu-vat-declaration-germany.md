...
description: В этой теме описывается, как настроить и сформировать авансовую декларацию налога на добавленную стоимость (НДС) для Германии в официальном формате XML.
author: anasyash
ms.date: 03/10/2022
ms.topic: article
...
ms.locfileid: "8402811"
---
# <a name="vat-declaration-germany"></a>Декларация НДС (Германия)

[!include [banner](../includes/banner.md)]

В этой теме описывается, как настроить и сформировать авансовую декларацию налога на добавленную стоимость (НДС) для Германии в официальном формате XML. В этой теме также объясняется, как просмотреть декларацию НДС в Microsoft Excel.
...
Для Германии необходимо настроить **Подстановку поля отчета**. Дополнительные сведения о настройке параметров для конкретного приложения см. в разделе [Настройка параметров для конкретного приложения для полей декларации по НДС](#set-up-application-specific-parameters-for-vat-declaration-fields) далее в этой теме.
...
4. На экспресс-вкладке **Условия** настройте следующие поля, чтобы связать налоговые коды и поля отчета.
    ...
    | Поле                  | Описание                                                                                                                                                                                                                                                                                                          |
    |------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Результат поиска          | Выберите значение поля отчета. Дополнительные сведения о значениях и их назначении строкам декларации по НДС см. в разделе [Обзор декларации по НДС](#vat-declaration-overview) ранее в этой теме.                                                                                               |
...
При использовании электронных сообщений для создания отчета можно собирать налоговые данные из нескольких юридических лиц. Дополнительные сведения см. в разделе [Выполнение декларации по НДС для нескольких юридических лиц](#run-a-vat-declaration-for-multiple-legal-entities) ниже в этой теме.
...
5. Необязательно: на экспресс-вкладке **Сообщения** выберите **Собрать данные**, затем нажмите кнопку **ОК**. Налоговые платежи, созданные ранее, добавляются к сообщению. Дополнительные сведения см. в разделе [Сопоставление и разноска налога](#settle-and-post-sales-tax) ранее в этой теме. Если пропустить этот шаг, можно по-прежнему создавать декларацию НДС, используя поле **Версия налоговой декларации** в диалоговом окне **Декларация**.
