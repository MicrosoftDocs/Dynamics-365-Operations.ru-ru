...
description: В этой статье приводятся сведения об отчетах по проводкам по кассе, доступных для компаний с российским контекстом.
author: AdamTrukawka
ms.date: 11/13/2019
ms.topic: article
ms.prod: ''
...
ms.openlocfilehash: b63b2315b0196b2cc667e538086a6dca2cf59dde
ms.sourcegitcommit: 87e727005399c82cbb6509f5ce9fb33d18928d30
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/12/2022
ms.locfileid: "9280631"
---
...
В статье [Мелкие наличные деньги для Восточной Европы и России](emea-petty-cash.md) представлены сведения о следующих отчетах:
...
В этой статье содержится информация о следующих дополнительных отчетах:
...
4. На вкладке **Платеж** в поле **Тип банковской проводки** выберите тип проводки, для которого ранее в этой статье вы установили флажок **Разрешить объявление на взнос наличными**.
