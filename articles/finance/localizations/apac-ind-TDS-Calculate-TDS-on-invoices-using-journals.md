...
description: В этой статье перечислены шаги для расчета налога, удерживаемого у источника (TDS), в журналах.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8863043"
---
# <a name="calculate-tds-on-invoices-using-journals"></a>Расчет TDS по накладным с использованием журналов

[!include [banner](../includes/banner.md)]

В этой статье перечислены шаги для расчета налога, удерживаемого у источника (TDS), в журналах.
