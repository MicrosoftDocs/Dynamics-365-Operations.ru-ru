...
<ul>
<li>Счет на оплату</em></li>
<li>Счет-фактура</li>
<li>Фактура<em></li>
<li>Накладная - Кредит-нота</li>
<li>Фактура - Кредит-нота</em></li>
<li>Фактура по налоговой проводке (клиент)<em></li>
</ul></td>
</tr>
<tr class="even">
...
<li>Фактура - Кредит-нота<em></li>
<li>Счет на оплату</em></li>
<li>Фактура по налоговой проводке (поставщик)<em></li>
</ul></td>
</tr>
<tr class="odd">
<td>Учет МЦ</td>
...
<ul>
<li>Накладная на отпуск по заказу на продажу (М-15)</em></li>
