...
6. В поле **Кредит-нота** выберите код проводки для возврата товаров. Этот код используется для возврата товаров после записи исходной проводки под кодом проводки. Компании в Швеции используют коды проводок с одной цифрой.
