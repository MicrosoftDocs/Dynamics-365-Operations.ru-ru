...
3. На вкладке **Настройка** в поле **Тип разноски** выберите **Подоходный налог**.     

    > [!NOTE]
    > Счета ГК, имеющие тип разноски **Подоходный налог**, могут быть определены только как счета модуля "расчеты с клиентами", которые используются для разноски суммы расчетов с клиентами TDS для налогового кода TDS.
