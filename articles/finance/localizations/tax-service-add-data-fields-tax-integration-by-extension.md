...
description: В этой статье объясняется, как использовать расширения X++ для добавления полей данных при интеграции налогов.
author: qire
ms.date: 04/27/2022
ms.topic: article
ms.prod: ''
...
> [!NOTE]
> Определите имя поля, которое используется в запросе как **private const str**. Эта строка должна точно совпадать с именем узла (не с подписью), добавленным в статье [Добавление полей данных в налоговые конфигурации](tax-service-add-data-fields-tax-configurations.md).
> 
