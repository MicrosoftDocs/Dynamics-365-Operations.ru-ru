...
description: В этой теме объясняется, как настроить назначения электронной отчетности (ER) для последующей обработки российских бухгалтерских документов, созданных в Microsoft Excel и Word.
author: anasyash
ms.date: 02/02/2022
ms.topic: overview
ms.prod: ''
...
ms.openlocfilehash: 390d9fec7fc90f34c3c34e83a920606f85ce4e27
ms.sourcegitcommit: 2aca3a95d42403c7f5d80dcd5e3ee958dca5c894
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 02/03/2022
ms.locfileid: "8088031"
---
...
В этой теме объясняется, как настроить назначения электронной отчетности (ER) для последующей обработки российских бухгалтерских документов, созданных в форматах Microsoft Excel и Word. Можно настроить конфигурацию для предварительного просмотра документа на экране, отправки документа на принтер или сохранения файла в формате SharePoint или Power BI. Для получения сведений о федеральном стандарте бухгалтерского учета 27-2021 в России и Dynamics 365 Finance см. технический документ [Dynamics 365 Finance и Supply Chain Management. Федеральный стандарт бухгалтерского учетных 27-2021 в России](https://servicetrust.microsoft.com/ViewPage/TrustDocumentsV3?command=Download&downloadType=Document&downloadId=cc7a904b-d553-43b3-94fd-58fa02e4f702&tab=7f51cb60-3d6c-11e9-b2af-7bb9f5d2d913&docTab=7f51cb60-3d6c-11e9-b2af-7bb9f5d2d913_Compliance_Guides).
...
Таблицы в разделе [Документы учета](#accounting-documents) в этой теме перечислены отчеты, к которым относится эта функция. В таблицах отображается имя компонента файла, который должен настраиваться для каждого отчета в назначениях ER. Они также указывают, можно ли настроить назначение **Файл** для отчета в управлении печатью.
