...
description: В этой статье объясняется, как совместно использовать конфигурации электронной отчетности (ER) в Microsoft Regulatory Configuration Services (RCS)/глобальном репозитории непосредственно с внешними организациями.
author: kfend
ms.date: 05/04/2020
ms.topic: article
ms.prod: ''
...
Конфигурация используется совместно с внешней организацией и доступна для данной организации в глобальном репозитории. Здесь ее можно импортировать в экземпляр RCS организации или в экземпляры приложений для управления финансами и операциями организации.
