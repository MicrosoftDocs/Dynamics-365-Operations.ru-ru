...
description: В этой статье представлены сведения о функциональности, относящейся к подотчетным лицам.
author: liza-golub
ms.date: 09/15/2021
ms.topic: overview
ms.prod: ''
...
Выполните следующие задачи для подотчетного лица. Обязательно выполните эти задачи в следующем порядке.

1. Создание групп подотчетных лиц.
...
Для отражения проводок подотчетного лица необходимо настроить следующие поля на странице **Параметры модуля расчетов с поставщиками** в разделе **Подотчетные лица**.
...
Для получения списка проводок по подотчетным лицом выберите **Проводки** на странице **Подотчетные лица**. Чтобы просмотреть проводки для всех подотчетных лиц или создать конкретный запрос на основе проводок подотчетных лиц, перейдите в раздел **Расчеты с поставщиками** > **Запросы и отчеты** > **Запросы и отчеты о подотчетных лицах** > **Проводки**. Выберите **Ваучер**, чтобы открыть страницу **Проводки ваучера**.
...
Разноска проводок по работникам, которые являются подотчетными лицами, может выполняться при помощи счетов подотчетных лиц. Указанный для каждого подотчетного лица идентификатор работника можно использовать для отслеживания всех проводок подотчетного лица. Этот номер используется в качестве номера счета для проводок по подотчетному лицу на страницах **Общие журналы** и **Проводки по подотч. лицам**.
...
1. В поле **Условия оплаты** в разделе **Цены и скидки** выберите условие оплаты. Дополнительные сведения об **Условиях оплаты** см. в разделе [Определение условий оплаты поставщикам](../accounts-payable/tasks/define-vendor-payment-terms.md). 
2. Выберите условие оплаты, для которого установлен флажок **От подотчетного лица** на странице **Условия оплаты**. 
3. На экспресс-вкладке **Цена и скидка** в поле **Подотчетное лицо** выберите подотчетное лицо для заказа на покупку.
...
### <a name="settle-advance-holder-balances-by-using-the-bank"></a>Сопоставление сальдо подотчетного лица с использованием банка
При сопоставлении сальдо подотчетных лиц с использованием банка записи о закрытии сальдо подотчетного лица создаются в общем журнале. Коды для журнала и банка можно установить в разделе **Подотчетные лица** на странице **Параметры расчетов с поставщиками**. 

1. Чтобы закрыть сальдо подотчетного лица с использованием банка, перейдите в раздел **Расчеты с поставщиками** > **Подотчетные лица** > **Подотчетные лица**. 
2. На панели операций выберите **Сальдо** > **Закрытие через банк**. 
3. На странице **Закрытие через банк** введите следующие сведения.

    | Поле                    | описание |
    |------------------------------|-------------------|
    | **Дата оплаты**          | Введите дату, когда требуется разнести платеж.|
    | **Сумма для переноса** | Введите сумму сальдо во время закрытия. Сумма, указанная в поле **Сумма** на странице **Сальдо**, отображается по умолчанию. |
    | **Автоматически**                | Установите флажок **Автоматический**, чтобы автоматически создать и разнести журнал, который заранее задан на странице **Параметры модуля расчетов с поставщиками**.|

### <a name="settle-advance-holder-balances-by-using-cash"></a>Сопоставление сальдо подотчетного лица с использованием кассы
При сопоставлении сальдо подотчетных лиц с использованием кассы записи о закрытии сальдо подотчетного лица создаются в журнале квитанций. Коды для журнала и кассы можно установить на вкладке **Подотчетные лица** на странице **Параметры расчетов с поставщиками**. 

1. Чтобы закрыть сальдо подотчетного лица с использованием кассы, перейдите в раздел **Расчеты с поставщиками** > **Подотчетные лица** > **Подотчетные лица**. 
2. На панели операций выберите **Сальдо** > **Закрытие через кассу**. 
3. На странице **Закрытие через кассу** введите следующие сведения.
