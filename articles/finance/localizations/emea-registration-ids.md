...
В следующей таблице перечислены поддерживаемые типы регистрации. Если вы знакомы с полями для регистрационных идентификаторов в Microsoft Dynamics AX 2012, в этой таблице эти поля также сопоставляются с категориями регистрации Dynamics 365 Finance.
