...
description: В этой статье содержатся сведения о российских форматах адресов и импорте из FIAS.
author: AdamTrukawka
ms.date: 11/05/2019
ms.topic: article
ms.prod: ''
...
ms.openlocfilehash: 97e9c535edd4f21a6ed5038cd815011644d7dbe5
ms.sourcegitcommit: 87e727005399c82cbb6509f5ce9fb33d18928d30
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/12/2022
ms.locfileid: "9286982"
---
...
База данных адресов Федеральной информационной системы адресов (или FIAS) может потребоваться для предприятий в Российской Федерации. Можно использовать специализированные средства для импорта FIAS в систему и поддержания ее актуальности. В этой статье описывается, как настроить и использовать механизмы импорта FIAS.

> [!NOTE]
> Федеральная налоговая служба (FTS) остановила обновление файлов с адресами в формате FIAS в августе 2021 года. Новый формат был утвержден в соответствии с приказом FTS от 13 мая 2020 ода: номер ED-7-6 / 329 @ FIAS (старый формат, содержащий информацию об адресах в структуре административного территориального деления); государственный адресный реестр (ГАР, новый формат, содержащий информацию об адресах в муниципальном делении). 
>
> Дополнительные сведения об импорте адресов в формате ГАР см. в разделе [Импорт из ГАР](rus-russian-address-format-import-gar.md)
...
## <a name="import-from-fias"></a>Импорт из ФИАС
...
3. В разделе **Импорт/экспорт** выберите плитку **Импорт**, чтобы создать новое задание импорта.
    ...
    ![Область управления данными, раздел импорта/экспорта, плитка «Импорт».](media/9%20Data%20management.jpg)
...
8. Нажмите **Сохранить**.
    ...
    ![Список только что добавленных сущностей.](media/11%20Template.jpg)
...
8. Выберите **ОК**, затем выберите **Сохранить**.
    ...
    ![Страница «Импорт» с подробными сведениями о задании полного импорта FIAS.](media/12%20Import.jpg)
...
9. Нажмите **ОК**.
    ...
    ![Страница «Импорт» с подробными сведениями о задании дельта-импорта FIAS.](media/13%20Import.jpg)
...
10. Для каждого объекта выберите кнопку в столбце **Просмотр карты**, чтобы открыть страницу **Сопоставить исходные данные с промежуточными**.
    ...
    ![Страница сопоставления исходных данных с промежуточными.](media/14%20Map%20source%20to%20staging.jpg)
