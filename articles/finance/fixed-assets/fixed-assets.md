...
description: Основные средства — это имеющие стоимость объекты, которыми владеет человек или организация. К ним относятся здания, транспортные средства, земля и оборудование.
...
ms.locfileid: "6753560"
---
# <a name="fixed-assets-home-page"></a>Домашняя страница основных средств

[!include [banner](../includes/banner.md)]

Основные средства — это имеющие стоимость объекты, которыми владеет человек или организация. К ним относятся здания, транспортные средства, земля и оборудование. 
