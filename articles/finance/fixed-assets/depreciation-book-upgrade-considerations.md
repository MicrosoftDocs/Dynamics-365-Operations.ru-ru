...
description: В этой статье описывается текущая функциональность книги в основных средствах. Эта функциональность основана на функции модели стоимости, доступной в ранних версиях, но также включает все функции, которые ранее были представлены только в журналах амортизации.
author: moaamer
ms.date: 06/20/2017
ms.topic: overview
ms.prod: ''
...
ms.locfileid: "8855501"
---
# <a name="depreciation-book-upgrade-overview"></a>Обзор обновления журнала амортизации

[!include [banner](../includes/banner.md)]

В этой статье описывается текущая функциональность книги в основных средствах. Эта функциональность основана на функции модели стоимости, доступной в ранних версиях, но также включает все функции, которые ранее были представлены только в журналах амортизации. Функция модели стоимости и функция журнала амортизации были объединены в одно понятие книги. Функция книги позволяет использовать один набор страниц, запросов и отчетов для всех процессов основных средств в организации. В этой статье приводятся некоторые аспекты, которые необходимо учитывать перед обновлением. 
