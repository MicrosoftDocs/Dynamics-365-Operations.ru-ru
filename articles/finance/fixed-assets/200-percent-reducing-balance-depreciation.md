...
description: Эта статья представляет обзор метода амортизации с уменьшаемым остатком в 200 %.
author: moaamer
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8870172"
---
# <a name="200-percent-reducing-balance-depreciation"></a>Амортизация с уменьшаемым остатком в 200%

[!include [banner](../includes/banner.md)]

Эта статья представляет обзор метода амортизации с уменьшаемым остатком в 200 %.
