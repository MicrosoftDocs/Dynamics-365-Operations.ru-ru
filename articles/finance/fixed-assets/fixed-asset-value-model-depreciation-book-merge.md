...
В этой теме описывается текущая функциональность книги в основных средствах. Эта функциональность основана на функции модели стоимости, доступной в ранних версиях, но также включает все функции, которые ранее были представлены только в журналах амортизации.

Функция книги позволяет использовать один набор страниц, запросов и отчетов для всех процессов основных средств в организации. Таблицы в этом разделе описывают более раннюю функциональность для журналов амортизации и моделей стоимости вместе с текущей функциональностью для книг.
