...
description: В этой статье приводится обзор настройки модуля "Основные средства".
author: moaamer
ms.date: 06/08/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8910152"
---
# <a name="set-up-fixed-assets"></a>Настройка основных средств

[!include [banner](../includes/banner.md)]

В этой статье приводится обзор настройки модуля **Основные средства**. 

Параметры управляют общим поведением в модуле "Основные средства". Группы ОС позволяют группировать активы и задавать атрибуты по умолчанию для каждого актива, назначенного группе. Книги назначаются группам ОС. Книги отслеживают финансовую стоимость основного средства с течением времени с помощью конфигурации амортизации, определенной в профиле амортизации.
...
Параметр на странице **Параметры основных средств** позволяет включить или выключить функцию блокировки. Эта функция включена в **Рабочей области управления функциями**.
...
Параметр **Блокировка журналов активов в журнале амортизации** позволяет блокировать книги активов в журнале амортизации. При разноске проводок амортизации система будет проверять, что один и тот же журнал активов не был добавлен к нескольким журналам амортизации. Если это так, этот журнал активов будет заблокирован и разноска будет остановлена. Если код журнала активов находится в заблокированном журнале, он будет разблокирован автоматически после завершения разноски для исходного журнала. Можно также разблокировать журнал вручную. 
