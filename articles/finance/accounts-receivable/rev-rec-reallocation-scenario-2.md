...
При выборе **Ваучер** в заказе на продажу 000036 журнал накладных отображает исходную запись учета. Для просмотра записи реверсирования и новой записи учета из заказа на продажу выберите **Корректировки выручки** на панели операций, а затем выберите **Ваучер**.
