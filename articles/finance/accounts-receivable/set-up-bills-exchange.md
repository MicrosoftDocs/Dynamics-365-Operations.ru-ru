...
description: В этой статье описываются шаги по настройке переводных векселей.
...
ms.locfileid: "8874735"
---
# <a name="set-up-bills-of-exchange"></a>Настройка спецификаций

[!include [banner](../includes/banner.md)]

В этой статье описываются шаги по настройке переводных векселей.
