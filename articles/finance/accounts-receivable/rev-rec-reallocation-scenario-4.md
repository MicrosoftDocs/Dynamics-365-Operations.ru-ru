...
description: В этой статье описывается сценарий перераспределения, в котором строка удаляется из существующего заказа на продажу, по которому частично выставлена накладная. Этот сценарий дает одинаковый результат и если строка удаляется из заказа на продажу, и если ей присваивается статус "Отменено".
author: kweekley
ms.date: 12/21/2020
ms.topic: index-page
ms.prod: ''
...
ms.locfileid: "8891676"
---
# <a name="revenue-recognition-reallocation--scenario-4"></a>Перераспределение признания выручки — Сценарий 4

[!include [banner](../includes/banner.md)]

В этой статье описывается сценарий перераспределения, в котором строка удаляется из существующего заказа на продажу, по которому частично выставлена накладная. Этот сценарий дает одинаковый результат и если строка удаляется из заказа на продажу, и если ей присваивается статус "Отменено".
