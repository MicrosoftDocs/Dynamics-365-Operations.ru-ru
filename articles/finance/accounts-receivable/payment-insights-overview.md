...
description: В этой статье описывается возможность аналитики платежей, которая помогает лучше понять типичную практику платежей отдельных клиентов. Функция может помочь определить обстоятельства, которые оправдывают запуск процессов сбора задолженностей раньше, чем вы бы их начали в ином случае.
...
В этой статье описывается возможность аналитики платежей, которая помогает лучше понять типичную практику платежей отдельных клиентов. Функция может помочь определить обстоятельства, которые оправдывают запуск процессов сбора задолженностей раньше, чем вы бы их начали в ином случае. 
