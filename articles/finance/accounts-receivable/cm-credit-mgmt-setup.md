...
- Установите для параметра **Пропустить резервирования запасов** значение **Да**, чтобы игнорировать резервирования запасов при проверке правил блокировки управления кредитом. В этом случае система проверяет количество завершенных строк и включает льготные периоды для контрольных точек, независимо от количества резервирования запасов.
