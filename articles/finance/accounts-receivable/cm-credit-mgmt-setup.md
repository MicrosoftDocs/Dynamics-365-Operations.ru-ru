...
Имеется четыре экспресс-вкладки, которые позволяют изменить параметры управления кредитом: **Удержания по кредитам**, **Контрольная точка управления кредитом**, **Статистика управления кредитом** и **Кредитные лимиты**. В следующих разделах описываются параметры, доступные на каждой экспресс-вкладке.

### <a name="credit-holds"></a>Удержания по кредиту

- Установите параметр **Разрешить изменение заказов на продажу после выпуска заказа** как **Да**, чтобы потребовать повторной проверки правил разноски, если стоимость заказа на продажу (расширенная цена) была изменена, так как заказ на продажу был выпущен из списка блокировки. .
