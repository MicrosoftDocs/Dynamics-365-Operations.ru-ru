...
description: В этой теме объясняется, как настроить значения по умолчанию для графиков выставления счетов, созданных в повторяющемся выставлении счетов по контракту. Здесь также объясняется создание групп графиков выставления счетов.
...
1. На странице **Параметры повторяющегося выставления счетов по контракту** на вкладке **Общие** в поле **Группа графиков выставления счетов** выберите группу графиков выставления счетов. Сведения о настройке групп графиков выставления счетов см. в разделе [Группы графиков выставления счетов](#set-up-billing-schedule-groups) далее в этой теме.
...
11. Задайте поля для создания заказов на продажу:
