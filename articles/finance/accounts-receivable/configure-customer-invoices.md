...
## <a name="post-to-revenue-account-for-sales-order-lines-that-have-no-price"></a>Разноска строк заказов на продажу, не имеющих цены, на счет выручки
У вас будет возможность обновить счет **Выручка** в **Главной книге** для строк заказа на продажу, не имеющих цены. Для настройки или просмотра этих сведений перейдите к параметру **Разносить строки накладных по заказам на продажу с нулевой ценой на счет выручки** на вкладке **Главная книга и налог** на странице **Параметры модуля расчетов с клиентами**. (**Расчеты с клиентами > Настройка > Параметры модуля расчетов с клиентами**). Выберите **Да**, чтобы обновить счет **Выручка** для строк накладной заказа на продажу, у которых нет цены. Счет выручки определяется на странице параметров **Разноска запасов** на вкладке определения счета **Заказ на продажу**. Если этот параметр не выбран, строки, не имеющие сведений о ценах, не будут разноситься на счет **Выручка**.
