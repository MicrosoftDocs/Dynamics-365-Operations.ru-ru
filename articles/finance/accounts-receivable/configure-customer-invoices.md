...
У вас будет возможность обновить счет **Выручка** в **Главной книге** для строк заказа на продажу, не содержащих цены и стоимости. 

Для настройки или просмотра этих сведений:
1. Перейдите к параметру **Разносить строки накладных по заказам на продажу с нулевой ценой и нулевой стоимостью на счет выручки** на вкладке **Главная книга и налог** на странице **Параметры модуля расчетов с клиентами**. (**Расчеты с клиентами > Настройка > Параметры модуля расчетов с клиентами**). 
2. Выберите **Да**, чтобы обновить счет **Выручка** для строк накладной заказа на продажу, не содержащих цены и стоимости. 
 - Если выбран этот параметр, ваучер будет содержать 0,00 записей для типов разноски **Сальдо клиента** и **Выручка**. Счет выручки определяется на странице параметра **Разноска запасов** на вкладке определения счета **Заказ на продажу**. 
 - Если этот флажок не установлен, строки, не имеющие информации о ценах или затратах, не будут разноситься на счет **Выручка**. Вместо этого ваучер будет содержать запись 0,00 для типа разноски **Сальдо клиента**.
