...
description: В этой статье описываются базовые функции для признания выручки по заказам на продажу и накладным. Признание выручки доступно в заказе на продажу и в соответствующей накладной, которая создается из заказа на продажу.
author: bking
ms.date: 08/24/2018
ms.topic: index-page
ms.prod: ''
...
В этой статье описываются базовые функции для признания выручки по заказам на продажу и накладным. Признание выручки доступно в заказе на продажу и в соответствующей накладной, которая создается из заказа на продажу. Заказ на продажу также может быть создан с помощью проекта "Время и расходы".

> [!NOTE]
> На рисунках в данной статье столбцы были скрыты или добавлены в сетки для лучшего представления концепций. Таким образом, страницы и данные на рисунках могут отличаться от тех, что отображаются для продукта.
