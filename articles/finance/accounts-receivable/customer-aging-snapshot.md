...
> [!NOTE]
> Чтобы сократить время, необходимое для создания снимка временных срезов, включите следующие функции в рабочей области **Управление функциями**: **Повышение эффективности обработки сроков оплаты по клиентам** 
