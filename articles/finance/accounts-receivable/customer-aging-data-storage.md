...
description: В этой статье описывается процесс использования внешнего хранилища для данных распределения по срокам для клиента. Можно выполнить процесс хранения данных по срокам оплаты для клиентов, чтобы выходные данные могли быть доступны для экспорта во внешнюю систему.
