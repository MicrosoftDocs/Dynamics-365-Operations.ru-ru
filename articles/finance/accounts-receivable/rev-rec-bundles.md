...
Однако напечатанный отчет о подтверждении отобразит только родительскую номенклатуру набора, поскольку этот отчет является внешним документом для клиента.

[![Отчет о подтверждении, отображающий только родительскую номенклатуру](./media/bundle-03.png)](./media/bundle-03.png)
