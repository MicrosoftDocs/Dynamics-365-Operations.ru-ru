...
description: В этой статье описываются функции набора, включенные в функцию признания выручки в модуле "Расчеты с клиентами". В набор входят родительская номенклатура и номенклатуры с несколькими компонентами.
author: bking
ms.date: 01/04/2021
ms.topic: index-page
ms.prod: ''
