...
ms.locfileid: "9780548"
---
# <a name="settle-partial-payment-before-discount-date-with-final-payment-after-discount-date"></a>Настройка частичного платежа до даты скидки с окончательным платежом после даты скидки
...
|-----------|------------------|-----------|---------|--------------------------------------|---------------------------------------|----------|----------|
| FTI-10020 | Накладная          | 25.06.2020 | 10020   | 1,000.00                             |                                       | 1,000.00 | USD      |
...
| Пометка     | Использовать скидку по оплате | Операция   | Учетная запись | Дата      | Срок выполнения  | Счет | Дебетовая сумма в валюте проводки | Валюта | Сумма сопоставления |
|----------|-------------------|-----------|---------|-----------|-----------|---------|--------------------------------------|----------|------------------|
| Выбрано | Обычное округление            | FTI-10020 | 4027    | 25.06.2020 | 25.07.2020 | 10020   | 1,000.00                             | USD      | 297.00           |
...
| Операция    | Тип транзакции | Дата      | Счет | Дебетовая сумма в валюте проводки | Сумма кредита в валюте проводки | Сальдо | Валюта |
|------------|------------------|-----------|---------|--------------------------------------|---------------------------------------|---------|----------|
| FTI-10020  | Накладная          | 25.06.2020 | 10020   | 1,000.00                             |                                       | 700.00  | USD      |
| ARP-10020  |  Платеж         | 01.07.2020  |         |                                      | 297.00                                | 0,00    | USD      |
...
| Пометка     | Использовать скидку по оплате | Операция   | Учетная запись | Дата      | Срок выполнения  | Счет | Дебетовая сумма в валюте проводки | Валюта | Сумма сопоставления |
|----------|-------------------|-----------|---------|-----------|-----------|---------|--------------------------------------|----------|------------------|
| Выбрано | Обычное округление            | FTI-10020 | 4027    | 25.06.2020 | 25.07.2020 | 10020   | 700.00                               | USD      | 700.00           |
...
|----------|-------------------|-----------|---------|-----------|-----------|---------|---------------|---------------------|----------|------------------|
| Выбрано | Всегда            | FTI-10020 | 4027    | 25.06.2020 | 25.07.2020 | 10020   | 700.00        |                        | USD      | 693.00           |
...
Арни изменяет значение в поле **Использовать скидку по оплате** обратно на **Обычная**, потому что Арни не разрешает этому клиенту использовать оставшуюся скидку по оплате в сумме 7,00. После этого Арни разносит платеж. Когда Арни открывает страницу **Проводки по клиенту**, сальдо накладной составляет 0,00. Имеется два платежа. Один платеж — на 297,00 со скидкой по оплате 3,00, другой платеж — на 700,00.

| Операция    | Тип транзакции | Дата      | Счет | Дебетовая сумма в валюте проводки | Сумма кредита в валюте проводки | Сальдо | Валюта |
|------------|------------------|-----------|---------|--------------------------------------|---------------------------------------|---------|----------|
| FTI-10020  | Накладная          | 25.06.2020 | 10020   | 1,000.00                             |                                       | 0,00    | USD      |
