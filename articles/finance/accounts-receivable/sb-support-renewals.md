...
description: В этой статье объясняется, как настроить и использовать процесс поддержки и возобновления для заказов на продажу, чтобы создать график выставления счетов для номенклатур возобновления.
