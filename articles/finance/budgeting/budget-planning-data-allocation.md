...
description: Эта статья описывает методы распределения, доступные в Microsoft Dynamics 365 Finance, и порядок их возможного использования.
author: panolte
ms.date: 03/05/2020
ms.topic: article
ms.prod: ''
