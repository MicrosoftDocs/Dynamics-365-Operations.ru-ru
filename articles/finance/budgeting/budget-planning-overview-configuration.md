...
description: В этой статье описывается планирование бюджета. В нем приводятся сведения, которые могут помочь конфигурации бюджетного планирования и настройке процессов бюджетного планирования.
author: panolte
ms.date: 01/11/2018
ms.topic: overview
ms.prod: ''
