...
description: В этой статье описывается, как создавать шаблоны Microsoft Excel, которые могут использоваться с бюджетными планами.
author: panolte
ms.date: 01/12/2018
ms.topic: article
ms.prod: ''
...
[![Начать добавление столбцов.](./media/bpt8-1024x301.png)](./media/bpt8.png) 
...
[![Отправка шаблона Excel.](./media/bpt10-1024x352.png)](./media/bpt10.png) 
...
[![Просмотр и редактирование документа в Excel.](./media/bpt111-1024x431.png)](./media/bpt111.png)
...
[![Открытие параметров соединителя данных.](./media/bpt13-1024x565.png)](./media/bpt13.png)
...
[![Скрыть параметр конструктора от соединителя данных.](./media/bpt14-1024x592.png)](./media/bpt14.png)
...
[![Включить блокировку.](./media/bpt15-1024x285.png)](./media/bpt15.png) 
