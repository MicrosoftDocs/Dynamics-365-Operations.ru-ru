...
description: В этой статье представлена функция контроля бюджета и представлены сведения, которые помогут выполнить настройку бюджетного контроля для оптимизации управления финансовыми ресурсами организации.
author: panolte
ms.date: 03/28/2022
ms.topic: overview
ms.prod: ''
...
В этой статье представлена функция контроля бюджета и представлены сведения, которые помогут выполнить настройку бюджетного контроля для оптимизации управления финансовыми ресурсами организации.
