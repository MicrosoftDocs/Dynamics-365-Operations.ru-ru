...
Также культура организации согласно отношению к бюджетированию и бюджетному контролю помогает при определении конфигурации.
...
> [!NOTE]
> Если это вычисление изменено во время бюджетного цикла, изменения не повлияют на документы, которые ранее могли пройти проверки бюджетного контроля и были разнесены или завершены. В выпуске приложения 10.0.17 для ограниченных клиентов стала доступна новая функция **Отслеживать суммы только в расчетах доступных бюджетных средств**. Эта функция позволяет изменять данные, отслеживаемые в таблицах BudgetSourceTracking. Если эта функция включена, суммы хранятся только в том случае, если они выбраны для использования в расчетах доступных бюджетных средств. Чтобы запросить включение функции **Отслеживать суммы только в расчетах доступных бюджетных средств**, обратитесь в службу поддержки. 
