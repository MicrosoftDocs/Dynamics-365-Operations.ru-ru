...
description: В этой статье описываются параметры конфигурации для аренды активов, такие как сведения для обеспечения безопасности и параметры учета.
author: moaamer
ms.date: 01/11/2022
ms.topic: article
ms.prod: ''
