...
description: В этой статье описываются типы разноски, которые используются для проводок по аренде активов.
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8889072"
---
# <a name="lease-posting-types"></a>Типы разноски аренды

[!include [banner](../includes/banner.md)]

В этой статье описываются типы разноски, которые используются для проводок по аренде активов.
