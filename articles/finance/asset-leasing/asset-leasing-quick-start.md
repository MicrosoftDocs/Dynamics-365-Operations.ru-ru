...
description: В этой статье описывается функциональная возможность "Аренда активов" и дается описание шагов по созданию аренды актива и просмотру информации об этих арендах.
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
