...
description: В этой статье объясняется, как реверсировать разнесенную проводку по аренде. Любая проводка, созданная через модуль аренды активов, может быть реверсирована.
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
