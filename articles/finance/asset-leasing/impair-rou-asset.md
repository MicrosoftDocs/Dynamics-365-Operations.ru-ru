...
description: В этой статье описываются функции, которые записывают обесценение и корректируют график амортизации активов операционной аренды по теме 842 кодификации стандартов бухгалтерского учета (ASC 842).
author: moaamer
ms.date: 12/03/2021
ms.topic: article
ms.prod: ''
...
Если сумма переноса актива в форме права пользования (ФПП) не может быть восстановлена, возможно, придется проверить, не обесценены ли активы. Если определено, что актив обесценился, модуль аренды активов может записать обесценивание и соответственно скорректировать график амортизации. В этой статье описываются функции, которые записывают обесценение и корректируют график амортизации операционной аренды по теме 842 кодификации стандартов бухгалтерского учета (ASC 842). Этот же метод применим также к арендам по международным стандартам финансовой отчетности 16 (МСФО 16).
