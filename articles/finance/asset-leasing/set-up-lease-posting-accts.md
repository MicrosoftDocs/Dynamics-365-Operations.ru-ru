...
description: В этой статье перечислены счета разноски, которые необходимы для проводок по аренде активов, и объясняется, как определять счета разноски на странице "Параметры разноски аренды".
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8859924"
---
# <a name="set-up-lease-posting-accounts"></a>Настройка счетов разноски аренды

[!include [banner](../includes/banner.md)]

В этой статье перечислены счета разноски, которые необходимы для проводок модуля "Аренда активов", и объясняется, как определять счета разноски на странице **Параметры разноски аренды**.
