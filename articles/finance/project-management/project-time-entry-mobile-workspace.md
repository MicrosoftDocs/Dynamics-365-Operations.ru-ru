...
Если в вашей организации развернута система Finance, системный администратор должен опубликовать мобильную рабочую область **Регистрация времени проекта**. См. инструкции в [Публикация мобильной рабочей области](../../dev-itpro/mobile-apps/publish-mobile-workspace.md).
