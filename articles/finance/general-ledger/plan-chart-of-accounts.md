...
description: Эта статья представляет информацию, которая поможет вам спланировать план счетов для вашей организации.
author: aprilolson
ms.date: 04/02/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9070645"
---
# <a name="plan-your-chart-of-accounts"></a>Планирование плана счетов

[!include [banner](../includes/banner.md)]

Эта статья представляет информацию, которая поможет вам спланировать план счетов для вашей организации.
...
> [!NOTE]
> В Dynamics 365 Finance версии 8.0 (апрель 2018) можно изменить разделитель плана счетов на странице **Параметры главной книги**.
