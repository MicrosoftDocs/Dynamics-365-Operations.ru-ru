...
description: В этой теме представлена информация об определениях разноски, и способах их определения и связывания. Для поддерживаемых типов проводок и документов можно использовать определения разноски вместо профилей разноски для классификации счетов ГК и финансовых аналитик по записям учета.
author: kweekley
ms.date: 09/03/2019
ms.topic: article
ms.prod: ''
...
ms.locfileid: "7726974"
---
# <a name="posting-definitions"></a>Определения разносок

[!include [banner](../includes/banner.md)]

В этой теме представлена информация об определениях разноски, и способах их определения и связывания.
