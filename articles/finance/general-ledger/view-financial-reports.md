...
description: В данной статье описывается, как просмотреть и изучить финансовые отчеты в Microsoft Dynamics 365 Finance. Она содержит сведения о различных параметрах, которые можно применить к финансовым отчетам, чтобы изменить их внешний вид и данные, которые они содержат.
author: kweekley
ms.date: 11/22/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9802400"
---
# <a name="view-financial-reports"></a>Просмотр финансовых отчетов

[!include [banner](../includes/banner.md)]

В данной статье описывается, как просмотреть и изучить финансовые отчеты. Она содержит сведения о различных параметрах, которые можно применить к финансовым отчетам, чтобы изменить их внешний вид и данные, которые они содержат.
...
Чтобы открыть отчет, выберите имя отчета. При открытии отчета в первый раз он автоматически создается за предыдущий месяц. Например, при открытии отчета в первый раз в августе 2020 г. отчет создается за 31 июля 2020 г. После открытия отчета можно начать его изучение, выполнив детализацию до определенных частей данных и изменив параметры отчета.
...
Можно обновить финансовый отчет, чтобы в нем отображались самые актуальные данные на период и год, на которые создан отчет. Например, если обновить финансовый отчет, созданный на октябрь 2020 г., в отчете отобразятся все новые проводки, которые были разнесены в октябре 2020 г. Чтобы обновить финансовый отчет, в области действий нажмите кнопку **Обновить**. Обновленный отчет доступен только пользователю, который обновил его. Чтобы другие пользователи могли просмотреть те же данные, отчет необходимо опубликовать.
...
[Финансовая отчетность](../../fin-ops-core/dev-itpro/analytics/financial-reporting-intro.md)
