...
description: В этой статье описываются наборы финансовых аналитик и даются некоторые советы по оптимизации их использования.
author: yukonpeegs
ms.date: 03/07/2022
ms.topic: article
ems.prod: ''
...
ms.locfileid: "8864291"
---
# <a name="financial-dimension-sets"></a>Наборы финансовых аналитик

[!include [banner](../includes/banner.md)]

В этой статье описываются наборы финансовых аналитик и даются некоторые советы по оптимизации их использования.
