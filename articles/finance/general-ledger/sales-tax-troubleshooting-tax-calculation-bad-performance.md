---
title: Расчет налога влияет на транзакции
description: В этой статье содержатся сведения об устранении неполадок, связанных с производительностью расчета налогов и ее влиянием на проводки.
author: shtao
ms.date: 04/07/2021
ms.topic: article
ms.prod: ''
