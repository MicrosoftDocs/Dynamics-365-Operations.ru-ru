...
| Расходы по закупкам для продукта | 600180 | Поступление материалов | Расход | Кредит | Да | П  | |Используется при разноске накладной заказа на покупку. При использовании стандартных затрат создаются два ваучера для счета для отслеживания расхождений закупочных цен. Корреспондирующий счет для этого счета — это расходы на покупку, счет без выставления накладной, который используется для разноски прихода и который сторнируется во время разноски накладной. Представляет собой себестоимость приобретенных запасов при выставлении накладных, что не отражаются на счете запасов в балансовом отчете. Это разноска прибылей и убытков для отклонения цены покупки, наиболее часто встречающейся покупках по номенклатуре со стандартной себестоимостью.|
