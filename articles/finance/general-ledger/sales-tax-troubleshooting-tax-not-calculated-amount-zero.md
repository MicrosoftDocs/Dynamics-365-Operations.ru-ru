...
description: В этой статье содержатся сведения об устранении неполадок, которые могут помочь, когда сумма налога равна 0 (нулю) или налог не рассчитывается.
author: shtao
ms.date: 04/01/2021
ms.topic: article
ms.prod: ''
