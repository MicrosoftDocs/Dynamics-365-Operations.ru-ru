...
description: В этом разделе описываются отчеты по умолчанию для балансовых отчетов. Здесь также описываются строительные блоки, связанные с этими отчетами.
author: jcart1106
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8734316"
---
# <a name="balance-sheet-financial-reports"></a>Финансовые отчеты по балансовому отчету

[!include [banner](../includes/banner.md)]

В этом разделе описываются отчеты по умолчанию для балансовых отчетов. Здесь также описываются строительные блоки, связанные с этими отчетами. 
