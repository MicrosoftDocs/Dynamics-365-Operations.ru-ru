...
| Поле                                     | описание |
|-------------------------------------------|-------------|
| Тип действия                               | Выберите тип действия. Сведения о доступных параметрах см. в разделе [Типы действий обработки сообщений](#action-types) далее в этой статье. |
