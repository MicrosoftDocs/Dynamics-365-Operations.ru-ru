...
description: В этой статье описываются различные типы финансовых аналитик и поясняется, как они настраиваются.
author: aprilolson
ms.date: 03/07/2022
ms.topic: article
ems.prod: ''
...
ms.locfileid: "9799635"
---
# <a name="financial-dimensions"></a>Финансовые аналитики

[!include [banner](../includes/banner.md)]

В этой статье объясняются различные типы финансовых аналитик и то, как они настраиваются.
...
## <a name="financial-dimension-service"></a>Служба финансовых аналитик

Надстройка Служба финансовых аналитик доступна в среде Microsoft Dynamics Lifecycle Services. Она обеспечивает улучшенную производительность при использовании структуры управления данными для импорта журнала с большим количеством строк. Чтобы использовать эту службу, необходимо включить ее на странице **Параметры службы финансовой аналитики**. В настоящее время служба функционирует только в импортированных журналах с 500 или более строками. Кроме того, в настоящее время она может обрабатывать только общие журналы, для которых в строках журнала установлен тип счета **ГК**. Другие типы счетов в строках журнала, такие как **Клиент**, **Поставщик** и **Банк**, в настоящее время не поддерживаются. Эта служба не будет вызываться, когда производные аналитики настраиваются в системе.

Служба финансовой аналитики обеспечивает улучшенную производительность при импорте журналов с помощью новой службы, которая работает параллельно с импортом данных. Она запускается только для счета ГК и данных финансовой аналитики в журнале и создает комбинации аналитик, указанные в поле строки счета ГК в строках журнала. В ходе обработки эта строка преобразуется в средство хранения структурированных данных, которое используется в среде финансовой аналитики в остальных разделах продукта для проверки, суммарной отчетности и запросов. Дополнительные сведения о сводных отчетах по данным финансовой аналитики см. в разделе [Наборы финансовых аналитик](financial-dimension-sets.md).
