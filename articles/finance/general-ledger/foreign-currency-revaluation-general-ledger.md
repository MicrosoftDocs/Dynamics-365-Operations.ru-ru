...
description: 'В этой статье содержится обзор следующих действий для процесса переоценки ГК в иностранной валюте: настройка, выполнение процесса, расчет для процесса и порядок реверсирования проводок переоценки при необходимости.'
author: kweekley
ms.date: 11/15/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9779997"
---
# <a name="foreign-currency-revaluation-for-general-ledger"></a>переоценка в иностранной валюте для главной книги

[!include [banner](../includes/banner.md)]

В этой статье содержится обзор следующих действий для процесса переоценки ГК в иностранной валюте: настройка, выполнение процесса, расчет для процесса и порядок реверсирования проводок переоценки при необходимости. 
...
Если требуется исключить корректировки, которые были разнесены с помощью **журнала корректировки в валюте отчетности** из процесса переоценки, установите для параметра **Исключить корректировки валюты отчетности** значение **Да**. По умолчанию корректировки в валюте отчетности включаются в переоценку. 
