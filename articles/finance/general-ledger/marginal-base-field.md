...
description: В этой статье объясняется, как значения в полях "База маржинальной прибыли" и "Метод расчета" определяют ставку(-ки) налога в проводках продажи и покупки.
author: kailiang
ms.date: 10/24/2022
ms.topic: article
ms.prod: ''
...
В этой статье объясняется, как значения в полях "База маржинальной прибыли" и "Метод расчета" определяют ставку(-ки) налога в проводках продажи и покупки.
