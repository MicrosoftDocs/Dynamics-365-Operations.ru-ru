---
title: Налог разносится на некорректный счет ГК в операции
description: В этой статье содержатся сведения об устранении неполадок, которые могут помочь при разноске налога на неправильный счет ГК в ваучере.
author: qire
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
...
Во время разноски налог может быть разнесен на неправильный счет ГК в ваучере. Для решения проблемы выполните действия, указанные в следующих разделах. В примерах этой статье в качестве бизнес-документа используется заказ на продажу.
