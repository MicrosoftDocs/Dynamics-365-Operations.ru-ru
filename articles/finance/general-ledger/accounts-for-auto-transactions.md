...
description: В этой статье объясняется, как счета для автоматических проводок используются для разноски в Microsoft Dynamics 365, и приводятся примеры для ключевых счетов для автоматических проводок.
