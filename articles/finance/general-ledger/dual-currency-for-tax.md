...
description: В этой статье объясняется, как расширить возможности учета в двух валютах в налоговом домене и как это повлияет на расчет и разноску налога.
author: EricWang
ms.date: 12/11/2020
ms.topic: article
ms.prod: ''
