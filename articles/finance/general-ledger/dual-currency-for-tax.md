...
- Преобразование налога (версия релиза 10.0.9)
- Автосальдо сопоставления налога в валюте отчетности (версия релиза 10.0.11)
...
Новые функции в настоящее время включены для клиентов частной предварительной версии. Чтобы включить эти функции, создайте запрос на обслуживание через соответствующие каналы в корпорацию Майкрософт.
