...
В Microsoft Dynamics 365 Finance версии 10.0.21 параметр **Включение расширенных сопоставлений ГК** был удален со страницы **Параметры главной книги**. Расширенное сопоставление ГК всегда включено.
