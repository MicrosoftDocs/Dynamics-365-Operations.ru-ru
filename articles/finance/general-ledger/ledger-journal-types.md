...
description: В этой статье описываются типы журналов, которые можно настроить для финансовых журналов.
author: kweekley
ms.date: 10/10/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8901323"
---
# <a name="ledger-journal-types"></a>Типы журналов ГК

[!include [banner](../includes/banner.md)]

В этой статье описываются типы журналов, которые можно настроить для финансовых журналов. Используйте страницу **Наименования журналов** для настройки журналов, применяемых в Dynamics 365 Finance.
...
| Проект - Расходы                | Создание проводок расходов по проекту.                                                                                                                                                                                                                                                                                                                        | Expense                                                        |
| Корректировка в валюте отчетности     | Создание корректировок в валюте отчетности для сальдо по счетам главной книги.               | Журналы корректировки в валюте отчетности                         |
