...
description: В этой статье объясняется, как настроить внутрихолдинговый учет, чтобы можно было использовать внутрихолдинговые журналы для распределений ГК и финансовые журналы, например ежедневные журналы, журналы накладных поставщиков и журналы платежей.
author: kweekley
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8871227"
---
# <a name="intercompany-accounting-setup"></a>Настройка внутрихолдинговой отчетности

[!include [banner](../includes/banner.md)]

В этой статье объясняется, как настроить внутрихолдинговый учет, чтобы можно было использовать внутрихолдинговые журналы для распределений ГК и финансовые журналы, например ежедневные журналы, журналы накладных поставщиков и журналы платежей.
