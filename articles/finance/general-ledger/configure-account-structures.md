...
Критерий: когда счет ГК находится между 400000 и 499999, добавьте клиента. Он не может быть пустым.
...
## <a name="more-than-seven-criteria-needed"></a>Требуется более семи критериев

При наличии более семи критериев, которые требуются, можно продолжить добавлять их на следующей строке. Можно заметить при работе в разделе **Подробные сведения о допустимых значениях**, что критерий **+ добавить новую** более не активен после ввода седьмого критерия. Это обусловлено многими факторами, такие как: 
 - Ширина столбца 
 - Как хранятся данные 
...
> [!NOTE]
> Обновление с Microsoft Dynamics AX 2012, где указано более семи критериев, не поддерживается. Это должно быть исправлено до завершения обновления на приложения для управления финансами и операциями. 
...
Когда вы удовлетворены новой настройкой или изменением структуры счета, необходимо активировать ее. Если структура счета назначена книге учета, эта активация может быть длительным процессом, поскольку все неразнесенные транзакции в системе должны быть синхронизирована с новой структурой. Разнесенные транзакции не влияют на изменения структуры счета. По сравнению с версией приложения 10.0.31 новая функция, которая называется **Улучшение процесса активации структуры счета**, доступна в разделе управления функциями. Дополнительные сведения об этой новой функции для активации структуры счетов см. в разделе [Улучшение процесса активации структуры счета](account-structure-improvement.md). 

Дополнительные сведения см. в разделах [Планирование плана счетов](plan-chart-of-accounts.md), [Финансовые аналитики](financial-dimensions.md) и [Ввод счета и комбинаций аналитик (элемент управления сегментированным вводом)](enter-account-dimension-combinations-segmented-entry-control.md).
