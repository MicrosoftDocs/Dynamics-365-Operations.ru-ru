...
> [!NOTE] 
> При запуске отчета **Пробный баланс** в финансовой отчетности убедитесь, что установлены флажки **Отображать строки без сумм** и **Отображать отчеты без активных строк** на вкладке **Параметры**.
...
2.  Убедитесь, что **Счет ГК** содержит все амперсанды (&), и после этого щелкните **ОК**.
