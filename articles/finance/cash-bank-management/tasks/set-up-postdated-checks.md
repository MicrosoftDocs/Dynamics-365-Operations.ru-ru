...
description: В этой статье объясняется, как указать, нужно ли разносить записи журнала для чеков, датированных будущим числом, и какие журналы разноски использовать для клиринговых записей и платежей поставщикам.
author: kweekley
ms.date: 11/15/2022
...
7. В поле **Общий журнал для записей клиринга** введите значение.
