...
description: В этой процедуре демонстрируются различные методы создания платежей поставщикам, в том числе с использованием предложения по оплате и путем ввода разового платежа.
author: kweekley
ms.date: 06/25/2019
...
ms.locfileid: "7394446"
---
# <a name="vendor-payment-overview"></a>Обзор платежей поставщикам

[!include [banner](../../includes/banner.md)]

В этой процедуре демонстрируются различные методы создания платежей поставщикам, в том числе с использованием предложения по оплате и путем ввода разового платежа. В данной процедуре используется демонстрационная компания USMF.
