...
12. В поле **Дата поставки** введите дату.
    * Примечание. В поле **Тип банковского документа** должно быть значение **Аккредитив**.  
13. Щелкните **OK**.
...
22. В области операций щелкните **Управлять**.
...
37. В области операций щелкните **Управлять**.
...
46. В области операций щелкните **Управлять**.
...
3. В списке перейдите по ссылке в выбранной строке.
    ...
    * Проверка: **Статус отгрузки** = **Выставлен счет** Сведения о банковской услуге  
4. Щелкните **Вид**.
