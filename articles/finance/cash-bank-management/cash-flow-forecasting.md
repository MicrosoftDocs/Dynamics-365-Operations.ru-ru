...
Новая вкладка на странице **Настройка прогнозирования движения денежных средств** позволяет управлять финансовыми аналитиками, которые используются для фильтрации в рабочей области **Прогнозирование движения денежных средств**. Эта вкладка отображается только в том случае, если в Finance Insights включена функция прогнозов движения денежных средств. 
