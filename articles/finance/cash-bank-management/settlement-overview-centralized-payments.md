...
description: В этой статье описывается сопоставление для централизованных платежей для Microsoft Dynamics 365 Finance.
author: angelad116
ms.date: 08/02/2018
ms.topic: overview
ms.prod: ''
...
## <a name="posting-types-transaction-types-and-default-descriptions"></a>Типы разноски, типы проводок и описание по умолчанию
