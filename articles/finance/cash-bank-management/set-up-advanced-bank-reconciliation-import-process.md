...
> [!NOTE]
> Эта функция станет устаревшей в сентябре 2022 года, новые пользователи должны использовать электронную отчетность. Дополнительные сведения см. в разделе [Настройка процесса импорта расширенной банковской выверки с помощью электронной отчетности](../accounts-payable/import-bai2-er.md).
