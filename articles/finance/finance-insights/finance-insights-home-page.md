...
Необходимо выполнить некоторые шаги настройки, прежде чем можно будет использовать финансовый анализ. Дополнительные сведения о настройке Finance Insights см. в разделе:
  - Для версий до 10.0.19: [Конфигурация для Finance Insights — версии до 10.0.19](configure-for-fin-insites.md).
