...
Предварительная версия Finance Insights доступна для пробных развертываний в США, Европе и Соединенном Королевстве. Корпорация Майкрософт последовательно добавляет поддержку дополнительных регионов.
...
Для использования предварительной версии Finance Insights требуется среда "песочницы" уровня 2 (несколько ящиков). Фоновые сведения о средах см. в разделе [Планирование среды](../../fin-ops-core/fin-ops/imp-lifecycle/environment-planning.md).
