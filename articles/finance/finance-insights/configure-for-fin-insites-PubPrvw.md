...
1. В Microsoft Dynamics Lifecycle Services (LCS) создайте или обновите среду Finance. Среде требуется приложение версии 10.0.20 или более поздней для приложений для финансов и операций.
...
1. Создайте учетную запись хранения:
    ...
    3. В диалоговом окне **Дополнительные параметры** для параметра **Data Lake storage Gen2** выберите **Включить** в функции **Иерархические пространства имен**. Если эта функция не включена, вы не сможете потреблять данные, которые приложения для финансов и операций записывают с помощью таких служб, как потоки данных Power BI.
