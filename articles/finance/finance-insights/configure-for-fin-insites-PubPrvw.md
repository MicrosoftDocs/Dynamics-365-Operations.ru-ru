...
description: В этой теме объясняется, как настроить систему для использования возможностей, доступных в Finance Insights версии 10.0.20 или более поздней.
