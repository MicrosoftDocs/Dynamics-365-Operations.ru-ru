...
---
# <a name="results-of-machine-learning-models-preview"></a>Результаты моделей машинного обучения (предварительная версия)
...
[![Пример предсказания вида](./media/species-prediction-matrix.png)](./media/species-prediction-matrix.png)
...
[![Модель 1](./media/payment-prediction-matrix.png)](payment-prediction-matrix.png) Модель 1
...
[![Пример прогноза платежей с большим образцом](./media/payment-prediction-matrix-2.png)](payment-prediction-matrix-2.png)
...
Раздел [Точность модели](#classify-machine-learning-accuracy) данной темы сравнивает следующие две матрицы ошибок. Даже несмотря на то, что первая модель имела меньшую точность, она была признана более полезной моделью, поскольку она показала более значительное улучшение по сравнению с предположением по умолчанию для времени оплаты.

[![Пример прогнозирования платежей и фактических данных](./media/payment-prediction-matrix.png)](payment-prediction-matrix.png)
