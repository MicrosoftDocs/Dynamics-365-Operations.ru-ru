...
description: В этой статье описывается возможность прогнозирования платежей, которая может помочь лучше понять типичные практики платежей клиентов. Эта функция также позволяет определить обстоятельства, которые могут вынудить вас начать процессы сбора задолженностей раньше, чем вы бы их начали в ином случае.
...
ms.locfileid: "8903170"
---
# <a name="customer-payment-predictions"></a>Прогнозы платежей клиентов

[!include [banner](../includes/banner.md)]

В этой статье описывается возможность прогнозирования платежей, которая может помочь лучше понять типичные практики платежей клиентов. Эта функция также позволяет определить обстоятельства, которые могут вынудить вас начать процессы сбора задолженностей раньше, чем вы бы их начали в ином случае.
