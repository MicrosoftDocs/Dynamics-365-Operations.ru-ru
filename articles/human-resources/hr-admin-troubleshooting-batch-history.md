...
description: В этой статье объясняется, как улучшить производительность в Microsoft Dynamics 365 Human Resources, выполнив очистку журнала пакетных заданий.
author: twheeloc
ms.date: 08/21/2021
ms.topic: article
ms.prod: ''
