...
description: В этой статье описываются новые или измененные функции в Microsoft Dynamics 365 Human Resources от 26 сентября 2020 года.
author: jcart1106
ms.date: 09/26/2020
ms.topic: article
ms.prod: ''
...
- **Доступно обновление платформы 10.0.13**: дополнительные сведения об обновлении см. в разделе [Обновления платформы для версии 10.0.13 приложений для управления финансами и операциями (октябрь 2020)](../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-13.md).
