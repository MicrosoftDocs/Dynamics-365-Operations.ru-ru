...
description: В этой статье перечислены системные требования для Microsoft Dynamics 365 Human Resources.
author: twheeloc
ms.date: 08/11/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8879347"
---
# <a name="system-requirements"></a>Требования к системе

[!include [Applies to Human Resources](../includes/applies-to-hr.md)]

В этой статье перечислены системные требования для Microsoft Dynamics 365 Human Resources. Кроме того, в ней описываются страны и регионы, в которых доступно Human Resources, а также сведения о языках и локализации для данных Human Resources.
