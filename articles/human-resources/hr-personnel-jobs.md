...
## <a name="job-family"></a>Группа должностей
Семейство должностей — это группа заданий, включающая аналогичные работы, которые требуют аналогичных обучения, навыков, знаний и опыта. Семейство должностей можно связать с должностью на экспресс-вкладке **Классификация заданий** на странице **Задания** и на экспресс-вкладке **Общие** на странице **Все должности**. Семейства должностей могут быть широкими или специальными в зависимости от требований предприятия и отчетности. Примерами широкого семейства должностей являются **Квалифицированные трудовые ресурсы** и **Неквалифицированные трудовые ресурсы**. Примерами специальных семейств должностей являются **Бухгалтерский учет**, **Производство** и **Продажи**.

Для ведения семейств должностей служит страница **Семейство должностей**, которую можно открыть с помощью функции поиска. На странице **Семейство должностей** введите уникальное название семейства и введите подробное описание, которое планируется использовать для ваших должностей.
...
Чтобы назначить план фиксированной компенсации сотруднику с должностью в задании, необходимо задать уровни компенсаций для данного задания. **Уровень компенсации** используется, когда минимальные, средние и максимальные суммы устанавливаются в структуре компенсаций (сетка компенсации). При создании плана фиксированной компенсации выбирается структура компенсаций. Структура компенсаций также включает уровень компенсации. При выборе плана фиксированной компенсации для сотрудника уровни компенсаций, доступные для выбора, зависят от задания, с которым связана должность сотрудника. Дополнительные сведения о настройке компенсации см. в разделе [Планы компенсационных выплат](hr-compensation-overview.md).

## <a name="job-skills"></a>Навыки должности
Навыки должности описывают навыки, необходимые для выполнения задания. Уровень навыков должен быть связан с каждым навыком должности. Уровни навыков определяются пользователем. Они указывают уровень знаний или квалификацию, требуемый для данного навыка. Например, компании могут настроить числовые уровни, такие как 1-5, где **1** означает начинающих и **5** обозначает экспертов. Кроме того, компании могут настроить уровни с метками **Начинающий**, **Средний уровень** или **Эксперт**. После настройки уровня навыков можно также настроить важность навыка. Например, если бухгалтеру требуется надежный набор знаний Microsoft Excel, можно создать навык, названный **Знания Excel**. Уровень навыка можно установить в значение **Промежуточный**, а значение важности можно настроить равным **Больше всего**.

Навыки, которые находятся в должности, могут использоваться при подборе персонала. Подбор персонала позволяет сравнить набор навыков, который необходим для должности, и навыков, связанных с работником. Затем он может определить процентное соответствие на основе неперекрывающихся навыков. Дополнительные сведения о подборе персонала см. в разделе [Настройка навыков](hr-develop-skills.md). 
