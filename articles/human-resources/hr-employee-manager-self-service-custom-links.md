...
Чтобы использовать эту функцию, включите **Пользовательские ссылке на портале самообслуживания менеджеров** в рабочей области **Управление функциями**. Дополнительные сведения о включении предварительных версий функций см. в разделе [Управление функциями](hr-admin-manage-features.md).
