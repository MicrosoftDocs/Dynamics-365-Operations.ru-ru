...
description: В этой статье описывается сущность "Образование в запросе по набору сотрудников" для Dynamics 365 Human Resources.
author: jaredha
ms.date: 02/05/2021
ms.topic: article
ms.prod: ''
...
В этой статье описывается сущность "Образование в запросе по набору сотрудников" для Dynamics 365 Human Resources.
