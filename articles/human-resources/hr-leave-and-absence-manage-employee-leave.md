...
## <a name="adjust-leave-balances"></a>Корректировка сальдо отпусков

1. В записи сотрудника выберите **Отпуск**.

2. Выберите **Настройка отпусков и отсутствия**.

3. Выберите **Корректировка сальдо**.

4. Выберите **Тип отпуска**.

5. Введите значение **Сумма корректировки**. 
