...
description: В этой статье описываются новые и измененные компоненты Microsoft Dynamics 365 Human Resources от 20 мая 2021 года.
author: marcelbf
ms.date: 05/20/2021
ms.topic: article
ms.prod: ''
...
| --- | --- | --- |
| Обновление платформы 10.0.18 (42) | -- | [Обновления платформы для версии 10.0.18 приложений для управления финансами и операциями (май 2021)](/dynamics365/fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-18) |
