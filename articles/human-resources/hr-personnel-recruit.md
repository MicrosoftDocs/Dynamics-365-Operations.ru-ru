...
description: В этой теме описывается, как нанимать кандидатов в Dynamics 365 Human Resources.
author: twheeloc
ms.date: 10/28/2021
ms.topic: article
ms.prod: ''
...
2. На вкладке  **Набор сотрудников**  задайте для поля **Набор сотрудников отключен** значение **Нет**.
3. В раскрывающемся списке **Интерфейс набора сотрудников** выберите **Набор сотрудников HR**.   

> [!Note] 
> После того, как выбран параметр **Набор сотрудников**, параметр **Проект по набору сотрудников** (устарело) будет доступен только для чтения. 
