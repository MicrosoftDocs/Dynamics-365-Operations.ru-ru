...
description: В этой статье представлен список разделов справки и другие ресурсы для настройки, управления и устранения неполадок в Dynamics 365 Human Resources.
author: twheeloc
ms.date: 08/11/2021
ms.topic: overview
ms.prod: ''
...
В этой статье представлен список разделов справки и другие ресурсы для настройки, управления и устранения неполадок в Dynamics 365 Human Resources.
...
- Устранение неполадок Human Resources
  - [Получение поддержки](../fin-ops-core/dev-itpro/lifecycle-services/lcs-support.md)
...
Перечень интерактивных курсов и обучения см. в разделе [Схемы обучения Dynamics 365 Human Resources](/training/browse/?products=dynamics-human-resources&resource_type=learning%20path).
