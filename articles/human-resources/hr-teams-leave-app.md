...
После запуска запроса на отпуск вы можете скорректировать дни в пределах карточки или выбрать параметр **Изменить сведения**, чтобы добавить дополнительные сведения о запросе.

![Изменить запрос для приложения отпусков Human Resources Teams](./media/hr-teams-leave-app-bot-edit.png)
 
По завершении ввода данных введите **Отправить**, чтобы отправить его на утверждение. Можно также ввести **Сохранить как черновик**, чтобы вернуться к нему позже.
