...
description: В этой статье представлены сведения и пример запроса для сущности "Сальдо отпуска" в Dynamics 365 Human Resources.
author: marcelbf
ms.date: 06/25/2021
ms.topic: article
ms.prod: ''
...
В этой статье описывается сущность "Сальдо отпуска" для Dynamics 365 Human Resources.
