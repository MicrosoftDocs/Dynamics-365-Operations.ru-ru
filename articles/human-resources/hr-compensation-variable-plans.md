...
description: Этот раздел описывает компоненты, которые необходимо настроить перед использованием переменной компенсации и регистрации сотрудника на план с переменной компенсацией.
author: twheeloc
ms.date: 08/24/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "7484176"
---
# <a name="create-variable-compensation-plans"></a>Создание планов переменных компенсаций

[!include [Applies to Human Resources](../includes/applies-to-hr.md)]

Переменная компенсация составляет нерегулярную заработную плату сотрудника, такую как как премии или вознаграждений акциями. В этой теме объясняется, как настроить компоненты, которые необходимы для переменной компенсации и регистрации сотрудника на план с переменной компенсацией.
