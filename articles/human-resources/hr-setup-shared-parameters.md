...
description: В этой теме описывается, как настроить параметры модуля "Управление персоналом" в разных юридических лицах.
author: twheeloc
ms.date: 10/28/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "7729107"
---
# <a name="configure-shared-parameters"></a>Настройка общих параметров

[!include [Applies to Human Resources](../includes/applies-to-hr.md)]

Необходимо настроить общие параметры для записей, которые используются совместно несколькими компаниями, например записи **Должность**. В этой теме описывается, как настроить параметры модуля "Управление персоналом" в разных юридических лицах.
