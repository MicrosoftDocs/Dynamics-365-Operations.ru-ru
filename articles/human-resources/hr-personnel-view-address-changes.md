...
description: В этой статье объясняется, как просматривать изменения в адресах и управлять ими в Dynamics 365 Human Resources.
author: twheeloc
ms.date: 10/28/2021
ms.topic: article
ms.prod: ''
...
В этой статье объясняется, как просматривать изменения в адресах и управлять ими на странице **Изменить личные данные** (которая открывается из рабочей области **Дистанционное обслуживание**) или на странице сведений **Работник** в Dynamics 365 Human Resources.
