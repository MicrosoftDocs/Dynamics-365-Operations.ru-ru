...
description: В этой статье объясняется, как разрешать проблемы с производительностью в Microsoft Dynamics 365 Human Resources путем планирования длительных пакетных заданий на нерабочие часы.
author: twheeloc
ms.date: 06/23/2020
ms.topic: article
ms.prod: ''
