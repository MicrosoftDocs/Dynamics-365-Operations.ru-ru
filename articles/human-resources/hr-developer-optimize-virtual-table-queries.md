...
- **Превышено время ожидания запроса**: возможно превышение времени ожидания запроса и возвращена следующая ошибка: "Получен маркер для вызова Финансы и операции, но Финансы и операции вернул ошибку типа InternalServerError".
...
- **Регулирование количества запросов**: запрос может чрезмерно использовать ресурсы сервера и быть подвергнутым регулировке. В этом случае запрос возвращает следующую ошибку: "Получен маркер для вызова Финансы и операции, но Финансы и операции вернул ошибку типа 429". Дополнительные сведения о регулировании в Human Resources см. в [Регулирование количества вопросов и ответов. Вопросы и ответы](./hr-admin-integration-throttling-faq.md).
