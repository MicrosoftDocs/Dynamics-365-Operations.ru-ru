...
description: В этой статье описывается концептуальная информация о подразделениях, должностях и позициях, которые являются организационными элементами, которые поддерживаются в модуле "Управление персоналом".
author: twheeloc
ms.date: 01/03/2022
ms.topic: article
ms.prod: ''
...
Подразделения, задания и должности — организационные элементы, которые поддерживаются в модуле « управление персоналом «. Эта статья содержит общие сведения об этих элементах. 
...
| Задание           | Задача задания                                                |
|---------------|-------------------------------------------------------------|
| Менеджер по продажам | Обзор производительности – обзор производительности задания каждого продавца.    |
| Бухгалтер    | Обзор отсутствия – утверждение или отклонение запросов или регистраций отсутствий каждого продавца. |
