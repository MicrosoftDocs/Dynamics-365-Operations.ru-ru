...
description: В этой статье описываются новые или измененные функции в Microsoft Dynamics 365 Human Resources от 26 июля 2021 года.
author: marcelbf
ms.date: 07/12/2021
ms.topic: article
ms.prod: ''
...
| --- | --- | --- |
| Обновление платформы update 10.0.20 | -- | [Обновления платформы для версии 10.0.20 приложений для управления финансами и операциями (август 2021)](/dynamics365/fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-20) |
