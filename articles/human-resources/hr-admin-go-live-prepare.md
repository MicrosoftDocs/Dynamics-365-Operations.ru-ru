...
Основной вехой в каждом из проектов реализации является переключение на производственную среду. 

Чтобы гарантировать, что производственная среда используется для эксплуатационных операций, корпорация Майкрософт подготавливает производственный экземпляр только в том случае, когда реализация приближается к стадии **Эксплуатация**, после завершения выполнения необходимых действий в методологии LCS. Дополнительные сведения о средах в подписке см. в  [руководстве по лицензированию Dynamics 365](https://go.microsoft.com/fwlink/?LinkId=866544). 

Клиенты должны выполнить этапы **Анализ**, **Проектирование и разработка** и **Тест** в методологии LCS, прежде чем кнопка **Настроить** для подачи запроса на производственную среду станет доступна. Чтобы выполнить этап в LCS, необходимо сначала выполнить все необходимые шаги на этом этапе. После завершения всех шагов этапа можно завершить весь этап. Можно всегда повторно открыть этап позже, если необходимо внести изменения. Дополнительные сведения см. в разделе  [Lifecycle Services (LCS) для клиентов приложений Finance and Operations](https://docs.microsoft.com/dynamics365/fin-ops-core/dev-itpro/lifecycle-services/lcs-works-lcs). 

Процесс выполнения шага состоит из двух частей: 
...
Рекомендуется выполнить шаги в методологии по мере выполнения реализации. Не дожидайтесь последней минуты. Не просто нажимайте все шаги, чтобы можно было получить производственную среду. Это в интересах клиента, чтобы получить хорошую реализацию. 
