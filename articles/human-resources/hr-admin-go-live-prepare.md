...
В этой статье описывается, как подготовиться к вводу в эксплуатацию проекта Dynamics 365 Human Resources, используя Microsoft Dynamics Lifecycle Services (LCS). 
