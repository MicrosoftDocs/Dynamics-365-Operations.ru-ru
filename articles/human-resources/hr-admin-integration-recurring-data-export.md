...
2. В конструкторе Logic Apps начнем с чистого приложения логики.
...
На следующем рисунке показано, как будет выглядеть конструктор Logic Apps, когда все этапы приложения логики выполняются успешно.
