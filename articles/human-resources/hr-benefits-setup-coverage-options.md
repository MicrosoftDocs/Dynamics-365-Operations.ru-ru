...
description: В этой статье объясняются параметры покрытия в Microsoft Dynamics 365 Human Resources для выборов участника в плане или программе льгот.
author: twheeloc
ms.date: 08/24/2021
ms.topic: article
ms.prod: ''
