...
В этой статье содержатся ответы на часто задаваемые вопросы об объединении инфраструктуры для Microsoft Dynamics 365 Human Resources и приложений для управления финансами и операциями.
