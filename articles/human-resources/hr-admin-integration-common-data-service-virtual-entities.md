...
description: В этой статье показано, как настроить, создать и обновить существующие виртуальные таблицы, а также проанализировать созданные и доступные таблицы для Dynamics 365 Human Resources.
author: twheeloc
ms.date: 08/19/2021
ms.topic: article
ms.prod: ''
...
5. На странице **Расширенный поиск** в раскрывающемся списке **Найти** выберите **Конфигурации виртуальных источников данных для управления финансами и операциями**.

   > [!NOTE]
   > Установка приложения виртуальной таблицы с предыдущего шага установки может занять несколько минут. Если **Конфигурации виртуальных источников данных для управления финансами и операциями** недоступны в списке, подождите минуту и обновите список.
