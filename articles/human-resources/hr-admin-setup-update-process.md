...
- **Обновления служб**: обновления выполняются через каждые две недели, которые включают исправления ошибок и новые возможности. Обновления службы также включают применимые обновления платформы при их выпуске. Дополнительные сведения о выпусках платформы см. в разделе [Что нового и что изменилось в обновлениях платформы](../fin-ops-core/dev-itpro/get-started/whats-new-home-page.md). Обновления имеют поэтапное глобальное развертывание по регионам. Дополнительные сведения об обновлениях см. в разделе [Что нового и что изменилось в Dynamics 365 Human Resources](hr-admin-whats-new.md).
