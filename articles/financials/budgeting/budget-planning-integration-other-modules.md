...
[!include[banner](../includes/banner.md)] Бюджетные планы можно создавать из нескольких разных ресурсов. Базовые элементы периодического процесса одинаковы для всех ресурсов. 
