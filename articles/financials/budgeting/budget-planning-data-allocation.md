...
Эта статья описывает различные методы распределения, доступные в Microsoft Dynamics 365 for Finance and Operations, Enterprise edition , и порядок их возможного использования.  
