...
Для наиболее точного бюджетного планирования можно создавать прогнозируемые должности, используя сведения из существующих должностей Microsoft Dynamics 365 for Finance and Operations независимо от того, занята должность в настоящий момент или нет. 
