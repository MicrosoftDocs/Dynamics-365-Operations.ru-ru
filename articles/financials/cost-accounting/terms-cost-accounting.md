...
-  Dynamics 365 for Finance and Operations (уже настроенный)
...
|  **Источники данных** |  **Соединитель данных "Импортированные проводки"** | **Соединитель данных Dynamics 365 for Finance and Operations**  | **Соединитель данных Dynamics AX**  |
|---|---|---|---|
