...
-  Dynamics 365 for Finance and Operations, Enterprise Edition (уже настроенный)
...
|  **Источники данных** |  **Соединитель данных "Импортированные проводки"** | **Соединитель данных Dynamics 365 for Finance and Operations, Enterprise Edition**  | **Соединитель данных Dynamics AX**  |
|---|---|---|---|
