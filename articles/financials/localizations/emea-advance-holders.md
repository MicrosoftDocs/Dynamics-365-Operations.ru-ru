...
Перед создания подотчетного лица у вас уже должны быть настроены работники. Дополнительные сведения см. в разделе [Ввод сведений о работнике (руководство по задаче).](../../fin-and-ops/hr/tasks/enter-worker-information.md) Используйте страницу **Подотчетные лица**, чтобы настроить работника как подотчетное лицо. Выберите работника для использования в качестве подотчетного лица, щелкните **Изменить**, затем задайте для параметра **Подотчетное лицо** значение **True**. Кроме того, необходимо заполнить следующие поля.
|                |                                                                                             |
|----------------|---------------------------------------------------------------------------------------------|
| **Поле**      | **Описание**                                                                             |
