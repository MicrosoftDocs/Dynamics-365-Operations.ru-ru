...
| Ограничен         | Вид ограничения, используемый для типа налоговой регистрации: нет, лицо, организация.|
| Категория регистрации | Уникальный код регистрации, утвержденный для использования в стране. Ниже приведен полный список категорий, поддерживаемых в Microsoft Dynamics 365 for Finance and Operations. |
