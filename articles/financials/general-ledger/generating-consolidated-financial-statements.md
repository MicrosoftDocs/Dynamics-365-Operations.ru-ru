...
![Определение многоуровневой аналитической структуры со свертками по регионам](./media/multilevel-reporting-tree-definition-roll-ups%20-worldwide-region.png "Определение многоуровневой аналитической структуры со свертками по регионам")
...
![Определение многоуровневой аналитической структуры со свертками по функциональным подразделениям](./media/multilevel-reporting-tree-definition-roll-ups%20-by-function.png "Определение многоуровневой аналитической структуры со свертками по функциональным подразделениям")
...
![Использование процента в определении аналитической структуры](./media/Using-reporting%20tree-definition-percentage.png "Использование процента в определении аналитической структуры")
...
![Задание настроек отчета](./media/reporting-setting-options.png "Задание настроек отчета")
...
![Счета ГК модуля "Финансовая отчетность"](./media/Financial-reporting-main-accounts.png "Счета ГК модуля \"Финансовая отчетность\"")
