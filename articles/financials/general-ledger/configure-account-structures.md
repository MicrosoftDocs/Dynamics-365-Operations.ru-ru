...
Раздел **Сегменты** и **Подробные сведения о допустимых значениях** обеспечивают рабочую сетку для ввода правил, которые будут выполняться при проверке во время разноски. Можно ввести непосредственно в ячейки в сетке, импортировать из Microsoft Excel, или использовать раздел **Подробные сведения о допустимых значениях**.
...
При наличии более 7 критерии, которые требуются, можно продолжить добавлять их на следующей строке. Можно заметить при работе в разделе **Подробные сведения о допустимых значениях**, что критерий **+ добавить новую** более не активен после ввода седьмого критериев. Это обусловлено многими факторами, такие как: 
 - Ширина столбца 
 - Как хранятся данные 
...
(ССЫЛКА НА ВИДЕО, КОТОРЫЙ БУДЕТ СОЗДАН)
