...
Чтобы создать определяемую пользователем финансовую аналитику, в поле **Использовать значения из** выберите **&lt;&nbsp;Настраиваемая аналитика&nbsp;&gt;**.
...
- Объект DerivedDimensionValue позволяет импортировать значения, которые должны выступать в качестве производных для каждой ведущей аналитики.
