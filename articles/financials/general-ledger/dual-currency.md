...
Функциональные возможности, введенные в Microsoft Dynamics 365 for Finance and Operations версии 10.0.5 (Октябрь 2019), обеспечивают функции через управление функциями для расширенной гибкости при консолидации и учете в двух валютах. Чтобы включить эту функцию, перейдите в рабочую область **Управление функциями** и выберите **Включить функцию учета в двух валютах в консолидации главной книги**.
