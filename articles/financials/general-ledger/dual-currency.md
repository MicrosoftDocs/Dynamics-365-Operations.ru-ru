...
Кроме того улучшены различные модули для отслеживания, отчетности и использования валюты отчетности в различных процессах. Затронуты следующие модули: **Главная книга**, **Финансовая отчетность**, **Расчеты с поставщиками**, **Расчеты с клиентами**, **Управление банком и кассовыми операциями** и **Основные средства**. После обновления необходимо выполнить определенные шаги для управления банком и кассовыми операциями и основными средствами. Таким образом, не забудьте внимательно прочитать соответствующие пункты в этом разделе.
...
- [Расчеты с поставщиками](#accounts-payable/accounts-receivable)
- [Расчеты с клиентами](#accounts-payable/accounts-receivable)
...
### <a name="accounts-payableaccounts-receivable"></a>Расчеты с клиентами и расчеты с поставщиками
