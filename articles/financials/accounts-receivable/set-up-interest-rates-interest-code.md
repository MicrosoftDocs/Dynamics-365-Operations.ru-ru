...
- Значение <strong>Процент</strong> выбрано** <strong>в поле **Рассчитать процент на основе</strong> на странице <strong>Настройка кодов процентов</strong>.
...
- Можно ввести дополнительные ограничения суммы процентов.
- Значение <strong>Сумма** выбрано в поле **Рассчитать процент на основе</strong> на странице <strong>Настройка кодов процентов</strong>.
