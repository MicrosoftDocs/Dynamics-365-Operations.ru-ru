...
4. В этом диалоговом окне можно выполнять различные задачи. Выберите один или несколько ваучеров, а затем выберите одну из следующих кнопок:
    ...
    - **Просмотр связанной информации** — отображаются все проводки журнала платежей, созданные в журнале платежей, связанном с выбранным документом. Кроме того, отображаются все сопоставления, связанные с этими платежами. При просмотре связанных платежей название этой кнопки меняется на **Просмотр сопоставлений**. Выберите **Просмотр сопоставлений**, чтобы отобразить только те проводки, которые отображались при первом открытии диалогового окна **Просмотр сопоставлений**.
...
- **Открыто на дату** — отображение только тех проводок, которые не сопоставлены полностью по состоянию на указанную дату. При выборе этого параметра можно изменить дату, которая отображается рядом с фильтром. Проводки, у которых значение параметра **Дата последнего сопоставления** позже указанной вами даты, отображаются в списке, даже если по состоянию на текущую дату эти проводки полностью сопоставлены. Однако сальдо представляет собой сальдо по состоянию на текущую дату, а не по состоянию на выбранную дату.

Также добавлен фильтр, который позволяет скрыть проводки пересчета валют. Просто установите флажок **Скрыть переоценки валюты**.

## <a name="more-easily-modify-due-dates-and-discount-dates"></a>Упрощение изменения сроков оплаты и дат скидок

Вы можете изменять сроки оплаты и даты скидок для открытых проводок по клиентам. В выпуске 8.1 делать это стало удобнее. На страницу списка **Проводки по поставщику** теперь можно добавить сроки оплаты. Щелкнув дату срока оплаты на странице списка **Проводки по поставщику**, также можно изменить сроки оплаты, даты скидок, условия оплаты и условия скидок по оплате в диалоговом окне **Обновление срока оплаты и даты скидок по оплате**.
...
Срок оплаты добавляется на страницу списка **Проводки по поставщику**, чтобы вам легче было изменять сроки оплаты и даты скидок по оплате для проводок.
