...
В этом разделе приводятся сведения о макетах экрана, входящих в состав набора демонстрационных данных POS-терминала в Dynamics 365 Retail.
...
Чтобы найти макеты экрана, выберите **Розничная торговля** \> **Настройка канала** \> **Настройка POS** \> **POS** \> **Макеты экрана**.
