...
- **Цена включает налог** — проверяется, что параметр **Цена включает налог** последователен во всех строках проводки.
...
## <a name="set-up-the-consistency-checker"></a>Настройка программы проверки целостности
