...
> [!NOTE]
> В Retail версии 10.0.5 параметр **Выполнить заказ только с одного склада** был заменен на **Максимум складов для выполнения**. Вместо того чтобы выбирать между выполнением заказов только с одного склада или с максимального количества складов, теперь пользователи могут задать конкретный набор складов (до 5) или максимальное количество складов. Это позволяет более гибко управлять складами при выполнении заказов.
