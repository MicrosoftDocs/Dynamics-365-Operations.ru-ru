...
ms.locfileid: "1549367"
---
# <a name="set-up-call-center-channels"></a>Настройка каналов центра обработки вызовов

[!include [banner](includes/banner.md)]

Компания может определить несколько каналов центра обработки вызовов в Microsoft Dynamics 365 for Retail. Каналы центра обработки вызовов настраиваются в пункте **Retail** \> **Каналы** \> **Центры обработки вызовов** \> **Все центры обработки вызовов**, и они являются специфическими для юридического лица.
