...
### <a name="effect-of-the-price-includes-sales-tax-setting-on-financial-postings"></a>Влияние параметра "Цена включает налог" на финансовые разноски
Все суммы, разнесенные в главную книгу для счетов выручки и скидки, подвержены влиянию параметра **Цена включает налог**. В следующем примере показано, как этот параметр влияет на финансовые проводки.

В примере обсуждаются только разноска продаж, так как параметр **Цена включает налог** не влияет на разноски стоимости запасов.

#### <a name="example"></a>Пример
Для этого примера суммы скидок настраиваются таким образом, чтобы они разносились отдельно от выручки.

Вы продаете продукт стоимостью $100, имеющий налоговую ставка 10 процентов, и к нему применяется скидка 5 процентов. Используются следующие счета из демонстрационных данных USRT:

- **Выручка:** 401100
- **Скидка:** 403200
- **Налог:** 202100

**Случай 1. Налог не включен (также известен как налог с продаж)**

- **Выручка:** $100
- **Скидка:** $5
- **Налог:** $9,5 (= 10 процентов от $95)

**Случай 2. Налог включен (также известен как налог на добавленную стоимость \[НДС\])**

- **Выручка:** $90
- **Скидка:** $4,5 (= 5 процентов от $90)
- **Налог:** $10
