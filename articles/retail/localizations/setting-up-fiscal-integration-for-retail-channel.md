...
2. Параметры **Пропустить** и **Пометить как зарегистрированный** в диалоговом окне обработки ошибок требуют разрешения **Разрешить пропуск регистрации или пометку как зарегистрированный**. Поэтому на странице **Группы разрешений** (**Розничная торговля \> Сотрудники \> Группы разрешений**) включите разрешение **Разрешить пропуск регистрации или пометку как зарегистрированный**.
