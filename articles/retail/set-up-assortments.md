...
description: В этой статье описывается, что такое ассортимент, и объясняется, как настроить ассортимент в Dynamics 365 Retail.
author: jblucher
manager: AnnBe
ms.date: 06/20/2017
ms.topic: article
