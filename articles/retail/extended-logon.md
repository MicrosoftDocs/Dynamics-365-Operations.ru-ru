...
# <a name="set-up-extended-logon-functionality-for-mpos-and-cloud-pos"></a>Настройка функции расширенного входа для MPOS и Cloud POS
...
Можно найти настройку для масок штрих-кода в разделе **Розница** &gt; **Настройка канала** &gt; **Настройка POS** &gt; **Профили POS** &gt; **Профили функциональности**. Экспресс-вкладка **Функции** включает следующие параметры, связанные с расширенным входом.
