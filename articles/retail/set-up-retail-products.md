...
description: В этой статье описывается, как настроить розничные продукты в Dynamics 365 Retail.
author: jblucher
manager: AnnBe
ms.date: 06/20/2017
ms.topic: article
