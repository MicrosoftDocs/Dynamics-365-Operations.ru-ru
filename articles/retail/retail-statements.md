...
- Розничные продажи, в которых клиент был добавлен в проводку в Retail POS, создают отдельные заказы на продажу и накладные — по одной для каждого уникального клиента.
