...
|            | Количество проекционных трубок    | 1–5                         | 3             |
...
Сведения о назначении этих оставшихся параметров см. в разделе [Обзор схемы поиска в SharePoint Server 2013](https://technet.microsoft.com/en-us/library/jj219669.aspx).
