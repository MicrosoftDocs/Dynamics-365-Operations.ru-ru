...
Настройки фильтра для атрибутов позволяют определить, как фильтры для атрибутов будут показаны в POS-терминале для розничной торговли. Для доступа к настройкам фильтра для атрибута на странице **Атрибуты** выберите атрибут, затем выберите в области действий пункт **Настройки фильтра**.
...
6. В следующих экспресс-вкладках обновите значения обязательных атрибутов:
    ...
    > [!NOTE]
    > Если совместно используемые носители продукта и атрибуты продукта создаются, они применяются для всех розничных продуктов.
