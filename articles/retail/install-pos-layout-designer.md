...
1. В Retail с помощью левого верхнего меню откройте **Розничная торговля** **и коммерция** &gt; **Настройка канала** &gt; **Настройка POS** &gt; **POS** &gt; **Макеты экрана**.
...
5. После установки на странице **Войти** введите свое имя пользователя и пароль Retail и щелкните **Войти**, чтобы запустить конструктор.
...
- Когда вы нажимаете **Конструктор**, запрос для загрузки (или выполнения) программы установки не отображаются или текущие параметры безопасности не позволяют загрузить файл. 
    ...
    **Решения:**
    ...
    - В Internet Explorer добавьте URL-адрес Retail в зону надежных сайтов. Щелкните **Настройки** &gt; **Свойства браузера** &gt; **Безопасность** &gt; **Надежные сайты** &gt; **Сайты** &gt; **Добавить**.

- Программа не запускается и отображается инструкция обратиться к поставщику.

    **Решение.** В Internet Explorer добавьте URL-адрес Retail в зону надежных сайтов. Щелкните **Настройка** &gt; **Свойства браузера** &gt; **Безопасность** &gt; **Надежные сайты** &gt; **Сайты** &gt; **Добавить**.
