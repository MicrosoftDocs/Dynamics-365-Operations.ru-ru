...
Поиск клиентов позволяет находить клиентов для различных целей. Например, кассирам может потребоваться просмотреть список пожеланий клиента или историю его покупок либо добавить клиента в транзакцию. Алгоритм поиска сравнивает искомые термины со значениями, имеющимися в следующих свойствах клиента: имя, электронная почта, телефон, номер карточки постоянного клиента, адрес и номер счета. Среди них свойство имени обеспечивает наибольшую гибкость, когда речь идет о нескольких поисках по ключевому слову, так как алгоритм возвращает всех клиентов, которые соответствуют любому из ключевых слов поиска, и клиенты, которые соответствуют большинству ключевых слов, отображаются в верхней части результатов. Это поведение помогает кассирам в ситуациях, когда они ищут путем ввода полного имени, но имя и фамилия были поменяны местами при начальном вводе данных. Однако из соображений производительности все остальные свойства сохраняют порядок ключевых слов, поэтому если ключевые слова не соответствуют порядку, в котором хранятся данные, никакие результаты не будут возвращены.
