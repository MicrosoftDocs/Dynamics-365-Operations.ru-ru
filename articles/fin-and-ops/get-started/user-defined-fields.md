...
3.   В раскрывающемся меню **Язык** отображается набор языков, для которых уже были предоставлены переводы. 
     1.   Если требуется изменить существующий перевод, выберите нужный язык в меню и измените значения для метки и текста справки.  
     2.   В противном случае нажмите кнопку **Добавить язык**, выберите нужный язык в меню и укажите переведенные значения метки и текста справки.  
