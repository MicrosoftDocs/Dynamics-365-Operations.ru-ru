...
# <a name="videos-for-dynamics-365-for-finance-and-operations"></a>Видео для Dynamics 365 for Finance and Operations

[!include [banner](../includes/banner.md)]

На этой странице перечислены созданные Майкрософт практические советы и видео по техническим вопросам, связанные с Dynamics 365 for Finance and Operations, которые доступны на YouTube и других сайтах.
...
- [Синхронизация заказа на выполнение работ между Dynamics 365 for Field Service и Finance and Operations](https://www.youtube.com/watch?v=hAB4TDVMjxU&t=2s)

#### <a name="data-management"></a>Управление данными
- [Использование информационных объектов и пакетов данных в Dynamics 365 for Finance and Operations](https://www.youtube.com/watch?v=UCyzbA41j8g&feature=youtu.be)
...
- [Интеграция Visual Studio Team Services с Lifecycle Services](https://www.youtube.com/watch?v=0QyyyUp1zHQ&t=1s)

#### <a name="explore-the-user-interface"></a>Знакомство с пользовательским интерфейсом
- [Добавление пользовательских полей](https://www.youtube.com/watch?v=gWSGZI9Vtnc)
...
- [Использование своей собственной базы данных (BYOD) в Dynamics 365 for Finance and Operations](https://www.youtube.com/watch?v=-MaxtBJu2_o&feature=youtu.be)
...
- [Управление процессом обновления кода и средств в Dynamics 365 for Finance and Operations](https://www.youtube.com/watch?v=M-AtR6ocYM8&feature=youtu.be)
...
- [Запрос производственной среды Dynamics 365 for Finance and Operations](https://www.youtube.com/watch?v=5j1GapLr3MY&feature=youtu.be)
...
[Технические вопросы по FastTrack для Dynamics 365](https://infopedia.eventbuilder.com/index?landingpageid=92tzhl) — технические сведения и рекомендации, которые помогают клиентам и партнерам получить подробную информацию в конкретной области. В следующем разделе перечислены записи технических вопросов по FastTrack, которые доступны для просмотра или загрузки. Также можно загрузить копию презентации в формате PDF с сайта технических вопросов. 

#### <a name="data-management"></a>Управление данными
- [Копирование юридического лица (DYN383PAL)](https://infopedia.eventbuilder.com/event?eventid=q3h0m7&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Управление данными (DYN445PAL2)](https://infopedia.eventbuilder.com/event?eventid=a7n1v0&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Уменьшение времени импорта и экспорта данных с помощью конфигураций (DYN315PAL)](https://infopedia.eventbuilder.com/event?eventid=s6v1q3&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="demo-data"></a>Демонстрационные данные
- [Пакеты демонстрационных данных (DYN443PAL)](https://infopedia.eventbuilder.com/event?eventid=m2r4o6&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="deployment"></a>Развертывание 
- [Локальное развертывание (DYN382PAL2)](https://infopedia.eventbuilder.com/event?eventid=m9i7a2&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="develop-and-customize"></a>Разработка и настройка
- [Средства интеграции Azure для Dynamics 365 for Finance and Operations (DYN386PAL)](https://infopedia.eventbuilder.com/event?eventid=l7f2i9&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Расширяемость (DYN384PAL2)](https://infopedia.eventbuilder.com/event?eventid=e0x4q5&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Расширение или создание новых аналитических рабочих областей (DYN321PAL)](https://infopedia.eventbuilder.com/event?eventid=r7z0f5&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Подход к проверке производительности (DYN449PAL2)](https://infopedia.eventbuilder.com/event?eventid=k6c6g9&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Подход к проверке производительности (DYN449PAL)](https://infopedia.eventbuilder.com/event?eventid=i1u5m9&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="financial-reporting"></a>Финансовая отчетность
- [Финансовая отчетность (DYN305PAL)](https://infopedia.eventbuilder.com/event?eventid=s0d0n3&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks) 
- [Варианты отчетности в Dynamics 365 for Finance and Operations (VIR810PAL)](https://infopedia.eventbuilder.com/event?eventid=p8x0s5&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
...
#### <a name="intelligence"></a>Бизнес-аналитика
- [Аналитика и варианты отчетности, печать и агент маршрутизации документов (DYN442PAL)](https://infopedia.eventbuilder.com/event?eventid=r6d9a6&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Введение в аналитические рабочие области (DYN317PAL)](https://infopedia.eventbuilder.com/event?eventid=h6e1a7&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="mobile"></a>Мобильный
- [Мобильная рабочая область расходов и проекта (DYN379PAL2)](https://infopedia.eventbuilder.com/event?eventid=u0g9h5&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Мобильная платформа (VIR824PAL)](https://infopedia.eventbuilder.com/event?eventid=p2o7n7&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
...
- [Обслуживание (VIR805PAL)](https://infopedia.eventbuilder.com/event?eventid=c2k8k3&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="upgrade-and-migration"></a>Обновление и миграция
- [Средства миграции с AX 2009 на Dynamics 365 for Operations (VIR809PAL)](https://infopedia.eventbuilder.com/event?eventid=c3g5k3&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Средства миграции AX 2009 (DYN306PAL2)](https://infopedia.eventbuilder.com/event?eventid=u3g7s0&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Обновление с AX 2012 до Dynamics 365 for Operations (VIR817PAL2)](https://infopedia.eventbuilder.com/event?eventid=t9e9e5&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Выполнение обновления с 7.0 (RTW)/7.1 (выпуск 1611) до 7.2 (июль 2017 г.) (DYN338PAL2)](https://infopedia.eventbuilder.com/event?eventid=q0w9p0&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Настройка Visual Studio Team Services (VSTS) (VIR782PAL)](https://infopedia.eventbuilder.com/event?eventid=g9f8g1&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="warehouse-management"></a>Управление складом
- [Добавления в получение смешанного номерного знака (DYN331PAL)](https://infopedia.eventbuilder.com/event?eventid=e0u6t2&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Пополнение на основании спроса для комплектации сырья (DYN333PAL2)](https://infopedia.eventbuilder.com/event?eventid=i5p9d2&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Процесс миграции номенклатуры и склада для использования расширенного управления складом (DYN316PAL)](https://infopedia.eventbuilder.com/event?eventid=w0k4b4&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
