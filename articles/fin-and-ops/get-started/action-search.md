...
Однако в текущей версии Finance and Operations сочетания клавиш становятся недоступны, они были заменены функцией поиска действия. Эта новая функция позволяет быстро искать и наживать кнопки на любой видимой панели операций.
