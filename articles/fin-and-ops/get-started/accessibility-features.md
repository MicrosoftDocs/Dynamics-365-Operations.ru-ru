...
В этом разделе описываются возможности, предназначенные для пользователей, обладающих различными физическими нарушениями. Например, имеются возможности для людей, использующих вспомогательные технологии при нарушении зрения, такие как экранный диктор Microsoft Windows.
