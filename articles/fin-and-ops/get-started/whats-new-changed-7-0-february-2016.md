...
| Оценить будущий спрос и создать прогнозы спроса на основе исторических данных проводок. | В Microsoft Dynamics AX 2012 R3 модели прогноза из службы Microsoft SQL Server Analysis Service используются для создания прогнозов спроса. | Оцените будущий спрос путем использование силы и расширяемости облачной службы машинного обучения Microsoft Azure. Она проста в использовании и расширяет модели прогноза в машинном обучении для того, чтобы соответствовать требованиям клиента. Служба выполняет выбор лучшего варианта и предлагает ключевые индикаторы производительности (KPI), которые можно использовать для того, чтобы высчитать точность прогноза. | Создайте более точные прогнозы путем использование методов машинного обучения. |
...
<td>Commerce Data Exchange — это система, которая передает данные между Microsoft Dynamics AX и розничными каналами, такими как интернет-магазины или традиционные магазины. Дополнительные сведения см. в разделе <a href="https://technet.microsoft.com/library/dn741440.aspx">Commerce Data Exchange [AX 2012]</a>.</td>
