...
#### [Обновление Platform update 12 (ноябрь 2017 г.)](get-started/whats-new-platform-update-12.md)
...
#### [Изменение формата для повторного применения шаблона Microsoft Excel для электронной отчетности](../dev-itpro/analytics/tasks/er-modify-format-by-reapplying-microsoft-excel-template-july-2017.md?toc=/fin-and-ops/toc.json)
...
##### [Разработка модели данных для использования финансовых аналитик как источника данных для электронной отчетности](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-1.md?toc=/fin-and-ops/toc.json)
##### [Сопоставление моделей для использования финансовых аналитик как источника данных для электронной отчетности](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-2.md?toc=/fin-and-ops/toc.json)
##### [Разработка отчета для использования финансовых аналитик как источника данных для электронной отчетности](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-3.md?toc=/fin-and-ops/toc.json)
##### [Выполнение отчета, использующего финансовые аналитики как источник данных для электронной отчетности](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-4.md?toc=/fin-and-ops/toc.json)
##### [Создание формата для подсчета и суммирования для электронной отчетности](../dev-itpro/analytics/tasks/er-format-counting-summing-1.md?toc=/fin-and-ops/toc.json)
##### [Настройка вычислений для подсчета и суммирования для электронной отчетности](../dev-itpro/analytics/tasks/er-format-counting-summing-2.md?toc=/fin-and-ops/toc.json)
##### [Использование вычислений для получения выходных данных подсчета и суммирования для электронной отчетности](../dev-itpro/analytics/tasks/er-format-counting-summing-3.md?toc=/fin-and-ops/toc.json)
##### [Выполнения формата для подсчета и суммирования для электронной отчетности](../dev-itpro/analytics/tasks/er-format-counting-summing-4.md?toc=/fin-and-ops/toc.json)
##### [Разработка формата для использования горизонтально разворачивающихся диапазонов для динамического добавления столбцов в отчеты Excel для электронной отчетности](../dev-itpro/analytics/tasks/er-horizontal-1.md?toc=/fin-and-ops/toc.json)
##### [Выполнение формата, использующего горизонтально разворачивающиеся диапазоны для динамического добавления столбцов в отчеты Excel для электронной отчетности](../dev-itpro/analytics/tasks/er-horizontal-2.md?toc=/fin-and-ops/toc.json)
##### [Подготовка модели данных для использования файлов управления документами в выходных форматах для электронной отчетности](../dev-itpro/analytics/tasks/er-document-management-files-1.md?toc=/fin-and-ops/toc.json)
##### [Расширение модели данных для использования файлов управления документами в выходных форматах для электронной отчетности](../dev-itpro/analytics/tasks/er-document-management-files-2.md?toc=/fin-and-ops/toc.json)
##### [Создание формата для использования файлов управления документами в выходных форматах для электронной отчетности](../dev-itpro/analytics/tasks/er-document-management-files-3.md?toc=/fin-and-ops/toc.json)
##### [Выполнение формата для использования файлов управления документами в выходных форматах для электронной отчетности](../dev-itpro/analytics/tasks/er-document-management-files-4.md?toc=/fin-and-ops/toc.json)
##### [Изменение и выполнение формата для использования файлов управления документами в выходных форматах для электронной отчетности](../dev-itpro/analytics/tasks/er-document-management-files-5.md?toc=/fin-and-ops/toc.json)
##### [Разработка конфигураций для создания отчетов в форматах Microsoft Office с внедренными изображениями для электронной отчетности (ER) (часть 1)](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-july-2017.md?toc=/fin-and-ops/toc.json)
##### [Обзор конфигураций для подготовки отчетов в форматах Microsoft Office с внедренными изображениями для электронной отчетности](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-part-2-review-configurations.md?toc=/fin-and-ops/toc.json)
##### [Создание отчетов в форматах Microsoft Office с внедренными изображениями для электронной отчетности](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-part-3-generate-reports.md?toc=/fin-and-ops/toc.json)
#### [Создание электронных документов и обновление данных в приложении с помощью средства электронной отчетности](../dev-itpro/analytics/generate-electronic-documents-update-application-data.md?toc=/fin-and-ops/toc.json)
##### [Импорт конфигураций для создания документов с обновлением данных приложения для электронной отчетности](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-1-import-configurations.md?toc=/fin-and-ops/toc.json)
##### [Создание документов с обновлением данных приложения для электронной отчетности](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-2-generate-documents.md?toc=/fin-and-ops/toc.json)
##### [Изменение модели и сопоставления для создания документов с обновлением данных приложения для электронной отчетности](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-3-modify-model-mapping.md?toc=/fin-and-ops/toc.json)
##### [Изменение формата для создания документов с обновлением данных приложения для электронной отчетности](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-4-modify-format.md?toc=/fin-and-ops/toc.json)
##### [Создание документов с обновлением данных приложения для электронной отчетности](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-5-generate-documents-application-data-update.md?toc=/fin-and-ops/toc.json)
#### [Внедрение изображений и фигур в бизнес-документы, создаваемые с помощью средства электронной отчетности](../dev-itpro/analytics/electronic-reporting-embed-images-shapes.md?toc=/fin-and-ops/toc.json)
