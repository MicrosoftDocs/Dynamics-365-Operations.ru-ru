...
#### Расчеты спецификаций с помощью схемы калькуляции (последовательное воспроизведение проводников по задачам)
...
#### [Поиск сведений о стандартных информационных объектах](../dev-itpro/data-entities/data-entities-report.md)
...
#### [Финансовый анализ](../dev-itpro/analytics/financial-insights.md)
...
#### [Места назначения](../dev-itpro/analytics/electronic-reporting-destinations.md)
...
##### [Разработка конфигураций для создания отчетов в форматах Microsoft Office с внедренными изображениями для электронной отчетности (ER) (часть 1)](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-july-2017.md)
...
#### [Разбор входящих документов для обновления данных приложения](../dev-itpro/analytics/parse-incoming-electronic-documents.md)
#### [Разбор входящих документов в формате CSV](../dev-itpro/analytics/parse-incoming-electronic-documents-csv-format.md)

##### [Изменения в API платформы электронной отчетности для Application update 7.3](../dev-itpro/analytics/er-apis-app73.md)
