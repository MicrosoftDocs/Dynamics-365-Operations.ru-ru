...
#### [Еще не реализованные функции AX 2012](get-started/ax-2012-features-not-implemented-but-not-deprecated.md)
...
#### [Платформа, update 11 (октябрь 2017 г.)](get-started/whats-new-platform-update-11.md)
#### [Платформа, update 10 (август 2017 г.)](get-started/whats-new-platform-update-10.md)
...
#### [Запись себестоимости](../supply-chain/cost-management/cost-entries.md)
...
#### [Создание заказа на покупку в соответствии с бюджетом](../supply-chain/cost-management/tasks/create-purchase-order-governed-by-budget.md)
#### Расчеты спецификаций с помощью схемы калькуляции
##### [Создание готового продукта (только для версии от февраля 2016 г.)](../supply-chain/pim/tasks/create-finished-product-2016-02.md)
##### [Создание полуфабриката (только для версии от февраля 2016 г.)](../supply-chain/pim/tasks/create-semi-finished-product-2016-02.md)
##### [Создание сырья (только для версии от февраля 2016 г.)](../supply-chain/pim/tasks/create-raw-materials-2016-02.md)
##### [Создание спецификаций (только для версии от февраля 2016 г.)](../supply-chain/pim/tasks/create-boms-2016-02.md)
##### [Создание маршрутов (только для версии от февраля 2016 г.)](../supply-chain/pim/tasks/create-routes-2016-02.md)
##### [Расчет спецификации с помощью одноуровневой структуры (только версия от февраля 2016 г.)](../supply-chain/cost-management/tasks/calculate-bom-single-level-structure-2016-02.md)
##### [Расчет спецификации с помощью многоуровневой структуры (только версия от февраля 2016 г.)](../supply-chain/cost-management/tasks/calculate-bom-multilevel-structure-2016-02.md)


## Управление данными и их интеграция

### [Информационные объекты, проекты и пакеты](../dev-itpro/data-entities/data-entities.md)
#### [Структура информационных объектов и пакетов](../dev-itpro/data-entities/data-entities-data-packages.md)
##### [Настройка проектов с данными](../dev-itpro/data-entities/configuration-data-projects.md)
##### [Настройка пакетов данных](../dev-itpro/data-entities/configuration-data-packages.md)
##### [Копирование данных о конфигурации между компаниями](../dev-itpro/data-entities/copy-configuration.md)
...
###### [Синхронизация организаций из Finance and Operations с клиентами в Sales](../supply-chain/sales-marketing/accounts-template-mapping.md)
###### [Синхронизация контактов из Finance and Operations с контактами в Sales](../supply-chain/sales-marketing/contacts-template-mapping.md)
...
###### [Синхронизация заголовков и строк заказов на продажу из Finance and Operations в Sales](../supply-chain/sales-marketing/sales-order-template-mapping.md)
###### [Синхронизация заголовков и строк счетов продажи из Finance and Operations в Sales](../supply-chain/sales-marketing/sales-invoice-template-mapping.md)
...
##### [Задачи настройки расширенной банковской выверки](../financials/cash-bank-management/configure-advanced-bank-reconciliation.md)
...
#### [Начало работы](../financials/cost-accounting/get-started.md)
##### [Терминология учета затрат](../financials/cost-accounting/terms-cost-accounting.md)
#### [Настройка базовых объектов](../financials/cost-accounting/configure-base-entities.md)
##### [Валюта (eLearning)](https://mbspartner.microsoft.com/AX/CourseModules/1215.md) 
##### [Валютные курсы (eLearning)](https://mbspartner.microsoft.com/AX/CourseModules/1215.md) 
##### [Финансовые календари, финансовые годы и периоды](../financials/budgeting/fiscal-calendars-fiscal-years-periods.md)
##### [Финансовые аналитики](../financials/general-ledger/financial-dimensions.md)
...
##### [Мобильная рабочая область управления затратами (видео)](https://youtu.be/imsuTg8rUVk.md)
...
##### [Использование рабочей области управления затратами для формирования отчетности (видео)](https://youtu.be/imsuTg8rUVk.md)
##### [Экспорт записей в Excel (видео)](https://youtu.be/-HKHYdClvx8.md)
...
#### [Политики приемлемости льготы](../talent/benefit-eligibility-policies.md)
...
#### [Распространение и заполнение анкет](../talent/distribute-questionnaires.md)
#### [Оценка результатов анкет](../talent/evaluate-questionnaire-results.md)
...
#### Частота и циклы
#### [Задачи цикла оплаты и периода выплат зарплаты](hr/localizations/noam-usa-pay-cycle-pay-period-tasks-sample.md)
...
#### [Обработка применимости льгот](hr/tasks/benefit-eligibility-process.md)
...
#### [Решения для формирования отчетности](../dev-itpro/analytics/create-nextgen-reporting-solutions.md)
...
#### [Экспорт объектов в собственную базу данных Azure SQL](../dev-itpro/analytics/export-entities-to-your-own-database.md)
...
## Управление запасами
### [Обработка входящего потока](../supply-chain/inventory/arrival-overview.md)
...
#### [Консигнация](../supply-chain/inventory/consignment.md)
#### [Настройка консигнации](../supply-chain/inventory/set-up-consignment.md)
...
### [Управление качеством](../supply-chain/inventory/quality-management-processes.md)
...
### Аналитики отслеживания номенклатур
...
#### [Обзор прогноза спроса](../supply-chain/master-planning/introduction-demand-forecasting.md)
...
#### [Сводные планы и функция работы с несколькими сайтами](../supply-chain/master-planning/master-plan-multisite-functionality.md)
...
#### [Совместная работа с поставщиками с помощью портала поставщика](../supply-chain/procurement/collaborate-vendors-vendor-portal.md)
...
#### [Безопасность пользователей портала поставщика](../supply-chain/procurement/configure-security-vendor-portal-users.md)
...
##### [Поддержка доски переноса канбана для сканеров штрихкодов](../supply-chain/production-control/kanban-transfer-board-support-barcode-scanner.md)
##### [Обратная связь производства](../supply-chain/production-control/production-feedback.md)
...
##### [Перемещение материалов с помощью заданий канбана (только для версии от февраля 2016 г.)](../supply-chain/production-control/tasks/transfer-materials-kanban-jobs.md)
...
##### [Копирование побочных продуктов из существующей версии формулы](../supply-chain/production-control/tasks/copy-co-products-existing-formula-version.md)
...
##### [Управление единицами измерения (руководства по задачам)](../supply-chain/pim/tasks/manage-unit-measure.md)


## [Управление сведениями о продуктах](../supply-chain/pim/product-information.md)
### Сведения о продукте
#### Категории продуктов
...
##### [Создание номенклатуры номера продукта для заранее определенных вариантов продуктов (руководство по задаче)](../supply-chain/pim/tasks/create-product-number-nomenclature-predefined-variants-2016-11.md)
##### [Создание номенклатуры номера продукта для настроенных вариантов продуктов (руководство по задаче)](../supply-chain/pim/tasks/create-product-number-nomenclature-product-variants_2016_11.md)
...
#### Подготовка продукта для спланированных заказов 
...
#### Оценка затрат по продукту
##### [Расчет спецификаций](../supply-chain/cost-management/bom-calculations.md)
### Модели конфигурации продукта
#### [Создание модели конфигурации продукта](../supply-chain/pim/build-product-configuration-model.md)
...
##### [Конфигурация на основе аналитик](../supply-chain/pim/dimension-based-product-configuration.md)
...
#### Создание конфигураций на основе ограничений
...
##### [Ограничение для выражения и ограничение таблицы](../supply-chain/pim/expression-constraints-table-constraints-product-configuration-models.md)
##### [Повторное использование конфигурации продукта](../supply-chain/pim/reuse-product-configurations.md)
##### [Настройка модели конфигурации](../supply-chain/pim/set-up-maintain-product-configuration-model.md)
...
##### [Создайте компонентов модели продукта (проводник по задаче)](../supply-chain/pim/tasks/create-product-model-components.md)
