...
# <a name="configure-a-parallel-branch-in-a-workflow"></a>Настройка параллельной ветви в workflow-процессе
...
2.  Перетащите элементы workflow-процесса на холст, а затем настройте элементы, как и любой другой workflow-процесс. Дополнительные сведения см. в разделе "Создание workflow-процесса".
