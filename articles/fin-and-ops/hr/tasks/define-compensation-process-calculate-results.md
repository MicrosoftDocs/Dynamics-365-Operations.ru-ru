--- 
title: "Определение процессов компенсации и расчет результатов"
...
---
# <a name="define-compensation-processes-and-calculate-results"></a>Определение процессов компенсации и расчет результатов
