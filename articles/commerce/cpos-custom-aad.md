...
1. В разделе **Конфигурация токенов** выполните следующие действия, чтобы добавить два утверждения.
    ...
    - Выберите пункт **Добавить необязательное утверждение**. Установите для поля **Тип токена** значение **ИД**, а затем выберите утверждение **SID**. Выберите **Добавить**.
    - Выберите пункт **Добавить необязательное утверждение**. Установите для поля **Тип токена** значение **Доступ**, а затем выберите утверждение **SID**. Выберите **Добавить**.
