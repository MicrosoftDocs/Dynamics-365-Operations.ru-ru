...
### <a name="relationship-between-template-defaults-and-page-content"></a>Отношение между шаблоном по умолчанию и содержимым страниц
