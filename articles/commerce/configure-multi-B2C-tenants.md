...
1. После ввода этих сведений выберите **OK**, чтобы сохранить изменения. Новый клиент Azure AD B2C должен появиться в списке под пунктом **Управление приложениями B2C**.
