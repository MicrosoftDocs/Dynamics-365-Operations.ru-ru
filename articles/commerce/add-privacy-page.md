...
1. Перейдите к разделу **Фрагменты страниц**, затем выберите **Создать**, чтобы создать фрагмент страницы.
1. В диалоговом окне **Создать фрагмент страницы** выберите модуль **Нижний колонтитул**.
