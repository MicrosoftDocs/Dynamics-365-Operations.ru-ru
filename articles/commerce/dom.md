...
![![Жизненный цикл заказа на продажу в контексте DOM](./media/flow.png "Жизненный цикл заказа на продажу в контексте DOM")](./media/flow.png "Sales order lifecycle in the context of DOM")
...
5. На вкладке **Решатель** установите следующие значения.
    ...
    - **Тип решателя** — выберите значение. В Commerce доступно два типа решателя: **Рабочий решатель** и **Упрощенный решатель**. Для всех компьютеров, которые используются DOM (все серверы, входящие в группу DOMBatch) , следует выбирать **Рабочий решатель**. Для рабочего решателя требуется специальный лицензионный ключ, который по умолчанию развертывается в производственных средах. Для непроизводственных сред этот лицензионный ключ необходимо развертывать вручную. Чтобы развернуть лицензионный ключ вручную, выполните следующие действия.
        ...
        4. Перейдите в клиент Headquarters и откройте страницу **Параметры DOM**. На вкладке **Решатель** в поле **Тип решателя** выберите **Рабочий решатель** и убедитесь, что никакие сообщения об ошибках не появляются.
...
6. Выберите **Retail и Commerce \> Распределенное управление заказами \> Настройка \> Параметры DOM**.
...
![![Критерии заказов на продажу](./media/ordercriteria.png "Критерии заказов на продажу")](./media/ordercriteria.png "Sales order criteria")
