...
- **Галерея мультимедиа** — этот модуль используется для демонстрации изображений продукта на странице сведений о продукте. Дополнительные сведения об этом модуле см. в разделе [Модуль галереи мультимедиа](mediagallery-module.md).
...
[Модуль галереи мультимедиа](media-gallery-module.md)
