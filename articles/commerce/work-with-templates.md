...
## <a name="rename-a-template"></a>Переименование шаблона

Чтобы переименовать шаблон в конструкторе сайта, выполните следующие шаги.

1. В левой области переходов выберите **Шаблоны**.
1. Выберите имя шаблона для переименования.
1. Выберите **Правка**, чтобы начать редактирование шаблона. Обратите внимание, что нельзя изменять шаблон, если он уже редактируется другим пользователем.
1. В области свойств шаблона выберите символ пера рядом с названием шаблона.
1. При необходимости измените имя шаблона.
