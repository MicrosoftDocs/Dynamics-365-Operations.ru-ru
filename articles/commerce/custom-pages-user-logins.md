...
1. В поле **URI пользовательской страницы** введите полный URL-адрес входа. Включите суффикс **?preloadscripts=true**. Например, введите **www.\<мой домен\>.com/sign-in?preloadscripts=true**.
