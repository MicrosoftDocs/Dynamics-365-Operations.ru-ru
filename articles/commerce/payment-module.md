...
Если требуются оба соединителя платежей Adyen и PayPal, добавьте оба модуля в раздел платежа. Убедитесь, что значение свойства **Поддерживаемые типы платежных средств** настроено для PayPal, и оставьте его пустым для Adyen. Кроме того, установите для свойства **Является основным платежом** значение **True** для Adyen.
