...
description: В этой статье представлены сведения о возможности использования выделенного платежного терминала и запроса пользователя о выборе кассового лотка и принтера чеков.
author: BrianShook
ms.date: 05/20/2020
ms.topic: article
ms.prod: ''
...
В этой статье представлены сведения о возможности использования выделенного платежного терминала и запроса пользователя о выборе кассового лотка и принтера чеков.
...
Функциональные возможности, описанные в этой статье, поддерживаются Modern POS для Windows и Modern POS для Android для клиентов POS.
...
Дополнительные сведения о настройке сетевых периферийных устройств см. в разделе [Обзор поддержки сетевых периферийных устройств](./dev-itpro/network-peripherals.md).
...
4. На экспресс-вкладках для различных типов устройств настройте следующие типы устройств:
    ...
    |---|---|---|---|
    | Принтер | Сеть | *Любой* | Название устройства вводится с учетом регистра. **Код профиля чеков** должен совпадать с **кодом профиля чеков**, который сопоставлен с сетевым принтером, настроенным в профиле оборудования, который назначен станции оборудования на уровне канала. |
    | Кассовый лоток | Сеть | *Любой* | Название устройства вводится с учетом регистра. Укажите для **Использование совместных смен** вариант **Да**. |
    | Услуга электронного платежа | Adyen | Неприменимо | Сведения о настройке готового соединителя Adyen см. в разделе [Соединитель платежей Dynamics 365 для Adyen](./dev-itpro/adyen-connector.md?tabs=8-1-3). Другие соединители платежей могут поддерживаться с помощью [SDK Commerce для платежей](./dev-itpro/end-to-end-payment-extension.md). |
...
10. На экспресс-вкладке **Клавиатура для набора ПИН-кода** введите IP-адрес платежного терминала. Сведения о том, как получить IP-адрес платежного терминала с помощью соединителя Adyen, см. в разделе [Соединитель платежей Dynamics 365 для Adyen](./dev-itpro/adyen-connector.md?tabs=8-1-3).
...
4. На экспресс-вкладках для различных типов устройств настройте следующие типы устройств:
    ...
    | Кассовый лоток | Откат | **Epson** или **Star** | Название устройства вводится с учетом регистра. Укажите для **Использование совместных смен** вариант **Да**. |
...
- [Настройка приложения POS Hybrid в Android и iOS](./dev-itpro/hybridapp.md)
- [Соединитель платежей Dynamics 365 для Adyen](./dev-itpro/adyen-connector.md?tabs=8-1-3)
- [Обзор поддержки сетевых периферийных устройств](./dev-itpro/network-peripherals.md)
