...
> [!NOTE]
> Функция захвата снимка экрана не поддерживается в Store Commerce, Commerce Modern POS и Cloud POS.
