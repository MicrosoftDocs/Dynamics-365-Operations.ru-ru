...
1. В области действий выберите **Создать**.
1. В поле **Склад** введите значение.  Если это сопоставление 1:1 с розничным магазином, можно воспользоваться именем магазина или названием регионального центра распределения.
1. В поле **Имя** введите значение.
