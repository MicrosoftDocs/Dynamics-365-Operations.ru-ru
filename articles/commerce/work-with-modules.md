...
1. В области структуры слева разверните дерево и выберите модуль содержимого (например, **Компонент**, **Главный имиджевый баннер** или **Баннер**).
1. В области свойств справа найдите элементы управления содержимым и параметрами модуля.
1. Введите свойства для всех нужных элементов управления модуля.
