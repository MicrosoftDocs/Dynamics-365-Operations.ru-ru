...
description: В этой статье описывается, как использовать атрибуты, чтобы предоставить способ описания продукта и его характеристик с помощью определенных пользователем полей.
author: ashishmsft
ms.date: 04/28/2018
ms.topic: article
ms.prod: ''
...
Для продуктов можно переопределить параметры метаданных атрибута на уровне канала. Эта возможность обсуждается далее в этой статье.
