...
Конструктор чеков включает в себя переменную **Логотип**, которая может использоваться для указания изображений, которые будут печататься в чеке. Изображения, включенные в чеки с использованием переменной **Логотип**, должны иметь тип файла монохромного растрового изображения (.bmp). Если изображение в формате BMP указано в конструкторе чека, но не печатается при отправке на принтер, возможно, размер файла слишком велик или размеры в пикселях изображения не совместимы с принтером. Если это происходит, попробуйте уменьшить разрешение файла изображения.   
