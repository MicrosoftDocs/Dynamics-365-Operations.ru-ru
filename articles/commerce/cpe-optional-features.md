...
---
# <a name="configure-optional-features-for-a-commerce-preview-environment"></a>Настройка дополнительных функций для среды предварительного просмотра Commerce
...
1. Войдите в Dynamics 365 Retail.
