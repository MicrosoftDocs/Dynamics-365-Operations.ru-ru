...
1. В диалоговом окне **Выбор модуля** выберите модули **Согласие на файлы cookie**, **Заголовок** и **Рекламный баннер**, затем выберите **ОК**.
...
1. В диалоговом окне **Выбор модуля** выберите модуль **Меню навигации**, затем выберите **ОК**.
...
1. В диалоговом окне **Выбор модуля** выберите модуль **Поиск**, затем выберите **ОК**.
...
1. В диалоговом окне **Выбрать модуль** выберите модуль **Значок корзины**, затем выберите **ОК**.
