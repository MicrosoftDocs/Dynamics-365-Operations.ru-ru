...
description: В этой статье описывается, как создать книгу Excel, чтобы можно было редактировать проводки розничной торговли в Microsoft Dynamics 365 Commerce.
author: josaw1
ms.date: 11/04/2020
ms.topic: index-page
ms.prod: ''
...
В этой статье описывается, как создать книгу Excel, чтобы можно было редактировать проводки розничной торговли в Microsoft Dynamics 365 Commerce.
