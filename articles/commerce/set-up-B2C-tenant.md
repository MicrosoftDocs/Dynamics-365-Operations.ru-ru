...
В этом разделе рассматривается создание или связывание клиента Azure AD B2C для использования на сайте Commerce. Дополнительные сведения см. в разделе [Учебник. Создание клиента Azure Active Directory B2C](/azure/active-directory-b2c/tutorial-create-tenant).
