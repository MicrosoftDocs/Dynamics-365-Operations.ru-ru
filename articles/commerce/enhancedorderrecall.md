---
title: Операция отзыва заказа в POS
description: В этой статье описываются возможности, доступные для усовершенствования страниц отзыва заказов в POS-терминале.
author: hhainesms
ms.date: 03/12/2021
ms.topic: article
ms.prod: ''
