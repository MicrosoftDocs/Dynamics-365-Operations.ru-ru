...
> - Страницы сведений о продукте динамически создают **альтернативный текст**, используя имя продукта, поэтому изменение **альтернативного текста** для изображения продукта не повлияет на отображаемое изображение.
