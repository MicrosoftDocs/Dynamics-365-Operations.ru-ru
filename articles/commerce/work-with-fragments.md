...
1. На интерактивной панели выберите многоточие (**...**) рядом с именем контейнера или ячейки.  В качестве альтернативы, если используется визуальный конструктор страниц, выберите символ "плюс" (**+**).  
