...
### <a name="rename-a-fragment"></a>Переименование фрагмента
...
1. Выберите имя фрагмента для переименования.
1. Выберите **Правка**, чтобы начать редактирование фрагмента. Обратите внимание, что нельзя изменять фрагмент, если он уже редактируется другим пользователем.
1. В области свойств фрагмента выберите символ пера рядом с названием фрагмента.
1. При необходимости измените имя фрагмента.
...
[Просмотр истории версий для отмены изменений страниц и фрагментов](version-history-revert.md)
