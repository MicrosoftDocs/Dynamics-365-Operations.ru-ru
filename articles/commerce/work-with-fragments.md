...
1. В области структуры в левой части выберите кнопку с многоточием (**...**) рядом с названием модуля. 
1. Выберите **Использовать совместно как фрагмент**. 
1. Отобразится диалоговое окно. Введите имя и метаданные для фрагмента.
