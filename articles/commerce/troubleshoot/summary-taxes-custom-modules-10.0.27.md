...
description: В этом разделе представлено руководство по устранению неполадок, которое может помочь при использовании настраиваемых модулей сводки заказов, а подытог сводки по заказам не включает налоги на расходы в сценарии «Цена включает налог».
...
В этом разделе представлено руководство по устранению неполадок, которое может помочь при использовании настраиваемых модулей сводки заказов, а подытог сводки по заказам не включает налоги на расходы в сценарии «Цена включает налог».
