...
Если для параметра **Включить автоматическую проверку** установлено значение **Да** в **Параметры Commerce** > **Запасы** > **Запасы магазина**, проверка выполняется автоматически, когда выбрана функция **Завершить выполнение**.
