...
description: В этой статье представлен обзор новых возможностей отношений с клиентами, доступных в приложении магазина.
author: bebeale
ms.date: 11/16/2022
ms.topic: overview
...
В следующем видеоролике рассматривается пример сценария отношений с клиентом в Dynamics 365 Commerce.
