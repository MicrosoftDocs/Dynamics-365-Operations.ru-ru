...
description: В этой статье описываются расширенные гарантии, а также описывается, как создавать и настраивать их в Microsoft Dynamics 365 Commerce.
author: sijoshi
ms.date: 06/08/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8886992"
---
# <a name="create-and-configure-extended-warranties"></a>Создание и настройка расширенных гарантий

[!include [banner](includes/banner.md)]

В этой статье описываются расширенные гарантии, а также описывается, как создавать и настраивать их в Microsoft Dynamics 365 Commerce.
