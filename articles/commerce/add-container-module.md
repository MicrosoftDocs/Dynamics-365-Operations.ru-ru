...
1. В модуле контейнера добавьте модуль блока содержимого.
...
1. Добавьте еще два модуля блока содержимого в модуль-контейнер.
1. Сохраните и просмотрите страницу. Теперь вы должны видеть три модуля блока содержимого, которые будут отображаться рядом.
1. После получения нужного макета завершите редактирование страницы и опубликуйте ее.
