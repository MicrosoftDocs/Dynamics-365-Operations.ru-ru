...
|-----------------------------|-------------|
| Скрытые субтитры (CC)      | Текст, который может быть показан для аудио и аудио описательных элементов видео, чтобы помочь пользователям с нарушениями слуха |
...
В Dynamics 365 Commerce в разделе **Активы** для вашего сайта можно отправить видеоактивы с отдельными файлами для скрытых субтитров, обычного аудио и описательного аудио. Скрытые субтитры также могут быть сгенерированы автоматически при отправке видеоактива.
...
> [!NOTE]
> Активы скрытых субтитров, обычного аудио и описательного аудио также могут быть добавлены после отправки видеоактива. Перейдите **Активы**, выберите видеоактив и проверьте его, затем на панели свойств видеоактива отправьте дополнительные активы.
...
1. Перейдите **Активы**, выберите видеоактив, а затем выберите **Редактировать CC/стенограмму**. Появляется редактор контента скрытых субтитров и стенограммы.
1. Выберите **Извлечь**.
1. Отредактируйте скрытые субтитры или текст стенограммы.
1. Когда вы закончите, выберите **Сохранить**, а затем выберите **Вернуть**.
...
1. Перейдите **Активы** и выберите видеоактив.
1. Выберите **Извлечь**.
