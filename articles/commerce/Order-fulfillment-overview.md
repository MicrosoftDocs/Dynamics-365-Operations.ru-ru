...
Формат листа комплектации настраивается в Commerce и добавляется в профиль чеков. Дополнительные сведения о настройке профилей чеков см. в разделе [Шаблоны и печать чеков](receipt-templates-printing.md).
