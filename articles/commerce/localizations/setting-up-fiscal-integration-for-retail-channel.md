...
1. Найдите и включите следующие функции:
    ...
    - **Переопределения технических профилей финансовой интеграции** — эта функция позволяет расширить настройку финансовой интеграции и добавить возможность проверки переопределения параметров технического профиля. Например, можно указать строки подключения к финансовому устройству на уровне отдельных POS-регистраторов. Эта функция также добавляет возможность проверки параметров подключения на странице **Параметры** POS-регистратора. 
    ...
    - **Резервная копия локального хранилища финансовой интеграции** — Эта функция расширяет возможности платформы финансовой интеграции в плане обработки ошибок и обеспечивает автоматическое резервное копирование данных финансовой регистрации, что позволяет восстановить эти сведения в локальном хранилище при активации устройства.
    - **Отложенная регистрация документов** — Эта функция расширяет возможности обработки ошибок в платформе финансовой интеграции путем включения возможности отложить финансовую регистрацию в случае сбоя финансовой регистрации и использовать резервный вариант с финансовой регистрацией или завершить финансовую регистрацию позже, без платформы финансовой интеграции.
...
## <a name="enable-manual-execution-of-deferred-fiscal-registration"></a>Включите выполнение вручную отложенной финансовой регистрации
