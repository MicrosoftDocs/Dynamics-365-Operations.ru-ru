...
- **Отложить** — операторы могут использовать этот параметр, если проводка не была зарегистрирована, так как служба регистрации недоступна. 

> [!NOTE]
> Параметры **Пропустить**, **Пометить как зарегистрированный** и **Отложить** необходимо активировать в процессе финансовой регистрации перед их использованием. Кроме того, операторам должны быть присвоены соответствующие разрешения.

Параметры **Пропустить**, **Пометить как зарегистрированный** и **Отложить** включают информационные коды для регистрации некоторых конкретных сведений о сбое, например причину ошибки или обоснование пропуска финансовой регистрации или пометки проводки как зарегистрированной. Дополнительные сведения о том, как настроить параметры обработки ошибок, см. в разделе [Задание параметров обработки ошибок](setting-up-fiscal-integration-for-retail-channel.md#set-error-handling-settings).
...
### <a name="postpone-option"></a>Параметр Отложить

Параметр **Отложить** позволяет продолжать процесс финансовой регистрации в случае невыполнения текущего шага. Он может использоваться, если имеется параметр резервного копирования финансовой регистрации.
