...
1. В диалоговом окне **Создать фрагмент страницы** выберите модуль **Рекламный баннер**, затем в поле **Имя фрагмента страницы** введите имя (например, **Баннер, общий для каналов**). Затем выберите **OK**.
