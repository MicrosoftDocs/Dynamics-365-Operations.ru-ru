...
Для информации см. раздел [Настройка и установка станции оборудования](retail-hardware-station-configuration-installation.md).
...
### <a name="all-modern-pos-clients-shared-an-iis-hardware-station"></a>Все клиенты Modern POS с общей станцией оборудования IIS
...
Дополнительные сведения о создании профилей оборудования см. в разделе [Определение и ведение клиентов канала, включая регистры и станции оборудования](define-maintain-channel-clients-registers-hw-stations.md). 
...
| Epson        | TM-T88V  | OPOS      |                         |
| Epson        | TM-T88VI | OPOS      |                         |
| Epson        | TM-T88   | Пользовательский    | Подключение по сети   |
| HP           | F7M67AA  | OPOS      | Питание по USB             |
| Star         | TSP650II | Пользовательский    | Подключение по сети   |
...
| Epson        | TM-T88V  | OPOS      |                       |
| Epson        | TM-T88VI | OPOS      |                       |
| Epson        | TM-T88V  | Пользовательский    | Подключение по сети |
| HP           | F7M67AA  | OPOS      | Питание по USB           |
| Star         | TSP650II | Пользовательский    | Подключение по сети |
| Toshiba      | HSP100   | OPOS      |                       |
| Toshiba      | HSP150   | OPOS      |                       |
