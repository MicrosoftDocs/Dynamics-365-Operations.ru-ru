...
В этом разделе объясняются понятия, связанные с периферийными устройствами розничного магазина. В нем описываются различные способы подключения периферийных устройств к POS-терминалу, а также компоненты, которые отвечают за настройку соединения с POS.
...
Для информации см. раздел [Настройка, установка и активация Retail Modern POS](retail-modern-pos-device-activation.md).
...
<td><ul>
<li>OPOS</li>
<li>Сеть <strong>Примечание.</strong> Только один денежный ящик можно настроить, если настроен параметр <strong>Использование совместных смен</strong> для денежного ящика.</li>
</ul></td>
</tr>
<tr class="odd">
<td>Трассант 2</td>
...
**Примечание.** Если станция оборудования IIS является "специальной", существует однозначное соответствие между клиентом POS и станцией оборудования.
...
4.  Перейдите в раздел **Retail и Commerce** &gt; **> ИТ розничной торговли** &gt; **График распределения**.
...
5.  Перейдите в раздел **Retail и Commerce** &gt; **> ИТ розничной торговли** &gt; **График распределения**.
...
**Примечание.** Программа установки станции оборудования автоматически вносит эти изменения реестра в процессе установки через дистанционное обслуживание.
...
**Примечание.** По умолчанию протокол SSL и все версии протокола TLS, за исключением TLS 1.2, отключены. Чтобы изменить или включить эти значения, выполните следующие шаги:
