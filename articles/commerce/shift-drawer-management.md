...
description: В этой статье описывается, как настраивать и использовать смены в POS-терминале (POS) Commerce.
author: josaw1
ms.date: 05/10/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9287466"
---
# <a name="shift-and-cash-drawer-management"></a>Управление сменами и кассовым лотком

[!include [banner](includes/banner.md)]

В этой статье описывается, как настраивать и использовать смены в POS-терминале (POS) Commerce.
...
Дополнительные сведения об инструкции и способах закрытия см. в разделе [Конфигурации магазинов для журналов операций розничной торговли](/dynamics365/unified-operations/retail/tasks/store-configurations-retail-statements).
