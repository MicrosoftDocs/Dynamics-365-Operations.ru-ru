...
Так как Dynamics 365 Commerce поддерживает предварительный просмотр "что видите, то и получаете" (WYSIWYG) с проверкой подлинности, авторы могут готовить свое содержимое страниц, не заботясь о том, что информация станет видимой для посетителей сайта. Если страница должна быть опубликована, но ее демонстрация должна быть ограничена, она должна иметь мета-тег **NOINDEX**, чтобы она не был проиндексирована поисковыми системами. Затем, когда страница готова для всей аудитории, должны присутствовать все базовые метаданные SEO, чтобы повысить эффективность индексирования поисковых систем. Кроме того, следует удалить мета-тег **NOLIMIT**.
