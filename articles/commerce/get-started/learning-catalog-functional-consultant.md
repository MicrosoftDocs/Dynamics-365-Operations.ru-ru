...
| Содержимое | описание | Формат | Длина |
|---------|-------------|--------|--------|
| [Развертывание Dynamics 365 Commerce](/training/paths/deploy-dynamics-365-commerce/) | В этой схеме обучения описывается, как развернуть среды Dynamics 365 Commerce и выполнить процедуры после подготовки для успешной реализации Commerce с помощью правильной топологии для каждого бизнес-потребности розничной торговли. | Бесплатный путь онлайн-обучения в произвольном темпе | 5 часов   |
