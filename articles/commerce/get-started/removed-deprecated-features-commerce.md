...
| &nbsp;  | &nbsp; |
|------------|--------------------|
| **Причина устаревания/удаления** | Рабочая группа Dynamics 365 Commerce проанализировала использование и адаптации функции аналитики Commernce (предварительная версия), и было принято решение перестать развивать эту функцию для того, чтобы сделать ее общедоступной.   |
...
| **Состояние**                         | Мы будем рассматривать отключение этой функции к 30 августа 2022 года.  Начиная с этой даты обновления не будут выполняться в текущих отчетах Power BI, предоставляемых аналитикой Commerce (предварительная версия).     |
