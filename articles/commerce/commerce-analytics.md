...
description: В этой статье объясняется, как установить и использовать возможности аналитики в Microsoft Dynamics 365 Commerce.
author: AamirAllaq
ms.date: 02/24/2022
...
ms.locfileid: "8887174"
---
# <a name="commerce-analytics-preview"></a>Аналитика Commerce (предварительная версия)

[!include [banner](includes/banner.md)]

В этой статье объясняется, как установить аналитику Commerce (предварительная версия), функциональную возможность аналитики, которая включена в Microsoft Dynamics 365 Commerce.
...
2. [Включение и настройка надстройки экспорта в Data Lake](#enableExportToDataLake).
3. [Установка и настройка Azure Synapse workspace](#configureAzureSynapse).
4. [Добавьте секреты в хранилище ключей](#addSecrets).
5. [Включение и настройка надстройки аналитики Commerce (предварительная версия)](#enableCommerceAnalyticsAddin).
6. [Установка приложения шаблона Power BI](#powerbi).
...
Отправьте [форму получения предварительной версии для аналитики Commerce (предварительная версия)](https://forms.office.com/r/vW5VLJGXZ2). После завершения обработки вашего запроса электронное письмо с подтверждением будет отправлено на адрес электронной почты, который указан в форме.
