...
description: В этой статье описываются параметры действия "Добавление продукта в корзину", а также рассказывается, как их применять в Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 07/08/2021
ms.topic: article
ms.prod: ''
