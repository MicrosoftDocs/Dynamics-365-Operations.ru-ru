...
## <a name="create-a-page-fragment-that-contains-a-metatag-for-your-favicon"></a>Создание фрагмента страницы, содержащего метатег для значка сайта

Чтобы создать фрагмент страницы, содержащий метатег для значка сайта, выполните следующие действия.

1. Перейдите к разделу **Фрагменты страницы**, затем выберите **Создать**.
1. В диалоговом окне **Создание фрагмента страницы** выберите **Метатеги** в качестве модуля, на котором основан фрагмент страницы.
1. Введите имя для фрагмента страницы, затем выберите **ОК**.
...
1. Выберите **Завершить редактирование**, а затем нажмите кнопку **Опубликовать**, чтобы опубликовать фрагмент страницы.

## <a name="add-the-metatag-page-fragment-to-the-html-head-section-of-your-pages"></a>Добавьте фрагмент страницы метатега в раздел HTML head страниц

Чтобы добавить фрагмент страницы метатега в раздел HTML **head** страниц, выполните следующие действия.
...
1. В дереве иерархии шаблонов нажмите кнопку с многоточием (**...**) справа от контейнера **HTML head**, а затем выберите **Добавить фрагмент страницы**.
1. В диалоговом окне **Выбор фрагмента страницы** выберите созданный ранее фрагмент страницы метатега и нажмите **ОК**.
1. Выберите **Завершить редактирование**, а затем нажмите кнопку **Опубликовать**, чтобы опубликовать шаблон.

> [!NOTE]
> Если сайт использует более одного шаблона, необходимо добавить фрагмент страницы метатега во все эти шаблоны.

При предварительном просмотре страниц, которые основаны на шаблоне, к которому был добавлен фрагмент страницы метатега, вы должны будете увидеть значок сайта на вкладке браузера.
