...
description: В этом разделе описывается, как интегрировать Microsoft Dynamics 365 Customer Voice на страницы сайта электронной коммерции Dynamics 365 Commerce.
author: samjarawan
ms.date: 05/17/2022
ms.topic: article
...
В этом разделе описывается, как интегрировать Microsoft Dynamics 365 Customer Voice на страницы сайта электронной коммерции Dynamics 365 Commerce.
...
В примерах этой темы используется шаблон проекта **Периодический опрос клиентов** и формат внедрения **Кнопка**.
