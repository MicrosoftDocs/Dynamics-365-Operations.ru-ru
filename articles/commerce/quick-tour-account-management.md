...
---
# <a name="overview-of-account-management-pages"></a>Обзор страниц управления учетными записями
...
На следующем рисунке показан пример страницы **Мой профиль**, которая была создана с помощью начального набора.
