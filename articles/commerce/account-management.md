...
description: В этой статье рассматриваются страницы и модули управления учетными записями в Microsoft Dynamics 365 Commerce.
author: v-chgri
ms.date: 03/17/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8853884"
---
# <a name="account-management-pages-and-modules"></a>Страницы и модули управления учетной записью

[!include [banner](includes/banner.md)]

В этой статье рассматриваются страницы и модули управления учетными записями в Microsoft Dynamics 365 Commerce.
...
Страница "Мой профиль" отображает сведения о профиле учетной записи пользователя, используя модуль профиля учетных записей. На странице отображается адрес электронной почты, связанный с учетной записью пользователя, а также установки, настроенные для данной учетной записи. При настройке пользовательских атрибутов клиента в разделе "Дополнительная информация" также будут показаны эти атрибуты. Пользователи могут изменять свое имя, предпочтения или дополнительную информацию (если имеется).
