...
description: В этой статье приводятся сведения о макетах экрана, входящих в состав набора демонстрационных данных POS-терминала в Dynamics 365 Commerce.
author: josaw1
ms.date: 10/05/2017
ms.topic: article
ms.prod: ''
...
| 4              | Расширенная версия для расширенной обновленной компоновки Fabrikam                                  |
...
Ниже приводится пример кода макета экрана для компании Fabrikam, макет версии 4, для пользователя "Директор магазина":
...
| Полный\*      | 1536 × 864 | 16:9         | Планшеты, более крупные экраны |
...
| Fabrikam        | Сан-Франциско  | Мода        | Зеленый  | Светлая |
...
| Fabrikam        | F4MGR            | Директор магазина | 000160, 000713         |
