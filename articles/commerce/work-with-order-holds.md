---
title: Настройка удержаний заказов центра обработки вызовов и работа с ними
description: В этой статье описывается, как работать с блокировками заказов с помощью Dynamics 365 Commerce.
author: josaw1
ms.date: 05/14/2018
ms.topic: article
ms.prod: ''
...
В этой статье описываются возможности блокировки заказа, имеющиеся в Dynamics 365 Commerce для заказов центра обработки вызовов.
