...
В Dynamics 365 Commerce центр обработки вызовов — это тип канала, который можно определить в приложении. Определение канала для объектов центра обработки вызовов позволяет системе связывать отдельные данные и обработку заказов по умолчанию с заказами на продажу. Компания может определить несколько каналов центра обработки вызовов в Commerce. 
