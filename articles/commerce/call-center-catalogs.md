...
description: Эта статья содержит описание функций специально для центра обработки вызовов по каталогам в Dynamics 365 Commerce.
author: josaw1
ms.date: 05/15/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8884064"
---
# <a name="call-center-catalogs"></a>Каталоги центра обработки вызовов

[!include [banner](includes/banner.md)]

Эта статья содержит описание функций специально для центра обработки вызовов, связанных с возможностями каталога в Dynamics 365 Commerce.
