...
При создании нового каталога, необходимо сначала связать каталог с одним или несколькими каналами. Это можно сделать в **Каналы Commerce**, экспресс-вкладка в форме **Настройка каталога**. Нажмите кнопку **Добавить** и выберите одно или несколько каналов. Только элементы, связанные с выбранным вами каналом [Ассортименты](https://docs.microsoft.com/dynamics365/unified-operations/retail/assortments), могут использоваться при создании каталога.
