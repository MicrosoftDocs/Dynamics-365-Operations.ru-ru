...
description: В этой статье описывается настройка режимов доставки и накладных расходов для заказа центра обработки вызовов в Dynamics 365 Commerce.
author: josaw1
ms.date: 04/26/2018
ms.topic: article
ms.prod: ''
