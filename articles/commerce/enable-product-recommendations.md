...
Кроме того, убедитесь, что измерения RetailSale включены. Дополнительные сведения об этом процессе настройки см. в разделе [Работа с мерами](/dynamics365/ai/customer-insights/pm-measures).
