---
title: Пропорциональное распределение накладных расходов из заголовка по соответствующим строкам продаж
description: В этой статье описываются дополнительные возможности для расчета и применения автоматических расходов по заказам канала Commerce с помощью функции расширенных автоматических накладных расходов.
author: hhaines
ms.date: 03/30/2020
ms.topic: article
ms.prod: ''
