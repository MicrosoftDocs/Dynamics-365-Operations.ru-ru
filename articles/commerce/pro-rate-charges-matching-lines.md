...
В версиях приложения, более ранних, чем версия 10.0.1, автоматические расходы уровня заголовка, которые имеют определенный способ отношений поставки, вычисляются только в том случае, если имеется соответствие со способом поставки, который определяется в заголовке заказа на продажу.
