...
description: В этом разделе описывается, как создавать отчеты для интернет-канала в Microsoft Dynamics 365 Retail.
author: psimolin
manager: annbe
ms.date: 10/01/2019
ms.topic: article
...
В этом разделе описывается, как создавать отчеты для интернет-канала в Microsoft Dynamics 365 Retail.

## <a name="overview"></a>Обзор

Можно создать и просмотреть несколько отчетов в Retail, чтобы увидеть, как работает интернет-канал.
...
1. Откройте пункт **Retail \> Запросы и отчеты \> Отчеты по продажам \> Сводный отчет по каналу**.
...
1. Откройте пункт **Retail \> Запросы и отчеты \> Отчеты по продажам \> Отчет о продажах каналов по годам**.
...
1. Откройте пункт **Retail \> Запросы и отчеты \> Отчеты по продажам \> Отчет о продажах каналов по часам**.
1. В поле **Дата начала** введите дату.
1. В поле **Дата окончания** введите дату.
1. В поле **Канал** выберите интернет-канал.
1. Нажмите **ОК**.
...
1. Откройте пункт **Retail \> Запросы и отчеты \> Отчеты по продажам \> Отчет "Лучшие клиенты"**.
1. В поле **Дата начала** введите дату.
1. В поле **Дата окончания** введите дату.
1. В поле **Канал** выберите интернет-канал.
1. Нажмите **ОК**.
...
1. Откройте пункт **Retail \> Запросы и отчеты \> Отчеты по продажам \> Отчет "Лучшие скидки"**.
1. В поле **Дата начала** введите дату.
1. В поле **Дата окончания** введите дату.
1. В поле **Канал** выберите интернет-канал.
1. Нажмите **ОК**.
...
1. Откройте пункт **Retail \> Запросы и отчеты \> Отчеты по продажам \> Отчет "Самые популярные продукты"**.
1. В поле **Дата начала** введите дату.
1. В поле **Дата окончания** введите дату.
1. В поле **Канал** выберите интернет-канал.
1. Нажмите **ОК**.
...
1. Перейдите в раздел **Retail \> Запросы и отчеты \> Отчеты по продажам \> Отчет о категориях продаж**.
1. В поле **Дата начала** введите дату.
1. В поле **Дата окончания** введите дату.
1. В поле **Канал** выберите интернет-канал.
1. Нажмите **ОК**.
...
В отчете **Продажи по организации** отображается эффективность магазинов розничной торговли по организационным подразделениям. Этот отчет включает количество продаж и сумму по магазинам, а также рентабельность продаж для каждого магазина. Организационное подразделение основано на иерархии отчетности по умолчанию.

Чтобы создать отчет **Продажи по организации**, выполните следующие действия.

1. Перейдите в раздел **Retail \> Запросы и отчеты \> Отчеты по продажам \> Отчет о продажах по организации**.
1. В поле **Дата начала** введите дату.
1. В поле **Дата окончания** введите дату.
1. Нажмите **ОК**.
