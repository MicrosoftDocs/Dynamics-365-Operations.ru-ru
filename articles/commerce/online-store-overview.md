...
description: В этой статье представлен обзор поддержки для сайтов электронной коммерции в Microsoft Dynamics 365 Commerce.
...
Сайты **по умолчанию** и **fabrikam** включают в себя предварительно настроенные шаблоны, фрагменты и страницы, которые помогут приступить к работе. Дополнительные сведения см. в следующих статьях:
...
Сведения об управлении параметрами сайта см. в следующих статьях:
...
Сведения об управлении содержимым сайта см. в следующих статьях:
