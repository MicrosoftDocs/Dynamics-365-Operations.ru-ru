...
description: В этой статье рассматриваются модули оценок и отзывов, используемые на страницах сведений о продукте в Microsoft Dynamics 365 Commerce.
...
ms.locfileid: "9283596"
---
# <a name="ratings-and-reviews-modules"></a>Модули оценок и отзывов

[!include [banner](includes/banner.md)]

В этой статье рассматриваются модули оценок и отзывов, используемые на страницах сведений о продукте (PDP) в Microsoft Dynamics 365 Commerce.
