...
description: В этой статье приводятся сведения о процессах и инструментах, которые можно использовать для устранения неполадок, связанных с рекомендациями по продуктам или их результатами.
author: bebeale
ms.date: 05/26/2020
ms.topic: article
ms.prod: ''
...
В этой статье приводятся сведения о процессах и инструментах, которые можно использовать для устранения неполадок, связанных с [рекомендациями по продуктам](product-recommendations.md) или их результатами.
