...
# [Встроенный в Dynamics 365 для операций](get-started/onboarding-home.md)
## Введение в Dynamics 365 для операций
### [Приступая к работе с эту Microsoft Dynamics 365](get-started/fasttrack-dynamics-365-overview.md)
...
### [Получение версии на предприятии Dynamics AX 2012](/dynamics365/operations/dev-itpro/deployment/csp-download-customersource?toc=/dynamics365/operations/toc.json)
## [Развертывание среды демонстрационные](/dynamics365/operations/dev-itpro/deployment/deploy-demo-environment?toc=/dynamics365/operations/toc.json)
...
### [Dynamics 365 для операций клиента часто задаваемые вопросы](get-started/client-faq.md)
...
### [Настройка способа отображения страниц](get-started/window-management.md)
### [Понимать особенности жизненного цикла служб](/dynamics365/operations/dev-itpro/lifecycle-services/lcs-works-lcs?toc=/dynamics365/operations/toc.json)
...
#### [Создание документации и учебных курсах](/dynamics365/operations/dev-itpro/user-interface/task-recorder?toc=/dynamics365/operations/toc.json)

## [Содержимое справки страной/регионом](/dynamics365/operations/dev-itpro/lcs-solutions/country-region?toc=/dynamics365/operations/toc.json)
...
## [Общие сведения об управлении временных хранилищ](organization-administration/cases.md)
...
## [Настройка и отправить по электронной почте](organization-administration/configure-email.md)
## [Данные даты и времени и часовых поясах](organization-administration/date-time-zones.md)

# Разработки workflow-процесс
## [Обзор системы workflow-процесса](organization-administration/overview-workflow-system.md)
...
## [Создайте workflow-процесс](organization-administration/create-workflow.md)
...
## [Настройте зависимое решение](organization-administration/configure-conditional-decision-workflow.md)
## [Настройка документооборота элемента строки](organization-administration/configure-line-item-workflow.md)
## [Настройка принятия решений вручную](organization-administration/configure-manual-decision-workflow.md)
## [Настройка задачи вручную](organization-administration/configure-manual-task-workflow.md)
## [Настройте параллельное действие](organization-administration/configure-parallel-activity-workflow.md)
## [Настройка параллельной ветви](organization-administration/configure-parallel-branch-workflow.md)
## [Настройка свойств рабочего процесса](organization-administration/configure-workflow-properties.md)
