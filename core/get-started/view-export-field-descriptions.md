...
Можно просматривать описания полей, наведя указатель мыши на поле. Если описание отсутствует, при наведении указателя мыши на поле отобразится имя поля. (Примечание: версия 7.0.0, описания полей можно просмотреть только на **поле описания** страницы.) На следующем рисунке показана в описании поля, которое отображается при наведении указателя на **Блокирование номенклатуры во время подсчета** поле. 
...
Например, ни одно описание отображаются при вводе **инвентаризации** в *** выберите поле страницы ***. Вы открываете раскрывающийся список и увидите две страницы с именем **Инвентаризация** и несколько страниц, в имени которых содержится слово "Инвентаризация". При выборе страницы с именем AOT **InventJournalCount** отобразятся описания полей для этой страницы. Однако, если снова открыть раскрывающийся список, вы увидите, что теперь список содержит все страницы, в имени AOT которых имеется InventJournalCount.
