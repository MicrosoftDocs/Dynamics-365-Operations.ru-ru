...
13. Нажмите на заголовок под кнопкой "Сохранить" с называнием "Журнал производительности" для возврата в сетку.
    * Можно добавить выбранный журнал или журналы к цели, чтобы они отображались при открытии цели. Ссылка добавляется на экспресс-вкладку "Ссылки".    Если добавить журнал к цели а затем добавить цель к оценке, журнал будет отображаться в оценке автоматически.  
