...
Microsoft Dynamics 365 для операций модуль, в котором вы работаете в определяет типы workflow-процесса, которые можно создавать. Выполните следующие действия, чтобы выбрать тип workflow-процесса для создания и открытия редактора workflow-процесса.
...
2.  Щелкните **установки**&gt;**\[имя модуля\] бизнес-правил**.
