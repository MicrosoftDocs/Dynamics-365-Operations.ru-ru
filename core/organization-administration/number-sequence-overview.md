...
description: "Номерные серии в Microsoft Dynamics 365 для операций используются для создания четких уникальных кодов для записей основных данных и записей проводок, для которых требуются коды. Запись основных данных или запись проводки, для которой требуется идентификатор, называется <em>образцом</em>."
author: MargoC
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
