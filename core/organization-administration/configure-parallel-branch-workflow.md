---
title: "Настройка параллельной ветви в рабочем процессе"
...
# <a name="configure-a-parallel-branch-in-a-workflow"></a>Настройка параллельной ветви в рабочем процессе
...
1.  Щелкните правой кнопкой мыши параллельную ветвь, а затем щелкните **свойства**. Будет открыта форма **Свойства**.
...
2.  Перетащите элементы workflow-процесса на холст, а затем настройте элементы, как и любой другой workflow-процесс. Для получения дополнительных сведений см. раздел Создание бизнес-правила.
