...
-   Невозможно объединить записи субъектов, связанных с одной ролью субъекта, такой как клиент или поставщик, в одном юридическом лице. Например сторона A связана с клиентом в компании 123 и субъект Б связан с другого клиента юридического лица 123. Невозможно объединить эти записи субъекта, потому что, если они были объединены, запись субъекта объединенной должна быть связана с несколькими клиентами в той же компании, и это не является допустимым. Однако можно объединить записи, если субъект Б связан с поставщиком в юридическом лице 123 или с клиентом в другом юридическом лице.
