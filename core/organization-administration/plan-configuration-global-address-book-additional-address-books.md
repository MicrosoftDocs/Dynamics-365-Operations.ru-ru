...
description: "В этой статье описываются вопросы и решений, которые необходимо выполнить в процессе планирования, перед тем как настроить и настройте глобальной адресной книги и любые Дополнительные адресные книги в Microsoft Dynamics 365 для операций. Некоторые из решений потребуют от вас подтвердить решения, которые были сделаны в других зонах продукта, таких как организационная иерархия."
author: kfend
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
В этой статье описываются вопросы и решений, которые необходимо выполнить в процессе планирования, перед тем как настроить и настройте глобальной адресной книги и любые Дополнительные адресные книги в Microsoft Dynamics 365 для операций. Некоторые из решений потребуют от вас подтвердить решения, которые были сделаны в других зонах продукта, таких как организационная иерархия.
