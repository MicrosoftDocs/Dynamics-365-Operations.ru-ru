...
description: "В этой статье объясняется, как настраивать и использовать два вида для розничных торговых точек смены продаж (POS) — общей и автономный. Совместные смены могут использоваться несколькими пользователями в нескольких местах, тогда как автономные смены одновременно могут использоваться только одним работником."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
В этой статье объясняется, как настраивать и использовать два вида для розничных торговых точек смены продаж (POS) — общей и автономный. Совместные смены могут использоваться несколькими пользователями в нескольких местах, тогда как автономные смены одновременно могут использоваться только одним работником.
...
## <a name="standalone-shifts"></a>Одиночный смены
...
1.  Щелкните **розничной торговли и электронной коммерции**&gt;**настройку канала**&gt;**настройки POS**&gt;**профилей POS**&gt;**профили оборудования**.
...
4.  Click **Save**.
5.  Щелкните **розничной торговли и электронной коммерции**&gt;**настройку канала**&gt;**настройки POS**&gt;**регистрирует**.
...
8.  Click **Save**.
9.  Щелкните **розничной торговли и электронной коммерции**&gt;**Retail ИТ**&gt;**график распределения**.
