...
Можно найти настройку для масок штрих-кода в разделе **Розница и коммерция** &gt; **Настройка канала** &gt; **Настройка POS** &gt; **Профили POS** &gt; **Профили функциональности**. Экспресс-вкладка **Функции** включает следующие параметры, связанные с расширенным входом.
