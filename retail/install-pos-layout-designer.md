...
-   Когда вы нажимаете **Конструктор**, запрос для загрузки (или выполнения) программы установки не отображаются или текущие параметры безопасности не позволяют загрузить файл. **Решения:**
    ...
    -   В Internet Explorer добавьте URL-адрес Dynamics 365 for Operations в список доверенных сайтов. Щелкните **Настройки** &gt; **Свойства браузера** &gt; **Безопасность** &gt; **Надежные сайты** &gt; **Сайты** &gt; **Добавить**.
-   Программа не запускается и отображается инструкция обратиться к поставщику. **Решение.** В Internet Explorer добавьте URL-адрес Dynamics 365 for Operations в список доверенных сайтов. Щелкните **Настройка** &gt; **Свойства браузера** &gt; **Безопасность** &gt; **Надежные сайты** &gt; **Сайты** &gt; **Добавить**.
