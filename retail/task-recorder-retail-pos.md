---
title: "Регистратор задач и справка для POS"
description: "В этом разделе описан порядок использования регистратора задач в Retail Modern POS и Cloud POS."
author: mugunthanm
manager: AnnBe
ms.date: 2017-05-15
ms.topic: article
...
В этом разделе описан порядок использования регистратора задач в Retail Modern POS и Cloud POS.
...
5.  Перейдите к пункту **Розничная торговля и коммерция** &gt; **ИТ розничной торговли** &gt; **График распределения**.
...
3.  Введите имя и описание записи, затем нажмите **Начать**. Сеанс записи начнется в момент нажатия кнопки **Начать**. **Примечание.** При нажатии кнопки **Закрыть** (**X**) в правом верхнем углу во время выполнения записи область **Регистратор задач** закрывается, но сеанс записи не завершается. Чтобы снова открыть область регистратора задач, нажмите кнопку "Справка" (вопросительный знак) в верхней части экрана. 
...
## <a name="help-at-retail-modern-pos-and-cloud-pos"></a>Справка в Retail Modern POS и Cloud POS
Чтобы отобразить собственные пользовательские записи задач в области справки Retail Modern POS и Cloud POS, чтобы их можно было просмотреть как текст, необходимо сохранить записи задач в собственной библиотеке BPM, а затем обновить параметры системы справки, чтобы она указывала на вашу библиотеку BPM. Дополнительные сведения см. в разделе [Подключение системы справки.](https://ax.help.dynamics.com/en/wiki/working-with-help/#connecting-the-help-system) Справка Retail Modern POS и Cloud POS выполняет поиск в LCS в режиме реального времени. Поиск производится во всех библиотеках BPM, которые выбраны в параметрах системы справки Microsoft Dynamics AX, и отображаются соответствующие результаты. Для доступа к меню **Справка** щелкните кнопку **Справка**, расположенную в верхней части экрана, затем в поле поиска введите имя процесса и нажмите кнопку поиска. 

[![Кнопка "Справка"](./media/help.jpg)](./media/help.jpg) 

При нажатии кнопки проводника по задаче в результатах поиска можно просмотреть шаги в виде раздела справки или экспортировать эти шаги в документ Word. Примечание. Справочная система в Retail Modern POS и Cloud POS не возвращает проводники по задачам автоматически на основании формы или операции; для получения результатов следует ввести имя процесса в поле поиска и нажать кнопку поиска.
