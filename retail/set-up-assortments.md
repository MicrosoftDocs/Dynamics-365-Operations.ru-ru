...
description: "В этой статье описывается, что ассортимент является и объясняется, как настроить ассортименты в Microsoft Dynamics 365 для операций - розничной торговли."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
