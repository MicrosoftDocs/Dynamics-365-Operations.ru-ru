...
## <a name="attribute-type"></a>Тип атрибута
  [![атрибуты-фиксированная-копия](./media/attributes-fixed-copy.png)](./media/attributes-fixed-copy.png) Атрибуты основываются на типах атрибутов. Тип атрибута определяет тип данных, которые можно ввести для определенного атрибута. В настоящее время Microsoft Dynamics 365 for Operations поддерживает следующие типы атрибутов:
