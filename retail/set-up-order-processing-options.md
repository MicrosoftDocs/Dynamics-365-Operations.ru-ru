...
description: "В этом разделе приводятся сведения об обработке заказов для обработки вызовов, с помощью Microsoft Dynamics 365 для операций - розничной торговли."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
