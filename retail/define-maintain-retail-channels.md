...
description: "В этой статье представлен обзор процесса установки и физическими магазинами, которые называются в Microsoft Dynamics 365 розничные магазины для операций. Она содержит сведения о задачах, которую следует выполнить как до, так и после настройки розничного магазина."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
В этой статье представлен обзор процесса установки и физическими магазинами, которые называются в Microsoft Dynamics 365 розничные магазины для операций. Она содержит сведения о задачах, которую следует выполнить как до, так и после настройки розничного магазина.

Поддерживает несколько розничных каналов, такие как Интернет-магазины, контакты и и физическими магазинами, розничной торговли и электронной коммерции в Dynamics 365 для операций. В модуле "Розничная торговля и коммерция" физические магазины называются магазинами розничной торговли. Каждый розничный магазин может иметь свои собственные способы оплаты, группы цен, контрольно-кассовые машины POS, счета выручки и расходов и сотрудников. Необходимо настроит все эти элементы для магазина розничной торговли до его создания. После создания магазина розничной торговли назначаются продукты, которые должны использоваться в магазине. Кроме того, необходимо назначить сотрудников, кассы и клиентов для магазина. Наконец, следует добавить новый магазин в организационную иерархию.

## <a name="setting-up-retail-stores"></a>Настройка розничных магазинов
Перед настройкой розничного магазина в Dynamics 365 for Operations необходимо выполнить некоторые предварительные шаги. Затем можно создать магазин розничной торговли и добавить сведения.
...
11. Настройка штатных сотрудников. **Примечание:** также необходимо назначить соответствующие разрешения, чтобы сотрудник, войдите в систему и осуществлять действия с использованием Dynamics 365 для операций в системе в Retail POS.
