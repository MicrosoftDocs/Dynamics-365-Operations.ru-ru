...
**Цвет заголовка** — цвет заголовка позволяет пользователю настраивать цвет заголовка страницы в соответствии с требованиями бренда предприятия розничной торговли. Эта возможность доступна только в Dynamics 365 for Operations версии 1611.
...
**Цифровая панель** — цифровая панель является основным пользовательским средством ввода на экране проводки POS-терминала. Ее можно настроить для отображения всей экранной панели, что идеально для сенсорных экранов, или для отображения только поля ввода, что может быть использовано с физической клавиатурой. Параметры цифровой панели доступны только в полном макете. В Dynamics 365 for Operations версии 1611 компактные макеты всегда имеют полную цифровую панель, доступную с экрана проводки.

**Панель итогов** — панель итогов можно настроить с одной или двумя столбцами для отображения таких полей, как количество строк, сумма скидки, накладные расходы, промежуточный итог и налог. В Dynamics 365 for Operations версии 1611 компактные макеты поддерживают только панель итогов с одним столбцом. 
