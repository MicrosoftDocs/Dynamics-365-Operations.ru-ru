---
title: "Новые задачи руководства (февраля 2016)"
description: "Этого вики-сайта список задач руководств, выпущенных для библиотек Microsoft BPM по состоянию на февраля 2016.  Библиотеки, которые были опубликованы включают в себя (февраля 2016) APQC единой библиотеки Microsoft Dynamics 365 операций и (февраля 2016) Приступая к работе."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="new-task-guides-february-2016"></a>Новые задачи руководства (февраля 2016)

Этого вики-сайта список задач руководств, выпущенных для библиотек Microsoft BPM по состоянию на февраля 2016.  Библиотеки, которые были опубликованы включают в себя (февраля 2016) APQC единой библиотеки Microsoft Dynamics 365 операций и (февраля 2016) Приступая к работе.

<a name="task-guides-in-the-february-2016-apqc-unified-library-for-microsoft-dynamics-365-for-operations"></a>Задачи руководства в (февраля 2016) APQC единой библиотека для Microsoft Dynamics 365 для операций
---------------------------------------------------------------------------------

(Февраля 2016) единой APQC библиотека содержит руководства задач, которые предназначены для использования для получения справки по Dynamics 365 для операций 7.0.0 на запуск в производство. Если требуется локализованной версии эти руководства задачи, они доступны в (май 2016) APQC единой библиотеки для Microsoft Dynamics 365 для операций. Дополнительные сведения о подключении в справочной системе в библиотеку руководстве задач см. в разделе [приступить к работе с помощью](help-overview.md).
...
| Создать... шаблон продукта \financial-dimensions\dimension-based               | Глобально             |
...
| Запуск... шаблон продукта \financial-dimensions\dimension-based              | Глобально             |
