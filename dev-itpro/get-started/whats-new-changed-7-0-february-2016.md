...
<td>Система справки в текущей версии Dynamics AX показывает руководства по задачам, которые хранятся в Microsoft Dynamics Lifecycle Services (LCS) BPM. Система справки также показывает темы из Microsoft wiki. Дополнительные сведения см. в разделах [Справка Dynamics AX - Приступая к работе](help-overview.md) и [Доступны новые руководства по задачам (февраль 2016 г.)](new-task-guides-available-february-2016.md).</td>
...
<td>Оборотная ведомость с отчетом по итоговым счетам по группе реализована в виде отчета SSRS (LedgerAccountSum\_FR).</td>
...
<td>Товарный код Интрастат содержит текстовое поле для определения дополнительных единиц измерения, и карточка **Продукт** содержит поле для определения дополнительных единиц измерения в килограммах.</td>
