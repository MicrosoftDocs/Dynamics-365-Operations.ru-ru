---
title: "Что такое новые или измененные в Dynamics AX 7.0 (февраля 2016)"
...
# <a name="whats-new-or-changed-in-dynamics-ax-70-february-2016"></a>Что такое новые или измененные в Dynamics AX 7.0 (февраля 2016)
...
<tbody>
<tr class="odd">
<td><strong>Что можно сделать?</strong></td>
<td><strong>Dynamics AX 2012</strong></td>
<td><strong>Dynamics AX 7.0</strong></td>
<td><strong>Почему это важно?</strong></td>
</tr>
<tr class="even">
...
| Автоматизировать сборку, тестирование и развертывание.                                                                            | Частично доступно                                                                                                                                                                                | Выполните развертывание топологии разработчика с помощью виртуальной машины разработки и сборки. Выполните автоматическую конфигурацию виртуальной машины сборки, чтобы обнаруживать и собирать модули из Visual Studio Online (VSO), а также запускать тесты. C\# и поддерживаются компиляции модуля X ++ и ссылки. | Это увеличивает производительность разработчика путем уменьшение затрат и усилий на тестирование и проверки.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| Пользуйтесь преимуществами Business Connector для того, чтобы создавать бизнес-логику и поддерживать сценарии интеграции.         | Business connector является доступным для вызова в коде X ++ из управляемого кода. Рекомендуется использовать business connector только автор бизнес-логики в C\#, а не сценарии интеграции. | Business Connector больше не поддерживается. Требование возможности создания обеспечено фактом, что X++ компилируется в управляемый код. Поэтому межпрограммное взаимодействие упрощается. Сценарии интеграции обеспечиваются путем использования OData.       | Вы больше не можете использовать Business Connector.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
<td>Информационные поля были добавлены на страницу **План счетов**.</td>
<td> Легче получить доступ к важной информации, когда планы счетов определяются и назначаются.</td>
</tr>
<tr class="odd">
<td>Просмотреть корректировки заключительной ведомости и закрывающих проводок в отдельных столбцах на странице списка **Оборотно-сальдовая ведомость**. </td>
<td>Пользователь видит оба типа проводок в одном столбце.</td>
<td>Дополнительный параметр был добавлен на страницу списка **Оборотно-сальдовая ведомость**.</td>
...
<tr class="even">
<td>Использовать новую страницу **Глобальные общие журналы**.</td>
<td>Недоступно </td>
<td>Новая страница **Глобальный общий журнал** для ввода общих журналов. Привилегии для этой страницы добавлены в роль **Бухгалтер**.</td>
<td>Бухгалтер общих служб может вводить общие журналы во всех компаниях, не покидая форму и не меняя контекст компании.</td>
</tr> 
<tr class="odd">
<td>Использовать новую страницу **Анализатор источника учета**.</td>
<td>Доступно с накопительного обновления 10 для Dynamics AX 2012 R3.</td>
<td>Новая страница **Анализатор источника учета** и действия для перехода на нее со страницы списка **Оборотно-сальдовая ведомость** и страницы **Проводки по ваучеру**.</td>
...
<td>Параметры отчета были добавлены, таким образом, различные фильтры применяются при просмотре отчета. Затем создается новый отчет на основе этих фильтров.</td>
...
<td>Анализ финансовых данных с помощью «Отслеживать результаты финансовой деятельности» Power BI содержимое.</td>
<td>Недоступно</td>
<td>На PowerBI.com выберите **Получить данные**, после этого выберите пакет содержимого **Dynamics AX – финансовые показатели**. Введите URL-адрес вашей конечной точки Dynamics AX для того, чтобы данные были отражены на панели мониторинга.</td>
...
<td>Недоступно </td>
<td>Шаблоны закрытия и графики могут быть созданы путем использования конфигурации закрытия финансового периода. Используйте рабочую область **Закрытие финансового периода** для того, чтобы отслеживать ход выполнения графиков закрытия в нескольких компаниях.</td>
...
<tr class="odd">
<td>Контролируйте бюджет в сравнении с фактическими данными и создавайте прогнозы главной книги путем использования рабочей области **Бюджеты и прогнозы главной книги** и дополнительных форм запроса.</td>
<td>Недоступно</td>
<td> В рабочую область можно перейти через панель мониторинга Dynamics AX. Она включает ссылки на несколько новых страниц запроса: **Сводка факт/бюджет**, **Сводка статистики бюджетного контроля**, **Записи бюджетного регистра** и **Бюджетные планы**.</td>
...
<td>Документ **Бюджетный план** просматривается в виде списка строк, которые имеют дату вступления в силу и суммы для сочетаний финансовых аналитик. Пользователь должен создать и использовать шаблоны Excel для того, чтобы просматривать данные бюджетного плана в PivotTable.</td>
...
<tr class="odd">
<td>Напечатать отчет **Проводки по накладным поставщиков**, используя информацию из отчета **Подробный список дат к оплате**, который включает время просрочки в днях. </td>
<td>Вы должны напечатать два различных отчета: **Подробный список дат к оплате** и **Проводки по накладным поставщиков**.</td>
<td>Информация из двух отчетов была консолидирована в отчете **Проводки по накладным поставщиков**. Отчет **Подробный список дат к оплате** устарел. </td>
...
<td>Недоступно</td>
<td>На странице **Период сопоставления налога** вы можете определить, что процесс сопоставления должен выполняться в пакетном режиме.</td>
...
<tr class="even">
<td>Получить доступ к управляемой процедурной справке (руководствам по задачам) и концептуальным разделам, нажав кнопку **Справка**.</td>
...
<td>Система справки в текущей версии Dynamics AX показывает руководства по задачам, которые хранятся в Microsoft Dynamics Lifecycle Services (LCS) BPM. Система справки также показывает темы из Microsoft wiki. Дополнительные сведения см. в разделе [справке Dynamics AX - начало работы](help-overview.md) и [создать задачу руководства (февраля 2016)](new-task-guides-available-february-2016.md).</td>
<td>Руководства по задачам — это контролируемое, управляемое и интерактивное взаимодействие с пользователем, при котором пользователь выполняет пошаговую процедуру выполнения задачи или бизнес-процесса. Можно загрузить и настроить руководства по задачам, предоставляемые корпорацией Майкрософт. Вики-сайт предоставляет более быстрый и гибкий способ создания, доставки и обновления документации по продукту. Поэтому она помогает гарантировать, что вы имеете доступ к самой последней технической информации.</td>
</tr>
</tbody>
</table>
...
<td>Вы должны создать отчеты **НДС по продажам и закупкам** путем использования функции нереализованного НДС, чтобы пользователи могли идентифицировать проводки, которые принадлежат к реализованным и нереализованным разделам на основе статуса.</td>
<td>Отчеты **НДС по продажам и закупкам** были изменены и теперь учитывают функцию условного налога только путем использования конкретных периодов сопоставления для определения нереализованных и реализованных кодов налога.</td>
...
<td>Недоступно</td>
<td>На странице **Параметры основных средств** вы можете выбрать ликвидацию в конце финансового периода или финансового года.</td>
...
<td>Функция реализован как конфигурацию электронной отчетности. Эта функция доступна в Германии и Австрии.</td>
...
<td>Оборотная ведомость с отчетом итоговых счетов для группы реализован как отчет SSRS (LedgerAccountSum\_FR).</td>
...
<td>Отдельные список товарных кодов Интрастат, объединяются с иерархии продуктов типа товарный код.</td>
...
<td>Код Интрастат товара имеет текстовое поле, чтобы определить дополнительные единицы измерения и ** продукции ** карты имеется поле для определения количества дополнительные единицы измерения в килограммах.</td>
...
|------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Что можно сделать?**                                                                                                                                 | **Dynamics AX 2012**                                                                                                             | **Dynamics AX 7.0**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | **Почему это важно?**                                                                                                                                                                                                                                            |
| Выполнить проверку наличия материалов для производственных заказов на отдельной странице, которая открывается из рабочей области **Управление производственным участком**. | Недоступно                                                                                                                    | Заведующий производством может проверить, доступны ли материалы для запланированных производственных заказов на необходимую дату. В рабочей области заведующий производством может увидеть, сколько производственных заказов имеют статус запланированных и ожидают выпуска. На основе динамического сводного плана информация о наличии материалов обновляется, если требования к материалам удовлетворяются наличными запасами для фактических заказов или запланированных заказов. На основе информации о наличии материалов заведующий может выпустить заказы на странице **Доступность материалов**.                                                                                                                                                                                                                                                                                                                        | Это помогает заведующим производством принимать правильные решения о распределении материалов по заказам при выпуске производственных заказов для цеха.                                                                                                       |
| Запустить производственные задания и сообщить о ходе их выполнения с помощью новой страницы **Карта задания — устройство**.                                                              | Форма **Регистрация задания** в первую очередь предназначена для терминалов с большими экранами, и доступ к пользовательскому интерфейсу обычно производится с помощью щелчка мышью. | Несмотря на то что новый ** устройства карты заданий ** страница предназначена для простоты, а также для сенсорного. Страница хорошо помещается на мобильных устройствах, таких как планшеты и телефоны. Для работника цеха она содержит меньше лишней информации и более интуитивна в использовании. Работник может выполнить традиционные задачи, такие как запуск, завершение и сообщение о ходе выполнения задания. Кроме работы над фактическим заданием или выхода из системы и регистрации ухода, работник может просматривать вложения, регистрировать перерыв на обед и выполнить другие действия. Работы помещаются в очередь к работнику в запланированной последовательности, но они могут также выбираться работником. Страница главным образом предназначена для дискретных технологических операций, где материалы подготовлены к производству. Для сценариев, которые связаны с сообщением о сопутствующих и побочных продуктах, и комплектации материалов путем отслеживания аналитик используйте страницу **Регистрация задания**. | Путем введения альтернативного пользовательского интерфейса, который рассчитан на сенсорные операции и доступен с устройств всех типов, таких как экраны терминалов и мобильные устройства, эта функция поможет уменьшить затраты на реализацию для традиционного развертывания регистраций в цехе. |

## <a name="master-planning-and-forecasting"></a>Сводное планирование и прогнозирование
|                                                                                                                            |                                                                                                                                                                                                                                                                                               |                                                                                                                                                                                                                                                                                                                                                                   |                                                                                                                                                         |
|----------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Что можно сделать?**                                                                                                       | **Dynamics AX 2012**                                                                                                                                                                                                                                                                          | **Dynamics AX 7.0**                                                                                                                                                                                                                                                                                                                                               | **Почему это важно?**                                                                                                                              |
| Предупредить пользователя, если заказ на продажу или производственный заказ не готов к поставке к запланированной дате.                         | Предупреждения, которые созданы сводным планированием, называются *сообщениями по фьючерсам*. *Фьючерса* -соглашение между двумя сторонами о покупке или продаже основного средства для цены, согласованная сегодня ( *фьючерса цены*), хотя поставки и оплаты возникают в будущем ( *Дата поставки)*. | *Сообщения по фьючерсам* и *дат фьючерсов* были переименованы *рассчитаны задержек* и * отсрочки даты, * соответственно.                                                                                                                                                                                                                                                   | Терминология, которая использована в AX 2012, была неточна и привела к неправильным переводам.                                                               |
...
<tr class="odd">
<td>Данные продаж для канала розничной торговли можно проанализируйте с помощью Power BI содержимое «Канала розничной торговли монитора производительности».</td>
<td>Недоступно</td>
...
<td>Commerce Data Exchange — это система, которая передает данные между Microsoft Dynamics AX и розничными каналами, такими как интернет-магазины или традиционные магазины. Дополнительную информацию см. в разделе <a href="https://technet.microsoft.com/en-us/library/dn741440.aspx">Commerce Data Exchange [AX 2012]</a>.</td>
...
<td>Для этой функциональности требуется <a href="http://www.microsoft.com/en-us/download/details.aspx?id=42636">System Center 2012 Management Pack для Microsoft Dynamics AX 2012 R3 CU8 Retail</a>.</td>
...
<li>Он предлагает «готовые» альтернативной поставки пакетов, например сочетание узла/складские операции/вариант/режим транспорта, на основании быстрый поставки (Дата начала доступности) условие, которое пользователь может выбрать из.</li>
