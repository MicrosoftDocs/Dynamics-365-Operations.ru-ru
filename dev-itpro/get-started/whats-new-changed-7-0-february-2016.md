...
<td>Система справки в текущей версии Dynamics AX показывает руководства по задачам, которые хранятся в Microsoft Dynamics Lifecycle Services (LCS) BPM. Система справки также показывает темы с сайта документов Microsoft. Дополнительные сведения см. в разделах [Справка Dynamics AX - Приступая к работе](help-overview.md) и [Доступны новые руководства по задачам (февраль 2016 г.)](new-task-guides-available-february-2016.md).</td>
