...
5.  Скопируйте URL-адрес браузера из целевого экземпляра Dynamics 365 for Operations, вставьте его в поле **URL-адрес сервера**, затем удалить все элементы после имени узла. Полученный URL-адрес должен содержать только имя узла.
