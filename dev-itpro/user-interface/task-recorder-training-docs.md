...
-   **Записи задач можно сохранить в BPM.** Можно сохранить запись задачи в строке иерархии в библиотеке средства моделирования бизнес-процессов (BPM) в Lifecycle Services (LCS). Список шагов и диаграмма бизнес-процесса будут созданы из записи. Записи задач, сохраненные в библиотеке BPM, можно отобразить в Dynamics 365 for Operations как справку.
-   **Записи задач можно сохранить как документы Word.** Это позволяет легко создавать печатные обучающие руководства.

Можно создать собственные записи задач, воспроизвести записи задач, предоставленные Майкрософт, или изменить записи задач, предоставленные Майкрософт, в соответствии с собственной конфигурацией. Дополнительные сведения о регистраторе задач см. в разделе [Регистратор задач в Dynamics 365 for Operations](task-recorder.md).
...
1.  В Microsoft Dynamics 365 for Operations откройте Регистратор задач. Регистратор задач расположен в меню **Настройки**.
...
[Справка по Dynamics 365 for Operations](..\get-started\help-overview.md)

[Подключение справки](..\get-started\help-connect.md)

[Регистратор задач в Dynamics 365 for Operations](task-recorder.md)

[Недавно добавленные в регистратор задач функции](\core\get-started\recently-added-editing-features-in-task-recorder)

[Создание новых библиотек обучения для Dynamics AX в Lifecycle Services с помощью регистратора задач (внешняя ссылка)](https://docs.com/mufife/163372c6-f366-4c5a-94fa-93e2c25f878a/creating-new-training-libraries-for-dynamics-ax)
