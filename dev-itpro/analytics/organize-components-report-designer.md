...
2.  На **файл** меню, щелкните **создать**&gt;**определение группы отчетов** чтобы открыть новую группу отчетов в окне просмотра. Можно также щелкнуть **группу отчетов** кнопку ![группу отчетов](https://i-technet.sec.s-msft.com/dynimg/IC679515.gif "группу отчетов") на панели инструментов.
...
4.  На **файл** меню, щелкните **Сохранить** для сохранения измененного отчета группы, щелкните **Сохранить** кнопку ![Сохранить](https://i-technet.sec.s-msft.com/dynimg/IC679516.gif "Сохранить") на панели инструментов.
...
3.  Щелкните **создать отчет** кнопку ![создать отчет о](https://i-technet.sec.s-msft.com/dynimg/IC679517.gif "создать отчет о") для создания отчетов.
...
<li><strong>Финансовые &amp;учетную запись</strong> − A отчет, содержащий общую сводку и подробные сведения о счете.</li>
<li><strong>Финансы, учетная запись, &amp;проводки</strong> − A отчет, содержащий общую сводку и сведения о проводке.</li>
</ul></td>
</tr>
<tr class="even">
<td>Промежуточный</td>
