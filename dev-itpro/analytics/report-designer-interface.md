...
| Просмотр отчета                       | Открытие последней версии созданного отчета в Dynamics 365 для операций. Эта команда доступна от определения отчета, если вы создали по крайней мере один отчет.                                 |
...
| Импорт иерархии набора аналитик         | Откройте диалоговое окно **Иерархия набора аналитик**, где вы можете импортировать иерархию набора аналитик из финансовых данных. Эта команда доступна в определении аналитической структуры для... система \financial-dimensions\dimension-based.  |
...
| Команда | описание                                                  |
|---------|--------------------------------------------------------------|
| Справка    | Открытие Dynamics 365 для операций справки вики-страницу для финансовой отчетности. |
|         |                                                              |
...
| Кнопка                                                                                                                                                                                   | Описание                                                                                                                                                                            |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [![New button](./media/rowc130389.png)](./media/rowc130389.png)                              | Создайте новую (пустое) определение отчета, определение столбца, определение дерева отчетности.                                                                               |
...
| [![Скопировать кнопку](./media/copyc130389.png)](./media/copyc130389.png)                           | Скопируйте выбранный текст в буфер обмена.                                                                                                                                               |
...
| [![Кнопка возврата](./media/redoc130389.png)](./media/redoc130389.png)                           | Реверсировать последнее действие отмены.                                                                                                                                                          |
| [![Найти кнопку](./media/findc130389.png)](./media/findc130389.png)                           | Раскройте диалоговое окно **Найти и заменить**, где вы можете искать и заменять текст в активном окне.                                                                                  |
...
| [![Кнопка блокировки](./media/lockc130389.png)](./media/lockc130389.png)                           | Примените пароль к текущему строительному блоку. Эта кнопка доступна для пользователей, которые имеют роль **Конструктор** или **Администратор**.                                                 |
| [![Кнопка ссылки строк](./media/rowlinkc130389.png)](./media/rowlinkc130389.png)                 | Откройте диалоговое окно **Ссылки на строку**, где вы можете определить источники для ссылок данных в определениях строки и определениях дерева отчетности. Эта кнопка доступна из определения строки. |
| [![Кнопка повышения](./media/promotec130389.png)](./media/promotec130389.png)                  | Повысить единицу определения дерева отчетности. Когда вы выбираете дочернюю единицу и после этого щелкаете **Повысить уровень**, дочерняя единица перемещается к такому же уровню, как ее родительская единица.                |
| [![Понижение кнопка](./media/demotec130389.png)](./media/demotec130389.png)                     | Понизить единицу определения дерева отчетности. Когда вы выбираете единицу и после этого щелкаете **Понизить уровень**, единица становится дочерней относительно единицы, которая предшествует ей.                               |
| [![Кнопка развертывания](./media/expandtreebuttonc130389.png)](./media/expandtreebuttonc130389.png) | Разверните все единицы определения дерева отчетности на уровне выбранной единицы.                                                                                                   |
...
| Кнопка                                                                                                                                                                                                   | Описание                                             |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|
| [![Кнопка стиля шрифта](./media/formattingc130389.png)](./media/formattingc130389.png)                         | Применить выбранный стиль шрифта к текущему тексту.      |
...
| [![Кнопка "Полужирный"](./media/boldc130389.png)](./media/boldc130389.png)                                           | Сделайте настоящий текст жирным.                             |
| [![Кнопка "Курсив"](./media/italicsc130389.png)](./media/italicsc130389.png)                                   | Сделайте настоящий текст курсивом.                           |
| [![Подчеркивание кнопка](./media/underlinec130389.png)](./media/underlinec130389.png)                            | Подчеркнуть настоящий текст.                             |
| [![«Уменьшить отступ»](./media/outdentlsc130389.png)](./media/outdentlsc130389.png)                      | Уменьшить отступ текущего текста.                |
| [![«Увеличить отступ»](./media/indentlsc130389.png)](./media/indentlsc130389.png)                        | Увеличить отступ текущего текста.                |
| [![Кнопки цвет фона](./media/fillbackgroundcolorc130389.png)](./media/fillbackgroundcolorc130389.png) | Изменить Цвет фона текущей ячейки.        |
| [![Кнопки цвет шрифта](./media/fontcolorc130389.png)](./media/fontcolorc130389.png)                           | Изменить Цвет текущего текста.                   |
...
| Кнопка                                                                                                                                                                                          | Описание                                                                                                                                                                  |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [![Кнопка для определения отчета](./media/reportc130389.png)](./media/reportc130389.png)                 | Покажите определение отчета, которое перечислено в меню **Окно**.                                                                                                            |
| [![Определение строки](./media/rowc130389.png)](./media/rowc130389.png)                          | Покажите определение строки, которое задано к активному определению отчета.                                                                                                    |
| [![Кнопку определение столбца](./media/columnc130389.png)](./media/columnc130389.png)                 | Покажите определение столбца, которое задано к активному определению отчета.                                                                                                 |
| [![Кнопки структуры определения отчетов](./media/treec130389.png)](./media/treec130389.png)             | Покажите определение дерева отчетности, которое задано к активному определению отчета.                                                                                         |
| [![Кнопка средства просмотра отчетов](./media/reportviewerc130389.png)](./media/reportviewerc130389.png)         | Запустите Report Viewer и покажите самую последнюю версию созданного отчета. Эта кнопка доступна от определения отчета, если вы создали по крайней мере один отчет. |
| [![Создать кнопку отчет](./media/generate-to-ddvc130389.png)](./media/generate-to-ddvc130389.png) | Создать отчет из активного определения отчета. Эта кнопка доступна из определения отчета.                                                                      |
