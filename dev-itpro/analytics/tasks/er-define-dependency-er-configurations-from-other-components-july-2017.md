...
---
# <a name="define-the-dependency-of-configurations-from-othcomponents-for-electronic-reporting-er"></a>Определение зависимости конфигураций от других компонентов для электронной отчетности (ER)
