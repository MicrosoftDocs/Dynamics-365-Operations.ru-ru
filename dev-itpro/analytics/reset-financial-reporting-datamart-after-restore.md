...
> [!NOTE]
> Корпорация Microsoft не предоставляет учетную запись хранилища как часть договора на Dynamics 365 for Operations. Необходимо либо приобрести учетную запись хранилища, либо использовать учетную запись хранилища из отдельной подписки Azure. 
> [!WARNING]
...
2.  Выберите группу строительных блоков, которую требуется экспортировать, и нажмите кнопку **Экспорт**. 
    > [!NOTE]
    > Для Dynamics 365 for Operations поддерживается только одна группа строительных блоков, **По умолчанию**.
