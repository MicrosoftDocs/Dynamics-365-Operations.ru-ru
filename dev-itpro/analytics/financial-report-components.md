...
Можно экспортировать группу шаблонов или отдельные шаблоны в группы шаблонов. Резервная копия может служить группы экспортированные шаблонов. Можно также скопировать экспортированные данные между группами или Dynamics 365 для операций установки. Конструктор отчетов включает в себя используемые начертания шрифтов и наборы аналитик, а также группы шаблонов.
1.  В конструкторе отчетов, в меню **Компания**, щелкните **Группы строительного блока**.
