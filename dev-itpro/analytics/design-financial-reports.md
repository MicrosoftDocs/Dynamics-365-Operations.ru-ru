...
description: "В этой статье приводятся упражнения, в которых описываются просмотр и создание финансовых отчетов для Microsoft Dynamics 365 for Operations."
author: jcart1106
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
В этой статье приводятся упражнения, в которых описываются просмотр и создание финансовых отчетов для Microsoft Dynamics 365 for Operations. Финансовая отчетность состоит из просмотра в Dynamics 365 for Operations и конструктора отчетов одним щелчком, который позволяет создавать и редактировать финансовые отчеты.  
...
16. Закройте отфильтрованный отчет. Финансовые отчеты можно отобразить в любой валюте, добавленной в Dynamics 365 for Operations.
...
4.  Выберите **Файл**, щелкните **Сохранить как** и назовите отчет "Подробный пробный баланс с атрибутами". Примечание. Каждый раз, когда создается новый отчет в конструкторе отчетов, список финансовых отчетов обновляется в Dynamics 365 for Operations.
...
[Финансовая отчетность](/dynamics365/operations/financials/general-ledger/financial-reporting-getting-started) 
[Просмотр финансовых отчетов](/dynamics365/operations/financials/general-ledger/view-financial-reports) 
