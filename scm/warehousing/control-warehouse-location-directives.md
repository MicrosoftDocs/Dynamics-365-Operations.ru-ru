---
title: "Контроль работы склада с использованием шаблонов рабочих и расположение директивы"
...
# <a name="control-warehouse-work-by-using-work-templates-and-location-directives"></a>Контроль работы склада с использованием шаблонов рабочих и расположение директивы
...
Директивы местоположения имеют один дополнительный уровень детализации: *действия директивы местоположения*. Можно определить несколько действий директивы расположения для каждой строки. Опять же порядковый номер используется для определения действия, оцениваются в порядке. На этом уровне можно настроить запрос для определения способов найти лучший местоположение на складе. Для поиска оптимального расположения можно также использовать предопределенные параметры **Стратегия**.
