...
### <a name="set-up-the-permission-to-move-reserved-inventory-for-individual-workers"></a>Настройка разрешений для перемещения зарезервированных запасов для отдельных работников
