...
Клиенты могут возвращать товары по разным причинам. Например, товар может быть дефектным или может не соответствовать ожиданиям клиента. Процесс возврата начинается, когда клиент отправляет запрос на возврат номенклатуры. После получения запроса клиента в Microsoft Dynamics 365 for Operations создается заказ на возврат.
