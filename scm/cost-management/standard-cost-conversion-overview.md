...
## <a name="2-review-and-change-the-new-costing-version-for-the-conversion-record"></a>2. Просмотрите и измените новой версии цены для записи преобразования
...
## <a name="3-identify-the-items-to-convert-to-standard-cost"></a>3. указать элементы для преобразования в стандартную себестоимость
...
## <a name="4-enter-or-calculate-the-pending-standard-cost-for-each-item-that-is-being-converted"></a>4. Ввод или расчет ожидаемых стандартных затрат для каждой преобразуемой номенклатур
...
## <a name="6-change-the-status-of-the-conversion-record-to-ready"></a>6. Изменение статуса записи преобразования готовности
...
## <a name="7-back-up-the-database-before-conversion"></a>7. Создайте резервную копию базы данных перед преобразованием
Создание резервной копии позволяет восстановить базу данных в случае ошибки во время преобразования.

## <a name="8-perform-the-conversion-when-the-conversion-record-has-a-ready-status"></a>8. выполнение преобразования, когда запись преобразования имеет статус Готово
