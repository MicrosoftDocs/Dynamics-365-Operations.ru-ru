---
title: "Настройка продуктов, произведенных или получены"
description: "Продукты могут быть изготовлены различными способами — произведено (произведенные) или получены (приобретенной). В этой статье описываются некоторые типичные моменты, которые следует учитывать при настройке продуктов для поддержки нескольких источника."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="set-up-products-that-can-be-produced-or-procured"></a>Настройка продуктов, произведенных или получены

Продукты могут быть изготовлены различными способами — произведено (произведенные) или получены (приобретенной). В этой статье описываются некоторые типичные моменты, которые следует учитывать при настройке продуктов для поддержки нескольких источника. 
