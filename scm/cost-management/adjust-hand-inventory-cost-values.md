...
Данная номенклатура настроена первой в складской модели, ФИФО (FIFO), а закрытие запасов было выполнено 28 февраля. Проводка финансового расхода по USD 11.00 будут сопоставлены приходу от 1 февраля, и будет выполнена корректировка в сумме USD 1.00. Следующие приходы на склад будут содержать открытые складские количества:
