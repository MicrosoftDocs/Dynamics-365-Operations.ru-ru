...
Система оценивает эту скользящую среднюю себестоимость номенклатуры с помощью следующей формулы: Расчетная цена = (физическая сумма + финансовая сумма) ÷ (физическое количество + финансовое количество)
...
\* Числитель = (физическая сумма + финансовая сумма) \*\* Знаменатель = (физическое количество + финансовое количество) **Примечание.** Если параметр **Включать физическую стоимость** не выбран для номенклатуры, система использует 0 (ноль) в качестве как физической суммы, так и физического количества. Дополнительные сведения об этом параметре см. в разделе [Включать физическую стоимость](include-physical-value.md).
