...
Модель НЗП бережливого производства в Microsoft Dynamics 365 for Operations позволяет использовать статус единицы обработки канбана для управления материалами, незаконченными продуктами и готовыми продуктами, которые являются частью НЗП.
