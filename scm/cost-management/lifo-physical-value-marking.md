...
-   Над (или под) каждой вертикальной стрелкой значение складской проводки, указанный в формате Quantity@Unitцены.
