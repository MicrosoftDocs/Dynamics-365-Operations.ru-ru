...
-   **Централизованный список работ**— пользователи могут просматривать централизованный список работ для просмотра задач и утверждений workflow назначенных им на всех рабочих процессов, они участвуют в. Этот параметр доступен на странице рабочих элементов.
...
Чтобы создать workflow-процесс, перейдите на закупки и источники &gt;установки &gt;закупки и источники бизнес-правил и создание нового бизнес-правила, выбрав тип для создания workflow-процесса.  
