...
-   Укажите, какие продукты должны иметь возможность заказать ваши сотрудники. Можно отобразить или скрыть определенные продукты в каталоге узла, или можно отобразить или скрыть все продукты в узле.
...
Каталог определяет, какие продукты доступны при создании заявок на покупку, но вы можете использовать правила политики доступа к категории для того, чтобы применить дополнительные ограничения. Поскольку узлы в каталоге представляют собой категории закупок, они могут быть подавлены правилом политики доступа к категории. В этом случае для сотрудников для использования заявок на продукты в этой категории недоступны. Определение правил политики доступа категории на **политики закупок** страницы. В следующей таблице описаны задачи, которые необходимо выполнить, чтобы создать и настроить каталог.
...
[Настройте иерархию категорий закупаемой продукции (руководство по задачам)](http://ax.help.dynamics.com/en/wiki/set-up-a-procurement-category-hierarchy/)
