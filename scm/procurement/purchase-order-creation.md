...
Хотя можно вручную создать заказы на покупку, обычно они создаются из других процессов. Заказы могут создаваться автоматически на основании других документов, таких как заявки. Кроме того они могут быть созданы в рамках сводного планирования процесса с помощью запланированных POs. При использовании соглашения о покупке POs могут быть созданы **заказа на запуск в производство** действия. Также существуют более расширенные методы для автоматического создания заказа на покупку. Например, заказы могут создаваться при использовании прямой поставки или цепочек внутрихолдинговых заказов.
...
После добавления заголовка и строк в заказ на покупку часто необходимо выполнить дополнительные шаги до подтверждения заказа. Из-за большого числа доступных параметров может быть полезно использовать [Поиск действий](/dynamics365/operations/action-search) для поиска соответствующего пункта меню.  
