---
title: "Совместная работа с поставщиками с помощью портала поставщиков"
description: "В этом разделе описывается, как специалисты по закупкам могут использовать портал поставщиков, чтобы сотрудничать со внешними поставщиками в процессе подтверждения заказа на покупку. Эти сведения используются только для февраля 2016 &amp;май 2016 версиях Dynamics AX."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="collaborate-with-vendors-by-using-the-vendor-portal"></a>Совместная работа с поставщиками с помощью портала поставщиков

В этом разделе описывается, как специалисты по закупкам могут использовать портал поставщиков, чтобы сотрудничать со внешними поставщиками в процессе подтверждения заказа на покупку. Эти сведения используются только для февраля 2016 &amp;май 2016 версиях Dynamics AX.

Информация этого раздела относится только к версиям Dynamics AX от февраля 2016 г. и мая 2016 г. Функцию портала поставщика была заменена поставщика расширенного функциональные возможности совместной работы в Dynamics 365 для операций версии 1611. Дополнительные сведения о новых функциональных возможностях совместной работы поставщика см. в разделе [использованию совместной работы поставщика для работы с внешних поставщиков](vendor-collaboration-work-external-vendors.md).  
