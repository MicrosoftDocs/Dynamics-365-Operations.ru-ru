...
# <a name="purchasing-policies"></a>Политики закупок
...
Можно настроить политики закупок по юридическому лицу предприятиями малого и менее сложных и можно использовать только организационную иерархию компаний.  
...
Fabrikam создает 2 политики закупок. Политика А применяется к его США юридического лица 1111. Политика Б применяется к их канадский юридическому лицу 2222. Когда сотрудник юридического лица 1111 создает заявку на покупку, правил политики создаются на основе политики а. Например каталог продукции, который сотрудник видит указана в правиле политики каталогов для политики а.  

Если сотрудник юридического лица 2222 создает заявку на покупку, используются правила политики из политики б.  
...
Правило консолидации создания и спрос заказ на покупку определяет правила политики, который будет использоваться при создании заказа на покупку из утвержденной заявки на покупку. Когда вы создаете правила этого типа, вы можете установить варианты на различных вкладках:
