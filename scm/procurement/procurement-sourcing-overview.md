...
-   Как результат сводного планирования, который указал требование, для которого необходимо покупки. Этот процесс создает спланированные заказы на покупку, а когда они запускаются в производство, заказы на покупку создаются.
...
При создании заказа на покупку, многие поля являются предварительно заполняется значениями, которые по умолчанию из сведениях о поставщике в **поставщики** страницы. Это значит, что в заказе на покупку вам нужно заполнить достаточно небольшое количество полей, хотя при желании вы можете заменить значения, подставленные по умолчанию.
