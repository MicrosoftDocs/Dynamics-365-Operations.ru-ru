---
title: "Общие сведения об управлении качеством"
...
# <a name="quality-management-overview"></a>Общие сведения об управлении качеством
...
<td>Используйте эту страницу для настройки, изменения и просмотра возможных результатов испытаний тестовой переменной, связанной с качественным испытанием. Для каждого результата назначается статус <strong>приемлемый</strong> или <strong>неприемлемый</strong>. Следует определить переменную и ее результаты для каждого качественного испытания, которое определено на странице <strong>Тесты</strong> (Для качественных проверок типа проверки устанавливается равным <strong>параметр</strong> на <strong>тесты</strong> страницы.) Используйте <strong>группы проверки</strong> страницу, чтобы назначить переменной проверки и результат по умолчанию для отдельного качественного испытания.</td>
