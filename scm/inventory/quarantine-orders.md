...
Карантинные заказы можно использовать, чтобы заблокировать запасы. Например, требуется установить карантин для номенклатуры по причинам контроля качества. Запасы, помещенные на карантин перемещается на карантинный склад. **Примечание.** При использовании расширенных процессов управления складом (в модуле управления складом) обработка карантинных заказов используется только для возвращенных заказов на продажу.

## <a name="quarantine-onhand-inventory-items"></a>Карантин onhand складских номенклатур
