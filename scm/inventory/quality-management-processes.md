...
Несоответствие описывает номенклатуру, у который имеется проблема с качеством.** **Процесс несоответствия позволяет создавать заказ на несоответствие, который описывает количество несоответствующего материала, источник проблемы, тип проблемы и пояснительные записки. Пользователь может определить классификацию типов проблем для упрощения анализа несоответствующих материалов. Вы можете также распечатать маркер несоответствия и отчет о несоответствии для того, чтобы обработать несоответствующий материал. Например, марке и отчет могут указывать на состояние **Непригодно для использования** или **Ограниченное использование**. Следующая таблица содержит шесть типов несоответствий по умолчанию и описывает информацию, которую необходимо записать для каждого типа.
