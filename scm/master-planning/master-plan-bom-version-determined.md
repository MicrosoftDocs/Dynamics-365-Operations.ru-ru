---
title: "Определения версии Спецификации"
description: "Во время развертывания спроса Если номенклатура имеет тип заказа по умолчанию для производства, механизм планирования ищет допустимую версию Спецификации, основанную на узле."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="determine-the-bom-version"></a>Определения версии Спецификации

Во время развертывания спроса Если номенклатура имеет тип заказа по умолчанию для производства, механизм планирования ищет допустимую версию Спецификации, основанную на узле. 
