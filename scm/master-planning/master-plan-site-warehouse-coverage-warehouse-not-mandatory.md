---
title: "Сводное планирование для покрытия узла и склада, склад не является обязательным"
...
# <a name="master-planning-for-site-and-warehouse-coverage-warehouse-not-mandatory"></a>Сводное планирование для покрытия узла и склада, склад не является обязательным
