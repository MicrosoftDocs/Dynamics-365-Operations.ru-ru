---
title: "Сводные планы"
description: "Используйте разнообразные сводные планы, чтобы поддерживать ежедневную деятельность компании, моделировать различные стратегии, которые требуется отслеживать и внедрять политику компании, например политику, касающуюся внутренней производительности или клиента удовлетворенности."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Используйте разнообразные сводные планы, чтобы поддерживать ежедневную деятельность компании, моделировать различные стратегии, которые требуется отслеживать и внедрять политику компании, например политику, касающуюся внутренней производительности или клиента удовлетворенности. 
...
[Разделение тактические и рабочем состоянии планирования для сводного планирования](http://blogs.msdn.com/b/axmfg/archive/2012/10/12/separating-tactical-and-operative-planning-for-master-scheduling.aspx)

[Сводное планирование: Используйте статический и динамический сводный план или в одном плане?](https://community.dynamics.com/ax/b/msdynaxlessonslearned/archive/2014/01/16/master-planning-use-a-static-and-dynamic-master-plan-or-use-one-plan)
