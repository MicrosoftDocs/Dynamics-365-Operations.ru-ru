...
description: "В этой статье объясняется сводного планирования сценарий, который включает в себя развертывание спецификации версии спецификации (BOM)."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
В этой статье объясняется сводного планирования сценарий, который включает в себя развертывание спецификации версии спецификации (BOM).
