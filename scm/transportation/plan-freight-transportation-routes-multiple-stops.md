---
title: "Расходы по фрахту транспортировки маршруты с несколькими позициями плана"
description: "В этой статье описываются различные элементы, которые можно использовать для планирования маршрутов транспортировки в Microsoft Dynamics AX."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="plan-freight-transportation-routes-with-multiple-stops"></a>Расходы по фрахту транспортировки маршруты с несколькими позициями плана

В этой статье описываются различные элементы, которые можно использовать для планирования маршрутов транспортировки в Microsoft Dynamics AX.
