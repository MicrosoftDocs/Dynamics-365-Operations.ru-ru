...
| Параметр             | Описание                                                                                                                                                                                                                                                                                                                                                                      |
|-----------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| *RateBaseAssigner*    | Тип .NET, который интерпретирует данные назначения базы ставки для определенной схемы. Значение параметра синтаксиса состоит из двух сегментов, разделенные вертикальной панели ()|). Первый сегмент содержит имя сборки, определяющее тип определителя. Второй сегмент определяет с полное имя типа определителя. Сюда входит пространство имен типа. |
| *MileageEngineCode*   | Код механизма расчета пробега, который определяет запись механизма расчета пробега в базе данных Microsoft Dynamics 365 for Operations.                                                                                                                                                                                                                                                             |
...
-   Определить эту информацию в **управление транспортировкой**&gt;**установки** на **базовый тип ставки** страницы.
