...
| *MileageEngineCode*   | Код механизма расчета пробега, который определяет запись механизма расчета пробега в базе данных Microsoft Dynamics 365 for Finance and Operations.                                                                                                                                                                                                                                                             |
| *ApportionmentEngine* | Код общего механизма, который определяет механизм распределения в базе данных Microsoft Dynamics 365 for Finance and Operations.                                                                                                                                                                                                                                                              |
