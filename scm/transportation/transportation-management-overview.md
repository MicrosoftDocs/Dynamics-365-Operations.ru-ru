...
![Загрузить документ](./media/Load-drawing1-1024x477.jpg)

## <a name="inbound-transportation"></a>Входящая транспортировка
При заказе номенклатур у поставщика, должны быть доставлены номенклатуры на складе, можно расположить транспортировки номенклатур самостоятельно. Dynamics 365 для операций можно использовать для планирования транспортировки и поступления входящего нагрузки. На следующем рисунке показан бизнес-процесс планирования транспортировки входящей загрузки. 
...
![Планирование и обработку исходящих загружает](./media/Planningandprocessingoutboundloads.jpg)
