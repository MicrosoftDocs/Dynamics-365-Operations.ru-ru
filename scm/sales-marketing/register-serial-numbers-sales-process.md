...
Необходимо включить серийные номера для процесса продажи, установив флажок **Активно в процессе продажи** на странице **Группы аналитик отслеживания**. Следующие события после этого происходят в Microsoft Dynamics 365 for Finance and Operations:
