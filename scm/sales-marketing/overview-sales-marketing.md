...
Кампания направлена на контакты для перспективных клиентов, интересов, возможных сделок и клиентов, которые были выбраны для участия в кампании. В Microsoft Dynamics 365 for Operations можно создать несколько типов кампаний, например телемаркетинг, рассылку и кампании по электронной почте, для увеличения числа потенциальных клиентов. По мере реализации кампании и получения положительных ответов можно начать процесс продажи с теми получателями, которые положительно ответили на кампанию.
