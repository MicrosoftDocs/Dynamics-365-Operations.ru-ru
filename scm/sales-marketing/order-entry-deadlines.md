...
Крайний срок ввода заказа во вторник был установлен равным 16:00. В некоторый вторник в 17:00 вы пытаетесь установить текущую дату как дату отгрузки. (Обратите внимание, что является время производства в данном примере). Если **контроль даты поставки** флажок установлен, появится предупреждение о том, что дата не подходит. Это предупреждение появляется на странице **Доступные даты отгрузки и прихода**, где вы можете после этого выбрать альтернативные даты.
...
| День недели             | О: заказа крайние сроки ввода (PST) | Б. заказа крайние сроки ввода (EST) |
|-----------------------------|--------------------------------|--------------------------------|
...
| Узел PST из следующих:         | Узел MST из следующих:        | Узел EST б:           | Узел MST б:        |
|---------------------|--------------------|-----------------------|--------------------|
