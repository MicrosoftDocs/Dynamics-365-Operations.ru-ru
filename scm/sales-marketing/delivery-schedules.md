...
Используйте графика поставки, когда общее количество в строке заказа или предложения, которые должны быть доставлены в несколько отгрузок. Строки поставки представлены в отдельных отгрузках. Два или более строки поставки составляют один график поставки. В строках поставки могут быть указаны различные даты, количества и способы поставки или аналитики хранения, такие как сайт и склад.  
...
Когда вы создаете график поставки, тип строки первоначального заказа автоматически изменяется на **Строка заказа с множественными поставками**. Строка этого типа называется коммерческой строкой и отмечена значком. Строка поставки отмечена другим значком. При изменении количества в строке поставки коммерческих строка будет обновлена с количеством график поставки. Если коммерческое соглашение имеет определенные общей скидки для заказа, график поставки гарантирует заказ взять итоговую скидки по заказу, даже в том случае, когда заказ разбивается на отдельные поставки.  
