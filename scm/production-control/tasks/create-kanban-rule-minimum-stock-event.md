...
---
# Создание правила канбана с помощью события минимального запаса
...
## Задание минимального количества для номенклатуры
...
## Выполнение задания создания события партии
