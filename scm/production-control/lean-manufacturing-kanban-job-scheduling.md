---
title: "Задание канбана для бережливого производства"
...
# <a name="kanban-job-scheduling-for-lean-manufacturing"></a>Задание канбана для бережливого производства
...
Планирование может запускаться автоматически при выборе **автоматическое планирование количества** параметр в правиле канбана. Если задано значение **автоматическое планирование количества** для **1**, каждое задание канбана планируется сразу же при его создании. В результате получается серия операций "первым вытянул — первым получил". Если установить параметр **Автоматическое планирование количества** в значение больше 1, задания канбана перед планированием группируются. Эта концепция позволяет уменьшить размеры канбанов, так чтобы они были меньше фактических экономических размеров партии. Например размер экономической партии для конкретной номенклатуры (или Семейство номенклатур) — 30. Вместо того чтобы создавать канбаны, использования количества продукта, 30, можно настроить правило канбана, чтобы он имел 10 единиц продукции и ** автоматическое планирование количества ** значение **3**. Хотя при автоматическом планировании задания канбана планируются для производственной ячейки только тогда, когда существует три незапланированных задания, планировщик и супервайзер цеха будут видеть, что два незапланированных задания ожидают выполнения. В этом случае планировщик или начальник цеха могут отправить эти два задания в производство путем их планирования вручную или путем создания дополнительных канбанов.
