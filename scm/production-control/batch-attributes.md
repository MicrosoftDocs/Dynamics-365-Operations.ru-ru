...
-   Действия по обеспечению допуска для атрибута **целое** или **дробь** типа. Если значение атрибута выходит за границы минимального и максимального диапазонов, может быть действие, предупреждение или сообщение об ошибке.
