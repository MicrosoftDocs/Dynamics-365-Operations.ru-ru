...
Управление производством интегрируется с другими модулями. Это взаимодействие позволяет менять производственные заказы и обеспечивать автоматическое их обновление во всех связанных процессах и расчетах в системе. Следующие процессы указаны в том в порядке, в каком их следует выполнять.
