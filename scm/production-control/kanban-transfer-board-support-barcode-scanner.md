---
title: "Доска переноса канбана поддержку сканеров штрих-кода"
...
# <a name="kanban-transfer-board-support-for-barcode-scanners"></a>Доска переноса канбана поддержку сканеров штрих-кода
...
При использовании считывателя штрих-кода для выберите задание, режим отображения изменений доски канбана. В этом режиме действуют следующие условия:
...
-   Можно обновить сведения в списке заданий вручную, щелкнув **обновление** (Shift + F5) в области действий. После обновления сведений общие результаты для фильтра задания отображаются еще раз.
