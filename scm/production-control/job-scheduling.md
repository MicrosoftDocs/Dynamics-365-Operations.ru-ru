...
-   В группе ресурсов определите ресурсы для выполнения задания. Для этой задачи требуется указать что группу ресурсов для операции. При планирования задания выбираются ресурсы или группы ресурсов на основе минимального времени упреждения, а также учитываются все предыдущие реверсирования ресурсов.
